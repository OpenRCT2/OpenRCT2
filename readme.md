...
- See the [How To Contribute]() section of the wiki for a more in-depth explanation of the concrete steps required to contribute (forking, cloning, pull requests, etc.). The wiki contains other documentation contributors may find useful, such a detailed description of data structures used in the game.
---

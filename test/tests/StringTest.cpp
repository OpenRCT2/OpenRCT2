...
TEST_F(StringTest, Convert_950_to_UTF8)
{
    ...
    auto actual = String::Convert(input, CODE_PAGE::OPENRCT2_CP_950, CODE_PAGE::OPENRCT2_CP_UTF8);
    ASSERT_EQ(expected, actual);
}
...
TEST_F(StringTest, Convert_UTF8_to_932)
{
    ...
    auto actual = String::Convert(input, CODE_PAGE::OPENRCT2_CP_UTF8, CODE_PAGE::OPENRCT2_CP_932);
    ASSERT_EQ(expected, actual);
}
...
TEST_F(StringTest, Convert_UTF8_to_UTF8)
{
    ...
    auto expected = input;
    auto actual = String::Convert(input, CODE_PAGE::OPENRCT2_CP_UTF8, CODE_PAGE::OPENRCT2_CP_UTF8);
    ASSERT_EQ(expected, actual);
}
...
TEST_F(StringTest, Convert_Empty)
{
    auto input = "";
    auto expected = input;
    auto actual = String::Convert(input, CODE_PAGE::OPENRCT2_CP_1252, CODE_PAGE::OPENRCT2_CP_UTF8);
    ASSERT_EQ(expected, actual);
}

...
static uint32 InterceptPaintFull(uint8 function, uint32 eax, uint32 ebx, uint32 ecx, uint32 edx, uint32 esi, uint32 edi,
                                 uint32 ebp);
...
static paint_struct * Paint6C(uint32 imageID, sint8 xOffset, sint8 yOffset, sint16 boundBoxLengthX, sint16 boundBoxLengthY,
                              sint8 boundBoxLengthZ, sint16 zOffset, uint32 rotation)
{
    function_call call          = { 0 };
...
static paint_struct * PaintFull(uint8 function, uint32 imageID, sint8 xOffset, sint8 yOffset, sint16 boundBoxLengthX,
                                sint16 boundBoxLengthY, sint8 boundBoxLengthZ, sint16 zOffset, sint16 boundBoxOffsetX,
                                sint16 boundBoxOffsetY, sint16 boundBoxOffsetZ, uint32 rotation)
{
    function_call call          = { 0 };
    call.function               = function;
    call.paint.image_id         = imageID;
...
static void CheckSegmentSupportHeight()
{
    ...
    for (int i = 0; i < 9; i++)
    {
        if (gSupportSegments[i].height != 0)
            hasChanged = true;
        if (gSupportSegments[i].slope != 0xFF)
            hasChanged = true;
    }
...
static uint32 InterceptPaint6C(uint32 eax, uint32 ebx, uint32 ecx, uint32 edx, uint32 esi, uint32 edi, uint32 ebp)
{
    ...
    return (uintptr_t)Paint6C(ebx, (sint8)(eax & 0xFF), (sint8)(ecx & 0xFF), (sint16)(edi & 0xFFFF), (sint16)(esi & 0xFFFF),
                              (sint8)((eax >> 8) & 0xFF), edx & 0xFFFF, ebp & 0x03);
}
                                 ...
                                 uint32 ebp)
{
    ...
    rct_xyz16 boundOffset = { RCT2_GLOBAL(RCT2_ADDRESS_PAINT_BOUNDBOX_OFFSET_X, sint16),
                              RCT2_GLOBAL(RCT2_ADDRESS_PAINT_BOUNDBOX_OFFSET_Y, sint16),
                              RCT2_GLOBAL(RCT2_ADDRESS_PAINT_BOUNDBOX_OFFSET_Z, sint16) };

    return (uintptr_t)PaintFull(function, ebx, (sint8)(eax & 0xFF), (sint8)(ecx & 0xFF), (sint16)(edi & 0xFFFF),
                                (sint16)(esi & 0xFFFF), (sint8)((eax >> 8) & 0xFF), edx & 0xFFFF, boundOffset.x, boundOffset.y,
                                boundOffset.z, ebp & 0x03);
}
};
...
{
    return PaintIntercept::Paint6C(image_id, x_offset, y_offset, bound_box_length_x, bound_box_length_y, bound_box_length_z,
                                   z_offset, rotation);
}
...
{
    return PaintIntercept::PaintFull(PAINT_98197C, image_id, x_offset, y_offset, bound_box_length_x, bound_box_length_y,
...
paint_struct * sub_98198C(uint32 image_id, sint8 x_offset, sint8 y_offset, sint16 bound_box_length_x, sint16 bound_box_length_y,
                          ...
                          sint16 bound_box_offset_z, uint32 rotation)
{
    return PaintIntercept::PaintFull(PAINT_98198C, image_id, x_offset, y_offset, bound_box_length_x, bound_box_length_y,
                                     bound_box_length_z, z_offset, bound_box_offset_x, bound_box_offset_y, bound_box_offset_z,
                                     rotation);
}
...
paint_struct * sub_98199C(uint32 image_id, sint8 x_offset, sint8 y_offset, sint16 bound_box_length_x, sint16 bound_box_length_y,
                          ...
                          sint16 bound_box_offset_z, uint32 rotation)
{
    return PaintIntercept::PaintFull(PAINT_98199C, image_id, x_offset, y_offset, bound_box_length_x, bound_box_length_y,
                                     bound_box_length_z, z_offset, bound_box_offset_x, bound_box_offset_y, bound_box_offset_z,
                                     rotation);
}

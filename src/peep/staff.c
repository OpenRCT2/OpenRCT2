                                           ...
                                           int * newPeep_sprite_index)
{
    ...
    else
    {
        ...
        if (network_get_mode() == NETWORK_MODE_NONE &&
            gConfigGeneral.auto_staff_placement != ((SDL_GetModState() & KMOD_SHIFT) != 0))
        {
...
{
    *ebx = staff_hire_new_staff_member((*ebx & 0xFF00) >> 8, *ebx & 0xFF, *eax & 0xFFFF, *ecx & 0xFFFF, *edx & 0xFFFF, edi);
}

...
void game_command_cheat(int * eax, int * ebx, int * ecx, int * edx, int * esi, int * edi, int * ebp)
{
    ...
    if (*ebx & GAME_COMMAND_FLAG_APPLY)
    {
        ...
        case CHEAT_FASTLIFTHILL:
            gCheatsFastLiftHill = !gCheatsFastLiftHill;
            break;
        case CHEAT_DISABLEBRAKESFAILURE:
            gCheatsDisableBrakesFailure = !gCheatsDisableBrakesFailure;
            break;
        case CHEAT_DISABLEALLBREAKDOWNS:
            gCheatsDisableAllBreakdowns = !gCheatsDisableAllBreakdowns;
            break;
        case CHEAT_DISABLETRAINLENGTHLIMIT:
            gCheatsDisableTrainLengthLimit = !gCheatsDisableTrainLengthLimit;
            break;
        case CHEAT_ENABLECHAINLIFTONALLTRACK:
            gCheatsEnableChainLiftOnAllTrack = !gCheatsEnableChainLiftOnAllTrack;
            break;
        ...
        case CHEAT_BUILDINPAUSEMODE:
            gCheatsBuildInPauseMode = !gCheatsBuildInPauseMode;
            break;
        case CHEAT_IGNORERIDEINTENSITY:
            gCheatsIgnoreRideIntensity = !gCheatsIgnoreRideIntensity;
            break;
        case CHEAT_DISABLEVANDALISM:
            gCheatsDisableVandalism = !gCheatsDisableVandalism;
            break;
        case CHEAT_DISABLELITTERING:
            gCheatsDisableLittering = !gCheatsDisableLittering;
            break;
        case CHEAT_INCREASEMONEY:
            cheat_increase_money(*edx);
            break;
        ...
        case CHEAT_FREEZECLIMATE:
            gCheatsFreezeClimate = !gCheatsFreezeClimate;
            break;
        case CHEAT_NEVERENDINGMARKETING:
            gCheatsNeverendingMarketing = !gCheatsNeverendingMarketing;
            break;
        ...
        case CHEAT_ALLOW_ARBITRARY_RIDE_TYPE_CHANGES:
            gCheatsAllowArbitraryRideTypeChanges = !gCheatsAllowArbitraryRideTypeChanges;
            window_invalidate_by_class(WC_RIDE);
            break;
        }

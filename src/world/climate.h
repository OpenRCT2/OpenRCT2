...
#define gClimateCurrentSnowLevel		RCT2_GLOBAL(RCT2_ADDRESS_CURRENT_SNOW_LEVEL, uint8)
...
#define gClimateNextSnowLevel			RCT2_GLOBAL(RCT2_ADDRESS_NEXT_SNOW_LEVEL, uint8)

...
const rct_ride_name_convention RideNameConvention[96] = {
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 00 Spiral Roller coaster
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 01 Stand Up Coaster
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 02 Suspended Swinging
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 03 Inverted
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 04 Steel Mini Coaster
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 05 Mini Railroad
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 06 Monorail
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 07 Mini Suspended Coaster
	{ RIDE_COMPONENT_TYPE_BOAT,			RIDE_COMPONENT_TYPE_DOCKING_PLATFORM,	RIDE_COMPONENT_TYPE_DOCKING_PLATFORM,	0 }, // 08 Boat Ride
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 09 Wooden Wild Mine/Mouse
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 0a Steeplechase/Motorbike/Soap Box Derby
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 0b Car Ride
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 0c Launched Freefall
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 0d Bobsleigh Coaster
	{ RIDE_COMPONENT_TYPE_CABIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 0e Observation Tower
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 0f Looping Roller Coaster
	{ RIDE_COMPONENT_TYPE_BOAT,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 10 Dinghy Slide
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 11 Mine Train Coaster
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 12 Chairlift
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 13 Corkscrew Roller Coaster
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 14 Maze
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_BUILDING,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 15 Spiral Slide
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 16 Go Karts
	{ RIDE_COMPONENT_TYPE_BOAT,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 17 Log Flume
	{ RIDE_COMPONENT_TYPE_BOAT,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 18 River Rapids
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_BUILDING,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 19 Bumper Cars
	{ RIDE_COMPONENT_TYPE_SHIP,			RIDE_COMPONENT_TYPE_STRUCTURE,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 1a Pirate Ship
	{ RIDE_COMPONENT_TYPE_SHIP,			RIDE_COMPONENT_TYPE_STRUCTURE,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 1b Swinging Inverter Ship
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_BUILDING,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 1c Food Stall
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_BUILDING,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 1d (none)
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_BUILDING,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 1e Drink Stall
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_BUILDING,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 1f (none)
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_BUILDING,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 20 Shop (all types)
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_STRUCTURE,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 21 Merry Go Round
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_BUILDING,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 22 Balloon Stall (maybe)
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_BUILDING,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 23 Information Kiosk
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_BUILDING,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 24 Bathroom
	{ RIDE_COMPONENT_TYPE_WHEEL,		RIDE_COMPONENT_TYPE_STRUCTURE,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 25 Ferris Wheel
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_STRUCTURE,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 26 Motion Simulator
	{ RIDE_COMPONENT_TYPE_BUILDING,		RIDE_COMPONENT_TYPE_STRUCTURE,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 27 3D Cinema
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_STRUCTURE,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 28 Topspin
	{ RIDE_COMPONENT_TYPE_RING,			RIDE_COMPONENT_TYPE_STRUCTURE,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 29 Space Rings
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 2a Reverse Freefall Coaster
	{ RIDE_COMPONENT_TYPE_CABIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 2b Elevator
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 2c Vertical Drop Roller Coaster
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_BUILDING,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 2d ATM
	{ RIDE_COMPONENT_TYPE_STRUCTURE,	RIDE_COMPONENT_TYPE_STRUCTURE,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 2e Twist
	{ RIDE_COMPONENT_TYPE_BUILDING,		RIDE_COMPONENT_TYPE_STRUCTURE,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 2f Haunted House
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_BUILDING,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 30 First Aid
	{ RIDE_COMPONENT_TYPE_BUILDING,		RIDE_COMPONENT_TYPE_STRUCTURE,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 31 Circus Show
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 32 Ghost Train
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 33 Twister Roller Coaster
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 34 Wooden Roller Coaster
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 35 Side-Friction Roller Coaster
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 36 Wild Mouse
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 37 Multi Dimension Coaster
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 38 (none)
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 39 Flying Roller Coaster
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 3a (none)
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 3b Virginia Reel
	{ RIDE_COMPONENT_TYPE_BOAT,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 3c Splash Boats
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 3d Mini Helicopters
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 3e Lay-down Roller Coaster
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 3f Suspended Monorail
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 40 (none)
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 41 Reverser Roller Coaster
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 42 Heartline Twister Roller Coaster
	{ RIDE_COMPONENT_TYPE_PLAYER,		RIDE_COMPONENT_TYPE_COURSE,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 43 Mini Golf
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 44 Giga Coaster
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 45 Roto-Drop
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_BUILDING,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 46 Flying Saucers
	{ RIDE_COMPONENT_TYPE_BUILDING,		RIDE_COMPONENT_TYPE_STRUCTURE,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 47 Crooked House
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 48 Monorail Cycles
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 49 Compact Inverted Coaster
	{ RIDE_COMPONENT_TYPE_BOAT,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 4a Water Coaster
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 4b Air Powered Vertical Coaster
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 4c Inverted Hairpin Coaster
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_STRUCTURE,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 4d Magic Carpet
	{ RIDE_COMPONENT_TYPE_BOAT,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_DOCKING_PLATFORM,	0 }, // 4e Submarine Ride
	{ RIDE_COMPONENT_TYPE_BOAT,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 4f River Rafts
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_BUILDING,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 50 (none)
	{ RIDE_COMPONENT_TYPE_WHEEL,		RIDE_COMPONENT_TYPE_STRUCTURE,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 51 Enterprise
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_BUILDING,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 52 (none)
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_BUILDING,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 53 (none)
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_BUILDING,			RIDE_COMPONENT_TYPE_STATION,			0 }, // 54 (none)
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 55 (none)
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 56 Inverted Impulse Coaster
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 57 Mini Roller Coaster
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 58 Mine Ride
	{ RIDE_COMPONENT_TYPE_CAR,			RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }, // 59 LIM Launched Roller Coaster
	{ RIDE_COMPONENT_TYPE_TRAIN,		RIDE_COMPONENT_TYPE_TRACK,				RIDE_COMPONENT_TYPE_STATION,			0 }
};

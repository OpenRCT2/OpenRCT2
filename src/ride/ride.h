...
enum
{
    ...
    RIDE_TYPE_FLAG_TRACK_ELEMENTS_HAVE_TWO_VARIETIES = 1 << 12, // used by rides with two variaties, like the u and o shapes of
                                                                // the dinghy slide and the dry and submerged track of the water
                                                                // coaster

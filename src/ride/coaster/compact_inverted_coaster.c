...
/** rct2: 0x008AE6E0 */
static void compact_inverted_rc_track_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
...
static void compact_inverted_rc_track_station(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                              rct_map_element * mapElement)
{
...
/** rct2: 0x008AE6F0 */
static void compact_inverted_rc_track_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
    ...
    if (track_paint_util_should_paint_supports(gPaintMapPosition))
    {
        ...
        {
        case 0:
            metal_a_supports_paint_setup(11, 6, 0, height + 56, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(11, 8, 0, height + 56, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_a_supports_paint_setup(11, 7, 0, height + 56, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_a_supports_paint_setup(11, 5, 0, height + 56, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
    }
...
/** rct2: 0x008AE700 */
static void compact_inverted_rc_track_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
...
/** rct2: 0x008AE710 */
static void compact_inverted_rc_track_flat_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
...
/** rct2: 0x008AE720 */
static void compact_inverted_rc_track_25_deg_up_to_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26629, 0, 0, 32, 10, 49, height + 29, 0, 10,
                               height + 11);
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26626, 0, 0, 32, 2, 49, height + 29, 0, 4, height + 11);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26630, 0, 0, 32, 10, 49, height + 29, 0, 10,
                               height + 11);
    ...
    else
    {
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26577, 0, 0, 32, 10, 49, height + 29, 0, 10,
                               height + 11);
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26574, 0, 0, 32, 2, 49, height + 29, 0, 4, height + 11);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26578, 0, 0, 32, 10, 49, height + 29, 0, 10,
                               height + 11);
...
/** rct2: 0x008AE730 */
static void compact_inverted_rc_track_60_deg_up_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26635, 0, 0, 32, 10, 49, height + 29, 0, 10,
                               height + 11);
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26632, 0, 0, 32, 2, 49, height + 29, 0, 4, height + 11);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26636, 0, 0, 32, 10, 49, height + 29, 0, 10,
                               height + 11);
    ...
    else
    {
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26583, 0, 0, 32, 10, 49, height + 29, 0, 10,
                               height + 11);
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26580, 0, 0, 32, 2, 49, height + 29, 0, 4, height + 11);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26584, 0, 0, 32, 10, 49, height + 29, 0, 10,
                               height + 11);
    ...
    if (track_paint_util_should_paint_supports(gPaintMapPosition))
    {
        ...
        {
        case 0:
            metal_a_supports_paint_setup(11, 6, 0, height + 70, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(11, 8, 0, height + 70, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_a_supports_paint_setup(11, 7, 0, height + 70, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_a_supports_paint_setup(11, 5, 0, height + 70, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
    }
...
/** rct2: 0x008AE740 */
static void compact_inverted_rc_track_25_deg_up_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
...
/** rct2: 0x008AE750 */
static void compact_inverted_rc_track_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
...
/** rct2: 0x008AE760 */
static void compact_inverted_rc_track_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
...
/** rct2: 0x008AE770 */
static void compact_inverted_rc_track_flat_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
...
/** rct2: 0x008AE780 */
static void compact_inverted_rc_track_25_deg_down_to_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
...
/** rct2: 0x008AE790 */
static void compact_inverted_rc_track_60_deg_down_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                 int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008AE7A0 */
static void compact_inverted_rc_track_25_deg_down_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
...
/** rct2: 0x008AE7B0 */
static void compact_inverted_rc_track_left_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    ...
    case 2:
        ...
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26703, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26688, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26692, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26697, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26702, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 3:
    ...
    case 5:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26691, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 1:
        ...
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26686, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008AE7C0 */
static void compact_inverted_rc_track_right_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
...
/** rct2: 0x008AE7D0 */
static void compact_inverted_rc_track_flat_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008AE7E0 */
static void compact_inverted_rc_track_flat_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008AE7F0 */
static void compact_inverted_rc_track_left_bank_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008AE800 */
static void compact_inverted_rc_track_right_bank_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008AE810 */
static void compact_inverted_rc_track_banked_left_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                 int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 2:
        ...
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26747, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26732, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26736, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26741, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26746, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 3:
    ...
    case 5:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26735, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 1:
        ...
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26730, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008AE820 */
static void compact_inverted_rc_track_banked_right_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                  int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn5TilesToRightQuarterTurn5Tiles[trackSequence];
...
/** rct2: 0x008AE830 */
static void compact_inverted_rc_track_left_bank_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008AE840 */
static void compact_inverted_rc_track_right_bank_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008AE850 */
static void compact_inverted_rc_track_25_deg_up_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008AE860 */
static void compact_inverted_rc_track_25_deg_up_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008AE870 */
static void compact_inverted_rc_track_left_bank_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008AE880 */
static void compact_inverted_rc_track_right_bank_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008AE890 */
static void compact_inverted_rc_track_25_deg_down_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008AE8A0 */
static void compact_inverted_rc_track_25_deg_down_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008AE8B0 */
static void compact_inverted_rc_track_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008AE8C0 */
static void compact_inverted_rc_track_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
...
/** rct2: 0x008AE8D0 */
static void compact_inverted_rc_track_left_quarter_turn_5_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                    int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_C4 | SEGMENT_CC | SEGMENT_D0 | SEGMENT_D4, direction), 0xFFFF, 0);
        metal_a_supports_paint_setup(11, 4, 0, height + 48, gTrackColours[SCHEME_SUPPORTS]);
...
/** rct2: 0x008AE8E0 */
static void compact_inverted_rc_track_right_quarter_turn_5_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                     int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_BC | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_CC | SEGMENT_D0, direction), 0xFFFF, 0);
        metal_a_supports_paint_setup(11, 4, 0, height + 48, gTrackColours[SCHEME_SUPPORTS]);
    ...
    case 6:
        ...
        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_B8 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_CC | SEGMENT_D4, direction), 0xFFFF, 0);
        metal_a_supports_paint_setup(11, 4, 0, height + 48, gTrackColours[SCHEME_SUPPORTS]);
...
/** rct2: 0x008AE8F0 */
static void compact_inverted_rc_track_left_quarter_turn_5_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                      int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn5TilesToRightQuarterTurn5Tiles[trackSequence];
...
/** rct2: 0x008AE900 */
static void compact_inverted_rc_track_right_quarter_turn_5_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                       int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn5TilesToRightQuarterTurn5Tiles[trackSequence];
...
/** rct2: 0x008AE910 */
static void compact_inverted_rc_track_s_bend_left(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AE920 */
static void compact_inverted_rc_track_s_bend_right(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AE930 */
static void compact_inverted_rc_track_left_vertical_loop(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        paint_util_set_segment_support_height(paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_B8 | SEGMENT_C0 | SEGMENT_C4 |
        ...
        {
        case 0:
            metal_a_supports_paint_setup(11, 6, 0, height + 49, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(11, 8, 0, height + 49, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_a_supports_paint_setup(11, 7, 0, height + 49, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_a_supports_paint_setup(11, 5, 0, height + 49, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
    ...
    case 1:
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27026, 0, 14, 32, 2, 63, height + 29, 0, 29,
                               height + 29);
            break;
        case 2:
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27019, 16, 0, 5, 2, 119, height + 2, 16, 29,
                               height + 2);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27027, 12, 0, 32, 2, 119, height + 2, 0, -6,
                               height + 2);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27022, 10, 16, 4, 2, 119, height + 2, 10, 0,
                               height + 2);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27030, 16, 16, 2, 2, 119, height + 2, 29, 29,
                               height + 2);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008AE940 */
static void compact_inverted_rc_track_right_vertical_loop(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        paint_util_set_segment_support_height(paint_util_rotate_segments(SEGMENT_B8 | SEGMENT_BC | SEGMENT_C0 | SEGMENT_C4 |
                                                                             SEGMENT_C8 | SEGMENT_CC | SEGMENT_D0 | SEGMENT_D4,
                                                                         direction),
                                              0xFFFF, 0);
        switch (direction)
    ...
    case 1:
        ...
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27042, 0, 14, 32, 2, 63, height + 29, 0, 29,
                               height + 29);
            break;
        case 3:
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27046, 16, 16, 2, 2, 119, height + 2, 29, 29,
                               height + 2);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27038, 10, 16, 4, 2, 119, height + 2, 10, 0,
                               height + 2);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27043, 12, 0, 32, 2, 119, height + 2, 0, -6,
                               height + 2);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27035, 16, 0, 5, 2, 119, height + 2, 16, 29,
                               height + 2);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008AE980 */
static void compact_inverted_rc_track_left_quarter_turn_3(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26709, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26715, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26706, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008AE990 */
static void compact_inverted_rc_track_right_quarter_turn_3(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
...
/** rct2: 0x008AE9A0 */
static void compact_inverted_rc_track_left_quarter_turn_3_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26721, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26727, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26718, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008AE9B0 */
static void compact_inverted_rc_track_right_quarter_turn_3_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
...
/** rct2: 0x008AE9C0 */
static void compact_inverted_rc_track_left_quarter_turn_3_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                    int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_C4 | SEGMENT_CC | SEGMENT_D0 | SEGMENT_D4, direction), 0xFFFF, 0);
        metal_a_supports_paint_setup(11, 4, 0, height + 46, gTrackColours[SCHEME_SUPPORTS]);
...
/** rct2: 0x008AE9D0 */
static void compact_inverted_rc_track_right_quarter_turn_3_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                     int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AE9E0 */
static void compact_inverted_rc_track_left_quarter_turn_3_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                      int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
...
/** rct2: 0x008AE9F0 */
static void compact_inverted_rc_track_right_quarter_turn_3_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                       int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
...
/** rct2: 0x008AEA00 */
static void compact_inverted_rc_track_left_twist_down_to_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AEA10 */
static void compact_inverted_rc_track_right_twist_down_to_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AEA20 */
static void compact_inverted_rc_track_left_twist_up_to_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AEA30 */
static void compact_inverted_rc_track_right_twist_up_to_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AEA40 */
static void compact_inverted_rc_track_half_loop_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27082, 0, 14, 32, 2, 63, height + 29, 0, 29,
                               height + 29);
            break;
        case 2:
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27075, 16, 0, 5, 2, 119, height + 2, 16, 29,
                               height + 2);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27083, 12, 0, 32, 2, 119, height + 2, 0, -6,
                               height + 2);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27078, 10, 16, 4, 2, 119, height + 2, 10, 0,
                               height + 2);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27086, 16, 16, 2, 2, 119, height + 2, 29, 29,
                               height + 2);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27085, 0, 16, 32, 20, 3, height + 34, 0, 6,
                               height + 34);
            break;
        }
        if (direction == 0 || direction == 3)
...
/** rct2: 0x008AEA50 */
static void compact_inverted_rc_track_half_loop_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
...
/** rct2: 0x008AEA60 */
static void compact_inverted_rc_track_left_corkscrew_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 2:
        ...
        metal_a_supports_paint_setup(11, 4, 0, height + 28, gTrackColours[SCHEME_SUPPORTS]);
        switch (direction)
        {
        case 2:
...
/** rct2: 0x008AEA70 */
static void compact_inverted_rc_track_right_corkscrew_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AEA80 */
static void compact_inverted_rc_track_left_corkscrew_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
...
/** rct2: 0x008AEA90 */
static void compact_inverted_rc_track_right_corkscrew_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
...
/** rct2: 0x008AEAD0 */
static void compact_inverted_rc_track_left_quarter_turn_1_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                    int height, rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008AEAB0 */
static void compact_inverted_rc_track_right_quarter_turn_1_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                     int height, rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008AEAC0 */
static void compact_inverted_rc_track_left_quarter_turn_1_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                      int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008AEAE0 */
static void compact_inverted_rc_track_right_quarter_turn_1_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                       int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008AEAA0 */
static void compact_inverted_rc_track_brakes(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                             rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008AEAF0 */
static void compact_inverted_rc_track_left_quarter_banked_helix_large_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                         int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 2:
        ...
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27127, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27112, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27116, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27121, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 43);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27126, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 3:
    ...
    case 5:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27115, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 1:
        ...
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27110, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 6:
        ...
        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_C0 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_CC | SEGMENT_D4, direction), 0xFFFF, 0);
        metal_a_supports_paint_setup(11, 4, 0, height + 56, gTrackColours[SCHEME_SUPPORTS]);
...
/** rct2: 0x008AEB00 */
static void compact_inverted_rc_track_right_quarter_banked_helix_large_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                          int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27090, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27095, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 2:
    ...
    case 3:
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27096, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27101, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 43);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27106, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 5:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27092, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 1:
        ...
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27107, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008AEB10 */
static void compact_inverted_rc_track_left_quarter_banked_helix_large_down(uint8 rideIndex, uint8 trackSequence,
                                                                           ...
                                                                           rct_map_element * mapElement)
{
    ...
    case 2:
        ...
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27107, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27092, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27096, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27101, 0, 0, 16, 16, 3, height + 29, 16, 16,
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27106, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27091, 0, 0, 16, 16, 3, height + 29, 0, 0, height + 43);
    ...
    case 5:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27095, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 1:
        ...
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27090, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008AEB20 */
static void compact_inverted_rc_track_right_quarter_banked_helix_large_down(uint8 rideIndex, uint8 trackSequence,
                                                                            uint8 direction, int height,
                                                                            rct_map_element * mapElement)
{
    switch (trackSequence)
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27110, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27115, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 2:
    ...
    case 3:
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27116, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27121, 0, 0, 16, 16, 3, height + 29, 16, 16,
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27126, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 5:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27112, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 1:
        ...
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27127, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008AEB30 */
static void compact_inverted_rc_track_on_ride_photo(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                    rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008AEDB0 */
static void compact_inverted_rc_track_90_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26609, 0, 0, 32, 20, 3, height + 29, 0, 6,
                                   height + 61);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26610, 0, 0, 32, 2, 31, height + 29, 0, 4,
                                   height + 11);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26611, 0, 0, 32, 2, 31, height + 29, 0, 4,
                                   height + 11);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26612, 0, 0, 32, 20, 3, height + 29, 0, 6,
                                   height + 61);
                break;
            }
        }
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26605, 0, 0, 32, 20, 3, height + 29, 0, 6,
                                   height + 61);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26606, 0, 0, 32, 2, 31, height + 29, 0, 4,
                                   height + 11);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26607, 0, 0, 32, 2, 31, height + 29, 0, 4,
                                   height + 11);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26608, 0, 0, 32, 20, 3, height + 29, 0, 6,
                                   height + 61);
                break;
            }
        }
...
/** rct2: 0x008AEDC0 */
static void compact_inverted_rc_track_90_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
...
/** rct2: 0x008AED70 */
static void compact_inverted_rc_track_60_deg_up_to_90_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26597, 0, 0, 32, 20, 3, height + 29, 0, 6,
                                   height + 85);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26598, 0, 0, 32, 2, 55, height + 29, 0, 4,
                                   height + 11);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26599, 0, 0, 32, 2, 55, height + 29, 0, 4,
                                   height + 11);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26600, 0, 0, 32, 20, 3, height + 29, 0, 6,
                                   height + 85);
                break;
            }
        }
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26589, 0, 0, 32, 20, 3, height + 29, 0, 6,
                                   height + 85);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26590, 0, 0, 32, 2, 55, height + 29, 0, 4,
                                   height + 11);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26591, 0, 0, 32, 2, 55, height + 29, 0, 4,
                                   height + 11);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26592, 0, 0, 32, 20, 3, height + 29, 0, 6,
                                   height + 85);
                break;
            }
        }
...
/** rct2: 0x008AED80 */
static void compact_inverted_rc_track_90_deg_down_to_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                 int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008AED90 */
static void compact_inverted_rc_track_90_deg_up_to_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
...
/** rct2: 0x008AEDA0 */
static void compact_inverted_rc_track_60_deg_down_to_90_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                 int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26603, 0, 0, 32, 2, 55, height + 29, 0, 4,
                                   height + 11);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26604, 0, 0, 32, 20, 3, height + 29, 0, 6,
                                   height + 85);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26601, 0, 0, 32, 20, 3, height + 29, 0, 6,
                                   height + 85);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26602, 0, 0, 32, 2, 55, height + 29, 0, 4,
                                   height + 11);
                break;
            }
        }
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26595, 0, 0, 32, 2, 55, height + 29, 0, 4,
                                   height + 11);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26596, 0, 0, 32, 20, 3, height + 29, 0, 6,
                                   height + 85);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26593, 0, 0, 32, 20, 3, height + 29, 0, 6,
                                   height + 85);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26594, 0, 0, 32, 2, 55, height + 29, 0, 4,
                                   height + 11);
                break;
            }
        }
...
/** rct2: 0x008AEB40 */
static void compact_inverted_rc_track_left_eighth_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26774, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26778, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26767, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26771, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26775, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 3:
    ...
    case 4:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26768, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26772, 0, 0, 16, 18, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26780, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        }
        ...
        {
        case 0:
            metal_a_supports_paint_setup(11, 3, 0, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(11, 1, 0, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_a_supports_paint_setup(11, 0, 0, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_a_supports_paint_setup(11, 2, 0, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008AEB50 */
static void compact_inverted_rc_track_right_eighth_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26750, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26754, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 2:
    ...
    case 2:
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26755, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26763, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 4:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26752, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26760, 0, 0, 16, 18, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26764, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        }
...
/** rct2: 0x008AEB60 */
static void compact_inverted_rc_track_left_eighth_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008AEB70 */
static void compact_inverted_rc_track_right_eighth_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                 int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftEighthTurnToOrthogonal[trackSequence];
...
/** rct2: 0x008AED30 */
static void compact_inverted_rc_track_left_eighth_bank_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26862, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26866, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26855, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26859, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26863, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 3:
    ...
    case 4:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26856, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26860, 0, 0, 16, 18, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26868, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        }
...
/** rct2: 0x008AED40 */
static void compact_inverted_rc_track_right_eighth_bank_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26838, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26842, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 2:
    ...
    case 2:
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26843, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26851, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 4:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26840, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26848, 0, 0, 16, 18, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26852, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        }
...
/** rct2: 0x008AED50 */
static void compact_inverted_rc_track_left_eighth_bank_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                     int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftEighthTurnToOrthogonal[trackSequence];
...
/** rct2: 0x008AED60 */
static void compact_inverted_rc_track_right_eighth_bank_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                      int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftEighthTurnToOrthogonal[trackSequence];
...
/** rct2: 0x008AEB80 */
static void compact_inverted_rc_track_diag_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26812, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
        else
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26784, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
    ...
    case 1:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26809, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26781, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
    ...
    case 2:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26811, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
        else
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26783, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
    ...
    case 3:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26810, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
        else
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26782, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
...
/** rct2: 0x008AEBB0 */
static void compact_inverted_rc_track_diag_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26824, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
        else
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26796, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
    ...
    case 1:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26821, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26793, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
    ...
    case 2:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26823, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
        else
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26795, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
    ...
    case 3:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26822, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
        else
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26794, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
        ...
        {
        case 0:
            metal_a_supports_paint_setup(11, 1, 0, height + 50, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(11, 0, 0, height + 50, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_a_supports_paint_setup(11, 2, 0, height + 50, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_a_supports_paint_setup(11, 3, 0, height + 50, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008AEC10 */
static void compact_inverted_rc_track_diag_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26808, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 93);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26805, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 93);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26807, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 93);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26806, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
        ...
        {
        case 0:
            metal_b_supports_paint_setup(11, 1, 32, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_b_supports_paint_setup(11, 0, 36, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_b_supports_paint_setup(11, 2, 32, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_b_supports_paint_setup(11, 3, 36, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008AEB90 */
static void compact_inverted_rc_track_diag_flat_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26816, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26788, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
    ...
    case 1:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26813, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26785, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
    ...
    case 2:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26815, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26787, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
    ...
    case 3:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26814, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26786, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
...
/** rct2: 0x008AEBF0 */
static void compact_inverted_rc_track_diag_25_deg_up_to_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                  int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26800, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 61);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26797, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 61);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26799, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 61);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26798, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 61);
            break;
        }
        ...
        {
        case 0:
            metal_b_supports_paint_setup(11, 1, 16, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_b_supports_paint_setup(11, 0, 16, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_b_supports_paint_setup(11, 2, 16, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_b_supports_paint_setup(11, 3, 16, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008AEC00 */
static void compact_inverted_rc_track_diag_60_deg_up_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                  int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26804, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 61);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26801, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 61);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26803, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 61);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26802, -16, -16, 16, 16, 3, height + 29, 0, 0,
                               height + 61);
            break;
        }
        ...
        {
        case 0:
            metal_b_supports_paint_setup(11, 1, 21, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_b_supports_paint_setup(11, 0, 21, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_b_supports_paint_setup(11, 2, 21, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_b_supports_paint_setup(11, 3, 21, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008AEBA0 */
static void compact_inverted_rc_track_diag_25_deg_up_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26820, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26792, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
    ...
    case 1:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26817, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26789, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
    ...
    case 2:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26819, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26791, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
    ...
    case 3:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26818, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26790, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        ...
        {
        case 0:
            metal_a_supports_paint_setup(11, 1, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(11, 0, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_a_supports_paint_setup(11, 2, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
...
/** rct2: 0x008AEBE0 */
static void compact_inverted_rc_track_diag_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AEC40 */
static void compact_inverted_rc_track_diag_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 3:
        ...
        {
        case 0:
            metal_b_supports_paint_setup(11, 1, 24, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_b_supports_paint_setup(11, 0, 28, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_b_supports_paint_setup(11, 2, 24, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_b_supports_paint_setup(11, 3, 28, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008AEBC0 */
static void compact_inverted_rc_track_diag_flat_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AEC20 */
static void compact_inverted_rc_track_diag_25_deg_down_to_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                      int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 3:
        ...
        {
        case 0:
            metal_b_supports_paint_setup(11, 1, 17, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_b_supports_paint_setup(11, 0, 17, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_b_supports_paint_setup(11, 2, 17, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_b_supports_paint_setup(11, 3, 17, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008AEC30 */
static void compact_inverted_rc_track_diag_60_deg_down_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                      int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 3:
        ...
        {
        case 0:
            metal_b_supports_paint_setup(11, 1, 8, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_b_supports_paint_setup(11, 0, 8, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_b_supports_paint_setup(11, 2, 8, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_b_supports_paint_setup(11, 3, 8, height + 38, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008AEBD0 */
static void compact_inverted_rc_track_diag_25_deg_down_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AEC70 */
static void compact_inverted_rc_track_diag_flat_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26876, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26873, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26875, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26874, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }

        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_B8 | SEGMENT_C0 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_D0, direction), 0xFFFF, 0);
        switch (direction)
        {
        case 0:
            metal_a_supports_paint_setup(11, 1, 0, height + 38, gTrackColours[SCHEME_SUPPORTS]);
...
/** rct2: 0x008AEC80 */
static void compact_inverted_rc_track_diag_flat_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26880, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26877, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26879, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26878, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }

        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_B8 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_D0, direction), 0xFFFF, 0);
        switch (direction)
        {
        case 0:
            metal_a_supports_paint_setup(11, 1, 0, height + 38, gTrackColours[SCHEME_SUPPORTS]);
...
/** rct2: 0x008AEC90 */
static void compact_inverted_rc_track_diag_left_bank_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AECA0 */
static void compact_inverted_rc_track_diag_right_bank_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AECD0 */
static void compact_inverted_rc_track_diag_left_bank_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                  int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26892, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26889, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26891, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26890, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
...
/** rct2: 0x008AECE0 */
static void compact_inverted_rc_track_diag_right_bank_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                   int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26896, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26893, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26895, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26894, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
...
/** rct2: 0x008AECB0 */
static void compact_inverted_rc_track_diag_25_deg_up_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                  int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26884, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26881, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26883, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26882, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
...
/** rct2: 0x008AECC0 */
static void compact_inverted_rc_track_diag_25_deg_up_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                   int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26888, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26885, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26887, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26886, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
...
/** rct2: 0x008AECF0 */
static void compact_inverted_rc_track_diag_left_bank_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                    int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AED00 */
static void compact_inverted_rc_track_diag_right_bank_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                     int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AED10 */
static void compact_inverted_rc_track_diag_25_deg_down_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                    int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AED20 */
static void compact_inverted_rc_track_diag_25_deg_down_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                     int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AEC50 */
static void compact_inverted_rc_track_diag_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26872, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26869, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26871, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26870, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
...
/** rct2: 0x008AEC60 */
static void compact_inverted_rc_track_diag_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                      rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AEAA0 */
static void compact_inverted_rc_track_block_brakes(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    switch (direction)
    {

...
/** rct2: 0x0082491C */
static void lay_down_rc_track_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                   rct_map_element * mapElement)
{
    ...
    else
    {
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            case 0:
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26557, 0, 0, 32, 20, 1, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26558, 0, 0, 32, 20, 1, height + 24, 0, 6,
                                   height + 22);
                break;
            }
        }
        else
        {
            ...
            case 0:
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26555, 0, 0, 32, 20, 1, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26556, 0, 0, 32, 20, 1, height + 24, 0, 6,
                                   height + 22);
                break;
            }
        }
...
static void lay_down_rc_track_station(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                      rct_map_element * mapElement)
{
    if (track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x0082492C */
static void lay_down_rc_track_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                        rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26621, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 40);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26622, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 40);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26623, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 40);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26624, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 40);
                break;
            }
        }
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26569, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 40);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26570, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 40);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26571, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 40);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26572, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 40);
                break;
            }
        }
...
/** rct2: 0x0082493C */
static void lay_down_rc_track_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                        rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x0082494C */
static void lay_down_rc_track_flat_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26613, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 32);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26614, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 32);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26615, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 32);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26616, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 32);
                break;
            }
        }
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26561, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 32);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26562, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 32);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26563, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 32);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26564, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 32);
                break;
            }
        }
...
/** rct2: 0x0082495C */
static void lay_down_rc_track_25_deg_up_to_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26577, 0, 0, 32, 10, 49, height + 24, 0, 10,
                               height + 6);
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26574, 0, 0, 32, 2, 49, height + 24, 0, 4, height + 6);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26578, 0, 0, 32, 10, 49, height + 24, 0, 10,
                               height + 6);
...
/** rct2: 0x0082496C */
static void lay_down_rc_track_60_deg_up_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26583, 0, 0, 32, 10, 49, height + 24, 0, 10,
                               height + 6);
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26580, 0, 0, 32, 2, 49, height + 24, 0, 4, height + 6);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26584, 0, 0, 32, 10, 49, height + 24, 0, 10,
                               height + 6);
...
/** rct2: 0x0082497C */
static void lay_down_rc_track_25_deg_up_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26617, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 32);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26618, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 32);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26619, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 32);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26620, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 32);
                break;
            }
        }
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26565, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 32);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26566, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 32);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26567, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 32);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26568, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 32);
                break;
            }
        }
...
/** rct2: 0x0082498C */
static void lay_down_rc_track_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                          rct_map_element * mapElement)
{
...
/** rct2: 0x0082499C */
static void lay_down_rc_track_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                          rct_map_element * mapElement)
{
...
/** rct2: 0x008249AC */
static void lay_down_rc_track_flat_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
...
/** rct2: 0x008249BC */
static void lay_down_rc_track_25_deg_down_to_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
...
/** rct2: 0x008249CC */
static void lay_down_rc_track_60_deg_down_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
...
/** rct2: 0x008249DC */
static void lay_down_rc_track_25_deg_down_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
...
/** rct2: 0x008249EC */
static void lay_down_rc_track_left_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26694, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26699, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26704, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26689, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            }
        ...
        case 2:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26693, 0, 0, 32, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26698, 0, 0, 32, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26703, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26688, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26692, 0, 0, 16, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26697, 0, 0, 16, 16, 3, height + 24, 16, 16,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26702, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26687, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 5:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26691, 0, 0, 16, 32, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26696, 0, 0, 16, 32, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26701, 0, 0, 16, 32, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26686, 0, 0, 16, 32, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 6:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26690, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26695, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26700, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26685, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            }
...
/** rct2: 0x008249FC */
static void lay_down_rc_track_right_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
...
/** rct2: 0x00824A0C */
static void lay_down_rc_track_flat_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824A1C */
static void lay_down_rc_track_flat_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824A2C */
static void lay_down_rc_track_left_bank_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824A3C */
static void lay_down_rc_track_right_bank_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824A4C */
static void lay_down_rc_track_banked_left_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 3:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16366, 0, 0, 16, 16, 1, height, 16, 16,
                                   height + 27);
                break;
            case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26738, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 24);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26743, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 24);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26748, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 24);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26733, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 24);
                break;
            }
        ...
        case 2:
            ...
            case 1:
                ...
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26747, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 24);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26732, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 24);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26736, 0, 0, 16, 16, 3, height + 24, 0, 16,
                                   height + 24);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26741, 0, 0, 16, 16, 3, height + 24, 16, 16,
                                   height + 24);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26746, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 24);
                break;
            case 3:
        ...
        case 5:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26735, 0, 0, 16, 32, 3, height + 24, 16, 0,
                                   height + 24);
                break;
            case 1:
            ...
            case 2:
                ...
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26730, 0, 0, 16, 32, 3, height + 24, 16, 0,
                                   height + 24);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 6:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26734, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 24);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26739, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 24);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26744, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 24);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26729, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 24);
                break;
            }
...
/** rct2: 0x00824A5C */
static void lay_down_rc_track_banked_right_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn5TilesToRightQuarterTurn5Tiles[trackSequence];
...
/** rct2: 0x00824A6C */
static void lay_down_rc_track_left_bank_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824A7C */
static void lay_down_rc_track_right_bank_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                      rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824A8C */
static void lay_down_rc_track_25_deg_up_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824A9C */
static void lay_down_rc_track_25_deg_up_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                      rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824AAC */
static void lay_down_rc_track_left_bank_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
...
/** rct2: 0x00824ABC */
static void lay_down_rc_track_right_bank_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
...
/** rct2: 0x00824ACC */
static void lay_down_rc_track_25_deg_down_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
...
/** rct2: 0x00824ADC */
static void lay_down_rc_track_25_deg_down_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
...
/** rct2: 0x00824AEC */
static void lay_down_rc_track_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                        rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824AFC */
static void lay_down_rc_track_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                         rct_map_element * mapElement)
{
...
/** rct2: 0x00824B0C */
static void lay_down_rc_track_left_quarter_turn_5_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824B1C */
static void lay_down_rc_track_right_quarter_turn_5_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824B2C */
static void lay_down_rc_track_left_quarter_turn_5_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn5TilesToRightQuarterTurn5Tiles[trackSequence];
...
/** rct2: 0x00824B3C */
static void lay_down_rc_track_right_quarter_turn_5_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
...
/** rct2: 0x00824B4C */
static void lay_down_rc_track_s_bend_left(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                          rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26641, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26645, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26644, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26648, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            }
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26642, 0, 0, 32, 26, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26646, 0, 0, 32, 26, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26643, 0, 0, 32, 26, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26647, 0, 0, 32, 26, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            }
...
/** rct2: 0x00824B5C */
static void lay_down_rc_track_s_bend_right(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                           rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26649, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26653, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26652, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26656, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            }
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26650, 0, 0, 32, 26, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26654, 0, 0, 32, 26, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26651, 0, 0, 32, 26, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26655, 0, 0, 32, 26, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            }
...
/** rct2: 0x00824B6C */
static void lay_down_rc_track_left_vertical_loop(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824B7C */
static void lay_down_rc_track_right_vertical_loop(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824BBC */
static void lay_down_rc_track_left_quarter_turn_3(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26710, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26713, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26716, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26707, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            }
        ...
        case 2:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26709, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26712, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26715, 0, 0, 16, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26706, 0, 0, 16, 16, 3, height + 24, 16, 16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26708, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26711, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26714, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26705, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            }
...
/** rct2: 0x00824BCC */
static void lay_down_rc_track_right_quarter_turn_3(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
...
/** rct2: 0x00824BDC */
static void lay_down_rc_track_left_quarter_turn_3_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26722, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26725, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26728, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26719, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            }
        ...
        case 2:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26721, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26724, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26727, 0, 0, 16, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26718, 0, 0, 16, 16, 3, height + 24, 16, 16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26720, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26723, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26726, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26717, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            }
...
/** rct2: 0x00824BEC */
static void lay_down_rc_track_right_quarter_turn_3_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
...
/** rct2: 0x00824BFC */
static void lay_down_rc_track_left_quarter_turn_3_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824C0C */
static void lay_down_rc_track_right_quarter_turn_3_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824C1C */
static void lay_down_rc_track_left_quarter_turn_3_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
...
/** rct2: 0x00824C2C */
static void lay_down_rc_track_right_quarter_turn_3_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
...
/** rct2: 0x00824C9C */
static void lay_down_rc_track_left_half_banked_helix_up_small(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824CAC */
static void lay_down_rc_track_right_half_banked_helix_up_small(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824CBC */
static void lay_down_rc_track_left_half_banked_helix_down_small(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                int height, rct_map_element * mapElement)
{
    if (trackSequence >= 4)
    {
...
/** rct2: 0x00824CCC */
static void lay_down_rc_track_right_half_banked_helix_down_small(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                 int height, rct_map_element * mapElement)
{
    if (trackSequence >= 4)
    {
...
/** rct2: 0x00824CDC */
static void lay_down_rc_track_left_half_banked_helix_up_large(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 3:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16452, 0, 0, 16, 16, 1, height, 16, 16,
                                   height + 27);
                break;
            case 2:
...
/** rct2: 0x00824CEC */
static void lay_down_rc_track_right_half_banked_helix_up_large(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 3:
            ...
            case 1:
                ...
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16430, 0, 0, 16, 16, 1, height, 16, 16,
                                   height + 27);
                break;
            case 3:
...
/** rct2: 0x00824CFC */
static void lay_down_rc_track_left_half_banked_helix_down_large(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                int height, rct_map_element * mapElement)
{
    if (trackSequence >= 7)
    {
...
/** rct2: 0x00824D0C */
static void lay_down_rc_track_right_half_banked_helix_down_large(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                 int height, rct_map_element * mapElement)
{
    if (trackSequence >= 7)
    {
...
/** rct2: 0x00824D3C */
static void lay_down_rc_track_left_quarter_turn_1_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824D1C */
static void lay_down_rc_track_right_quarter_turn_1_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824D2C */
static void lay_down_rc_track_left_quarter_turn_1_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
...
/** rct2: 0x00824D4C */
static void lay_down_rc_track_right_quarter_turn_1_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
...
/** rct2: 0x00824D5C */
static void lay_down_rc_track_brakes(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                     rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824D6C */
static void lay_down_rc_track_on_ride_photo(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                            rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824D8C */
static void lay_down_rc_track_left_eighth_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26765, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26769, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26773, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26777, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            }
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26766, 0, 0, 32, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26770, 0, 0, 34, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26774, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26778, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26767, 0, 0, 16, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26771, 0, 0, 16, 16, 3, height + 24, 16, 16,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26775, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26779, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 4:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26768, 0, 0, 16, 16, 3, height + 24, 16, 16,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26772, 0, 0, 16, 18, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26776, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26780, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            }
...
/** rct2: 0x00824D9C */
static void lay_down_rc_track_right_eighth_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26749, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26753, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26757, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26761, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            }
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26750, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26754, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26758, 0, 0, 34, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26762, 0, 0, 32, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26751, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26755, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26759, 0, 0, 28, 28, 3, height + 24, 4, 4,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26763, 0, 0, 16, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 4:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26752, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26756, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26760, 0, 0, 16, 18, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26764, 0, 0, 16, 16, 3, height + 24, 16, 16,
                                   height + 22);
                break;
            }
...
/** rct2: 0x00824DAC */
static void lay_down_rc_track_left_eighth_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
...
/** rct2: 0x00824DBC */
static void lay_down_rc_track_right_eighth_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
    trackSequence = mapLeftEighthTurnToOrthogonal[trackSequence];
...
/** rct2: 0x00824DCC */
static void lay_down_rc_track_left_eighth_bank_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 2:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16778, 0, 0, 16, 16, 0, height, 16, 16,
                                   height + 27);
                break;
            case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26853, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26857, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26861, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26865, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            }
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26854, 0, 0, 32, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26858, 0, 0, 34, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26862, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26866, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26855, 0, 0, 16, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26859, 0, 0, 16, 16, 3, height + 24, 16, 16,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26863, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26867, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 4:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26856, 0, 0, 16, 16, 3, height + 24, 16, 16,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26860, 0, 0, 16, 18, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26864, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26868, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            }
...
/** rct2: 0x00824DDC */
static void lay_down_rc_track_right_eighth_bank_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26837, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26841, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26845, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26849, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            }
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26838, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26842, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26846, 0, 0, 34, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26850, 0, 0, 32, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26839, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26843, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26847, 0, 0, 28, 28, 3, height + 24, 4, 4,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26851, 0, 0, 16, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 4:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26840, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26844, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26848, 0, 0, 16, 18, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26852, 0, 0, 16, 16, 3, height + 24, 16, 16,
                                   height + 22);
                break;
            }
...
/** rct2: 0x00824DEC */
static void lay_down_rc_track_left_eighth_bank_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    trackSequence = mapLeftEighthTurnToOrthogonal[trackSequence];
...
/** rct2: 0x00824DFC */
static void lay_down_rc_track_right_eighth_bank_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    trackSequence = mapLeftEighthTurnToOrthogonal[trackSequence];
...
/** rct2: 0x00824D7C */
static void lay_down_rc_track_diag_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                        rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16699, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16637, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 1:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16696, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16634, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 2:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16698, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16636, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 3:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16697, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    metal_a_supports_paint_setup(11, 0, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 2:
            ...
            else
            {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16635, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    metal_a_supports_paint_setup(11, 0, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 2:
    ...
    else
    {
        ...
        case 0:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26812, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 22);
                    break;
                }
            }
            else
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26784, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 22);
                    break;
                }
            }
        ...
        case 1:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26809, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 22);
                    break;
                }
            }
            else
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26781, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 22);
                    break;
                }
            }
        ...
        case 2:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26811, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 22);
                    break;
                }
            }
            else
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26783, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 22);
                    break;
                }
            }
        ...
        case 3:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26810, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 22);
                    break;
                }
            }
            else
            {
                ...
                {
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26782, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 22);
                    break;
                }
            }
...
/** rct2: 0x00824E2C */
static void lay_down_rc_track_diag_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                             rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16711, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16649, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 1:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16708, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16646, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 2:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16710, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16648, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 3:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16709, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
            ...
            else
            {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16647, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    metal_b_supports_paint_setup(11, 0, 8, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 2:
    ...
    else
    {
        ...
        case 0:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26824, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 40);
                    break;
                }
            }
            else
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26796, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 40);
                    break;
                }
            }
        ...
        case 1:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26821, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 40);
                    break;
                }
            }
            else
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26793, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 40);
                    break;
                }
            }
        ...
        case 2:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26823, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 40);
                    break;
                }
            }
            else
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26795, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 40);
                    break;
                }
            }
        ...
        case 3:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26822, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 40);
                    break;
                }
            }
            else
            {
                ...
                {
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26794, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 40);
                    break;
                }
            }
...
/** rct2: 0x00824E8C */
static void lay_down_rc_track_diag_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                             rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16723, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16661, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 1:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16720, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16658, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 2:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16722, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16660, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 3:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16721, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
            ...
            else
            {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16659, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    metal_b_supports_paint_setup(11, 0, 36, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26808, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 88);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26805, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 88);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26807, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 88);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26806, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 24);
                break;
            }
...
/** rct2: 0x00824E0C */
static void lay_down_rc_track_diag_flat_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16703, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16641, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 1:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16700, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16638, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 2:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16702, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16640, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 3:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16701, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
            ...
            else
            {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16639, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    metal_b_supports_paint_setup(11, 0, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 2:
    ...
    else
    {
        ...
        case 0:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26816, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
            else
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26788, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
        ...
        case 1:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26813, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
            else
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26785, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
        ...
        case 2:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26815, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
            else
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26787, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
        ...
        case 3:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26814, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
            else
            {
                ...
                {
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26786, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
...
/** rct2: 0x00824E6C */
static void lay_down_rc_track_diag_25_deg_up_to_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16715, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16653, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 1:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16712, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16650, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 2:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16714, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16652, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 3:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16713, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
            ...
            else
            {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16651, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    metal_b_supports_paint_setup(11, 0, 16, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26800, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 56);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26797, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 56);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26799, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 56);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26798, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 56);
                break;
            }
...
/** rct2: 0x00824E7C */
static void lay_down_rc_track_diag_60_deg_up_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16719, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16657, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 1:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16716, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16654, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 2:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16718, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16656, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 3:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16717, -16, -16, 16, 16, 3, height, 0, 0,
                                       height);
            ...
            else
            {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16655, -16, -16, 16, 16, 3, height, 0, 0,
                                       height);
                    metal_b_supports_paint_setup(11, 0, 21, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26804, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 56);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26801, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 56);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26803, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 56);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26802, -16, -16, 16, 16, 3, height + 24, 0, 0,
                                   height + 56);
                break;
            }
...
/** rct2: 0x00824E1C */
static void lay_down_rc_track_diag_25_deg_up_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16707, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16645, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 1:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16704, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16642, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 2:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16706, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16644, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 3:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16705, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
            ...
            else
            {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16643, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    metal_b_supports_paint_setup(11, 0, 4, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 2:
    ...
    else
    {
        ...
        case 0:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26820, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
            else
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26792, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
        ...
        case 1:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26817, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
            else
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26789, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
        ...
        case 2:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26819, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
            else
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26791, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
        ...
        case 3:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26818, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
            else
            {
                ...
                {
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26790, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
...
/** rct2: 0x00824E5C */
static void lay_down_rc_track_diag_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                               rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26794, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 40);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26795, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 40);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26793, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 40);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26796, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 40);
                break;
            }
...
/** rct2: 0x00824EBC */
static void lay_down_rc_track_diag_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                               rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824E3C */
static void lay_down_rc_track_diag_flat_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26790, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26791, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26789, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26792, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
...
/** rct2: 0x00824E9C */
static void lay_down_rc_track_diag_25_deg_down_to_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824EAC */
static void lay_down_rc_track_diag_60_deg_down_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824E4C */
static void lay_down_rc_track_diag_25_deg_down_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26786, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26787, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26785, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26788, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
...
/** rct2: 0x00824EEC */
static void lay_down_rc_track_diag_flat_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16669, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16666, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16670, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 27);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16668, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16667, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                metal_a_supports_paint_setup(11, 0, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26876, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26873, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26875, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26874, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
...
/** rct2: 0x00824EFC */
static void lay_down_rc_track_diag_flat_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                      rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16674, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16671, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16673, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16675, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 27);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16672, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                metal_a_supports_paint_setup(11, 0, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26880, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26877, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26879, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26878, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
...
/** rct2: 0x00824F0C */
static void lay_down_rc_track_diag_left_bank_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824F1C */
static void lay_down_rc_track_diag_right_bank_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                      rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824F4C */
static void lay_down_rc_track_diag_left_bank_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16689, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16686, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16690, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16688, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16687, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                metal_b_supports_paint_setup(11, 0, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26892, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26889, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26891, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26890, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
...
/** rct2: 0x00824F5C */
static void lay_down_rc_track_diag_right_bank_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16694, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16691, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16693, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16695, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16692, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                metal_b_supports_paint_setup(11, 0, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26896, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26893, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26895, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26894, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
...
/** rct2: 0x00824F2C */
static void lay_down_rc_track_diag_25_deg_up_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16679, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16676, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16680, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16678, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16677, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                metal_b_supports_paint_setup(11, 0, 4, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26884, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26881, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26883, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26882, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
...
/** rct2: 0x00824F3C */
static void lay_down_rc_track_diag_25_deg_up_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16684, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16681, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16683, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16685, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16682, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                metal_b_supports_paint_setup(11, 0, 4, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26888, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26885, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26887, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26886, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
...
/** rct2: 0x00824F6C */
static void lay_down_rc_track_diag_left_bank_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824F7C */
static void lay_down_rc_track_diag_right_bank_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824F8C */
static void lay_down_rc_track_diag_25_deg_down_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824F9C */
static void lay_down_rc_track_diag_25_deg_down_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824ECC */
static void lay_down_rc_track_diag_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                             rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16665, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16662, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 27);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16664, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16663, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                metal_a_supports_paint_setup(11, 0, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26872, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26869, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26871, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26870, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
...
/** rct2: 0x00824EDC */
static void lay_down_rc_track_diag_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                              rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824FAC */
static void lay_down_rc_track_left_flyer_twist_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26973, 0, 6, 32, 20, 3, height + 24, 0, 6,
                                   height + 24);
                break;
            case 1:
        ...
        case 2:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26974, 0, 6, 32, 20, 3, height + 24, 0, 6,
                                   height + 24);
                break;
            case 1:
...
/** rct2: 0x00824FBC */
static void lay_down_rc_track_right_flyer_twist_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824FCC */
static void lay_down_rc_track_left_flyer_twist_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                    rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824FDC */
static void lay_down_rc_track_right_flyer_twist_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824C3C */
static void lay_down_rc_track_flyer_half_loop_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824C4C */
static void lay_down_rc_track_flyer_half_loop_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824C5C */
static void lay_down_rc_track_left_flyer_corkscrew_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                      rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824C6C */
static void lay_down_rc_track_right_flyer_corkscrew_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824C7C */
static void lay_down_rc_track_left_flyer_corkscrew_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00824C8C */
static void lay_down_rc_track_right_flyer_corkscrew_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
...
/** rct2: 0x00824FEC */
static void lay_down_rc_track_block_brakes(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                           rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {

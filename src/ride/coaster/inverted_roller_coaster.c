...
/** rct2: 0x008A92E8 */
static void inverted_rc_track_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                   rct_map_element * mapElement)
{
    ...
    {
        metal_a_supports_paint_setup(3, 4, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
    }
...
static void inverted_rc_track_station(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                      rct_map_element * mapElement)
{
...
/** rct2: 0x008A92F8 */
static void inverted_rc_track_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                        rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
    ...
    if (track_paint_util_should_paint_supports(gPaintMapPosition))
    {
        ...
        {
        case 0:
            metal_a_supports_paint_setup(3, 6, 0, height + 62, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(3, 8, 0, height + 62, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_a_supports_paint_setup(3, 7, 0, height + 62, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_a_supports_paint_setup(3, 5, 0, height + 62, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
    }
...
/** rct2: 0x008A9308 */
static void inverted_rc_track_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                        rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A9318 */
static void inverted_rc_track_flat_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
    ...
    if (track_paint_util_should_paint_supports(gPaintMapPosition))
    {
        ...
        {
        case 0:
            metal_a_supports_paint_setup(3, 6, 0, height + 54, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(3, 8, 0, height + 54, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_a_supports_paint_setup(3, 7, 0, height + 54, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_a_supports_paint_setup(3, 5, 0, height + 54, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
    }
...
/** rct2: 0x008A9328 */
static void inverted_rc_track_25_deg_up_to_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A9338 */
static void inverted_rc_track_60_deg_up_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    switch (direction)
    {
    ...
    if (track_paint_util_should_paint_supports(gPaintMapPosition))
    {
        ...
        {
        case 0:
            metal_a_supports_paint_setup(3, 6, 0, height + 76, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(3, 8, 0, height + 76, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_a_supports_paint_setup(3, 7, 0, height + 76, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_a_supports_paint_setup(3, 5, 0, height + 76, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
    }
...
/** rct2: 0x008A9348 */
static void inverted_rc_track_25_deg_up_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
...
/** rct2: 0x008A9358 */
static void inverted_rc_track_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                          rct_map_element * mapElement)
{
...
/** rct2: 0x008A9368 */
static void inverted_rc_track_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                          rct_map_element * mapElement)
{
...
/** rct2: 0x008A9378 */
static void inverted_rc_track_flat_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
...
/** rct2: 0x008A9388 */
static void inverted_rc_track_25_deg_down_to_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
...
/** rct2: 0x008A9398 */
static void inverted_rc_track_60_deg_down_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
...
/** rct2: 0x008A93A8 */
static void inverted_rc_track_25_deg_down_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
...
/** rct2: 0x008A93B8 */
static void inverted_rc_track_left_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
    ...
    case 2:
        ...
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27151, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27136, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27140, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27145, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27150, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 3:
    ...
    case 5:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27139, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 1:
        ...
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27134, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008A93C8 */
static void inverted_rc_track_right_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
...
/** rct2: 0x008A93D8 */
static void inverted_rc_track_flat_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A93E8 */
static void inverted_rc_track_flat_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A93F8 */
static void inverted_rc_track_left_bank_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A9408 */
static void inverted_rc_track_right_bank_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A9418 */
static void inverted_rc_track_banked_left_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 2:
        ...
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27171, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27156, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27160, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27165, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27170, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 3:
    ...
    case 5:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27159, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 1:
        ...
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27154, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008A9428 */
static void inverted_rc_track_banked_right_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn5TilesToRightQuarterTurn5Tiles[trackSequence];
...
/** rct2: 0x008A9438 */
static void inverted_rc_track_left_bank_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A9448 */
static void inverted_rc_track_right_bank_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                      rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A9458 */
static void inverted_rc_track_25_deg_up_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A9468 */
static void inverted_rc_track_25_deg_up_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                      rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A9478 */
static void inverted_rc_track_left_bank_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
...
/** rct2: 0x008A9488 */
static void inverted_rc_track_right_bank_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
...
/** rct2: 0x008A9498 */
static void inverted_rc_track_25_deg_down_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
...
/** rct2: 0x008A94A8 */
static void inverted_rc_track_25_deg_down_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
...
/** rct2: 0x008A94B8 */
static void inverted_rc_track_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                        rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A94C8 */
static void inverted_rc_track_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                         rct_map_element * mapElement)
{
...
/** rct2: 0x008A94D8 */
static void inverted_rc_track_left_quarter_turn_5_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_C4 | SEGMENT_CC | SEGMENT_D0 | SEGMENT_D4, direction), 0xFFFF, 0);
        metal_a_supports_paint_setup(3, 4, 0, height + 54, gTrackColours[SCHEME_SUPPORTS]);
...
/** rct2: 0x008A94E8 */
static void inverted_rc_track_right_quarter_turn_5_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A94F8 */
static void inverted_rc_track_left_quarter_turn_5_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn5TilesToRightQuarterTurn5Tiles[trackSequence];
...
/** rct2: 0x008A9508 */
static void inverted_rc_track_right_quarter_turn_5_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
...
/** rct2: 0x008A9518 */
static void inverted_rc_track_s_bend_left(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                          rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        {
        case 0:
            metal_a_supports_paint_setup(3, 5, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(3, 6, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008A9528 */
static void inverted_rc_track_s_bend_right(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                           rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        {
        case 0:
            metal_a_supports_paint_setup(3, 8, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(3, 7, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008A9538 */
static void inverted_rc_track_left_vertical_loop(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 0:
            metal_a_supports_paint_setup(3, 6, 0, height + 55, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(3, 8, 0, height + 55, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_a_supports_paint_setup(3, 7, 0, height + 55, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_a_supports_paint_setup(3, 5, 0, height + 55, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
    ...
    case 1:
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27364, 0, 14, 32, 2, 63, height + 29, 0, 29,
                               height + 29);
            break;
        case 2:
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27357, 16, 0, 5, 2, 119, height + 2, 16, 29,
                               height + 2);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27365, 12, 0, 32, 2, 119, height + 2, 0, -6,
                               height + 2);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27360, 10, 16, 4, 2, 119, height + 2, 10, 0,
                               height + 2);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27368, 16, 16, 2, 2, 119, height + 2, 29, 29,
                               height + 2);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008A9548 */
static void inverted_rc_track_right_vertical_loop(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27380, 0, 14, 32, 2, 63, height + 29, 0, 29,
                               height + 29);
            break;
        case 3:
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27384, 16, 16, 2, 2, 119, height + 2, 29, 29,
                               height + 2);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27376, 10, 16, 4, 2, 119, height + 2, 10, 0,
                               height + 2);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27381, 12, 0, 32, 2, 119, height + 2, 0, -6,
                               height + 2);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27373, 16, 0, 5, 2, 119, height + 2, 16, 29,
                               height + 2);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008A9588 */
static void inverted_rc_track_left_quarter_turn_3(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27391, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27397, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27388, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008A9598 */
static void inverted_rc_track_right_quarter_turn_3(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
...
/** rct2: 0x008A95A8 */
static void inverted_rc_track_left_quarter_turn_3_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27403, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27409, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27400, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008A95B8 */
static void inverted_rc_track_right_quarter_turn_3_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
...
/** rct2: 0x008A95C8 */
static void inverted_rc_track_left_quarter_turn_3_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_C4 | SEGMENT_CC | SEGMENT_D0 | SEGMENT_D4, direction), 0xFFFF, 0);
        metal_a_supports_paint_setup(3, 4, 0, height + 52, gTrackColours[SCHEME_SUPPORTS]);
...
/** rct2: 0x008A95D8 */
static void inverted_rc_track_right_quarter_turn_3_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A95E8 */
static void inverted_rc_track_left_quarter_turn_3_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
...
/** rct2: 0x008A95F8 */
static void inverted_rc_track_right_quarter_turn_3_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
...
/** rct2: 0x008A9608 */
static void inverted_rc_track_left_twist_down_to_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                    rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A9618 */
static void inverted_rc_track_right_twist_down_to_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A9628 */
static void inverted_rc_track_left_twist_up_to_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                    rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A9638 */
static void inverted_rc_track_right_twist_up_to_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A9648 */
static void inverted_rc_track_half_loop_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                           rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27460, 0, 14, 32, 2, 63, height + 29, 0, 29,
                               height + 29);
            break;
        case 2:
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27453, 16, 0, 5, 2, 119, height + 2, 16, 29,
                               height + 2);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27461, 12, 0, 32, 2, 119, height + 2, 0, -6,
                               height + 2);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27456, 10, 16, 4, 2, 119, height + 2, 10, 0,
                               height + 2);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27464, 16, 16, 2, 2, 119, height + 2, 29, 29,
                               height + 2);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27463, 0, 16, 32, 20, 3, height + 34, 0, 6,
                               height + 34);
            break;
        }
        if (direction == 0 || direction == 3)
...
/** rct2: 0x008A9658 */
static void inverted_rc_track_half_loop_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                             rct_map_element * mapElement)
{
...
/** rct2: 0x008A9668 */
static void inverted_rc_track_left_corkscrew_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_BC | SEGMENT_C0 | SEGMENT_C4 | SEGMENT_CC | SEGMENT_D0 | SEGMENT_D4,
                                       direction),
            0xFFFF, 0);
        metal_a_supports_paint_setup(3, 4, 0, height + 50, gTrackColours[SCHEME_SUPPORTS]);
    ...
    case 2:
        ...
        metal_a_supports_paint_setup(3, 4, 0, height + 28, gTrackColours[SCHEME_SUPPORTS]);
        switch (direction)
        {
        case 2:
...
/** rct2: 0x008A9678 */
static void inverted_rc_track_right_corkscrew_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A9688 */
static void inverted_rc_track_left_corkscrew_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
...
/** rct2: 0x008A9698 */
static void inverted_rc_track_right_corkscrew_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
...
/** rct2: 0x008A96D8 */
static void inverted_rc_track_left_quarter_turn_1_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A96B8 */
static void inverted_rc_track_right_quarter_turn_1_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A96C8 */
static void inverted_rc_track_left_quarter_turn_1_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
...
/** rct2: 0x008A96E8 */
static void inverted_rc_track_right_quarter_turn_1_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008A96A8 */
static void inverted_rc_track_brakes(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                     rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A96F8 */
static void inverted_rc_track_left_quarter_banked_helix_large_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                 int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_C4 | SEGMENT_CC | SEGMENT_D0 | SEGMENT_D4, direction), 0xFFFF, 0);
        metal_a_supports_paint_setup(3, 4, 0, height + 46, gTrackColours[SCHEME_SUPPORTS]);
    ...
    case 2:
        ...
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27211, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27196, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27200, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27205, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 43);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27210, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 3:
    ...
    case 5:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27199, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 1:
        ...
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27194, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 6:
        ...
        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_C0 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_CC | SEGMENT_D4, direction), 0xFFFF, 0);
        metal_a_supports_paint_setup(3, 4, 0, height + 58, gTrackColours[SCHEME_SUPPORTS]);
...
/** rct2: 0x008A9708 */
static void inverted_rc_track_right_quarter_banked_helix_large_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                  int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27174, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27179, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 2:
    ...
    case 3:
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27180, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27185, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 43);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27190, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 5:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27176, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 1:
        ...
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27191, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008A9718 */
static void inverted_rc_track_left_quarter_banked_helix_large_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                   int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 2:
        ...
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27191, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27176, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27180, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27185, 0, 0, 16, 16, 3, height + 29, 16, 16,
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27190, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27175, 0, 0, 16, 16, 3, height + 29, 0, 0, height + 43);
    ...
    case 5:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27179, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 1:
        ...
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27174, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008A9728 */
static void inverted_rc_track_right_quarter_banked_helix_large_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                    int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27194, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27199, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 2:
    ...
    case 3:
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27200, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27205, 0, 0, 16, 16, 3, height + 29, 16, 16,
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27210, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 5:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27196, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 1:
        ...
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27211, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008A9A38 */
static void inverted_rc_track_25_deg_up_left_banked(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                    rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A9A48 */
static void inverted_rc_track_25_deg_up_right_banked(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A9738 */
static void inverted_rc_track_on_ride_photo(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                            rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A9A58 */
static void inverted_rc_track_25_deg_down_left_banked(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                      rct_map_element * mapElement)
{
...
/** rct2: 0x008A9A68 */
static void inverted_rc_track_25_deg_down_right_banked(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
...
/** rct2: 0x008A9748 */
static void inverted_rc_track_left_eighth_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27516, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27520, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27509, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27513, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27517, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 3:
    ...
    case 4:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27510, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27514, 0, 0, 16, 18, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27522, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        }
        ...
        {
        case 0:
            metal_a_supports_paint_setup(3, 3, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(3, 1, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_a_supports_paint_setup(3, 0, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_a_supports_paint_setup(3, 2, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008A9758 */
static void inverted_rc_track_right_eighth_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27492, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27496, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 2:
    ...
    case 2:
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27497, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27505, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 4:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27494, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27502, 0, 0, 16, 18, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27506, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        }
...
/** rct2: 0x008A9768 */
static void inverted_rc_track_left_eighth_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
...
/** rct2: 0x008A9778 */
static void inverted_rc_track_right_eighth_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
    trackSequence = mapLeftEighthTurnToOrthogonal[trackSequence];
...
/** rct2: 0x008A9938 */
static void inverted_rc_track_left_eighth_bank_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27548, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27552, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27541, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27545, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27549, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 3:
    ...
    case 4:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27542, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27546, 0, 0, 16, 18, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27554, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        }
...
/** rct2: 0x008A9948 */
static void inverted_rc_track_right_eighth_bank_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27524, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27528, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 2:
    ...
    case 2:
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27529, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27537, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 4:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27526, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27534, 0, 0, 16, 18, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27538, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        }
...
/** rct2: 0x008A9958 */
static void inverted_rc_track_left_eighth_bank_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    trackSequence = mapLeftEighthTurnToOrthogonal[trackSequence];
...
/** rct2: 0x008A9968 */
static void inverted_rc_track_right_eighth_bank_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    trackSequence = mapLeftEighthTurnToOrthogonal[trackSequence];
...
/** rct2: 0x008A9788 */
static void inverted_rc_track_diag_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                        rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27614, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
        else
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27558, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
    ...
    case 1:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27611, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27555, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
    ...
    case 2:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27613, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
        else
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27557, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
    ...
    case 3:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27612, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
        else
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27556, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
...
/** rct2: 0x008A97B8 */
static void inverted_rc_track_diag_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                             rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27626, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
        else
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27570, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
    ...
    case 1:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27623, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27567, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
    ...
    case 2:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27625, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
        else
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27569, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
    ...
    case 3:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27624, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
        else
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27568, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
        ...
        {
        case 0:
            metal_a_supports_paint_setup(3, 1, 0, height + 56, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(3, 0, 0, height + 56, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_a_supports_paint_setup(3, 2, 0, height + 56, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_a_supports_paint_setup(3, 3, 0, height + 56, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008A9818 */
static void inverted_rc_track_diag_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                             rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27582, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 93);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27579, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 93);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27581, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 93);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27580, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
        ...
        {
        case 0:
            metal_b_supports_paint_setup(3, 1, 32, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_b_supports_paint_setup(3, 0, 36, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_b_supports_paint_setup(3, 2, 32, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_b_supports_paint_setup(3, 3, 36, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008A9798 */
static void inverted_rc_track_diag_flat_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27618, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27562, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
    ...
    case 1:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27615, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27559, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
    ...
    case 2:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27617, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27561, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
    ...
    case 3:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27616, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27560, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
...
/** rct2: 0x008A97F8 */
static void inverted_rc_track_diag_25_deg_up_to_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27574, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 61);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27571, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 61);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27573, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 61);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27572, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 61);
            break;
        }
        ...
        {
        case 0:
            metal_b_supports_paint_setup(3, 1, 16, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_b_supports_paint_setup(3, 0, 16, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_b_supports_paint_setup(3, 2, 16, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_b_supports_paint_setup(3, 3, 16, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008A9808 */
static void inverted_rc_track_diag_60_deg_up_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27578, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 61);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27575, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 61);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27577, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 61);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27576, -16, -16, 16, 16, 3, height + 29, 0, 0,
                               height + 61);
            break;
        }
        ...
        {
        case 0:
            metal_b_supports_paint_setup(3, 1, 21, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_b_supports_paint_setup(3, 0, 21, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_b_supports_paint_setup(3, 2, 21, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_b_supports_paint_setup(3, 3, 21, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008A97A8 */
static void inverted_rc_track_diag_25_deg_up_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27622, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27566, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
    ...
    case 1:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27619, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27563, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
    ...
    case 2:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27621, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27565, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
    ...
    case 3:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27620, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27564, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        ...
        {
        case 0:
            metal_a_supports_paint_setup(3, 1, 0, height + 50, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(3, 0, 0, height + 50, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_a_supports_paint_setup(3, 2, 0, height + 50, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
...
/** rct2: 0x008A97E8 */
static void inverted_rc_track_diag_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                               rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A9848 */
static void inverted_rc_track_diag_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                               rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 3:
        ...
        {
        case 0:
            metal_b_supports_paint_setup(3, 1, 24, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_b_supports_paint_setup(3, 0, 28, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_b_supports_paint_setup(3, 2, 24, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_b_supports_paint_setup(3, 3, 28, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008A97C8 */
static void inverted_rc_track_diag_flat_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A9828 */
static void inverted_rc_track_diag_25_deg_down_to_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 3:
        ...
        {
        case 0:
            metal_b_supports_paint_setup(3, 1, 17, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_b_supports_paint_setup(3, 0, 17, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_b_supports_paint_setup(3, 2, 17, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_b_supports_paint_setup(3, 3, 17, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008A9838 */
static void inverted_rc_track_diag_60_deg_down_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 3:
        ...
        {
        case 0:
            metal_b_supports_paint_setup(3, 1, 8, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_b_supports_paint_setup(3, 0, 8, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_b_supports_paint_setup(3, 2, 8, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_b_supports_paint_setup(3, 3, 8, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008A97D8 */
static void inverted_rc_track_diag_25_deg_down_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A9878 */
static void inverted_rc_track_diag_flat_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27590, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27587, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27589, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27588, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
...
/** rct2: 0x008A9888 */
static void inverted_rc_track_diag_flat_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                      rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27594, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27591, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27593, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27592, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
...
/** rct2: 0x008A9898 */
static void inverted_rc_track_diag_left_bank_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A98A8 */
static void inverted_rc_track_diag_right_bank_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                      rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A98D8 */
static void inverted_rc_track_diag_left_bank_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27606, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27603, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27605, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27604, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
...
/** rct2: 0x008A98E8 */
static void inverted_rc_track_diag_right_bank_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27610, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27607, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27609, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27608, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
...
/** rct2: 0x008A98B8 */
static void inverted_rc_track_diag_25_deg_up_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27598, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27595, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27597, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27596, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
...
/** rct2: 0x008A98C8 */
static void inverted_rc_track_diag_25_deg_up_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27602, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27599, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27601, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27600, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 37);
            break;
        }
...
/** rct2: 0x008A98F8 */
static void inverted_rc_track_diag_left_bank_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A9908 */
static void inverted_rc_track_diag_right_bank_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A9918 */
static void inverted_rc_track_diag_25_deg_down_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A9928 */
static void inverted_rc_track_diag_25_deg_down_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A9858 */
static void inverted_rc_track_diag_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                             rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27586, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27583, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27585, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 27584, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
...
/** rct2: 0x008A9868 */
static void inverted_rc_track_diag_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                              rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A9978 */
static void inverted_rc_track_left_large_half_loop_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                      rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 6:
        ...
        case 0:
            ...
            metal_a_supports_paint_setup(3, 4, 27, height, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
        ...
        case 2:
            ...
            metal_a_supports_paint_setup(3, 4, 25, height, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
...
/** rct2: 0x008A9988 */
static void inverted_rc_track_right_large_half_loop_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A9998 */
static void inverted_rc_track_right_large_half_loop_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
...
/** rct2: 0x008A99A8 */
static void inverted_rc_track_left_large_half_loop_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
...
/** rct2: 0x008A96A8 */
static void inverted_rc_track_block_brakes(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                           rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A9A78 */
static void inverted_rc_track_left_banked_quarter_turn_3_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                   int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A9A88 */
static void inverted_rc_track_right_banked_quarter_turn_3_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                    int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A9A98 */
static void inverted_rc_track_left_banked_quarter_turn_3_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                     int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
...
/** rct2: 0x008A9AA8 */
static void inverted_rc_track_right_banked_quarter_turn_3_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                      int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
...
/** rct2: 0x008A9BB8 */
static void inverted_rc_track_left_banked_quarter_turn_5_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                   int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A9BC8 */
static void inverted_rc_track_right_banked_quarter_turn_5_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                    int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A9BD8 */
static void inverted_rc_track_left_banked_quarter_turn_5_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                     int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn5TilesToRightQuarterTurn5Tiles[trackSequence];
...
/** rct2: 0x008A9BE8 */
static void inverted_rc_track_right_banked_quarter_turn_5_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                      int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn5TilesToRightQuarterTurn5Tiles[trackSequence];
...
/** rct2: 0x008A9AB8 */
static void inverted_rc_track_25_deg_up_to_left_banked_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                 int height, rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A9AC8 */
static void inverted_rc_track_25_deg_up_to_right_banked_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                  int height, rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A9AD8 */
static void inverted_rc_track_left_banked_25_deg_up_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                 int height, rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A9AE8 */
static void inverted_rc_track_right_banked_25_deg_up_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                  int height, rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A9AF8 */
static void inverted_rc_track_25_deg_down_to_left_banked_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                     int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008A9B08 */
static void inverted_rc_track_25_deg_down_to_right_banked_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                      int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008A9B18 */
static void inverted_rc_track_left_banked_25_deg_down_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                     int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008A9B28 */
static void inverted_rc_track_right_banked_25_deg_down_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                      int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008A9B38 */
static void inverted_rc_track_left_banked_flat_to_left_banked_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                        int height, rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A9B48 */
static void inverted_rc_track_right_banked_flat_to_right_banked_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                          int height, rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A9B58 */
static void inverted_rc_track_left_banked_25_deg_up_to_left_banked_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                        int height, rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A9B68 */
static void inverted_rc_track_right_banked_25_deg_up_to_right_banked_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                          int height, rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A9B78 */
static void inverted_rc_track_left_banked_flat_to_left_banked_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                          int height, rct_map_element * mapElement)
{
    inverted_rc_track_right_banked_25_deg_up_to_right_banked_flat(rideIndex, trackSequence, (direction + 2) & 3, height,
                                                                  mapElement);
}

/** rct2: 0x008A9B88 */
static void inverted_rc_track_right_banked_flat_to_right_banked_25_deg_down(uint8 rideIndex, uint8 trackSequence,
                                                                            uint8 direction, int height,
                                                                            rct_map_element * mapElement)
{
    inverted_rc_track_left_banked_25_deg_up_to_left_banked_flat(rideIndex, trackSequence, (direction + 2) & 3, height,
                                                                mapElement);
}

/** rct2: 0x008A9B98 */
static void inverted_rc_track_left_banked_25_deg_down_to_left_banked_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                          int height, rct_map_element * mapElement)
{
    inverted_rc_track_right_banked_flat_to_right_banked_25_deg_up(rideIndex, trackSequence, (direction + 2) & 3, height,
                                                                  mapElement);
}

/** rct2: 0x008A9BA8 */
static void inverted_rc_track_right_banked_25_deg_down_to_right_banked_flat(uint8 rideIndex, uint8 trackSequence,
                                                                            uint8 direction, int height,
                                                                            rct_map_element * mapElement)
{
    inverted_rc_track_left_banked_flat_to_left_banked_25_deg_up(rideIndex, trackSequence, (direction + 2) & 3, height,
                                                                mapElement);
}

/** rct2: 0x008A99B8 */
static void inverted_rc_track_flat_to_left_banked_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A99C8 */
static void inverted_rc_track_flat_to_right_banked_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A99D8 */
static void inverted_rc_track_left_banked_25_deg_up_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A99E8 */
static void inverted_rc_track_right_banked_25_deg_up_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A99F8 */
static void inverted_rc_track_flat_to_left_banked_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
...
/** rct2: 0x008A9A08 */
static void inverted_rc_track_flat_to_right_banked_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008A9A18 */
static void inverted_rc_track_left_banked_25_deg_down_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
...
/** rct2: 0x008A9A28 */
static void inverted_rc_track_right_banked_25_deg_down_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{

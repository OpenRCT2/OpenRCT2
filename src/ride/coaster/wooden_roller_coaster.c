...
static void wooden_rc_track_paint(uint32 imageIdTrack, uint32 imageIdRails, uint8 direction, sint8 x_offset, sint8 y_offset,
                                  sint16 bound_box_length_x, sint16 bound_box_length_y, sint8 bound_box_length_z,
                                  sint16 z_offset, sint16 bound_box_offset_x, sint16 bound_box_offset_y,
                                  sint16 bound_box_offset_z)
{
    ...
    sub_98197C_rotated(direction, imageId, x_offset, y_offset, bound_box_length_x, bound_box_length_y, bound_box_length_z,
                       z_offset, bound_box_offset_x, bound_box_offset_y, bound_box_offset_z);
    sub_98199C_rotated(direction, railsImageId, x_offset, y_offset, bound_box_length_x, bound_box_length_y, bound_box_length_z,
                       z_offset, bound_box_offset_x, bound_box_offset_y, bound_box_offset_z);
}
...
static void wooden_rc_track_paint_bb(const sprite_bb_2 * bb, sint16 height)
{
    ...
    sub_98197C(imageId, (sint8)bb->offset.x, (sint8)bb->offset.y, bb->bb_size.x, bb->bb_size.y, (sint8)bb->bb_size.z,
               height + bb->offset.z, bb->bb_offset.x, bb->bb_offset.y, height + bb->bb_offset.z, get_current_rotation());
    sub_98199C(railsImageId, (sint8)bb->offset.x, (sint8)bb->offset.y, bb->bb_size.x, bb->bb_size.y, (sint8)bb->bb_size.z,
               height + bb->offset.z, bb->bb_offset.x, bb->bb_offset.y, height + bb->bb_offset.z, get_current_rotation());
}

/** rct2: 0x008AC568 */
static void wooden_rc_track_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                 rct_map_element * mapElement)
{
    ...
    wooden_rc_track_paint(imageIds[direction][isChained], railsImageIds[direction][isChained], direction, 0, 2, 32, 25, 2,
                          height, 0, 3, height);
...
static void wooden_rc_track_station(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                    rct_map_element * mapElement)
{
    ...
    {
        wooden_rc_track_paint(_wooden_rc_block_brakes_image_ids[direction][0], _wooden_rc_block_brakes_image_ids[direction][1],
                              direction, 0, 2, 32, 27, 2, height, 0, 2, height);
    }
    else
    {
        wooden_rc_track_paint(stationImageIds[direction][0], stationImageIds[direction][1], direction, 0, 2, 32, 27, 2, height,
                              0, 2, height);
    }
    wooden_a_supports_paint_setup(direction & 1, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
...
/** rct2: 0x008AC578 */
static void wooden_rc_track_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                      rct_map_element * mapElement)
{
    ...
    uint8 isChained = track_element_is_lift_hill(mapElement) ? 1 : 0;
    wooden_rc_track_paint(imageIds[isChained][direction][0], imageIds[isChained][direction][1], direction, 0, 0, 32, 25, 2,
                          height, 0, 3, height);
    if (direction == 1 || direction == 2)
    {
        wooden_rc_track_paint(imageIds[isChained][direction][2], imageIds[isChained][direction][3], direction, 0, 0, 32, 1, 9,
...
/** rct2: 0x008AC588 */
static void wooden_rc_track_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                      rct_map_element * mapElement)
{
    static const uint32 imageIds[4][2] = {
    ...
    {
        wooden_rc_track_paint(imageIds[direction][0], imageIds[direction][1], direction, 0, 0, 2, 24, 93, height, 28, 4,
                              height - 16);
    }
...
/** rct2: 0x008AC598 */
static void wooden_rc_track_flat_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                              rct_map_element * mapElement)
{
    static const uint32 imageIds[2][4][4] = {
        {
...
/** rct2: 0x008AC5A8 */
static void wooden_rc_track_25_deg_up_to_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    ...
    {
        wooden_rc_track_paint(imageIds[direction][0], imageIds[direction][1], direction, 0, 0, 2, 24, 43, height, 28, 4,
                              height + 2);
...
/** rct2: 0x008AC5B8 */
static void wooden_rc_track_60_deg_up_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    static const uint32 imageIds[4][4] = {
    ...
    {
        wooden_rc_track_paint(imageIds[direction][0], imageIds[direction][1], direction, 0, 0, 24, 1, 61, height, 4, 28,
                              height - 16);
        wooden_rc_track_paint(imageIds[direction][2], imageIds[direction][3], direction, 0, 0, 32, 2, 43, height, 0, 4, height);
    }
...
/** rct2: 0x008AC5C8 */
static void wooden_rc_track_25_deg_up_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                              rct_map_element * mapElement)
{
    static const uint32 imageIds[2][4][4] = {
        {
...
/** rct2: 0x008AC5D8 */
static void wooden_rc_track_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                        rct_map_element * mapElement)
{
...
/** rct2: 0x008AC5E8 */
static void wooden_rc_track_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                        rct_map_element * mapElement)
{
...
/** rct2: 0x008AC5F8 */
static void wooden_rc_track_flat_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
...
/** rct2: 0x008AC608 */
static void wooden_rc_track_25_deg_down_to_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
...
/** rct2: 0x008AC618 */
static void wooden_rc_track_60_deg_down_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
...
/** rct2: 0x008AC628 */
static void wooden_rc_track_25_deg_down_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
    wooden_rc_track_flat_to_25_deg_up(rideIndex, trackSequence, (direction + 2) & 3, height, mapElement);
}

static void wooden_rc_track_right_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
...
static void wooden_rc_track_left_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
...
/** rct2: 0x008AC658 */
static void wooden_rc_track_flat_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                              rct_map_element * mapElement)
{
    static const uint32 imageIds[4][4] = {
    ...
    {
        wooden_rc_track_paint(imageIds[direction][2], imageIds[direction][3], direction, 0, 0, 32, 1, 9, height, 0, 26,
                              height + 5);
    }
    wooden_a_supports_paint_setup(direction & 1, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
    paint_util_push_tunnel_rotated(direction, height, TUNNEL_6);
...
/** rct2: 0x008AC668 */
static void wooden_rc_track_flat_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                               rct_map_element * mapElement)
{
    static const uint32 imageIds[4][4] = {
...
/** rct2: 0x008AC678 */
static void wooden_rc_track_left_bank_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                              rct_map_element * mapElement)
{
...
/** rct2: 0x008AC688 */
static void wooden_rc_track_right_bank_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                               rct_map_element * mapElement)
{
    wooden_rc_track_flat_to_left_bank(rideIndex, trackSequence, (direction + 2) & 3, height, mapElement);
}

static void wooden_rc_track_banked_right_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
    static const sprite_bb_2 imageIds[2][4][7] = {
        { {
...
static void wooden_rc_track_banked_left_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn5TilesToRightQuarterTurn5Tiles[trackSequence];
...
/** rct2: 0x008AC6B8 */
static void wooden_rc_track_left_bank_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    static const uint32 imageIds[4][4] = {
...
/** rct2: 0x008AC6C8 */
static void wooden_rc_track_right_bank_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                    rct_map_element * mapElement)
{
    static const uint32 imageIds[4][4] = {
...
/** rct2: 0x008AC6D8 */
static void wooden_rc_track_25_deg_up_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    static const uint32 imageIds[4][4] = {
...
/** rct2: 0x008AC6E8 */
static void wooden_rc_track_25_deg_up_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                    rct_map_element * mapElement)
{
    static const uint32 imageIds[4][4] = {
...
/** rct2: 0x008AC6F8 */
static void wooden_rc_track_left_bank_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
...
/** rct2: 0x008AC708 */
static void wooden_rc_track_right_bank_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                      rct_map_element * mapElement)
{
...
/** rct2: 0x008AC718 */
static void wooden_rc_track_25_deg_down_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
...
/** rct2: 0x008AC728 */
static void wooden_rc_track_25_deg_down_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                      rct_map_element * mapElement)
{
...
/** rct2: 0x008AC738 */
static void wooden_rc_track_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                      rct_map_element * mapElement)
{
    static const uint32 imageIds[4][2] = {
...
/** rct2: 0x008AC748 */
static void wooden_rc_track_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                       rct_map_element * mapElement)
{
...
/** rct2: 0x008AC758 */
static void wooden_rc_track_left_quarter_turn_5_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        break;
    case 1:
        paint_util_set_segment_support_height(paint_util_rotate_segments(SEGMENT_BC | SEGMENT_CC | SEGMENT_D4, direction),
                                              0xFFFF, 0);
        paint_util_set_general_support_height(height + 72, 0x20);
        break;
    case 2:
    ...
    case 3:
        ...
        paint_util_set_segment_support_height(paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_BC | SEGMENT_C0 | SEGMENT_C4 |
...
/** rct2: 0x008AC768 */
static void wooden_rc_track_right_quarter_turn_5_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        break;
    case 1:
        paint_util_set_segment_support_height(paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_C8 | SEGMENT_CC, direction),
                                              0xFFFF, 0);
        paint_util_set_general_support_height(height + 72, 0x20);
        break;
    case 2:
    ...
    case 3:
        ...
        paint_util_set_segment_support_height(paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_B8 | SEGMENT_BC | SEGMENT_C4 |
                                                                             SEGMENT_C8 | SEGMENT_CC | SEGMENT_D0 | SEGMENT_D4,
                                                                         direction),
                                              0xFFFF, 0);
        paint_util_set_general_support_height(height + 64, 0x20);
...
/** rct2: 0x008AC778 */
static void wooden_rc_track_left_quarter_turn_5_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn5TilesToRightQuarterTurn5Tiles[trackSequence];
...
/** rct2: 0x008AC788 */
static void wooden_rc_track_right_quarter_turn_5_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn5TilesToRightQuarterTurn5Tiles[trackSequence];
...
/** rct2: 0x008AC798 */
static void wooden_rc_track_s_bend_left(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                        rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AC7A8 */
static void wooden_rc_track_s_bend_right(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                         rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008ACE18 */
static void wooden_rc_track_left_vertical_loop(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                               rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008ACE28 */
static void wooden_rc_track_right_vertical_loop(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AC7E8 */
static void wooden_rc_track_left_quarter_turn_3(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AC7F8 */
static void wooden_rc_track_right_quarter_turn_3(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
...
/** rct2: 0x008AC808 */
static void wooden_rc_track_left_quarter_turn_3_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AC818 */
static void wooden_rc_track_right_quarter_turn_3_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                      rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
...
/** rct2: 0x008AC828 */
static void wooden_rc_track_left_quarter_turn_3_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AC838 */
static void wooden_rc_track_right_quarter_turn_3_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AC848 */
static void wooden_rc_track_left_quarter_turn_3_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
...
/** rct2: 0x008AC858 */
static void wooden_rc_track_right_quarter_turn_3_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
...
/** rct2: 0x008ACAB8 */
static void wooden_rc_track_left_half_banked_helix_up_small(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_B8 | SEGMENT_BC | SEGMENT_C0 | SEGMENT_D4, direction), 48, 0x20);
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_B8 | SEGMENT_BC | SEGMENT_CC, direction), 48, 0x20);
        paint_util_set_segment_support_height(
    ...
    case 4:
        ...
        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_BC | SEGMENT_C0 | SEGMENT_CC, direction), 48, 0x20);
        paint_util_set_segment_support_height(
    ...
    case 7:
        ...
        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_B8 | SEGMENT_C0 | SEGMENT_C8, direction), 48, 0x20);
        paint_util_set_segment_support_height(
...
/** rct2: 0x008ACAC8 */
static void wooden_rc_track_right_half_banked_helix_up_small(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008ACAD8 */
static void wooden_rc_track_left_half_banked_helix_down_small(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    if (trackSequence >= 4)
    {
...
/** rct2: 0x008ACAE8 */
static void wooden_rc_track_right_half_banked_helix_down_small(uint8 rideIndex, uint8 trackSequence, uint8 direction,
...
/** rct2: 0x008ACAF8 */
static void wooden_rc_track_left_half_banked_helix_up_large(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        break;
    case 1:
        paint_util_set_segment_support_height(paint_util_rotate_segments(SEGMENT_BC | SEGMENT_CC | SEGMENT_D4, direction), 48,
                                              0x20);
        paint_util_set_general_support_height(height + 32, 0x20);
        break;
    case 2:
    ...
    case 3:
        ...
        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_C0 | SEGMENT_C8 | SEGMENT_D0, direction), 48, 0x20);
        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_BC | SEGMENT_C4 | SEGMENT_CC | SEGMENT_D4, direction), 0xFFFF, 0);
        paint_util_set_general_support_height(height + 32, 0x20);
        break;
    ...
    case 7:
        ...
        break;
    case 8:
        paint_util_set_segment_support_height(paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_C8 | SEGMENT_CC, direction), 48,
                                              0x20);
        paint_util_set_general_support_height(height + 32, 0x20);
        break;
    case 9:
    ...
    case 10:
        ...
        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_B8 | SEGMENT_BC | SEGMENT_D0 | SEGMENT_D4, direction), 48, 0x20);
        paint_util_set_segment_support_height(
...
/** rct2: 0x008ACB08 */
static void wooden_rc_track_right_half_banked_helix_up_large(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008ACB18 */
static void wooden_rc_track_left_half_banked_helix_down_large(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    if (trackSequence >= 7)
    {
...
/** rct2: 0x008ACB28 */
static void wooden_rc_track_right_half_banked_helix_down_large(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
    if (trackSequence >= 7)
    {
...
/** rct2: 0x008ACB98 */
static void wooden_rc_track_left_quarter_turn_1_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008ACB78 */
static void wooden_rc_track_right_quarter_turn_1_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008ACB88 */
static void wooden_rc_track_left_quarter_turn_1_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
...
/** rct2: 0x008ACBA8 */
static void wooden_rc_track_right_quarter_turn_1_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
...
/** rct2: 0x008AC868 */
static void wooden_rc_track_brakes(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                   rct_map_element * mapElement)
{
    static const uint32 imageIds[4][2] = {
...
/** rct2: 0x008ACC78 */
static void wooden_rc_track_25_deg_up_left_banked(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008ACC88 */
static void wooden_rc_track_25_deg_up_right_banked(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008AC878 */
static void wooden_rc_track_on_ride_photo(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                          rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008ACC98 */
static void wooden_rc_track_25_deg_down_left_banked(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                    rct_map_element * mapElement)
{
...
/** rct2: 0x008ACCA8 */
static void wooden_rc_track_25_deg_down_right_banked(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
...
/** rct2: 0x008ACE08 */
static void wooden_rc_track_water_splash(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                         rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AC958 */
static void wooden_rc_track_left_eighth_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AC968 */
static void wooden_rc_track_right_eighth_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AC978 */
static void wooden_rc_track_left_eighth_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                      rct_map_element * mapElement)
{
...
/** rct2: 0x008AC988 */
static void wooden_rc_track_right_eighth_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    trackSequence = mapLeftEighthTurnToOrthogonal[trackSequence];
...
/** rct2: 0x008AC998 */
static void wooden_rc_track_left_eighth_bank_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AC9A8 */
static void wooden_rc_track_right_eighth_bank_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                      rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AC9B8 */
static void wooden_rc_track_left_eighth_bank_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
    trackSequence = mapLeftEighthTurnToOrthogonal[trackSequence];
...
/** rct2: 0x008AC9C8 */
static void wooden_rc_track_right_eighth_bank_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    trackSequence = mapLeftEighthTurnToOrthogonal[trackSequence];
...
/** rct2: 0x008AC888 */
static void wooden_rc_track_diag_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                      rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24050, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24916, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
        else
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24008, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24874, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
    ...
    case 1:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24047, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24913, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24051, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 27);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24917, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 27);
                wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 1:
        ...
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24005, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24871, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24009, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 27);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24875, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 27);
                wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 1:
    ...
    case 2:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            case 1:
                ...
                break;
            case 2:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24049, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24915, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24052, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 27);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24918, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 27);
                wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 3:
        ...
        else
        {
            ...
            case 1:
                ...
                break;
            case 2:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24007, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24873, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24010, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 27);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24876, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 27);
                wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 3:
    ...
    case 3:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24048, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24914, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
        else
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24006, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24872, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
...
/** rct2: 0x008AC8B8 */
static void wooden_rc_track_diag_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                           rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24068, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24934, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
        else
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24026, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24892, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
    ...
    case 1:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24065, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24931, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24069, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 43);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24935, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 43);
        ...
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24023, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24889, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24027, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 43);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24893, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 43);
                wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 1:
    ...
    case 2:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            case 1:
                ...
                break;
            case 2:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24067, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24933, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24070, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 43);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24936, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 43);
                wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 3:
        ...
        else
        {
            ...
            case 1:
                ...
                break;
            case 2:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24025, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24891, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24028, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 43);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24894, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 43);
                wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 3:
    ...
    case 3:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24066, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24932, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
        else
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24024, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24890, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
...
/** rct2: 0x008AC8E8 */
static void wooden_rc_track_diag_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                           rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        case 0:
            ...
            sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24045, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 91);
            sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24911, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 91);
            wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
            break;
        case 1:
    ...
    case 2:
        ...
        case 2:
            ...
            sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24046, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 91);
            sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24912, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 91);
            wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
            break;
        case 3:
...
/** rct2: 0x008AC898 */
static void wooden_rc_track_diag_flat_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24056, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24922, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
        else
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24014, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24880, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
    ...
    case 1:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24053, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24919, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24057, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24923, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 1:
        ...
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24011, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24877, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24015, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24881, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 1:
    ...
    case 2:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            case 1:
                ...
                break;
            case 2:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24055, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24921, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24058, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24924, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 3:
        ...
        else
        {
            ...
            case 1:
                ...
                break;
            case 2:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24013, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24879, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24016, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24882, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 3:
    ...
    case 3:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24054, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24920, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
        else
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24012, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24878, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
...
/** rct2: 0x008AC8C8 */
static void wooden_rc_track_diag_25_deg_up_to_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        case 0:
            ...
            sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24033, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 59);
            sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24899, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 59);
            wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
            break;
        case 1:
    ...
    case 2:
        ...
        case 2:
            ...
            sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24034, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 59);
            sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24900, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 59);
            wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
            break;
        case 3:
...
/** rct2: 0x008AC8D8 */
static void wooden_rc_track_diag_60_deg_up_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        case 0:
            ...
            sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24039, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 59);
            sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24905, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 59);
            wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
            break;
        case 1:
    ...
    case 2:
        ...
        case 2:
            ...
            sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24040, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 59);
            sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24906, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 59);
            wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
            break;
        case 3:
...
/** rct2: 0x008AC8A8 */
static void wooden_rc_track_diag_25_deg_up_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24062, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24928, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
        else
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24020, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24886, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
    ...
    case 1:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24059, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24925, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24063, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24929, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 1:
        ...
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24017, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24883, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24021, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24887, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 1:
    ...
    case 2:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            case 1:
                ...
                break;
            case 2:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24061, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24927, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24064, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24930, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 3:
        ...
        else
        {
            ...
            case 1:
                ...
                break;
            case 2:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24019, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24885, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24022, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24888, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 3:
    ...
    case 3:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24060, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24926, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
        else
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24018, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24884, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
...
/** rct2: 0x008AC918 */
static void wooden_rc_track_diag_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                             rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AC948 */
static void wooden_rc_track_diag_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                             rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AC8F8 */
static void wooden_rc_track_diag_flat_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AC928 */
static void wooden_rc_track_diag_25_deg_down_to_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AC938 */
static void wooden_rc_track_diag_60_deg_down_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AC908 */
static void wooden_rc_track_diag_25_deg_down_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008ACA18 */
static void wooden_rc_track_diag_flat_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        case 0:
            ...
            sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24081, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 27);
            sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24947, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 27);
            wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
            break;
        case 1:
    ...
    case 2:
        ...
        case 2:
            ...
            sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24082, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 27);
            sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24948, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 27);
            wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
            break;
        case 3:
...
/** rct2: 0x008AC9F8 */
static void wooden_rc_track_diag_flat_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                    rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        case 0:
            ...
            sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24087, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 27);
            sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24953, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 27);
            wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
            break;
        case 1:
    ...
    case 2:
        ...
        case 2:
            ...
            sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24088, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 27);
            sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24954, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 27);
            wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
            break;
        case 3:
...
/** rct2: 0x008ACA08 */
static void wooden_rc_track_diag_left_bank_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008ACA28 */
static void wooden_rc_track_diag_right_bank_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                    rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008ACA58 */
static void wooden_rc_track_diag_left_bank_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        case 0:
            ...
            sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24105, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 35);
            sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24971, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 35);
            wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
            break;
        case 1:
    ...
    case 2:
        ...
        case 2:
            ...
            sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24106, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 35);
            sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24972, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 35);
            wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
            break;
        case 3:
...
/** rct2: 0x008ACA68 */
static void wooden_rc_track_diag_right_bank_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        case 0:
            ...
            sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24111, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 35);
            sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24977, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 35);
            wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
            break;
        case 1:
    ...
    case 2:
        ...
        case 2:
            ...
            sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24112, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 35);
            sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24978, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 35);
            wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
            break;
        case 3:
...
/** rct2: 0x008ACA38 */
static void wooden_rc_track_diag_25_deg_up_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        case 0:
            ...
            sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24093, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 35);
            sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24959, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 35);
            wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
            break;
        case 1:
    ...
    case 2:
        ...
        case 2:
            ...
            sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24094, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 35);
            sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24960, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 35);
            wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
            break;
        case 3:
...
/** rct2: 0x008ACA48 */
static void wooden_rc_track_diag_25_deg_up_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        case 0:
            ...
            sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24099, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 35);
            sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24965, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 35);
            wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
            break;
        case 1:
    ...
    case 2:
        ...
        case 2:
            ...
            sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24100, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 35);
            sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24966, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 35);
            wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
            break;
        case 3:
...
/** rct2: 0x008ACA78 */
static void wooden_rc_track_diag_left_bank_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008ACA88 */
static void wooden_rc_track_diag_right_bank_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008ACA98 */
static void wooden_rc_track_diag_25_deg_down_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008ACAA8 */
static void wooden_rc_track_diag_25_deg_down_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008AC9D8 */
static void wooden_rc_track_diag_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                           rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        case 0:
            ...
            sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24075, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 27);
            sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24941, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 27);
            wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
            break;
        case 1:
    ...
    case 2:
        ...
        case 2:
            ...
            sub_98197C_rotated(direction, wooden_rc_get_track_colour() | 24076, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 27);
            sub_98199C_rotated(direction, wooden_rc_get_rails_colour() | 24942, -16, -16, 32, 32, 0, height, -16, -16,
                               height + 27);
            wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
            break;
        case 3:
...
/** rct2: 0x008AC9E8 */
static void wooden_rc_track_diag_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                            rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008ACB38 */
static void wooden_rc_track_left_bank_to_left_quarter_turn_3_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                       int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008ACB48 */
static void wooden_rc_track_right_bank_to_right_quarter_turn_3_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                         int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008ACB58 */
static void wooden_rc_track_left_quarter_turn_3_25_deg_down_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                         int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008ACB68 */
static void wooden_rc_track_right_quarter_turn_3_25_deg_down_to_right_bank(uint8 rideIndex, uint8 trackSequence,
...
/** rct2: 0x008ACDF8 */
static void wooden_rc_track_block_brakes(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                         rct_map_element * mapElement)
{
    wooden_rc_track_paint(_wooden_rc_block_brakes_image_ids[direction][0], _wooden_rc_block_brakes_image_ids[direction][1],
                          direction, 0, 2, 32, 25, 2, height, 0, 3, height);
    wooden_a_supports_paint_setup(direction & 1, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
    paint_util_push_tunnel_rotated(direction, height, TUNNEL_6);
    paint_util_set_segment_support_height(SEGMENTS_ALL, 0xFFFF, 0);
    paint_util_set_general_support_height(height + 32, 0x20);
...
/** rct2: 0x008ACCB8 */
static void wooden_rc_track_left_banked_quarter_turn_3_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                 int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008ACCC8 */
static void wooden_rc_track_right_banked_quarter_turn_3_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                  int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008ACCD8 */
static void wooden_rc_track_left_banked_quarter_turn_3_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                   int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
...
/** rct2: 0x008ACCE8 */
static void wooden_rc_track_right_banked_quarter_turn_3_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                    int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
...
/** rct2: 0x008ACC38 */
static void wooden_rc_track_left_banked_quarter_turn_5_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                 int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008ACC48 */
static void wooden_rc_track_right_banked_quarter_turn_5_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                  int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008ACC58 */
static void wooden_rc_track_left_banked_quarter_turn_5_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                   int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn5TilesToRightQuarterTurn5Tiles[trackSequence];
...
/** rct2: 0x008ACC68 */
static void wooden_rc_track_right_banked_quarter_turn_5_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                    int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn5TilesToRightQuarterTurn5Tiles[trackSequence];
...
/** rct2: 0x008ACCF8 */
static void wooden_rc_track_25_deg_up_to_left_banked_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008ACD08 */
static void wooden_rc_track_25_deg_up_to_right_banked_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                int height, rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008ACD18 */
static void wooden_rc_track_left_banked_25_deg_up_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008ACD28 */
static void wooden_rc_track_right_banked_25_deg_up_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                int height, rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008ACD38 */
static void wooden_rc_track_25_deg_down_to_left_banked_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                   int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008ACD48 */
static void wooden_rc_track_25_deg_down_to_right_banked_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                    int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008ACD58 */
static void wooden_rc_track_left_banked_25_deg_down_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                   int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008ACD68 */
static void wooden_rc_track_right_banked_25_deg_down_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                    int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008ACD78 */
static void wooden_rc_track_left_banked_flat_to_left_banked_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                      int height, rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008ACD88 */
static void wooden_rc_track_right_banked_flat_to_right_banked_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                        int height, rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008ACD98 */
static void wooden_rc_track_left_banked_25_deg_up_to_left_banked_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                      int height, rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008ACDA8 */
static void wooden_rc_track_right_banked_25_deg_up_to_right_banked_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                        int height, rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008ACDB8 */
static void wooden_rc_track_left_banked_flat_to_left_banked_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                        int height, rct_map_element * mapElement)
{
    wooden_rc_track_right_banked_25_deg_up_to_right_banked_flat(rideIndex, trackSequence, (direction + 2) & 3, height,
                                                                mapElement);
}

/** rct2: 0x008ACDC8 */
static void wooden_rc_track_right_banked_flat_to_right_banked_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                          int height, rct_map_element * mapElement)
{
    wooden_rc_track_left_banked_25_deg_up_to_left_banked_flat(rideIndex, trackSequence, (direction + 2) & 3, height,
                                                              mapElement);
}

/** rct2: 0x008ACDD8 */
static void wooden_rc_track_left_banked_25_deg_down_to_left_banked_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                        int height, rct_map_element * mapElement)
{
    wooden_rc_track_right_banked_flat_to_right_banked_25_deg_up(rideIndex, trackSequence, (direction + 2) & 3, height,
                                                                mapElement);
}

/** rct2: 0x008ACDE8 */
static void wooden_rc_track_right_banked_25_deg_down_to_right_banked_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                          int height, rct_map_element * mapElement)
{
    wooden_rc_track_left_banked_flat_to_left_banked_25_deg_up(rideIndex, trackSequence, (direction + 2) & 3, height,
                                                              mapElement);
}

/** rct2: 0x008ACBB8 */
static void wooden_rc_track_flat_to_left_banked_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008ACBC8 */
static void wooden_rc_track_flat_to_right_banked_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008ACBD8 */
static void wooden_rc_track_left_banked_25_deg_up_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008ACBE8 */
static void wooden_rc_track_right_banked_25_deg_up_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008ACBF8 */
static void wooden_rc_track_flat_to_left_banked_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
...
/** rct2: 0x008ACC08 */
static void wooden_rc_track_flat_to_right_banked_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
...
/** rct2: 0x008ACC18 */
static void wooden_rc_track_left_banked_25_deg_down_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
...
/** rct2: 0x008ACC28 */
static void wooden_rc_track_right_banked_25_deg_down_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{

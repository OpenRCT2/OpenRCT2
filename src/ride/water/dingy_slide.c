...
static void dinghy_slide_track_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
...
static void dinghy_slide_track_station(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                       rct_map_element * mapElement)
{
...
static void dinghy_slide_track_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                         rct_map_element * mapElement)
{
    static const uint32 imageIds[2][4][2] = {
        {
...
static void dinghy_slide_track_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                         rct_map_element * mapElement)
{
    static const uint32 imageIds[4][2] = {
...
static void dinghy_slide_track_flat_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
    static const uint32 imageIds[2][4][2] = {
        {
...
static void dinghy_slide_track_25_deg_up_to_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                      rct_map_element * mapElement)
{
    static const uint32 imageIds[4][2] = {
...
static void dinghy_slide_track_60_deg_up_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                      rct_map_element * mapElement)
{
    static const uint32 imageIds[4][2] = {
...
static void dinghy_slide_track_25_deg_up_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
    static const uint32 imageIds[2][4][2] = {
        {
...
static void dinghy_slide_track_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                           rct_map_element * mapElement)
{
    dinghy_slide_track_25_deg_up(rideIndex, trackSequence, (direction + 2) & 3, height, mapElement);
}

static void dinghy_slide_track_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                           rct_map_element * mapElement)
{
    dinghy_slide_track_60_deg_up(rideIndex, trackSequence, (direction + 2) & 3, height, mapElement);
}

static void dinghy_slide_track_flat_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    dinghy_slide_track_25_deg_up_to_flat(rideIndex, trackSequence, (direction + 2) & 3, height, mapElement);
}

static void dinghy_slide_track_25_deg_down_to_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    dinghy_slide_track_60_deg_up_to_25_deg_up(rideIndex, trackSequence, (direction + 2) & 3, height, mapElement);
}

static void dinghy_slide_track_25_deg_down_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    dinghy_slide_track_flat_to_25_deg_up(rideIndex, trackSequence, (direction + 2) & 3, height, mapElement);
}

static void dinghy_slide_track_right_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                    rct_map_element * mapElement)
{
    ...
    track_paint_util_right_quarter_turn_5_tiles_paint_2(height, direction, get_current_rotation(), trackSequence,
                                                        gTrackColours[SCHEME_TRACK], frontImageIds);
...
static void dinghy_slide_track_left_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
...
static void dinghy_slide_track_60_deg_down_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    dinghy_slide_track_25_deg_up_to_60_deg_up(rideIndex, trackSequence, (direction + 2) & 3, height, mapElement);
}

static void dinghy_slide_track_s_bend_left(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                           rct_map_element * mapElement)
{
    ...
    case 1:
        ...
        {
            metal_a_supports_paint_setup(0, 5 + (direction & 1), (direction & 1), height, gTrackColours[SCHEME_SUPPORTS]);
        }
        paint_util_set_segment_support_height(
...
static void dinghy_slide_track_s_bend_right(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                            rct_map_element * mapElement)
{
    static const uint32 imageIds[4][4][2] = {
...
static void dinghy_slide_track_right_quarter_turn_3(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                    rct_map_element * mapElement)
{
    ...
    track_paint_util_right_quarter_turn_3_tiles_paint_3(height, direction, get_current_rotation(), trackSequence,
                                                        gTrackColours[SCHEME_TRACK], imageIds);
    track_paint_util_right_quarter_turn_3_tiles_paint_3(height, direction, get_current_rotation(), trackSequence,
                                                        gTrackColours[SCHEME_TRACK], frontImageIds);
...
static void dinghy_slide_track_left_quarter_turn_3(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
...
static void dinghy_slide_track_flat_covered(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                            rct_map_element * mapElement)
{
    static const uint32 imageIds[4][2] = {
...
static void dinghy_slide_track_25_deg_up_covered(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
    static const uint32 imageIds[4][2] = {
...
static void dinghy_slide_track_60_deg_up_covered(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
    static const uint32 imageIds[4][2] = {
...
static void dinghy_slide_track_flat_to_25_deg_up_covered(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
    static const uint32 imageIds[4][2] = {
...
static void dinghy_slide_track_25_deg_up_to_60_deg_up_covered(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    static const uint32 imageIds[4][2] = {
...
static void dinghy_slide_track_60_deg_up_to_25_deg_up_covered(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    static const uint32 imageIds[4][2] = {
...
static void dinghy_slide_track_25_deg_up_to_flat_covered(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
    static const uint32 imageIds[4][2] = {
...
static void dinghy_slide_track_25_deg_down_covered(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    dinghy_slide_track_25_deg_up_covered(rideIndex, trackSequence, (direction + 2) & 3, height, mapElement);
}

static void dinghy_slide_track_60_deg_down_covered(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    dinghy_slide_track_60_deg_up_covered(rideIndex, trackSequence, (direction + 2) & 3, height, mapElement);
}

static void dinghy_slide_track_flat_to_25_deg_down_covered(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
    dinghy_slide_track_25_deg_up_to_flat_covered(rideIndex, trackSequence, (direction + 2) & 3, height, mapElement);
}

static void dinghy_slide_track_25_deg_down_to_60_deg_down_covered(uint8 rideIndex, uint8 trackSequence, uint8 direction,
...
static void dinghy_slide_track_25_deg_down_to_flat_covered(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
    dinghy_slide_track_flat_to_25_deg_up_covered(rideIndex, trackSequence, (direction + 2) & 3, height, mapElement);
}

static void dinghy_slide_track_right_quarter_turn_5_covered(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    static const sprite_bb imageIds[4][5] = {
        {
...
static void dinghy_slide_track_left_quarter_turn_5_covered(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn5TilesToRightQuarterTurn5Tiles[trackSequence];
...
static void dinghy_slide_track_s_bend_left_covered(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    static const uint32 imageIds[4][4][2] = {
...
static void dinghy_slide_track_s_bend_right_covered(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                    rct_map_element * mapElement)
{
    static const uint32 imageIds[4][4][2] = {
...
static void dinghy_slide_track_right_quarter_turn_3_covered(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    static const sprite_bb imageIds[4][3] = {
        {
...
static void dinghy_slide_track_left_quarter_turn_3_covered(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
...
static void dinghy_slide_track_60_deg_down_to_25_deg_down_covered(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                  int height, rct_map_element * mapElement)
{

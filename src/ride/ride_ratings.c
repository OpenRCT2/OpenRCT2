...
static void ride_ratings_update_state_2()
{
    ...
    do
    {
        ...
        if (trackType == 255 ||
            ((mapElement->properties.track.sequence & 0x0F) == 0 && trackType == mapElement->properties.track.type))
        {
            ...
            rct_xy_element trackElement = {.x       = gRideRatingsCalcData.proximity_x,
        ...
        case MAP_ELEMENT_TYPE_TRACK:
        {
            ...
            if (unk != 0)
            {
                ...
                if (zDiff >= 0 && zDiff <= 16)
                {
                    ...
                    if (mapElement->properties.track.type == TRACK_ELEM_LEFT_VERTICAL_LOOP ||
...
static void ride_ratings_score_close_proximity_loops(rct_map_element * inputMapElement)
{
    ...
    if (trackType == TRACK_ELEM_LEFT_VERTICAL_LOOP || trackType == TRACK_ELEM_RIGHT_VERTICAL_LOOP)
    {
        ...
        ride_ratings_score_close_proximity_loops_helper(inputMapElement, gRideRatingsCalcData.proximity_x,
                                                        gRideRatingsCalcData.proximity_y);
    ...
    do
    {
        ...
        case MAP_ELEMENT_TYPE_TRACK:
        {
            ...
            else
            {
                ...
                bool isStation = (trackType == TRACK_ELEM_END_STATION || trackType == TRACK_ELEM_MIDDLE_STATION ||
...
static void ride_ratings_calculate_value(rct_ride * ride)
{
    ...
    int value = (((ride->excitement * RideRatings[ride->type].excitement) * 32) >> 15) +
...
{
    rating_tuple result = {.excitement = 0, .intensity = 0, .nausea = 0 };
...
static void ride_ratings_apply_max_speed(rating_tuple * ratings, rct_ride * ride, int excitementMultiplier,
                                         int intensityMultiplier, int nauseaMultiplier)
{
...
static void ride_ratings_apply_average_speed(rating_tuple * ratings, rct_ride * ride, int excitementMultiplier,
...
static void ride_ratings_apply_gforces(rating_tuple * ratings, rct_ride * ride, int excitementMultiplier,
                                       int intensityMultiplier, int nauseaMultiplier)
{
...
static void ride_ratings_apply_turns(rating_tuple * ratings, rct_ride * ride, int excitementMultiplier, int intensityMultiplier,
...
static void ride_ratings_apply_drops(rating_tuple * ratings, rct_ride * ride, int excitementMultiplier, int intensityMultiplier,
                                     int nauseaMultiplier)
{
...
static void ride_ratings_apply_sheltered_ratings(rating_tuple * ratings, rct_ride * ride, int excitementMultiplier,
                                                 int intensityMultiplier, int nauseaMultiplier)
{
...
static void ride_ratings_apply_operation_option(rating_tuple * ratings, rct_ride * ride, int excitementMultiplier,
                                                int intensityMultiplier, int nauseaMultiplier)
{
...
static void ride_ratings_apply_highest_drop_height_penalty(rating_tuple * ratings, rct_ride * ride, int minHighestDropHeight,
                                                           int excitementPenalty, int intensityPenalty, int nauseaPenalty)
{
...
static void ride_ratings_apply_max_speed_penalty(rating_tuple * ratings, rct_ride * ride, int minMaxSpeed,
                                                 int excitementPenalty, int intensityPenalty, int nauseaPenalty)
{
...
static void ride_ratings_apply_num_drops_penalty(rating_tuple * ratings, rct_ride * ride, int minNumDrops,
                                                 int excitementPenalty, int intensityPenalty, int nauseaPenalty)
{
...
static void ride_ratings_apply_max_negative_g_penalty(rating_tuple * ratings, rct_ride * ride, int maxMaxNegativeVerticalG,
                                                      int excitementPenalty, int intensityPenalty, int nauseaPenalty)
{
...
static void ride_ratings_apply_max_lateral_g_penalty(rating_tuple * ratings, rct_ride * ride, int minMaxLateralG,
                                                     int excitementPenalty, int intensityPenalty, int nauseaPenalty)
{
...
static void ride_ratings_apply_first_length_penalty(rating_tuple * ratings, rct_ride * ride, int minFirstLength,
                                                    int excitementPenalty, int intensityPenalty, int nauseaPenalty)
{
...
static void ride_ratings_calculate_haunted_house(rct_ride * ride)
{
    ...
    rating_tuple ratings = {.excitement = RIDE_RATING(3, 41), .intensity = RIDE_RATING(1, 53), .nausea = RIDE_RATING(0, 10) };
...
static void ride_ratings_calculate_circus_show(rct_ride * ride)
{
    ...
    rating_tuple ratings = {.excitement = RIDE_RATING(2, 10), .intensity = RIDE_RATING(0, 30), .nausea = RIDE_RATING(0, 0) };
...
static void ride_ratings_calculate_flying_saucers(rct_ride * ride)
{
    ...
    rating_tuple ratings = {.excitement = RIDE_RATING(2, 40), .intensity = RIDE_RATING(0, 55), .nausea = RIDE_RATING(0, 39) };
...
static void ride_ratings_calculate_crooked_house(rct_ride * ride)
{
    ...
    rating_tuple ratings = {.excitement = RIDE_RATING(2, 15), .intensity = RIDE_RATING(0, 62), .nausea = RIDE_RATING(0, 34) };
...
static void ride_ratings_calculate_enterprise(rct_ride * ride)
{
    ...
    // Base ratings
    rating_tuple ratings = {.excitement = RIDE_RATING(3, 60), .intensity = RIDE_RATING(4, 55), .nausea = RIDE_RATING(5, 72) };

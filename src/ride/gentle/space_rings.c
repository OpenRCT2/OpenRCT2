...
static void paint_space_rings_structure(rct_ride * ride, uint8 direction, uint32 segment, int height)
{
    ...
    if (ride->num_stations == 0 || vehicleIndex < ride->num_vehicles)
    {
        ...
        {
            imageColourFlags =
                ride->vehicle_colours[vehicleIndex].body_colour << 19 | ride->vehicle_colours[0].trim_colour << 24 | 0xA0000000;
        }
...
static void paint_space_rings(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height, rct_map_element * mapElement)
{
    ...
    case 7:
        ...
        break;
    default:
        track_paint_util_paint_fences(edges, position, mapElement, ride, gTrackColours[SCHEME_MISC], height,
    ...
    {
    case 0:
        paint_space_rings_structure(ride, direction, 0, height + 3);
        break;
    case 5:
        paint_space_rings_structure(ride, direction, 1, height + 3);
        break;
    case 7:
        paint_space_rings_structure(ride, direction, 2, height + 3);
        break;
    case 8:
        paint_space_rings_structure(ride, direction, 3, height + 3);
        break;
    }

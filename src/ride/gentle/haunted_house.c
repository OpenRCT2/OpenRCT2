 ...
 * rct2: 0x0076F72C
 */
static void paint_haunted_house_structure(uint8 rideIndex, uint8 direction, sint8 xOffset, sint8 yOffset, uint8 part,
                                          uint16 height)
{
    ...
    sub_98197C(imageId, xOffset, yOffset, boundBox.length_x, boundBox.length_y, 127, height, boundBox.offset_x,
    ...
    if (dpi->zoom_level == 0 && frameNum != 0)
    {
        ...
        sub_98199C(imageId, xOffset, yOffset, boundBox.length_x, boundBox.length_y, 127, height, boundBox.offset_x,
                   boundBox.offset_y, height, get_current_rotation());
    }
...
static void paint_haunted_house(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height, rct_map_element * mapElement)
{
    ...
    {
    case 3:
        paint_haunted_house_structure(rideIndex, direction, 32, -32, 0, height + 3);
        break;
    case 6:
        paint_haunted_house_structure(rideIndex, direction, -32, 32, 4, height + 3);
        break;
    case 7:
        paint_haunted_house_structure(rideIndex, direction, -32, -32, 2, height + 3);
        break;
    }

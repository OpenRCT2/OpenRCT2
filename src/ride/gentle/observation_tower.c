...
/** rct2: 0x0070DD6C */
static void paint_observation_tower_base(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
...
/** rct2: 0x0070DD7C */
static void paint_observation_tower_section(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                            rct_map_element * mapElement)
{
    if (trackSequence == 1)
    {
    ...
    {
        uint32 imageId = SPR_OBSERVATION_TOWER_SEGMENT_TOP | gTrackColours[SCHEME_TRACK];

...
static const CommandLineOptionDefinition SpriteOptions[]{ { CMDLINE_TYPE_STRING, &_mode, 'm', "mode",
                                                            "the type of sprite conversion <" SZ_DEFAULT "|" SZ_CLOSEST
                                                            "|" SZ_DITHERING ">" },
                                                          OptionTableEnd };
...
const CommandLineCommand CommandLine::SpriteCommands[]{
    ...
    DefineCommand("build", "<spritefile> <resourcedir> [silent]", SpriteOptions, HandleSprite), CommandTableEnd
};

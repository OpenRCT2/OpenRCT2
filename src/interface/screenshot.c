...
static int screenshot_get_next_path(char * path, size_t size)
{
    ...
    snprintf(path, size, "%s%s %d-%02d-%02d %02d-%02d-%02d.png", screenshotPath, park_name, currentDate.year, currentDate.month,
    ...
    {
        // Glue together path and filename
        snprintf(path, size, "%s%s %d-%02d-%02d %02d-%02d-%02d (%d).png", screenshotPath, park_name, currentDate.year,
                 currentDate.month, currentDate.day, currentTime.hour, currentTime.minute, currentTime.second, i);

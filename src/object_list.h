...
#include "world/water.h"
	...
	extern rct_wall_scenery_entry		*gWallEntries[128];
	extern rct_banner					*gBannerEntries[32];
	extern rct_path_type				*gFootpathEntries[16];
	...
	#define gWallEntries				RCT2_ADDRESS(RCT2_ADDRESS_WALL_SCENERY_ENTRIES,		rct_wall_scenery_entry*)
	#define gBannerEntries				RCT2_ADDRESS(RCT2_ADDRESS_BANNER_SCENERY_ENTRIES,	rct_banner*)
	#define gFootpathEntries			RCT2_ADDRESS(RCT2_ADDRESS_PATH_TYPES,				rct_path_type*)

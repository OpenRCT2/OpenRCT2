...
/** rct2: 0x0097EDA4 */
const sint8 money_wave[] = { 0, 1, 2, 2, 3, 3, 3, 3, 2, 2, 1, 0, -1, -2, -2, -3, -3, -3, -3, -2, -2, -1,
                             0, 1, 2, 2, 3, 3, 3, 3, 2, 2, 1, 0, -1, -2, -2, -3, -3, -3, -3, -2, -2, -1 };

/** rct2: 0x0097ED90 */
const uint32 vehicle_particle_base_sprites[] = { 22577, 22589, 22601, 22613, 22625 };
...
void misc_paint(rct_sprite * misc, int imageDirection)
{
    ...
    case SPRITE_MISC_MONEY_EFFECT: // 1
    {
        ...
        sub_685EBC(amount, stringId, moneyEffect.y, moneyEffect.z, (sint8 *)&money_wave[moneyEffect.wiggle % 22],
                   moneyEffect.offset_x, get_current_rotation());
        break;
    }

...
const uint8 byte_9A406C[] = { 2, 2, 22, 26, 30, 34, 34, 34, 34, 34, 30, 26, 22, 2, 6,  2,
                              2, 2, 6,  10, 14, 18, 18, 18, 18, 18, 14, 10, 6,  2, 22, 2 };

const uint8 byte_9A408C[] = { 0, 0, 4,  8,  12, 16, 16, 16, 16, 16, 12, 8,  4,  0, 20, 0,
                              0, 0, 20, 24, 28, 32, 32, 32, 32, 32, 28, 24, 20, 0, 4,  0 };

const uint8 byte_9A40AC[] = { 2, 2, 6,  10, 14, 18, 18, 18, 18, 18, 14, 10, 6,  2, 22, 2,
                              2, 2, 22, 26, 30, 34, 34, 34, 34, 34, 30, 26, 22, 2, 6,  2 };
const uint8 byte_9A40CC[] = { 0, 0, 20, 24, 28, 32, 32, 32, 32, 32, 28, 24, 20, 0, 4,  0,
                              0, 0, 4,  8,  12, 16, 16, 16, 16, 16, 12, 8,  4,  0, 20, 0 };

static void fence_paint_door(uint32 imageId, rct_scenery_entry * sceneryEntry, uint32 imageColourFlags, uint32 tertiaryColour,
                             uint32 dword_141F710, rct_xyz16 offset, rct_xyz16 boundsR1, rct_xyz16 boundsR1_,
                             rct_xyz16 boundsR2, rct_xyz16 boundsR2_, rct_xyz16 boundsL1, rct_xyz16 boundsL1_)
{
    ...
    if (sceneryEntry->wall.flags & WALL_SCENERY_IS_BANNER)
    {
        ...
        ps = sub_98197C(imageId, (sint8)offset.x, (sint8)offset.y, boundsR1.x, boundsR1.y, (sint8)boundsR1.z, offset.z,
                        boundsR1_.x, boundsR1_.y, boundsR1_.z, get_current_rotation());
        if (ps != NULL)
        {
            ps->tertiary_colour = tertiaryColour;
        }

        ps = sub_98197C(imageId + 1, (sint8)offset.x, (sint8)offset.y, boundsR2.x, boundsR2.y, (sint8)boundsR2.z, offset.z,
                        boundsR2_.x, boundsR2_.y, boundsR2_.z, get_current_rotation());
        if (ps != NULL)
        {
            ps->tertiary_colour = tertiaryColour;
        }
    ...
    else
    {
        ...
        ps = sub_98197C(imageId, (sint8)offset.x, (sint8)offset.y, boundsL1.x, boundsL1.y, (sint8)boundsL1.z, offset.z,
                        boundsL1_.x, boundsL1_.y, boundsL1_.z, get_current_rotation());
        if (ps != NULL)
        {
            ps->tertiary_colour = tertiaryColour;
        }

        ps = sub_98199C(imageId + 1, (sint8)offset.x, (sint8)offset.y, boundsL1.x, boundsL1.y, (sint8)boundsL1.z, offset.z,
                        boundsL1_.x, boundsL1_.y, boundsL1_.z, get_current_rotation());
        if (ps != NULL)
        {
            ps->tertiary_colour = tertiaryColour;
...
static void fence_paint_wall(uint32 frameNum, const rct_scenery_entry * sceneryEntry, uint32 dword_141F710,
                             uint32 imageColourFlags, uint32 dword_141F718, uint32 tertiaryColour, uint32 imageOffset,
                             rct_xyz16 offset, rct_xyz16 bounds, rct_xyz16 boundsOffset)
{
    ...
    else
    {
        ...
        paint_struct * paint = sub_98197C(imageId, (sint8)offset.x, (sint8)offset.y, bounds.x, bounds.y, (sint8)bounds.z,
                                          offset.z, boundsOffset.x, boundsOffset.y, boundsOffset.z, get_current_rotation());
        if (paint != NULL)
        {
...
void fence_paint(uint8 direction, int height, rct_map_element * map_element)
{
    ...
    if (sceneryEntry->wall.flags & WALL_SCENERY_IS_DOOR)
    {
        ...
        case 0:
            ...
            fence_paint_door(imageId, sceneryEntry, imageColourFlags, tertiaryColour, dword_141F710, offset, boundsR1,
    ...
    fence_paint_wall(frameNum, sceneryEntry, dword_141F710, imageColourFlags, dword_141F718, tertiaryColour, imageOffset,
                     offset, bounds, boundsOffset);
    ...
    sub_98199C(scrolling_text_setup(stringId, scroll, scrollingMode), 0, 0, 1, 1, 13, height + 8, boundsOffset.x,
               boundsOffset.y, boundsOffset.z, get_current_rotation());
}

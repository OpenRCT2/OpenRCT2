...
static TTFFontSetDescriptor TTFFontGulim = {{
	{ "gulim.ttc",		9,		-1,		-3,		6,		NULL },
	{ "gulim.ttc",		11,		1,		-1,		14,		NULL },
	{ "gulim.ttc",		12,		1,		-2,		14,		NULL },
	{ "gulim.ttc",		13,		1,		0,		20,		NULL },
}};
...
const language_descriptor LanguagesDescriptors[LANGUAGE_COUNT] = {
	...
	{ "kr-KR",		"Korean",					"Korean",					"korean",				&TTFFontGulim,			RCT2_LANGUAGE_ID_KOREAN					},	// LANGUAGE_KOREAN
};

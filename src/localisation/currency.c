...
const currency_descriptor CurrencyDescriptors[CURRENCY_END] = {
	...
	{	"HKD",	100,	CURRENCY_SUFFIX,	"$",	CURRENCY_SUFFIX,	"HKD",	STR_HKD	},	// Hong Kong Dollar
	{	"TWD",	1000,	CURRENCY_SUFFIX,	"NT$",	CURRENCY_SUFFIX,	"NT$",	STR_TWD	},	// New Taiwan Dollar
	{	"HKD",	100,	CURRENCY_SUFFIX,	"CN\xC2\xA5",	CURRENCY_SUFFIX,	"CNY",	STR_YUAN	},	// Chinese Yuan
};

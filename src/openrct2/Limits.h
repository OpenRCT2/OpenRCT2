...
namespace OpenRCT2::Limits
{
    ...
    constexpr uint8_t CustomerHistorySize = RCT12::Limits::kCustomerHistorySize;
    constexpr uint16_t MaxGolfHoles = RCT12::Limits::kMaxGolfHoles;
    constexpr uint16_t MaxHelices = RCT12::Limits::kMaxHelices;
    constexpr uint16_t MaxInversions = RCT12::Limits::kMaxInversions;
    ...
    constexpr uint8_t MaxAwards = RCT12::Limits::kMaxAwards;
    constexpr uint8_t NumColourSchemes = RCT12::Limits::kNumColourSchemes;
    constexpr uint8_t DowntimeHistorySize = RCT2::Limits::kDowntimeHistorySize;
    constexpr uint16_t MaxPeepSpawns = 256;
    constexpr uint16_t MaxParkEntrances = 256;
    constexpr uint8_t MaxWaitingTime = RCT12::Limits::kMaxWaitingTime;

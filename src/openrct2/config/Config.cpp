...
#pragma region Enums
    ...
    static const auto Enum_Currency = ConfigEnum<int32_t>({
        ConfigEnumEntry<int32_t>("GBP", CurrencyType::Pounds),
        ConfigEnumEntry<int32_t>("USD", CurrencyType::Dollars),
        ConfigEnumEntry<int32_t>("FRF", CurrencyType::Franc),
        ConfigEnumEntry<int32_t>("DEM", CurrencyType::DeutscheMark),
        ConfigEnumEntry<int32_t>("JPY", CurrencyType::Yen),
        ConfigEnumEntry<int32_t>("ESP", CurrencyType::Peseta),
        ConfigEnumEntry<int32_t>("ITL", CurrencyType::Lira),
        ConfigEnumEntry<int32_t>("NLG", CurrencyType::Guilders),
        ConfigEnumEntry<int32_t>("SEK", CurrencyType::Krona),
        ConfigEnumEntry<int32_t>("EUR", CurrencyType::Euros),
        ConfigEnumEntry<int32_t>("KRW", CurrencyType::Won),
        ConfigEnumEntry<int32_t>("RUB", CurrencyType::Rouble),
        ConfigEnumEntry<int32_t>("CZK", CurrencyType::CzechKoruna),
        ConfigEnumEntry<int32_t>("HKD", CurrencyType::HKD),
        ConfigEnumEntry<int32_t>("TWD", CurrencyType::TWD),
        ConfigEnumEntry<int32_t>("CNY", CurrencyType::Yuan),
        ConfigEnumEntry<int32_t>("HUF", CurrencyType::Forint),
        ConfigEnumEntry<int32_t>("CUSTOM", CurrencyType::Custom),
    });

...
#pragma endregion
    ...
    static void ReadGeneral(IIniReader* reader)
    {
        if (reader->ReadSection("general"))
        {
            ...
            model->ShowMoneyEffectIfPaused = reader->GetBoolean("show_money_effect_if_paused", false);
    ...
    static void WriteGeneral(IIniWriter* writer)
    {
        ...
        writer->WriteBoolean("show_money_effect_if_paused", model->ShowMoneyEffectIfPaused);

...
#pragma endregion
    ...
    static void ReadGeneral(IIniReader* reader)
    {
        if (reader->ReadSection("general"))
        {
            ...
            model->disable_screensaver_lock = reader->GetBoolean("disable_screensaver_lock", true);
    ...
    static void WriteGeneral(IIniWriter* writer)
    {
        ...
        writer->WriteBoolean("disable_screensaver_lock", model->disable_screensaver_lock);

...
// 5766 is unused
    ...
    STR_PEEPWATCH_TOGGLE = 6200,
    STR_PEEPWATCH_ENABLE_MAINTENANCE_OFF = 6201,
    STR_PEEPWATCH_ENABLE_MAINTENANCE_ON = 6202,
    STR_PEEPWATCH_WATCHING = 6203,
    STR_PEEPWATCH_EATING = 6204,
    STR_PEEPWATCH_DRINKING = 6205,
    STR_PEEPWATCH_NOBODY_IS_HERE = 6206,
    STR_PEEPWATCH_DISTABLE = 6207,
    STR_PEEPWATCH_SHOW_HAPPY = 6208,
    STR_PEEPWATCH_SHOW_ENERGY = 6209,
    STR_PEEPWATCH_SHOW_HUNGER = 6210,
    STR_PEEPWATCH_SHOW_THIRST = 6211,
    STR_PEEPWATCH_SHOW_NAUSEA = 6212,
    STR_PEEPWATCH_SHOW_BATHROOM = 6213,
    STR_PEEPWATCH_ITEM_LIST_HEADER = 6214,
    STR_PEEPWATCH_GUEST_LIST_HEADER = 6215,
    STR_PEEPWATCH_IMPORTANCE_STAR = 6216,
    STR_PEEPWATCH_IMPORTANCE_PUSH = 6217,
    STR_PEEPWATCH_PEEPS_AHEAD = 6218,
    STR_PEEPWATCH_DISTANCE = 6219,
    STR_PEEPWATCH_PEEPS_AHEAD_SHORT = 6220,
    STR_PEEPWATCH_DISTANCE_SHORT = 6221,
    STR_PEEPWATCH_THOUGHT = 6222,
    STR_PEEPWATCH_SHOW_CASH = 6223,
    STR_PEEPWATCH_SHOW_RIDES = 6224,
    STR_PEEPWATCH_SHOW_FOOD = 6225,
    STR_PEEPWATCH_SHOW_DRINKS = 6226,
    STR_PEEPWATCH_SHOW_SOUVENIRS = 6227,
    STR_PEEPWATCH_SHOW_TIME_IN_PARK = 6228,
    STR_PEEPWATCH_ITEM_LIST_NOTHING = 6229,
    STR_PEEPWATCH_SHOW_RIDES_FREE = 6230,
    STR_PEEPWATCH_SHOW_FOOD_FREE = 6231,
    STR_PEEPWATCH_SHOW_DRINKS_FREE = 6232,
    STR_PEEPWATCH_SHOW_SOUVENIRS_FREE = 6233,
    STR_PEEPWATCH_SHOW_ENTRANCE = 6234,
    STR_PEEPWATCH_ITEM_LIST_ITEM = 6235,

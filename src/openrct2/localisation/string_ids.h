...
// 5766 is unused
    ...
    STR_OPTIONS_SPEEDRUNNING_TIP = 6165,
    STR_ENABLE_SPEEDRUNNING_MODE = 6166,
    STR_ENABLE_SPEEDRUNNING_TIP = 6167,
    STR_SPEEDRUNNING_LABEL = 6168,
    STR_ENABLE_SPEEDRUNNING_SPEED_CHANGES = 6169,
    STR_ENABLE_SPEEDRUNNING_SPEED_CHANGES_TIP = 6170,
    STR_START_FULL_SPEEDRUN_TIP = 6171,

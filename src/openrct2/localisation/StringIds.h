...
enum : StringId
{
    ...
    // Competition Multiplayer Strings
    STR_COMPETITION_LEADERBOARD = 7100,
    STR_COMPETITION_SETUP = 7101,
    STR_NO_ACTIVE_COMPETITION = 7102,
    STR_RANK_COLUMN = 7103,
    STR_PLAYER_NAME_COLUMN = 7104,
    STR_SCORE_COLUMN = 7105,
    STR_STATUS_COLUMN = 7106,
    STR_TIME_REMAINING_FORMAT = 7107,
    STR_YOUR_RANK_FORMAT = 7108,
    STR_YOUR_SCORE_FORMAT = 7109,
    STR_COMPETITION_STARTING = 7110,
    STR_COMPETITION_STARTED = 7111,
    STR_COMPETITION_ENDED = 7112,
    STR_YOU_WON_COMPETITION = 7113,
    STR_YOU_LOST_COMPETITION = 7114,
    STR_PLAYER_ELIMINATED = 7115,
    STR_PLAYER_LEADING = 7116,
    STR_CANT_BUILD_IN_OTHER_PLAYERS_TERRITORY = 7117,
    STR_TERRITORY_ASSIGNED = 7118,
    STR_COMPETITION_TYPE_PARK_VALUE = 7119,
    STR_COMPETITION_TYPE_GUEST_COUNT = 7120,
    STR_COMPETITION_TYPE_RIDE_INCOME = 7121,
    STR_COMPETITION_TYPE_SPEED = 7122,
    STR_COMPETITION_TYPE_SURVIVAL = 7123,
    STR_COMPETITION_TYPE_RIDE_MASTER = 7124,
    STR_START_COMPETITION = 7125,
    STR_LEAVE_COMPETITION = 7126,
    STR_VIEW_LEADERBOARD = 7127,

...
enum : StringId
{
    ...
    STR_MAPGEN_RULE_FOREST_FLOOR = 7273,
    STR_MAPGEN_RULE_WATERFALL_NW = 7260,
    STR_MAPGEN_RULE_WATERFALL_NE = 7261,
    STR_MAPGEN_RULE_WATERFALL_SE = 7262,
    STR_MAPGEN_RULE_WATERFALL_SW = 7263,

    STR_MAPGEN_RULE_SCENERY_CACTI = 7149,
    STR_MAPGEN_RULE_SCENERY_OASIS = 7150,
    STR_MAPGEN_RULE_SCENERY_SHRUBS = 7151,
    STR_MAPGEN_RULE_SCENERY_CONIFERS = 7154,
    STR_MAPGEN_RULE_SCENERY_CONIFERS_SNOW = 7153,
    STR_MAPGEN_RULE_SCENERY_CANOPY = 7156,
    STR_MAPGEN_RULE_SCENERY_FLOWERS = 7157,
    STR_MAPGEN_RULE_SCENERY_GROUND = 7158,
    STR_MAPGEN_RULE_SCENERY_BROAD_LEAVED = 7160,
    STR_MAPGEN_RULE_SCENERY_MIXED = 7161,
    STR_MAPGEN_RULE_SCENERY_CYPRESSES_AND_PINES = 7162,

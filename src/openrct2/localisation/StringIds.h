...
enum
{
    ...
    STR_SHORTCUT_UNKNOWN_2525 = 2525,
    STR_SHORTCUT_UNKNOWN_2526 = 2526,
    STR_SHORTCUT_UNKNOWN_2527 = 2527,
    STR_SHORTCUT_UNKNOWN_2528 = 2528,
    STR_SHORTCUT_UNKNOWN_2529 = 2529,
    STR_SHORTCUT_UNKNOWN_2530 = 2530,
    STR_SHORTCUT_UNKNOWN_2531 = 2531,
    STR_SHORTCUT_UNKNOWN_2532 = 2532,
    STR_SHORTCUT_BACKSPACE = 2533,
    STR_SHORTCUT_TAB = 2534,
    STR_SHORTCUT_UNKNOWN_2535 = 2535,
    STR_SHORTCUT_UNKNOWN_2536 = 2536,
    STR_SHORTCUT_CLEAR = 2537,
    STR_SHORTCUT_RETURN = 2538,
    STR_SHORTCUT_UNKNOWN_2539 = 2539,
    STR_SHORTCUT_UNKNOWN_2540 = 2540,
    STR_SHORTCUT_UNKNOWN_2541 = 2541,
    STR_SHORTCUT_UNKNOWN_2542 = 2542,
    STR_SHORTCUT_ALT = 2543,
    STR_SHORTCUT_PAUSE = 2544,
    STR_SHORTCUT_CAPS = 2545,
    STR_SHORTCUT_UNKNOWN_2546 = 2546,
    STR_SHORTCUT_UNKNOWN_2547 = 2547,
    STR_SHORTCUT_UNKNOWN_2548 = 2548,
    STR_SHORTCUT_UNKNOWN_2549 = 2549,
    STR_SHORTCUT_UNKNOWN_2550 = 2550,
    STR_SHORTCUT_UNKNOWN_2551 = 2551,
    STR_SHORTCUT_ESCAPE = 2552,
    STR_SHORTCUT_UNKNOWN_2553 = 2553,
    STR_SHORTCUT_UNKNOWN_2554 = 2554,
    STR_SHORTCUT_UNKNOWN_2555 = 2555,
    STR_SHORTCUT_UNKNOWN_2556 = 2556,
    ...
    STR_SHORTCUT_8 = 2581,
    STR_SHORTCUT_9 = 2582,
    STR_SHORTCUT_UNKNOWN_2583 = 2583,
    STR_SHORTCUT_UNKNOWN_2584 = 2584,
    STR_SHORTCUT_UNKNOWN_2585 = 2585,
    STR_SHORTCUT_UNKNOWN_2586 = 2586,
    STR_SHORTCUT_UNKNOWN_2587 = 2587,
    STR_SHORTCUT_UNKNOWN_2588 = 2588,
    STR_SHORTCUT_UNKNOWN_2589 = 2589,
    STR_SHORTCUT_A = 2590,
    STR_SHORTCUT_B = 2591,
    STR_SHORTCUT_C = 2592,
    STR_SHORTCUT_D = 2593,
    ...
    STR_SHORTCUT_Y = 2614,
    STR_SHORTCUT_Z = 2615,
    STR_SHORTCUT_UNKNOWN_2616 = 2616,
    STR_SHORTCUT_UNKNOWN_2617 = 2617,
    STR_SHORTCUT_MENU = 2618,
    STR_SHORTCUT_UNKNOWN_2619 = 2619,
    STR_SHORTCUT_UNKNOWN_2620 = 2620,
    ...
    STR_SHORTCUT_UNKNOWN_2633 = 2633,
    STR_SHORTCUT_NUMPAD_MINUS = 2634,
    STR_SHORTCUT_NUMPAD_PERIOD = 2635,
    STR_SHORTCUT_NUMPAD_DIVIDE = 2636,
    STR_SHORTCUT_F1 = 2637,
    STR_SHORTCUT_F2 = 2638,
    STR_SHORTCUT_F3 = 2639,
    STR_SHORTCUT_F4 = 2640,
    STR_SHORTCUT_F5 = 2641,
    STR_SHORTCUT_F6 = 2642,
    STR_SHORTCUT_F7 = 2643,
    STR_SHORTCUT_F8 = 2644,
    STR_SHORTCUT_F9 = 2645,
    STR_SHORTCUT_F10 = 2646,
    STR_SHORTCUT_F11 = 2647,
    STR_SHORTCUT_F12 = 2648,
    STR_SHORTCUT_F13 = 2649,
    STR_SHORTCUT_F14 = 2650,
    STR_SHORTCUT_F15 = 2651,
    STR_SHORTCUT_F16 = 2652,
    STR_SHORTCUT_F17 = 2653,
    STR_SHORTCUT_F18 = 2654,
    STR_SHORTCUT_F19 = 2655,
    STR_SHORTCUT_F20 = 2656,
    STR_SHORTCUT_F21 = 2657,
    STR_SHORTCUT_F22 = 2658,
    STR_SHORTCUT_F23 = 2659,
    STR_SHORTCUT_F24 = 2660,
    STR_SHORTCUT_UNKNOWN_2661 = 2661,
    STR_SHORTCUT_UNKNOWN_2662 = 2662,
    STR_SHORTCUT_UNKNOWN_2663 = 2663,
    STR_SHORTCUT_UNKNOWN_2664 = 2664,
    STR_SHORTCUT_UNKNOWN_2665 = 2665,
    STR_SHORTCUT_UNKNOWN_2666 = 2666,
    STR_SHORTCUT_UNKNOWN_2667 = 2667,
    STR_SHORTCUT_UNKNOWN_2668 = 2668,
    STR_SHORTCUT_NUMLOCK = 2669,
    STR_SHORTCUT_SCROLL = 2670,
    STR_SHORTCUT_UNKNOWN_2671 = 2671,
    STR_SHORTCUT_UNKNOWN_2672 = 2672,
    STR_SHORTCUT_UNKNOWN_2673 = 2673,
    STR_SHORTCUT_UNKNOWN_2674 = 2674,
    STR_SHORTCUT_UNKNOWN_2675 = 2675,
    STR_SHORTCUT_UNKNOWN_2676 = 2676,
    STR_SHORTCUT_UNKNOWN_2677 = 2677,
    STR_SHORTCUT_UNKNOWN_2678 = 2678,
    STR_SHORTCUT_UNKNOWN_2679 = 2679,

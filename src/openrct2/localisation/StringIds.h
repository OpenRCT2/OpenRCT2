...
enum
{
    ...
    STR_DEBUG_WIDE_PATH_GROUP_BOX = 6364,
    STR_SHOW_WIDE_PATH_GROUP_ANY = 6365,
    STR_SHOW_WIDE_PATH_GROUP_ALL = 6366,
    STR_SHOW_WIDE_PATH_GROUP_NUMBER = 6367,
    STR_SHOW_WIDE_PATH_GROUP_NONE = 6368,
    STR_SHOW_WIDE_PATH_LEVEL_NUMBER = 6369,
    STR_SHOW_WIDE_PATH_LEVEL_NONE = 6370,
    STR_SHOW_WIDE_PATH_LEVEL_BASIC = 6371,
    STR_OPTIONS_WIDEPATHING = 6372,
    STR_WIDEPATHING_TIP = 6373,
    STR_WIDEPATHING_LEVELS_LABEL = 6374,

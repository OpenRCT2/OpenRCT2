...
// 5766 is unused
    ...
    STR_OPTIONS_SPEEDRUNNING_TIP = 6215,
    STR_ENABLE_SPEEDRUNNING_MODE = 6216,
    STR_ENABLE_SPEEDRUNNING_TIP = 6217,
    STR_SPEEDRUNNING_LABEL = 6218,
    STR_START_FULL_SPEEDRUN_TIP = 6219,
    STR_START_IL_SPEEDRUN_TIP = 6220,
    STR_START_FULL_SPEEDRUN = 6221,
    STR_START_IL_SPEEDRUN = 6222,
    STR_SPEEDRUNNING_NEXT_LEVEL = 6223,
    STR_SPEEDRUNNING_QUIT_TO_MENU = 6224,
    STR_SPEEDRUNNING_INVALID_RUN = 6225,
    STR_SPEEDRUNNING_DAYS_LABEL = 6226,
    STR_SPEEDRUNNING_TIME_LABEL = 6227,
    STR_SPEEDRUNNING_DAYS_VALUE = 6228,
    STR_SPEEDRUNNING_TIME_VALUE = 6229,

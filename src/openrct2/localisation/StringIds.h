...
enum : uint16_t
{
    ...
    STR_MARKETING_RENEWED_FREE_ENTRY = 6577,
    STR_MARKETING_RENEWED_FREE_RIDES = 6578,
    STR_MARKETING_RENEWED_HALF_PRICE_ENTRY = 6579,
    STR_MARKETING_RENEWED_FREE_RIDE = 6580,
    STR_MARKETING_RENEWED_PARK_ADS = 6581,
    STR_MARKETING_RENEWED_RIDE_ADS = 6582,
    STR_MARKETING_CANT_RENEW_FREE_ENTRY = 6583,
    STR_MARKETING_CANT_RENEW_FREE_RIDES = 6584,
    STR_MARKETING_CANT_RENEW_HALF_PRICE_ENTRY = 6585,
    STR_MARKETING_CANT_RENEW_FREE_RIDE = 6586,
    STR_MARKETING_CANT_RENEW_PARK_ADS = 6587,
    STR_MARKETING_CANT_RENEW_RIDE_ADS = 6588,

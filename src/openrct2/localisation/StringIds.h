...
enum : uint16_t
{
    ...
    STR_RIDE_NAME_LSM_LAUNCH_ROLLER_COASTER = 97,
    STR_RIDE_NAME_MULTI_LOOPING_ROLLER_COASTER = 98,
    ...
    STR_RIDE_DESCRIPTION_LSM_LAUNCH_ROLLER_COASTER = 607,
    STR_RIDE_DESCRIPTION_MULTI_LOOPING_ROLLER_COASTER = 608,

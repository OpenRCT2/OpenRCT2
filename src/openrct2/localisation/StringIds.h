...
enum : StringId
{
    ...
    STR_MAPGEN_RULE_SCENERY_CACTI = 7109,
    STR_MAPGEN_RULE_SCENERY_OASIS = 7110,
    STR_MAPGEN_RULE_SCENERY_SHRUBS = 7111,
    STR_MAPGEN_RULE_SCENERY_CONIFERS = 7114,
    STR_MAPGEN_RULE_SCENERY_CONIFERS_SNOW = 7113,
    STR_MAPGEN_RULE_SCENERY_CANOPY = 7116,
    STR_MAPGEN_RULE_SCENERY_FLOWERS = 7117,
    STR_MAPGEN_RULE_SCENERY_GROUND = 7118,
    STR_MAPGEN_RULE_SCENERY_BROAD_LEAVED = 7120,
    STR_MAPGEN_RULE_SCENERY_MIXED = 7121,
    STR_MAPGEN_RULE_SCENERY_CYPRESSES_AND_PINES = 7122,

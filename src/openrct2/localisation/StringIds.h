...
// 5766 is unused
    ...
    STR_OPTIONS_SPEEDRUNNING_TIP = 6222,
    STR_ENABLE_SPEEDRUNNING_MODE = 6223,
    STR_ENABLE_SPEEDRUNNING_TIP = 6224,
    STR_SPEEDRUNNING_LABEL = 6225,
    STR_START_FULL_SPEEDRUN_TIP = 6226,
    STR_START_IL_SPEEDRUN_TIP = 6227,
    STR_SPEEDRUNNING_NEXT_SCENARIO = 6228,
    STR_SPEEDRUNNING_QUIT_TO_MENU = 6229,
    STR_SPEEDRUNNING_INVALID_RUN = 6230,
    STR_SPEEDRUNNING_DAYS_LABEL = 6231,
    STR_SPEEDRUNNING_TIME_LABEL = 6232,
    STR_SPEEDRUNNING_DAYS_VALUE = 6233,
    STR_SPEEDRUNNING_TIME_VALUE = 6234,
    STR_SPEEDRUNNING_RUN_GROUP = 6235,
    STR_SPEEDRUNNING_RUN_SCENARIO = 6236,
    STR_SPEEDRUNNING_OPTION_PROMPT = 6237,
    STR_SPEEDRUNNING_GROUP_OR_SCENARIO = 6238,

...
enum : uint16_t
{
    ...
    STR_GENERIC_VALUE_TOO_SIGN_FIRST_WARNING = 6490,
    STR_GENERIC_VALUE_TOO_SIGN_NORMAL_WARNING = 6491,
    STR_GENERIC_VALUE_TOO_SIGN_SEMILAST_WARNING = 6492,
    STR_GENERIC_VALUE_TOO_SIGN_LAST_WARNING = 6493,
    STR_PARK_RATING = 6494,
    STR_PARK_VALUE = 6495,
    STR_GUEST_NUMBER = 6496,
    STR_PROFIT_RIDE_TICKET = 6497,
    STR_PROFIT_STALL = 6498,
    STR_DROPPED_BELOW = 6499,
    STR_RISEN_ABOVE = 6500,
    STR_RAISED = 6501,
    STR_LOWERED = 6502,
    STR_BELOW = 6503,
    STR_ABOVE = 6504,
    ...
    STR_FEWER = 6510,
    STR_LESS = 6511,
    STR_ERROR_OBJECTIVE_REQUIRES_MONEY = 6512,
    STR_ERROR_OBJECTIVE_VALUE_RANGE_CONFLICT = 6513,
    STR_ERROR_OBJECTIVE_PROFIT_TOTAL_LOWER_THAN_SUB = 6514,
    STR_ERROR_OBJECTIVE_REQUIRES_RIDE_PRICES = 6515,
    STR_ERROR_OBJECTIVE_MAX_STAT_BELOW_MIN = 6516,
    STR_ERROR_OBJECTIVE_INSUFFICIENT_RIDE_TYPES_AVAILABLE = 6517,
    STR_ERROR_OBJECTIVE_CANNOT_ADD_TWICE = 6518,
    STR_ERROR_OBJECTIVE_CANNOT_ADD_TWICE_EXCEPT_FINISHED = 6519,
    STR_ERROR_OBJECTIVE_NOT_ENOUGH_PREBUILT_RIDES = 6520,
    STR_ERROR_OBJECTIVE_DUPLICATE_RESEARCH_RIDE = 6521,
    STR_ERROR_OBJECTIVE_DUPLICATE_BUILD_RIDE = 6522,
    STR_DATELESS = 6523,
    STR_BEFORE_DATE = 6524,
    STR_AT_DATE = 6525,
    STR_AFTER_DATE = 6526,
    STR_DURING_PERIOD = 6527,
    STR_AT_END_OF_PERIOD = 6528,
    STR_AFTER_PERIOD = 6529,
    STR_NO_DEADLINE = 6530,
    STR_ERROR_PERIOD_OF_0 = 6531,
    STR_ERROR_DATE_AFTER_PERIOD = 6532,
    STR_ERROR_DATE_AFTER_EALIER_DATE = 6533,
    STR_GOALGROUP_CONFLICTS_WITH_OTHER_GROUPS = 6534,

...
namespace OpenRCT2::Drawing
{
    enum class FilterPaletteID : int32_t
    {
        ...
        paletteGlassAmber = paletteGlass + EnumValue(Colour::amber),
        paletteGlassAmethyst = paletteGlass + EnumValue(Colour::amethyst),
        paletteGlassAsparagus = paletteGlass + EnumValue(Colour::asparagus),
        paletteGlassBrown = paletteGlass + EnumValue(Colour::brown),
        paletteGlassBurntPink = paletteGlass + EnumValue(Colour::burntPink),
        paletteGlassCactus = paletteGlass + EnumValue(Colour::cactus),
        paletteGlassCaramel = paletteGlass + EnumValue(Colour::caramel),
        paletteGlassCopper = paletteGlass + EnumValue(Colour::copper),

...
static const std::unordered_map<UnicodeChar, int32_t> kCodepointOffsetMap = {
    ...
    { UnicodeChar::aOgonekUc, CSChar::a_ogonek_uc - kCSSpriteFontOffset },
    { UnicodeChar::aOgonek, CSChar::a_ogonek - kCSSpriteFontOffset },
    { UnicodeChar::cAcuteUc, CSChar::c_acute_uc - kCSSpriteFontOffset },
    { UnicodeChar::cAcute, CSChar::c_acute - kCSSpriteFontOffset },
    ...
    { UnicodeChar::eOgonekUc, CSChar::e_ogonek_uc - kCSSpriteFontOffset },
    { UnicodeChar::eOgonek, CSChar::e_ogonek - kCSSpriteFontOffset },
    ...
    { UnicodeChar::lStrokeUc, CSChar::l_stroke_uc - kCSSpriteFontOffset },
    { UnicodeChar::lStroke, CSChar::l_stroke - kCSSpriteFontOffset },
    { UnicodeChar::nAcuteUc, CSChar::n_acute_uc - kCSSpriteFontOffset },
    { UnicodeChar::nAcute, CSChar::n_acute - kCSSpriteFontOffset },
    { UnicodeChar::nCaronUc, SPR_FONTS_N_CARON_UPPER - SPR_FONTS_BEGIN },
    { UnicodeChar::nCaron, SPR_FONTS_N_CARON_LOWER - SPR_FONTS_BEGIN },
    { UnicodeChar::oMacron, CSChar::o_circumflex - kCSSpriteFontOffset }, // No visual difference
    ...
    { UnicodeChar::sAcuteUc, CSChar::s_acute_uc - kCSSpriteFontOffset },
    { UnicodeChar::sAcute, CSChar::s_acute - kCSSpriteFontOffset },
    ...
    { UnicodeChar::zAcuteUc, CSChar::z_acute_uc - kCSSpriteFontOffset },
    { UnicodeChar::zAcute, CSChar::z_acute - kCSSpriteFontOffset },
    { UnicodeChar::zDotUc, CSChar::z_dot_uc - kCSSpriteFontOffset },
    { UnicodeChar::zDot, CSChar::z_dot - kCSSpriteFontOffset },
    ...
    { UnicodeChar::multiplicationSign, CSChar::cross - kCSSpriteFontOffset },
    ...
    { UnicodeChar::quoteOpen, CSChar::quote_open - kCSSpriteFontOffset },
    { UnicodeChar::quoteClose, CSChar::quote_close - kCSSpriteFontOffset },
    ...
    { UnicodeChar::smallUp, CSChar::small_up - kCSSpriteFontOffset },
    { UnicodeChar::right, CSChar::right - kCSSpriteFontOffset },
    { UnicodeChar::down, CSChar::down - kCSSpriteFontOffset },
    { UnicodeChar::smallDown, CSChar::small_down - kCSSpriteFontOffset },
    ...
    // Misc
    { UnicodeChar::superscriptMinusOne, CSChar::superscript_minus_one - kCSSpriteFontOffset },
};

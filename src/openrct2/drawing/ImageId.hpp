...
namespace OpenRCT2
{
    ...
    public:
        ...
        {
            return _index == rhs._index && _primary == rhs._primary && _secondary == rhs._secondary
                && _tertiary == rhs._tertiary && _flags == rhs._flags;
        }
    ...
    static_assert(
        sizeof(ImageId) == 8, "The size of this struct is expected to fit in 64 bits for perfomance reasons. See #18555");
} // namespace OpenRCT2

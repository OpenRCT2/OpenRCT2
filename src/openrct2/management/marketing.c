...
void game_command_callback_marketing_start_campaign(sint32 eax, sint32 ebx, sint32 ecx, sint32 edx, sint32 esi, sint32 edi,
                                                    sint32 ebp)
{
...
void marketing_start_campaign(sint32 type, sint32 rideOrItem, sint32 numWeeks)
{
    ...
    game_do_command(0, (numWeeks << 8) | GAME_COMMAND_FLAG_APPLY, 0, (rideOrItem << 8) | type,
                    GAME_COMMAND_START_MARKETING_CAMPAIGN, 0, 0);
}
 ...
 *  rct2: 0x0069E73C
 */
void game_command_start_campaign(sint32 * eax, sint32 * ebx, sint32 * ecx, sint32 * edx, sint32 * esi, sint32 * edi,
                                 sint32 * ebp)
{
...
bool marketing_is_campaign_type_applicable(sint32 campaignType)
{
    ...
    case ADVERTISING_CAMPAIGN_FOOD_OR_DRINK_FREE:
        ...
        FOR_ALL_RIDES(i, ride)
        {
            ...
            if (shop_item_is_food_or_drink(rideEntry->shop_item) || shop_item_is_food_or_drink(rideEntry->shop_item_secondary))
            {
                return true;
            }
        }

    ...
    private:
        ...
        void Launch()
        {
            ...
            if (gOpenRCT2Headless)
            {
                ...
                if (gOpenRCT2StartupAction != STARTUP_ACTION::STARTUP_ACTION_OPEN)
                {
                    gOpenRCT2StartupAction = STARTUP_ACTION::STARTUP_ACTION_NONE;
                }
            }
            else
            {
                if ((gOpenRCT2StartupAction == STARTUP_ACTION::STARTUP_ACTION_TITLE) && gConfigGeneral.play_intro)
                {
                    gOpenRCT2StartupAction = STARTUP_ACTION::STARTUP_ACTION_INTRO;
                }
            }

            switch (gOpenRCT2StartupAction)
            {
                case STARTUP_ACTION::STARTUP_ACTION_INTRO:
                    gIntroState = IntroState::PublisherBegin;
                    title_load();
                    break;
                case STARTUP_ACTION::STARTUP_ACTION_TITLE:
                    title_load();
                    break;
                case STARTUP_ACTION::STARTUP_ACTION_OPEN:
                {
                ...
                case STARTUP_ACTION::STARTUP_ACTION_EDIT:

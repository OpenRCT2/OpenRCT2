        ...
        void ReadWriteScenarioChunk(OrcaStream& os)
        {
            os.ReadWriteChunk(ParkFileChunkType::SCENARIO, [&os](OrcaStream::ChunkStream& cs) {
                ...
                else
                {
                    ...
                    cs.Write<uint8_t>(gScenarioObjective.PhasedGoals[0].yearDate);
                    switch (gScenarioObjective.LegacyType)
                    {
                        ...
                        case OBJECTIVE_BUILD_THE_BEST:
                            cs.Write<uint16_t>(
                                std::static_pointer_cast<ObjectiveSpecificRideGoal>(gScenarioObjective.PhasedGoals[0].goals[0])
                                    ->GetBaseRideType());
                            cs.Write<money64>(0);
                            break;
                    ...
                    if (gScenarioObjective.LegacyType == OBJECTIVE_GUESTS_AND_RATING)

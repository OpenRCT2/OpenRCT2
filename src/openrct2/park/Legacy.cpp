    ...
    ObjectList& requiredObjects, ObjectEntryIndex entryIndex, const RCT2::FootpathMapping* footpathMapping)
{
    ...
    {
        surfaceIndex = requiredObjects.Add(ObjectType::footpathSurface, footpathMapping->NormalSurface);
    }
    ...
    {
        queueSurfaceIndex = requiredObjects.Add(ObjectType::footpathSurface, footpathMapping->QueueSurface);
    }
    ...
    {
        railingIndex = requiredObjects.Add(ObjectType::footpathRailings, footpathMapping->Railing);
    }

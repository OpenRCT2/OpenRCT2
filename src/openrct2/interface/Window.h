...
constexpr int32_t kWindowMazeConstructionWidgetIdxMazeDirectionGroupbox = kWindowRideConstructionWidgetIdxConstruct;
constexpr int32_t kWindowMazeConstructionWidgetIdxMazeEntrance = kWindowRideConstructionWidgetIdxEntrance;
constexpr int32_t kWindowMazeConstructionWidgetIdxMazeExit = kWindowRideConstructionWidgetIdxExit;
constexpr int32_t kWindowScenaryWidgetIdxScenaryBackground = 0;
constexpr int32_t kWindowScenaryWidgetIdxScenaryTab1 = 15;
...
constexpr int32_t kWindowPeepWidgetIdxPatrol = 10;
constexpr int32_t kWindowPeepWidgetIdxActionLabel = 13;
...
constexpr int32_t kWindowEditorObjectSelectionWidgetIdxTab1 = 22;

...
enum
{
    VIEWPORT_FLAG_GRIDLINES = (1 << 0),
    VIEWPORT_FLAG_UNDERGROUND_INSIDE = (1 << 1),
    VIEWPORT_FLAG_HIDE_BASE = (1 << 2),
    VIEWPORT_FLAG_HIDE_VERTICAL = (1 << 3),

    VIEWPORT_FLAG_SOUND_ON = (1 << 4),
    VIEWPORT_FLAG_LAND_OWNERSHIP = (1 << 5),
    VIEWPORT_FLAG_CONSTRUCTION_RIGHTS = (1 << 6),
    VIEWPORT_FLAG_HIDE_ENTITIES = (1 << 7),
    VIEWPORT_FLAG_CLIP_VIEW = (1 << 8),
    VIEWPORT_FLAG_HIGHLIGHT_PATH_ISSUES = (1 << 9),
    VIEWPORT_FLAG_TRANSPARENT_BACKGROUND = (1 << 10),

    VIEWPORT_FLAG_LAND_HEIGHTS = (1 << 12),
    VIEWPORT_FLAG_TRACK_HEIGHTS = (1 << 13),
    VIEWPORT_FLAG_PATH_HEIGHTS = (1 << 14),

    VIEWPORT_FLAG_HIDE_RIDES = (1 << 16),
    VIEWPORT_FLAG_HIDE_VEHICLES = (1 << 17),
    VIEWPORT_FLAG_HIDE_TREES = (1 << 18),
    VIEWPORT_FLAG_HIDE_SCENERY = (1 << 19),
    VIEWPORT_FLAG_HIDE_PATHS = (1 << 20),
    VIEWPORT_FLAG_HIDE_SUPPORTS = (1 << 21),
    VIEWPORT_FLAG_HIDE_GUESTS = (1 << 22),

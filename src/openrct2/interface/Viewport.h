...
namespace OpenRCT2
{
    ...
    {
        GRIDLINES = 7,
        UNDERGROUND_INSIDE = 0,
        HIDE_BASE = 12,
        HIDE_VERTICAL = 13,

        SOUND_ON = 10,
        LAND_OWNERSHIP = 8,
        CONSTRUCTION_RIGHTS = 9,
        HIDE_ENTITIES = 14,
        CLIP_VIEW = 15,
        CLIP_VIEW_SEE_THROUGH = 17,
        HIGHLIGHT_PATH_ISSUES = 18,
        TRANSPARENT_BACKGROUND = 19,
        ...
        INVISIBLE_RIDES = 24,
        INVISIBLE_VEHICLES = 25,
        INVISIBLE_VEGETATION = 26,
        INVISIBLE_SCENERY = 27,
        INVISIBLE_PATHS = 28,
        INVISIBLE_SUPPORTS = 29,

        INDEPENDENT_ROTATION = 30,
        RENDERING_INHIBITED = 31,
    };
} // namespace OpenRCT2

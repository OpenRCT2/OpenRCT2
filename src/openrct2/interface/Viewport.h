...
enum
{
    ...
    VIEWPORT_FLAG_INVISIBLE_VEHICLES = (1 << 21),
    VIEWPORT_FLAG_INVISIBLE_RIDES = (1 << 22),
    VIEWPORT_FLAG_INVISIBLE_SCENERY = (1 << 23),
    VIEWPORT_FLAG_INVISIBLE_PATHS = (1 << 24),
    VIEWPORT_FLAG_INVISIBLE_GUESTS = (1 << 25),
    VIEWPORT_FLAG_INVISIBLE_STAFF = (1 << 26),

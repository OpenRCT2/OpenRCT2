    ...
    if (argc > 0)
    {
        if (strcmp(argv[0], "list") == 0)
        {
            ...
            FOR_ALL_RIDES(i, ride)
            {
                ...
                console_printf("ride: %03d type: %02u subtype %03u operating mode: %02u name: %s", i, ride->type, ride->subtype,
                               ride->mode, name);
            }
        }
        else if (strcmp(argv[0], "set") == 0)
        {
            ...
            if (strcmp(argv[1], "type") == 0)
            {
                ...
                else
                {
                    ...
                    sint32 res             = game_do_command(0, (type << 8) | 1, 0, (RIDE_SETTING_RIDE_TYPE << 8) | ride_index,
    ...
    if (argc > 0)
    {
        ...
        else if (strcmp(argv[0], "set") == 0)
        {
            ...
            else if (strcmp(argv[1], "costume") == 0)
            {
                ...
                bool is_entertainer =
                    peep != NULL && peep->type == PEEP_TYPE_STAFF && peep->staff_type == STAFF_TYPE_ENTERTAINER;
                if (!is_entertainer)
                {
...
static sint32 cc_set(const utf8 ** argv, sint32 argc)
{
    ...
    if (argc > 1)
    {
        ...
        {
            gGuestInitialCash =
                clamp(MONEY((sint32)double_val[0], ((sint32)(double_val[0] * 100)) % 100), MONEY(0, 0), MONEY(1000, 0));
        ...
        else if (strcmp(argv[0], "construction_rights_cost") == 0 && invalidArguments(&invalidArgs, double_valid[0]))
        {
            gConstructionRightsPrice =
                clamp(MONEY((sint32)double_val[0], ((sint32)(double_val[0] * 100)) % 100), MONEY(0, 0), MONEY(200, 0));

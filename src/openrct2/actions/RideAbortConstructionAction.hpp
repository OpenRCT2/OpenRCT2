...
DEFINE_GAME_ACTION(RideAbortConstructionAction, GAME_COMMAND_RIDE_ABORT_CONSTRUCTION, GameActionResult)
{
private:
    NetworkRideId_t _rideIndex{ RideIdNewNull };

public:
    RideAbortConstructionAction()
    {
    }
    RideAbortConstructionAction(ride_id_t rideIndex)

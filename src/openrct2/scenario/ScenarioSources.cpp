...
#pragma region Scenario Data
    ...
    {
        { SC_WHISPERING_CLIFFS,  "Whispering Cliffs",  SCENARIO_CATEGORY_BEGINNER,    "rct1.scenario_text.whispering_cliffs"  },
        { SC_THREE_MONKEYS_PARK, "Three Monkeys Park", SCENARIO_CATEGORY_BEGINNER,    "rct1.scenario_text.three_monkeys_park" },
        { SC_CANARY_MINES,       "Canary Mines",       SCENARIO_CATEGORY_BEGINNER,    "rct1.scenario_text.canary_mines"       },
        { SC_BARONY_BRIDGE,      "Barony Bridge",      SCENARIO_CATEGORY_BEGINNER,    "rct1.scenario_text.barony_bridge"      },
        { SC_FUNTOPIA,           "Funtopia",           SCENARIO_CATEGORY_BEGINNER,    "rct1.scenario_text.funtopia"           },
        { SC_HAUNTED_HARBOUR,    "Haunted Harbour",    SCENARIO_CATEGORY_BEGINNER,    "rct1.scenario_text.haunted_harbour"    },
        { SC_FUN_FORTRESS,       "Fun Fortress",       SCENARIO_CATEGORY_BEGINNER,    "rct1.scenario_text.fun_fortress"       },
        { SC_FUTURE_WORLD,       "Future World",       SCENARIO_CATEGORY_BEGINNER,    "rct1.scenario_text.future_world"       },
        { SC_GENTLE_GLEN,        "Gentle Glen",        SCENARIO_CATEGORY_BEGINNER,    "rct1.scenario_text.gentle_glen"        },
        { SC_JOLLY_JUNGLE,       "Jolly Jungle",       SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.jolly_jungle"       },
        { SC_HYDRO_HILLS,        "Hydro Hills",        SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.hydro_hills"        },
        { SC_SPRIGHTLY_PARK,     "Sprightly Park",     SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.sprightly_park"     },
        { SC_MAGIC_QUARTERS,     "Magic Quarters",     SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.magic_quarters"     },
        { SC_FRUIT_FARM,         "Fruit Farm",         SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.fruit_farm"         },
        { SC_BUTTERFLY_DAM,      "Butterfly Dam",      SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.butterfly_dam"      },
        { SC_COASTER_CANYON,     "Coaster Canyon",     SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.coaster_canyon"     },
        { SC_THUNDERSTORM_PARK,  "Thunderstorm Park",  SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.thunderstorm_park"  },
        { SC_HARMONIC_HILLS,     "Harmonic Hills",     SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.harmonic_hills"     },
        { SC_ROMAN_VILLAGE,      "Roman Village",      SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.roman_village"      },
        { SC_SWAMP_COVE,         "Swamp Cove",         SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.swamp_cove"         },
        { SC_ADRENALINE_HEIGHTS, "Adrenaline Heights", SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.adrenaline_heights" },
        { SC_UTOPIA_PARK,        "Utopia Park",        SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.utopia_park"        },
        { SC_ROTTING_HEIGHTS,    "Rotting Heights",    SCENARIO_CATEGORY_EXPERT,      "rct1.scenario_text.rotting_heights"    },
        { SC_FIASCO_FOREST,      "Fiasco Forest",      SCENARIO_CATEGORY_EXPERT,      "rct1.scenario_text.fiasco_forest"      },
        { SC_PICKLE_PARK,        "Pickle Park",        SCENARIO_CATEGORY_EXPERT,      "rct1.scenario_text.pickle_park"        },
        { SC_GIGGLE_DOWNS,       "Giggle Downs",       SCENARIO_CATEGORY_EXPERT,      "rct1.scenario_text.giggle_downs"       },
        { SC_MINERAL_PARK,       "Mineral Park",       SCENARIO_CATEGORY_EXPERT,      "rct1.scenario_text.mineral_park"       },
        { SC_COASTER_CRAZY,      "Coaster Crazy",      SCENARIO_CATEGORY_EXPERT,      "rct1.scenario_text.coaster_crazy"      },
        { SC_URBAN_PARK,         "Urban Park",         SCENARIO_CATEGORY_EXPERT,      "rct1.scenario_text.urban_park"         },
        { SC_GEOFFREY_GARDENS,   "Geoffrey Gardens",   SCENARIO_CATEGORY_EXPERT,      "rct1.scenario_text.geoffrey_gardens"   },
    };

    // RCT: Loopy Landscapes
    static constexpr ScenarioTitleDescriptor ScenarioTitlesRCT1LL[] =
    {
        { SC_ICEBERG_ISLANDS,  "Iceberg Islands",  SCENARIO_CATEGORY_BEGINNER,    "rct1.scenario_text.iceberg_islands"  },
        { SC_VOLCANIA,         "Volcania",         SCENARIO_CATEGORY_BEGINNER,    "rct1.scenario_text.volcania"         },
        { SC_ARID_HEIGHTS,     "Arid Heights",     SCENARIO_CATEGORY_BEGINNER,    "rct1.scenario_text.arid_heights"     },
        { SC_RAZOR_ROCKS,      "Razor Rocks",      SCENARIO_CATEGORY_BEGINNER,    "rct1.scenario_text.razor_rocks"      },
        { SC_CRATER_LAKE,      "Crater Lake",      SCENARIO_CATEGORY_BEGINNER,    "rct1.scenario_text.crater_lake"      },
        { SC_VERTIGO_VIEWS,    "Vertigo Views",    SCENARIO_CATEGORY_BEGINNER,    "rct1.scenario_text.vertigo_views"    },
        { SC_PARADISE_PIER_2,  "Paradise Pier 2",  SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.paradise_pier_2"  },
        { SC_DRAGONS_COVE,     "Dragon's Cove",    SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.dragons_cove"     },
        { SC_GOOD_KNIGHT_PARK, "Good Knight Park", SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.good_knight_park" },
        { SC_WACKY_WARREN,     "Wacky Warren",     SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.wacky_warren"     },
        { SC_GRAND_GLACIER,    "Grand Glacier",    SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.grand_glacier"    },
        { SC_CRAZY_CRATERS,    "Crazy Craters",    SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.crazy_craters"    },
        { SC_DUSTY_DESERT,     "Dusty Desert",     SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.dusty_desert"     },
        { SC_WOODWORM_PARK,    "Woodworm Park",    SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.woodworm_park"    },
        { SC_ICARUS_PARK,      "Icarus Park",      SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.icarus_park"      },
        { SC_SUNNY_SWAMPS,     "Sunny Swamps",     SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.sunny_swamps"     },
        { SC_FRIGHTMARE_HILLS, "Frightmare Hills", SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.frightmare_hills" },
        { SC_THUNDER_ROCKS,    "Thunder Rocks",    SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.thunder_rocks"    },
        { SC_OCTAGON_PARK,     "Octagon Park",     SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.octagon_park"     },
        { SC_PLEASURE_ISLAND,  "Pleasure Island",  SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.pleasure_island"  },
        { SC_ICICLE_WORLDS,    "Icicle Worlds",    SCENARIO_CATEGORY_CHALLENGING, "rct1.scenario_text.icicle_worlds"    },
        { SC_SOUTHERN_SANDS,   "Southern Sands",   SCENARIO_CATEGORY_EXPERT,      "rct1.scenario_text.southern_sands"   },
        { SC_TINY_TOWERS,      "Tiny Towers",      SCENARIO_CATEGORY_EXPERT,      "rct1.scenario_text.tiny_towers"      },
        { SC_NEVERMORE_PARK,   "Nevermore Park",   SCENARIO_CATEGORY_EXPERT,      "rct1.scenario_text.nevermore_park"   },
        { SC_PACIFICA,         "Pacifica",         SCENARIO_CATEGORY_EXPERT,      "rct1.scenario_text.pacifica"         },
        { SC_URBAN_JUNGLE,     "Urban Jungle",     SCENARIO_CATEGORY_EXPERT,      "rct1.scenario_text.urban_jungle"     },
        { SC_TERROR_TOWN,      "Terror Town",      SCENARIO_CATEGORY_EXPERT,      "rct1.scenario_text.terror_town"      },
        { SC_MEGAWORLD_PARK,   "Megaworld Park",   SCENARIO_CATEGORY_EXPERT,      "rct1.scenario_text.megaworld_park"   },
        { SC_VENUS_PONDS,      "Venus Ponds",      SCENARIO_CATEGORY_EXPERT,      "rct1.scenario_text.venus_ponds"      },
        { SC_MICRO_PARK,       "Micro Park",       SCENARIO_CATEGORY_EXPERT,      "rct1.scenario_text.micro_park"       },
    };
    ...
    {
        { SC_ALTON_TOWERS,             "Alton Towers",              SCENARIO_CATEGORY_REAL, "rct1.scenario_text.alton_towers"              },
        { SC_HEIDE_PARK,               "Heide-Park",                SCENARIO_CATEGORY_REAL, "rct1.scenario_text.heidepark"                 },
        { SC_BLACKPOOL_PLEASURE_BEACH, "Blackpool Pleasure Beach",  SCENARIO_CATEGORY_REAL, "rct1.scenario_text.blackpool_pleasure_beach"  },
    ...
    {
        { SC_FORT_ANACHRONISM,                          "Fort Anachronism",                           SCENARIO_CATEGORY_DLC,            "rct1.scenario_text.fort_anachronism"                         },
        ...
        { SC_UNIDENTIFIED,                              "Panda World",                                SCENARIO_CATEGORY_DLC,            "rct2.scenario_text.panda_world"                              },

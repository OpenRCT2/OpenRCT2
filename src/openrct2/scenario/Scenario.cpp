...
const StringId kScenarioGroupStringIds[EnumValue(ScenarioGroup::count)] = {
    STR_GRAPHITE_GROUP, STR_EMERALD_GROUP, STR_RUBY_GROUP,   STR_SAPPHIRE_GROUP, STR_AMETHYST_GROUP, STR_CORAL_GROUP,
    STR_IVORY_GROUP,    STR_BRONZE_GROUP,  STR_SILVER_GROUP, STR_GOLD_GROUP,     STR_OTHER_PARKS,    STR_BONUS_GROUP,
};

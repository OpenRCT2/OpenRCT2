...
static money32 footpath_element_insert(sint32 type, sint32 x, sint32 y, sint32 z, sint32 slope, sint32 flags,
                                       uint8 pathItemType)
{
    rct_map_element * mapElement;
    sint32            bl, zHigh;
...
static money32 footpath_element_update(sint32 x, sint32 y, rct_map_element * mapElement, sint32 type, sint32 flags,
                                       uint8 pathItemType)
{
...
static money32 footpath_place_real(sint32 type, sint32 x, sint32 y, sint32 z, sint32 slope, sint32 flags, uint8 pathItemType,
                                   bool clearDirection, sint32 direction)
{
    rct_map_element * mapElement;
    ...
    if (gGameCommandNestLevel == 1 && !(flags & GAME_COMMAND_FLAG_GHOST))
    {
        ...
        if (clearDirection && !gCheatsDisableClearanceChecks)
        {
            ...
            wall_remove_intersecting_walls(x - TileDirectionDelta[direction].x, y - TileDirectionDelta[direction].y, z, z + 4,
                                           direction);
        }
    }
 ...
 *  rct2: 0x006A61DE
 */
void game_command_place_footpath(sint32 * eax, sint32 * ebx, sint32 * ecx, sint32 * edx, sint32 * esi, sint32 * edi,
                                 sint32 * ebp)
{
    *ebx = footpath_place_real((*edx >> 8) & 0xFF, *eax & 0xFFFF, *ecx & 0xFFFF, *edx & 0xFF, (*ebx >> 8) & 0xFF, *ebx & 0xFF,
                               *edi & 0xFF, (*ebp & FOOTPATH_CLEAR_DIRECTIONAL) >> 8, *ebp & 0xFF);
}
 ...
 *  rct2: 0x006A68AE
 */
void game_command_place_footpath_from_track(sint32 * eax, sint32 * ebx, sint32 * ecx, sint32 * edx, sint32 * esi, sint32 * edi,
                                            sint32 * ebp)
{
 ...
 *  rct2: 0x006A67C0
 */
void game_command_remove_footpath(sint32 * eax, sint32 * ebx, sint32 * ecx, sint32 * edx, sint32 * esi, sint32 * edi,
                                  sint32 * ebp)
{
...
money32 footpath_place_remove_intersecting(sint32 type, sint32 x, sint32 y, sint32 z, sint32 slope, sint32 flags,
                                           sint32 direction)
{
    return game_do_command(x, (slope << 8) | flags, y, (type << 8) | z, GAME_COMMAND_PLACE_PATH, 0,
                           FOOTPATH_CLEAR_DIRECTIONAL | direction);
}
...
money32 footpath_provisional_set(sint32 type, sint32 x, sint32 y, sint32 z, sint32 slope)
{
    ...
    cost = footpath_place(type, x, y, z, slope,
                          GAME_COMMAND_FLAG_GHOST | GAME_COMMAND_FLAG_5 | GAME_COMMAND_FLAG_4 |
 ...
 *      mapElement: edx
 */
void footpath_get_coordinates_from_pos(sint32 screenX, sint32 screenY, sint32 * x, sint32 * y, sint32 * direction,
                                       rct_map_element ** mapElement)
{
 ...
 * mapElement: edx
 */
void footpath_bridge_get_info_from_pos(sint32 screenX, sint32 screenY, sint32 * x, sint32 * y, sint32 * direction,
                                       rct_map_element ** mapElement)
{
    ...
    *y = map_pos.y;
    ...
    get_map_coordinates_from_pos(screenX, screenY,
                                 VIEWPORT_INTERACTION_MASK_RIDE & VIEWPORT_INTERACTION_MASK_FOOTPATH &
...
static void neighbour_list_push(rct_neighbour_list * neighbourList, sint32 order, sint32 direction, uint8 rideIndex,
                                uint8 entrance_index)
{
...
static bool sub_footpath_disconnect_queue_from_path(sint32 x, sint32 y, rct_map_element * mapElement, sint32 action,
                                                    sint32 direction)
{
 ...
 *  rct2: 0x006A6D7E
 */
static void loc_6A6D7E(sint32 initialX, sint32 initialY, sint32 z, sint32 direction, rct_map_element * initialMapElement,
            ...
            case MAP_ELEMENT_TYPE_ENTRANCE:
                if (z == mapElement->base_height)
                {
                    if (entrance_has_direction(
                            mapElement, ((direction - map_element_get_direction(mapElement)) & MAP_ELEMENT_DIRECTION_MASK) ^ 2))
                    {
                        if (query)
                        {
...
static void loc_6A6C85(sint32 x, sint32 y, sint32 direction, rct_map_element * mapElement, sint32 flags, bool query,
 ...
 *  rct2: 0x006A742F
 */
void footpath_chain_ride_queue(sint32 rideIndex, sint32 entranceIndex, sint32 x, sint32 y, rct_map_element * mapElement,
                               sint32 direction)
{
 ...
 */
static sint32 footpath_is_connected_to_map_edge_recurse(sint32 x, sint32 y, sint32 z, sint32 direction, sint32 flags,
 ...
 *  rct2: 0x006A6B7F
 */
static void footpath_remove_edges_towards_here(sint32 x, sint32 y, sint32 z, sint32 direction, rct_map_element * mapElement,
                                               bool isQueue)
{
    sint32 d;

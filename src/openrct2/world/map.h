...
enum {
    ...
    TILE_ELEMENT_SLOPE_NE_CORNER_UP = (1 << 0),
    TILE_ELEMENT_SLOPE_SE_CORNER_UP = (1 << 1),
    TILE_ELEMENT_SLOPE_SW_CORNER_UP = (1 << 2),
    TILE_ELEMENT_SLOPE_NW_CORNER_UP = (1 << 3),
    TILE_ELEMENT_SLOPE_DOUBLE_HEIGHT = (1 << 4),

    TILE_ELEMENT_SLOPE_NW_CORNER_DN = TILE_ELEMENT_SLOPE_ALL_CORNERS_UP & ~TILE_ELEMENT_SLOPE_NW_CORNER_UP,
    TILE_ELEMENT_SLOPE_SW_CORNER_DN = TILE_ELEMENT_SLOPE_ALL_CORNERS_UP & ~TILE_ELEMENT_SLOPE_SW_CORNER_UP,
    TILE_ELEMENT_SLOPE_SE_CORNER_DN = TILE_ELEMENT_SLOPE_ALL_CORNERS_UP & ~TILE_ELEMENT_SLOPE_SE_CORNER_UP,
    TILE_ELEMENT_SLOPE_NE_CORNER_DN = TILE_ELEMENT_SLOPE_ALL_CORNERS_UP & ~TILE_ELEMENT_SLOPE_NE_CORNER_UP,

    TILE_ELEMENT_SLOPE_E_SIDE_UP = TILE_ELEMENT_SLOPE_NE_CORNER_UP | TILE_ELEMENT_SLOPE_SE_CORNER_UP,
    TILE_ELEMENT_SLOPE_S_SIDE_UP = TILE_ELEMENT_SLOPE_SE_CORNER_UP | TILE_ELEMENT_SLOPE_SW_CORNER_UP,
    TILE_ELEMENT_SLOPE_N_SIDE_UP = TILE_ELEMENT_SLOPE_NE_CORNER_UP | TILE_ELEMENT_SLOPE_NW_CORNER_UP,
    TILE_ELEMENT_SLOPE_W_SIDE_UP = TILE_ELEMENT_SLOPE_SW_CORNER_UP | TILE_ELEMENT_SLOPE_NW_CORNER_UP,

    TILE_ELEMENT_SLOPE_NW_SE_VALLEY = TILE_ELEMENT_SLOPE_SE_CORNER_UP | TILE_ELEMENT_SLOPE_NW_CORNER_UP,
    TILE_ELEMENT_SLOPE_NE_SW_VALLEY = TILE_ELEMENT_SLOPE_NE_CORNER_UP | TILE_ELEMENT_SLOPE_SW_CORNER_UP
};

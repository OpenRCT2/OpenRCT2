...
enum {
    TILE_ELEMENT_SLOPE_NE_CORNER_UP = 1,
    TILE_ELEMENT_SLOPE_SE_CORNER_UP = 2,
    TILE_ELEMENT_SLOPE_SW_CORNER_UP = 4,
    TILE_ELEMENT_SLOPE_NW_CORNER_UP = 8,

    TILE_ELEMENT_SLOPE_NW_CORNER_DN = 7,
    TILE_ELEMENT_SLOPE_SW_CORNER_DN = 9,
    TILE_ELEMENT_SLOPE_SE_CORNER_DN = 13,
    TILE_ELEMENT_SLOPE_NE_CORNER_DN = 14,

    TILE_ELEMENT_SLOPE_E_SIDE_UP = 3,
    TILE_ELEMENT_SLOPE_S_SIDE_UP = 6,
    TILE_ELEMENT_SLOPE_N_SIDE_UP = 9,
    TILE_ELEMENT_SLOPE_W_SIDE_UP = 12,

    TILE_ELEMENT_SLOPE_NW_SE_VALLEY = 5,
    TILE_ELEMENT_SLOPE_NE_SW_VALLEY = 10,

    TILE_ELEMENT_SLOPE_DOUBLE_HEIGHT = 16
};

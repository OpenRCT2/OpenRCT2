...
sint32 map_element_height(sint32 x, sint32 y)
{
    ...
    uint32 height = (map_get_water_height(mapElement) << 20) | (mapElement->base_height << 3);
 ...
 *  rct2: 0x006B8E1B
 */
void game_command_remove_large_scenery(sint32 * eax, sint32 * ebx, sint32 * ecx, sint32 * edx, sint32 * esi, sint32 * edi,
                                       sint32 * ebp)
{
 ...
 *  rct2: 0x006B909A
 */
void game_command_set_large_scenery_colour(sint32 * eax, sint32 * ebx, sint32 * ecx, sint32 * edx, sint32 * esi, sint32 * edi,
                                           sint32 * ebp)
{
    gCommandExpenditureType      = RCT_EXPENDITURE_TYPE_LANDSCAPING;
    sint32 x                     = *eax;
 ...
 *  rct2: 0x0068DF91
 */
void game_command_clear_scenery(sint32 * eax, sint32 * ebx, sint32 * ecx, sint32 * edx, sint32 * esi, sint32 * edi,
                                sint32 * ebp)
{
 ...
 *  rct2: 0x00663CCD
 */
static money32 map_change_surface_style(sint32 x0, sint32 y0, sint32 x1, sint32 y1, uint8 surfaceStyle, uint8 edgeStyle,
                                        uint8 flags)
{
    gCommandExpenditureType = RCT_EXPENDITURE_TYPE_LANDSCAPING;
    ...
    for (sint32 x = x0; x <= x1; x += 32)
    {
        for (sint32 y = y0; y <= y1; y += 32)
        {
            ...
            {
                uint8 cur_terrain =
                    (map_element_get_direction(mapElement) << 3) | (mapElement->properties.surface.terrain >> 5);
 ...
 *  rct2: 0x00663CCD
 */
void game_command_change_surface_style(sint32 * eax, sint32 * ebx, sint32 * ecx, sint32 * edx, sint32 * esi, sint32 * edi,
                                       sint32 * ebp)
{
...
void game_command_set_land_height(sint32 * eax, sint32 * ebx, sint32 * ecx, sint32 * edx, sint32 * esi, sint32 * edi,
                                  sint32 * ebp)
{
 ...
 *  rct2: 0x006648E3
 */
void game_command_set_land_ownership(sint32 * eax, sint32 * ebx, sint32 * ecx, sint32 * edx, sint32 * esi, sint32 * edi,
                                     sint32 * ebp)
{
...
static money32 raise_land(sint32 flags, sint32 x, sint32 y, sint32 z, sint32 ax, sint32 ay, sint32 bx, sint32 by,
...
static money32 lower_land(sint32 flags, sint32 x, sint32 y, sint32 z, sint32 ax, sint32 ay, sint32 bx, sint32 by,
                          sint32 selectionType)
{
    money32 cost = 0;
...
static money32 smooth_land_row_by_edge(sint32 flags, sint32 x, sint32 y, sint32 expectedLandHeight1, sint32 expectedLandHeight2,
                                       sint32 stepX, sint32 stepY, sint32 direction1, sint32 direction2, sint32 checkDirection1,
                                       sint32 checkDirection2, bool raiseLand)
{
    ...
    while ((shouldContinue & 0x3) != 0)
    {
        ...
        else
        {
            ...
            if (map_element_get_corner_height(mapElement, direction1) + landChangePerTile !=
                map_element_get_corner_height(mapElement, checkDirection1))
            {
                shouldContinue &= ~0x1;
            }
            if (map_element_get_corner_height(mapElement, direction2) + landChangePerTile !=
                map_element_get_corner_height(mapElement, checkDirection2))
            {
                shouldContinue &= ~0x2;
            }
            if ((shouldContinue & 0x1) && map_element_get_corner_height(mapElement, checkDirection1) !=
                                              map_element_get_corner_height(nextMapElement, direction1))
            {
                shouldContinue &= ~0x1;
            }
            if ((shouldContinue & 0x2) && map_element_get_corner_height(mapElement, checkDirection2) !=
                                              map_element_get_corner_height(nextMapElement, direction2))
            {
                shouldContinue &= ~0x2;
            }
        }
        ...
        if (raiseLand)
        {
            ...
            if ((shouldContinue & 0x8) && map_get_corner_height(mapElement->base_height, oldSlope, direction2) ==
...
static money32 smooth_land_row_by_corner(sint32 flags, sint32 x, sint32 y, sint32 expectedLandHeight, sint32 stepX,
                                         sint32 stepY, sint32 direction, sint32 checkDirection, bool raiseLand)
{
    ...
    while (shouldContinue)
    {
        ...
        else
        {
            ...
            if (map_element_get_corner_height(mapElement, direction) + landChangePerTile !=
                map_element_get_corner_height(mapElement, checkDirection))
            {
                shouldContinue = false;
            }
            if (shouldContinue && map_element_get_corner_height(mapElement, checkDirection) !=
                                      map_element_get_corner_height(nextMapElement, direction))
            {
                shouldContinue = false;
            }
        }
        if (stepX * stepY != 0)
        {
            totalCost += smooth_land_row_by_corner(flags, x, y, expectedLandHeight + (landChangePerTile / 2), 0, stepY,
                                                   direction, checkDirection ^ 3, raiseLand);
            totalCost += smooth_land_row_by_corner(flags, x, y, expectedLandHeight + (landChangePerTile / 2), stepX, 0,
                                                   direction, checkDirection ^ 1, raiseLand);
        }
...
static money32 smooth_land(sint32 flags, sint32 centreX, sint32 centreY, sint32 mapLeft, sint32 mapTop, sint32 mapRight,
                           sint32 mapBottom, sint32 command)
{
    // Cap bounds to map
 ...
 *  rct2: 0x006E650F
 */
void game_command_set_water_height(sint32 * eax, sint32 * ebx, sint32 * ecx, sint32 * edx, sint32 * esi, sint32 * edi,
                                   sint32 * ebp)
{
    sint32 x                = *eax;
    sint32 y                = *ecx;
 ...
 *  rct2: 0x006B893C
 */
void game_command_place_large_scenery(sint32 * eax, sint32 * ebx, sint32 * ecx, sint32 * edx, sint32 * esi, sint32 * edi,
                                      sint32 * ebp)
{
    gCommandExpenditureType = RCT_EXPENDITURE_TYPE_LANDSCAPING;
    sint32 x                = (sint16)*eax;
...
static void map_get_bounding_box(sint32 ax, sint32 ay, sint32 bx, sint32 by, sint32 * left, sint32 * top, sint32 * right,
                                 sint32 * bottom)
{
    sint32 x, y;
    x               = ax;
...
void map_reorganise_elements()
{
    ...
    rct_map_element * new_map_elements =
        malloc(3 * (MAXIMUM_MAP_SIZE_TECHNICAL * MAXIMUM_MAP_SIZE_TECHNICAL) * sizeof(rct_map_element));
    ...
    memset(gMapElements + num_elements, 0,
           (3 * (MAXIMUM_MAP_SIZE_TECHNICAL * MAXIMUM_MAP_SIZE_TECHNICAL) - num_elements) * sizeof(rct_map_element));
 ...
 *  bl = bl
 */
sint32 map_can_construct_with_clear_at(sint32 x, sint32 y, sint32 zLow, sint32 zHigh, CLEAR_FUNC * clearFunc, uint8 bl,
                                       uint8 flags, money32 * price)
{
...
static void clear_element_at(sint32 x, sint32 y, rct_map_element ** elementPtr)
{
    ...
    case MAP_ELEMENT_TYPE_WALL:
        ...
        game_do_command(x, GAME_COMMAND_FLAG_APPLY, y, map_element_get_direction(element) | (element->base_height << 8),
                        GAME_COMMAND_REMOVE_WALL, 0, 0);
        break;
    case MAP_ELEMENT_TYPE_SCENERY_MULTIPLE:
        gGameCommandErrorTitle = STR_CANT_REMOVE_THIS;
        game_do_command(x, (GAME_COMMAND_FLAG_APPLY) | (map_element_get_direction(element) << 8), y,
...
bool map_large_scenery_get_origin(sint32 x, sint32 y, sint32 z, sint32 direction, sint32 sequence, sint32 * outX, sint32 * outY,
                                  sint32 * outZ, rct_map_element ** outElement)
{
    rct_map_element *        mapElement;
    rct_scenery_entry *      sceneryEntry;
...
void game_command_set_sign_name(sint32 * eax, sint32 * ebx, sint32 * ecx, sint32 * edx, sint32 * esi, sint32 * edi,
                                sint32 * ebp)
{
...
void game_command_set_sign_style(sint32 * eax, sint32 * ebx, sint32 * ecx, sint32 * edx, sint32 * esi, sint32 * edi,
                                 sint32 * ebp)
{
    ...
    { // large sign
        ...
        if (!sign_set_colour(banner->x * 32, banner->y * 32, mapElement->base_height, map_element_get_direction(mapElement),
 ...
 * @param ride index
 */
rct_map_element * map_get_track_element_at_with_direction_from_ride(sint32 x, sint32 y, sint32 z, sint32 direction,
                                                                    sint32 rideIndex)
{
    rct_map_element * mapElement = map_get_first_element_at(x >> 5, y >> 5);
    do
...
uint16 check_max_allowable_land_rights_for_tile(uint8 x, uint8 y, uint8 base_z)
{
    ...
    do
    {
            ...
            (type == MAP_ELEMENT_TYPE_ENTRANCE && mapElement->properties.entrance.type == ENTRANCE_TYPE_PARK_ENTRANCE))
        {
            ...
            if (mapElement->base_height - 3 > base_z || mapElement->base_height < base_z)
            {

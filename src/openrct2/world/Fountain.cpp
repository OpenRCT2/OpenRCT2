...
template<> bool SpriteBase::Is<JumpingFountain>()
{
    return sprite_identifier == SPRITE_IDENTIFIER_MISC && (type == SPRITE_MISC_JUMPING_FOUNTAIN_SNOW || type == SPRITE_MISC_JUMPING_FOUNTAIN_WATER);
}

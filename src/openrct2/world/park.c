 ...
 *  rct2: 0x00669E30
 */
void game_command_set_park_entrance_fee(sint32 * eax, sint32 * ebx, sint32 * ecx, sint32 * edx, sint32 * esi, sint32 * edi,
                                        sint32 * ebp)
{
 ...
 *  rct2: 0x00669D4A
 */
void game_command_set_park_open(sint32 * eax, sint32 * ebx, sint32 * ecx, sint32 * edx, sint32 * esi, sint32 * edi,
                                sint32 * ebp)
{
    if (!(*ebx & GAME_COMMAND_FLAG_APPLY))
    {
...
void park_set_name(const char * name)
{
    ...
    game_do_command(1, GAME_COMMAND_FLAG_APPLY, 0, *((sint32 *)(name + 0)), GAME_COMMAND_SET_PARK_NAME, *((sint32 *)(name + 8)),
                    *((sint32 *)(name + 4)));
    game_do_command(2, GAME_COMMAND_FLAG_APPLY, 0, *((sint32 *)(name + 12)), GAME_COMMAND_SET_PARK_NAME,
                    *((sint32 *)(name + 20)), *((sint32 *)(name + 16)));
    game_do_command(0, GAME_COMMAND_FLAG_APPLY, 0, *((sint32 *)(name + 24)), GAME_COMMAND_SET_PARK_NAME,
                    *((sint32 *)(name + 32)), *((sint32 *)(name + 28)));
}
 ...
 *  rct2: 0x00669C6D
 */
void game_command_set_park_name(sint32 * eax, sint32 * ebx, sint32 * ecx, sint32 * edx, sint32 * esi, sint32 * edi,
                                sint32 * ebp)
{
    ...
    if (*ebx & GAME_COMMAND_FLAG_APPLY)
    {
            ...
            gConfigNetwork.log_server_actions)
        {
            ...
            char   log_msg[256];
            char * args[3] = { (char *)player_name, oldName, newName };
 ...
 *  rct2: 0x006649BD
 */
void game_command_buy_land_rights(sint32 * eax, sint32 * ebx, sint32 * ecx, sint32 * edx, sint32 * esi, sint32 * edi,
                                  sint32 * ebp)
{

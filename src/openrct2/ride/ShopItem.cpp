...
constexpr ShopItemDescriptor ShopItems[EnumValue(ShopItem::count)] = {
    ...
    /* ShopItem::cashMachineFee */   {  0.00_GBP, 0.00_GBP,   0.00_GBP,  0.00_GBP,   0.00_GBP,      0,                                 { STR_SHOP_ITEM_PRICE_LABEL_CASH_MACHINE_FEE,       kStringIdNone,                              kStringIdNone,                              kStringIdNone,                                  kStringIdNone                             }, 0,                                                           Litter::Type::vomit,            0xFF,             ShopItem::none,             PeepThoughtType::NotPaying,             PeepThoughtType::None               },

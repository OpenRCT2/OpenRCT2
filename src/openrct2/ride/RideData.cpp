...
const rct_ride_properties RideProperties[RIDE_TYPE_COUNT] = {
        ...
        {RIDE_TYPE_FLAG_HAS_TRACK_COLOUR_MAIN | RIDE_TYPE_FLAG_HAS_TRACK_COLOUR_SUPPORTS | RIDE_TYPE_FLAG_3 | /*RIDE_TYPE_FLAG_CAN_SYNCHRONISE_ADJACENT_STATIONS| DOES NOT WORK!*/

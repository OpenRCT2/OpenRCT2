...
constexpr RideTypeDescriptor LogFlumeRTD =
{
    ...
    .TrackPaintFunctions = TrackDrawerDescriptor({
        ...
        .enabledTrackGroups = {TrackGroup::straight, TrackGroup::stationEnd, TrackGroup::slope, TrackGroup::sBend, TrackGroup::curveSmall, TrackGroup::onridePhoto, TrackGroup::logFlumeReverser, TrackGroup::slopeSteepDown, TrackGroup::liftHill },
        .extraTrackGroups = {},
    }),
    ...
    .Flags = kRtdFlagsHasThreeColours | EnumsToFlags(RtdFlag::hasLeaveWhenAnotherVehicleArrivesAtStation,
                     ...
                     RtdFlag::interestingToLookAt, RtdFlag::upInclineRequiresLift),
    ...
    .Heights = { 10, 24, 7, 9, },
    .MaxMass = 255,
    .LiftData = { OpenRCT2::Audio::SoundId::LiftFlume, 0, 5 },

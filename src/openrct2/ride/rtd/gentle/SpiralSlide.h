...
constexpr RideTypeDescriptor SpiralSlideRTD =
{
    ...
    .RideModes = RideModes::IndexToFlags({ RideModeID::SINGLE_RIDE_PER_ADMISSION, RideModeID::UNLIMITED_RIDES_PER_ADMISSION }),
    .DefaultMode = RideModeID::SINGLE_RIDE_PER_ADMISSION,

...
static const uint8 edges_1x4_ne_sw[] = {
    EDGE_NW | EDGE_SE, EDGE_NW | EDGE_SE | EDGE_NE, EDGE_NW | EDGE_SE, EDGE_NW | EDGE_SE | EDGE_SW,
};

static const uint8 edges_1x4_nw_se[] = {
    EDGE_NE | EDGE_SW, EDGE_NE | EDGE_SW | EDGE_NW, EDGE_NE | EDGE_SW, EDGE_NE | EDGE_SW | EDGE_SE,
};
...
static void paint_ferris_wheel(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height, rct_map_element * mapElement)
{
    ...
    {
    case 1:
        paint_ferris_wheel_structure(rideIndex, direction, 48, height);
        break;
    case 2:
        paint_ferris_wheel_structure(rideIndex, direction, 16, height);
        break;
    case 0:
        paint_ferris_wheel_structure(rideIndex, direction, -16, height);
        break;

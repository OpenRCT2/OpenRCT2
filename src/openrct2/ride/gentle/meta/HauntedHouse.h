...
constexpr const RideTypeDescriptor HauntedHouseRTD =
{
    ...
    SET_FIELD(RideModes, (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_HAUNTED_HOUSE))),
    SET_FIELD(DefaultMode, static_cast<uint8_t>(RideMode::RIDE_MODE_HAUNTED_HOUSE)),

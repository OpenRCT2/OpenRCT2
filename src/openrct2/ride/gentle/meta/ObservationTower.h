...
constexpr const RideTypeDescriptor ObservationTowerRTD =
{
    ...
    SET_FIELD(RideModes, (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_ROTATING_LIFT))),
    SET_FIELD(DefaultMode, static_cast<uint8_t>(RideMode::RIDE_MODE_ROTATING_LIFT)),

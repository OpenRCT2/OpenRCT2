...
constexpr const RideTypeDescriptor SpiralSlideRTD =
{
    ...
    SET_FIELD(RideModes, (1ULL << static_cast<uint8_t>(RideMode::SINGLE_RIDE_PER_ADMISSION)) | (1ULL << static_cast<uint8_t>(RideMode::UNLIMITED_RIDES_PER_ADMISSION))),
    SET_FIELD(DefaultMode, RideMode::SINGLE_RIDE_PER_ADMISSION),

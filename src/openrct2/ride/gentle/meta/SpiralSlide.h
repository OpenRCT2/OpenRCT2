...
constexpr const RideTypeDescriptor SpiralSlideRTD =
{
    ...
    SET_FIELD(RideModes, (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_SINGLE_RIDE_PER_ADMISSION)) | (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_UNLIMITED_RIDES_PER_ADMISSION))),
    SET_FIELD(DefaultMode, static_cast<uint8_t>(RideMode::RIDE_MODE_SINGLE_RIDE_PER_ADMISSION)),

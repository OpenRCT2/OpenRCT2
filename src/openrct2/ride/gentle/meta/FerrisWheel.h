...
constexpr const RideTypeDescriptor FerrisWheelRTD =
{
    ...
    SET_FIELD(RideModes, (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_FORWARD_ROTATION)) | (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_BACKWARD_ROTATION))),
    SET_FIELD(DefaultMode, static_cast<uint8_t>(RideMode::RIDE_MODE_FORWARD_ROTATION)),

...
static void paint_car_ride_track_25_deg_down(
    ...
    const TileElement* tileElement)
{
    paint_car_ride_track_25_deg_up(session, ride, trackSequence, (direction + 2) % 4, height, tileElement);
}
...
static void paint_car_ride_track_flat_to_25_deg_down(
    ...
    const TileElement* tileElement)
{
    paint_car_ride_track_25_deg_up_to_flat(session, ride, trackSequence, (direction + 2) % 4, height, tileElement);
}
...
static void paint_car_ride_track_25_deg_down_to_flat(
    ...
    const TileElement* tileElement)
{
    paint_car_ride_track_flat_to_25_deg_up(session, ride, trackSequence, (direction + 2) % 4, height, tileElement);
}
    ...
    const TileElement* tileElement)
{
    ...
    paint_car_ride_track_right_quarter_turn_3_tiles(session, ride, trackSequence, (direction + 1) % 4, height, tileElement);
}
...
static void paint_car_ride_track_right_quarter_turn_1_tile(
    ...
    const TileElement* tileElement)
{
    paint_car_ride_track_left_quarter_turn_1_tile(session, ride, trackSequence, (direction + 3) % 4, height, tileElement);
}
...
static void paint_car_ride_track_60_deg_down(
    ...
    const TileElement* tileElement)
{
    paint_car_ride_track_60_deg_up(session, ride, trackSequence, (direction + 2) % 4, height, tileElement);
}
...
static void paint_car_ride_track_25_deg_down_to_60_deg_down(
    ...
    const TileElement* tileElement)
{
    paint_car_ride_track_60_deg_up_to_25_deg_up(session, ride, trackSequence, (direction + 2) % 4, height, tileElement);
}
...
static void paint_car_ride_track_60_deg_down_to_25_deg_down(
    ...
    const TileElement* tileElement)
{
    paint_car_ride_track_25_deg_up_to_60_deg_up(session, ride, trackSequence, (direction + 2) % 4, height, tileElement);
}

...
constexpr RideTypeDescriptor kDinghySlideRTD =
{
    ...
    .ExtraTrackPieces = {},
    .CoveredTrackPieces = {TrackElemType::kFlat, TrackElemType::kUp25, TrackElemType::kUp60, TrackElemType::kFlatToUp25, TrackElemType::kUp25ToUp60, TrackElemType::kUp60ToUp25, TrackElemType::kUp25ToFlat, TrackElemType::kDown25, TrackElemType::kDown60, TrackElemType::kFlatToDown25, TrackElemType::kDown25ToDown60, TrackElemType::kDown60ToDown25, TrackElemType::kDown25ToFlat, TrackElemType::kLeftQuarterTurn5Tiles, TrackElemType::kRightQuarterTurn5Tiles, TrackElemType::kSBendLeft, TrackElemType::kSBendRight, TrackElemType::kLeftQuarterTurn3Tiles,TrackElemType::kRightQuarterTurn3Tiles},
    ...
    .kEnumName = nameof(RIDE_TYPE_DINGHY_SLIDE),

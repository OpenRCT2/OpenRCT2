...
constexpr RideTypeDescriptor LogFlumeRTD =
{
    ...
    SET_FIELD(EnabledTrackPieces, {TRACK_STRAIGHT, TRACK_STATION_END, TRACK_SLOPE, TRACK_LIFT_HILL, TRACK_S_BEND, TRACK_CURVE_SMALL, TRACK_ON_RIDE_PHOTO, TRACK_LOG_FLUME_REVERSER, TRACK_SLOPE_STEEP_DOWN}),
    ...
    SET_FIELD(LiftData, { OpenRCT2::Audio::SoundId::Null, 0, 5 }),

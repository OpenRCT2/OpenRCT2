...
static void dinghy_slide_track_25_deg_down(
    ...
    const TileElement* tileElement)
{
    dinghy_slide_track_25_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void dinghy_slide_track_60_deg_down(
    ...
    const TileElement* tileElement)
{
    dinghy_slide_track_60_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void dinghy_slide_track_flat_to_25_deg_down(
    ...
    const TileElement* tileElement)
{
    dinghy_slide_track_25_deg_up_to_flat(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void dinghy_slide_track_25_deg_down_to_60_deg_down(
    ...
    const TileElement* tileElement)
{
    dinghy_slide_track_60_deg_up_to_25_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void dinghy_slide_track_25_deg_down_to_flat(
    ...
    const TileElement* tileElement)
{
    dinghy_slide_track_flat_to_25_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
    ...
    const TileElement* tileElement)
{
    ...
    dinghy_slide_track_right_quarter_turn_5(session, ride, trackSequence, (direction + 1) % 4, height, tileElement);
}
...
static void dinghy_slide_track_60_deg_down_to_25_deg_down(
    ...
    const TileElement* tileElement)
{
    dinghy_slide_track_25_deg_up_to_60_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
    ...
    const TileElement* tileElement)
{
    ...
    dinghy_slide_track_right_quarter_turn_3(session, ride, trackSequence, (direction + 1) % 4, height, tileElement);
}
...
static void dinghy_slide_track_25_deg_down_covered(
    ...
    const TileElement* tileElement)
{
    dinghy_slide_track_25_deg_up_covered(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void dinghy_slide_track_60_deg_down_covered(
    ...
    const TileElement* tileElement)
{
    dinghy_slide_track_60_deg_up_covered(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void dinghy_slide_track_flat_to_25_deg_down_covered(
    ...
    const TileElement* tileElement)
{
    dinghy_slide_track_25_deg_up_to_flat_covered(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void dinghy_slide_track_25_deg_down_to_60_deg_down_covered(
    ...
    const TileElement* tileElement)
{
    dinghy_slide_track_60_deg_up_to_25_deg_up_covered(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void dinghy_slide_track_25_deg_down_to_flat_covered(
    ...
    const TileElement* tileElement)
{
    dinghy_slide_track_flat_to_25_deg_up_covered(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
{
    trackSequence = mapLeftQuarterTurn5TilesToRightQuarterTurn5Tiles[trackSequence];
    dinghy_slide_track_right_quarter_turn_5_covered(session, ride, trackSequence, (direction + 1) % 4, height, tileElement);
}
...
{
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
    dinghy_slide_track_right_quarter_turn_3_covered(session, ride, trackSequence, (direction + 1) % 4, height, tileElement);
}
...
static void dinghy_slide_track_60_deg_down_to_25_deg_down_covered(
    ...
    const TileElement* tileElement)
{
    dinghy_slide_track_25_deg_up_to_60_deg_up_covered(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}

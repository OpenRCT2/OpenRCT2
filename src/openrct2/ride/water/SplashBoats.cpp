...
static void paint_splash_boats_track_60_deg_down(
    ...
    const TileElement* tileElement)
{
    paint_splash_boats_track_60_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void paint_splash_boats_track_25_deg_down_to_60_deg_down(
    ...
    const TileElement* tileElement)
{
    paint_splash_boats_track_60_deg_up_to_25_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void paint_splash_boats_track_60_deg_down_to_25_deg_down(
    ...
    const TileElement* tileElement)
{
    paint_splash_boats_track_25_deg_up_to_60_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
    ...
    const TileElement* tileElement)
{
    ...
    paint_splash_boats_track_flat(session, ride, trackSequence, direction, height, tileElement);

...
namespace OpenRCT2
{
        ...
        const TrackElement& trackElement)
    {
        ...
        else
        {
            ...
            {
                MetalASupportsPaintSetup(
                    session, METAL_SUPPORTS_BOXED, 4, 8, height + 12, session.TrackColours[SCHEME_SUPPORTS]);
            }
        ...
        const TrackElement& trackElement)
    {
        ...
        else
        {
            ...
            {
                MetalASupportsPaintSetup(
                    session, METAL_SUPPORTS_BOXED, 4, 8, height + 8, session.TrackColours[SCHEME_SUPPORTS]);
            }
        }
        PaintUtilSetSegmentSupportHeight(
            session, PaintUtilRotateSegments(SEGMENT_C4 | SEGMENT_CC | SEGMENT_D0, direction), 0xFFFF, 0);

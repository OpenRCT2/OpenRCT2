...
static void vehicle_sprite_paint(
    paint_session* session, const Vehicle* vehicle, const int32_t imageId, const int32_t imageDirection, int32_t z,
 ...
 *  rct2: 0x006D5600
 */
static void vehicle_visual_splash1_effect(paint_session* session, const int32_t z, const Vehicle* vehicle)
{
 ...
 *  rct2: 0x006D5696
 */
static void vehicle_visual_splash2_effect(paint_session* session, const int32_t z, const Vehicle* vehicle)
{
 ...
 *  rct2: 0x006D57EE
 */
static void vehicle_visual_splash3_effect(paint_session* session, const int32_t z, const Vehicle* vehicle)
{
    if (vehicle->sprite_direction & 7)
    {
        return;
 ...
 *  rct2: 0x006D5783
 */
static void vehicle_visual_splash4_effect(paint_session* session, const int32_t z, const Vehicle* vehicle)
{
 ...
 *  rct2: 0x006D5701
 */
static void vehicle_visual_splash5_effect(paint_session* session, const int32_t z, const Vehicle* vehicle)
{
    Vehicle* vehicle2 = GetEntity<Vehicle>(vehicle->prev_vehicle_on_ride);
    if (vehicle2 == nullptr)
    {
...
void vehicle_visual_splash_effect(
    paint_session* session, const int32_t z, const Vehicle* vehicle, const rct_ride_entry_vehicle* vehicleEntry)
{
...
void vehicle_visual_default(
    paint_session* session, const int32_t imageDirection, const int32_t z, const Vehicle* vehicle,
    const rct_ride_entry_vehicle* vehicleEntry)
{
 ...
 *  rct2: 0x006D4244
 */
template<> void PaintEntity(paint_session* session, const Vehicle* vehicle, const int32_t imageDirection)
{
    const rct_ride_entry_vehicle* vehicleEntry;

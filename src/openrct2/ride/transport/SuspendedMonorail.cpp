...
static void suspended_monorail_track_25_deg_down(
    ...
    const TileElement* tileElement)
{
    suspended_monorail_track_25_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void suspended_monorail_track_flat_to_25_deg_down(
    ...
    const TileElement* tileElement)
{
    suspended_monorail_track_25_deg_up_to_flat(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void suspended_monorail_track_25_deg_down_to_flat(
    ...
    const TileElement* tileElement)
{
    suspended_monorail_track_flat_to_25_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
    ...
    const TileElement* tileElement)
{
    ...
    suspended_monorail_track_left_quarter_turn_5(session, ride, trackSequence, (direction - 1) & 3, height, tileElement);
}
    ...
    const TileElement* tileElement)
{
    ...
    suspended_monorail_track_left_quarter_turn_3(session, ride, trackSequence, (direction - 1) & 3, height, tileElement);
}
    ...
    const TileElement* tileElement)
{
    ...
    suspended_monorail_track_right_eighth_to_diag(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
{
    trackSequence = mapLeftEighthTurnToOrthogonal[trackSequence];
    suspended_monorail_track_left_eighth_to_diag(session, ride, trackSequence, (direction + 3) & 3, height, tileElement);
}

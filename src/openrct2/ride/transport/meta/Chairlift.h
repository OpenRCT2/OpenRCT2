...
constexpr const RideTypeDescriptor ChairliftRTD =
{
    ...
    SET_FIELD(RideModes, (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_STATION_TO_STATION))),
    SET_FIELD(DefaultMode, static_cast<uint8_t>(RideMode::RIDE_MODE_STATION_TO_STATION)),

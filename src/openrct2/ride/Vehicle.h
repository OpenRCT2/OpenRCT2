...
namespace OpenRCT2
{
    ...
    enum : uint32_t
    {
        ...
        VEHICLE_UPDATE_FLAG_USE_INVERTED_SPRITES = (1 << 11), // Used on rides where trains can run for extended periods of
                                                              // time, i.e. the Flying, Lay-down and Multi-dimension RCs.
        ...
        VEHICLE_UPDATE_FLAG_SINGLE_CAR_POSITION = (1 << 14),     // OpenRCT2 Flag: Used to override UpdateMotion to move the
                                                             // position of an individual car on a train
    };

...
enum : uint32_t
{
    ...
    VEHICLE_FLAG_CURRENTLY_COLLIDING = (1 << 6), // When go-karts are colliding, they have a higher chance of changing lanes
    ...
    VEHICLE_FLAG_REVERSE_INCLINE_COMPLETED_LAP = (1 << 12), // Set when the vehicle travels backwards through the station for
                                                            // the first time

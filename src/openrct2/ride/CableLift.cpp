    ...
    Ride& ride, int32_t x, int32_t y, int32_t z, int32_t direction, uint16_t var_44, int32_t remaining_distance, bool head)
{
    ...
    current->SpriteData.sprite_width = 10;
    current->SpriteData.sprite_height_negative = 10;
    current->SpriteData.sprite_height_positive = 10;
    current->mass = 100;
    current->num_seats = 0;
    current->speed = 20;
    ...
    current->SpriteData.sprite_direction = direction << 3;
    ...
    current->SetTrackDirection(current->SpriteData.sprite_direction >> 3);
...
bool Vehicle::CableLiftUpdateTrackMotionForwards()
{
    ...
    for (; remaining_distance >= 13962; _vehicleUnkF64E10++)
    {
        ...
        SpriteData.sprite_direction = moveInfo->direction;

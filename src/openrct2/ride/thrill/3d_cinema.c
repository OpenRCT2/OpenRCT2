...
static void paint_3d_cinema_structure(uint8 rideIndex, uint8 direction, sint8 xOffset, sint8 yOffset, uint16 height)
{
    ...
    sub_98197C(imageId, xOffset, yOffset, 24, 24, 47, height + 3, xOffset + 16, yOffset + 16, height + 3,
...
static void paint_3d_cinema(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height, rct_map_element * mapElement)
{
    ...
    track_paint_util_paint_fences(edges, position, mapElement, ride, gTrackColours[SCHEME_MISC], height, fenceSpritesRope,
                                  get_current_rotation());

    switch (trackSequence)
    {
    case 1:
        paint_3d_cinema_structure(rideIndex, direction, 32, 32, height);
        break;
    case 3:
        paint_3d_cinema_structure(rideIndex, direction, 32, -32, height);
        break;
    case 5:
        paint_3d_cinema_structure(rideIndex, direction, 0, -32, height);
        break;
    case 6:
        paint_3d_cinema_structure(rideIndex, direction, -32, 32, height);
        break;
    case 7:
        ...
        break;
    case 8:
        paint_3d_cinema_structure(rideIndex, direction, -32, 0, height);
        break;
    }

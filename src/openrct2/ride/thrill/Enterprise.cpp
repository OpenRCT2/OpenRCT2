...
namespace OpenRCT2
{
    static void PaintEnterpriseRiders(
        PaintSession& session, const RideObjectEntry& rideEntry, Vehicle& vehicle, uint32_t imageOffset,
    ...
    static void PaintEnterpriseStructure(
        PaintSession& session, const Ride& ride, int8_t xOffset, int8_t yOffset, uint16_t height,

...
/** rct2: 0x008A2ABC */
static void paint_enterprise_structure(rct_ride * ride, sint8 xOffset, sint8 yOffset, uint16 height,
...
static void paint_enterprise(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height, rct_map_element * mapElement)
{
    ...
    track_paint_util_paint_fences(edges, position, mapElement, ride, gTrackColours[SCHEME_TRACK], height, fenceSpritesRope,
                                  get_current_rotation());

    switch (trackSequence)
    {
    case 5:
        paint_enterprise_structure(ride, 16, 16, height, mapElement);
        break;
    case 6:
        paint_enterprise_structure(ride, 16, -16, height, mapElement);
        break;
    ...
    case 0:
        paint_enterprise_structure(ride, 48, 48, height, mapElement);
        break;
    case 3:
        paint_enterprise_structure(ride, 48, -48, height, mapElement);
        break;
    ...
    case 7:
        paint_enterprise_structure(ride, 16, -48, height, mapElement);
        break;
    case 11:
        paint_enterprise_structure(ride, -16, -48, height, mapElement);
        break;
    case 14:
        paint_enterprise_structure(ride, -48, -16, height, mapElement);
        break;
    case 13:
        paint_enterprise_structure(ride, -48, 16, height, mapElement);
        break;

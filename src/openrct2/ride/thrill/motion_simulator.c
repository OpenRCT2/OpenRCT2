 ...
 *  rct2: 0x0076522A
 */
static void paint_motionsimulator_vehicle(sint8 offsetX, sint8 offsetY, uint8 direction, int height,
...
/** rct2: 0x008A85C4 */
static void paint_motionsimulator(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                  rct_map_element * mapElement)
{
    ...
    {
    case 1:
        paint_motionsimulator_vehicle(16, -16, direction, height, mapElement);
        break;
    case 2:
        paint_motionsimulator_vehicle(-16, 16, direction, height, mapElement);
        break;

...
constexpr const RideTypeDescriptor RotoDropRTD =
{
    ...
    SET_FIELD(RideModes, (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_FREEFALL_DROP))),
    SET_FIELD(DefaultMode, static_cast<uint8_t>(RideMode::RIDE_MODE_FREEFALL_DROP)),

...
constexpr const RideTypeDescriptor LaunchedFreefallRTD =
{
    ...
    SET_FIELD(RideModes, (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_UPWARD_LAUNCH)) | (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_DOWNWARD_LAUNCH))),
    SET_FIELD(DefaultMode, static_cast<uint8_t>(RideMode::RIDE_MODE_UPWARD_LAUNCH)),

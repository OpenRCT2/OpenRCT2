...
constexpr const RideTypeDescriptor CinemaRTD =
{
    ...
    SET_FIELD(RideModes, (1ULL << static_cast<uint8_t>(RideMode::MOUSE_TAILS_3D_FILM)) | (1ULL << static_cast<uint8_t>(RideMode::STORM_CHASERS_3D_FILM)) | (1ULL << static_cast<uint8_t>(RideMode::SPACE_RAIDERS_3D_FILM))),
    SET_FIELD(DefaultMode, RideMode::MOUSE_TAILS_3D_FILM),

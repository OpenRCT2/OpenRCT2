...
constexpr const RideTypeDescriptor CinemaRTD =
{
    ...
    SET_FIELD(RideModes, (1ULL << static_cast<uint8_t>(RideMode::MouseTails3DFilm)) | (1ULL << static_cast<uint8_t>(RideMode::StormChasers3DFilm)) | (1ULL << static_cast<uint8_t>(RideMode::SpaceRaiders3DFilm))),

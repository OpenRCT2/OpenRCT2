...
constexpr const RideTypeDescriptor CinemaRTD =
{
    ...
    SET_FIELD(RideModes, (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_3D_FILM_MOUSE_TAILS)) | (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_3D_FILM_STORM_CHASERS)) | (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_3D_FILM_SPACE_RAIDERS))),
    SET_FIELD(DefaultMode, static_cast<uint8_t>(RideMode::RIDE_MODE_3D_FILM_MOUSE_TAILS)),

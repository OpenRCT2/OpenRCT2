...
constexpr const RideTypeDescriptor TopSpinRTD =
{
    ...
    SET_FIELD(RideModes, (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_BEGINNERS)) | (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_INTENSE)) | (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_BERSERK))),
    SET_FIELD(DefaultMode, static_cast<uint8_t>(RideMode::RIDE_MODE_BEGINNERS)),

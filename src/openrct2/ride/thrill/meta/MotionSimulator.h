...
constexpr const RideTypeDescriptor MotionSimulatorRTD =
{
    ...
    SET_FIELD(RideModes, (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_FILM_AVENGING_AVIATORS)) | (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_FILM_THRILL_RIDERS))),
    SET_FIELD(DefaultMode, static_cast<uint8_t>(RideMode::RIDE_MODE_FILM_AVENGING_AVIATORS)),

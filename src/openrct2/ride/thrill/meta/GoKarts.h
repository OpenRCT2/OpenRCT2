...
constexpr const RideTypeDescriptor GoKartsRTD =
{
    ...
    SET_FIELD(RideModes, (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_RACE)) | (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_CONTINUOUS_CIRCUIT))),
    SET_FIELD(DefaultMode, static_cast<uint8_t>(RideMode::RIDE_MODE_RACE)),

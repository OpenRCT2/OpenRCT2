...
namespace OpenRCT2
{
    ...
    constexpr TrackColourPresetList kDefaultFlatRideColourPreset = TRACK_COLOUR_PRESETS(
        { Drawing::Colour::brightRed, Drawing::Colour::lightBlue, Drawing::Colour::yellow });
    constexpr TrackColourPresetList kDefaultStallColourPreset = TRACK_COLOUR_PRESETS(
        { Drawing::Colour::brightRed, Drawing::Colour::brightRed, Drawing::Colour::brightRed });
    ...
    using RideTrackGroups = BitSet<EnumValue(TrackGroup::count)>;
    ...
    using StartRideMusicFunction = void (*)(const RideAudio::ViewportRideMusicInstance&);
    ...
    using RideUpdateMeasurementsSpecialElementsFunc = void (*)(Ride& ride, TrackElemType trackType);
    ...
    struct RideTypeDescriptor
    {
        ...
        // rct2: 0x0097CD1E
        RideRating::Tuple RatingsMultipliers{};
    ...
    constexpr RideTypeDescriptor kDummyRTD =
    {
    	...
    	.RatingsData =
        {
            ...
            { RideRating::make(1, 00), RideRating::make(1, 00), RideRating::make(1, 00) },
            1,
            -1,
            false,
            {

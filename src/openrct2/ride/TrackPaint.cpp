...
static constexpr std::array<std::array<std::array<BoundBoxXYZ, 2>, kQuarterHelixTrackSequenceCount>, kNumOrthogonalDirections>
    kLeftQuarterHelixLargeUpBoundingBoxes = { {
        { {
            { { { { 0, 6, 1 }, { 32, 20, 1 } }, { { 0, 27, 0 }, { 32, 1, 22 } } } },
            { { kBoundingBoxUnimplemented, kBoundingBoxUnimplemented } },
            { { { { 0, 0, 1 }, { 32, 16, 1 } }, kBoundingBoxUnimplemented } },
            { { { { 0, 16, 1 }, { 16, 16, 1 } }, kBoundingBoxUnimplemented } },
            { { kBoundingBoxUnimplemented, kBoundingBoxUnimplemented } },
            { { { { 16, 0, 1 }, { 16, 32, 1 } }, kBoundingBoxUnimplemented } },
            { { { { 6, 0, kCoordsZStep + 1 }, { 20, 32, 1 } }, kBoundingBoxUnimplemented } },
        } },
        { {
        ...
        { {
            { { { { 0, 6, 1 }, { 32, 20, 1 } }, kBoundingBoxUnimplemented } },
            { { kBoundingBoxUnimplemented, kBoundingBoxUnimplemented } },
            { { { { 0, 16, 1 }, { 32, 16, 1 } }, kBoundingBoxUnimplemented } },
            { { { { 16, 0, 1 }, { 16, 16, 1 } }, kBoundingBoxUnimplemented } },
            { { kBoundingBoxUnimplemented, kBoundingBoxUnimplemented } },
            { { { { 0, 0, 1 }, { 16, 32, 1 } }, { { 27, 16, 1 }, { 1, 16, 30 } } } },
            { { { { 6, 0, kCoordsZStep + 1 }, { 20, 32, 1 } }, { { 27, 0, kCoordsZStep + 1 }, { 1, 32, 22 } } } },
        } },
        { {
            { { { { 6, 0, 1 }, { 20, 32, 1 } }, kBoundingBoxUnimplemented } },
            { { { { 0, 0, 1 }, { 16, 16, 1 } }, kBoundingBoxUnimplemented } },
            { { { { 16, 0, 1 }, { 16, 32, 1 } }, kBoundingBoxUnimplemented } },
            { { { { 0, 0, 1 }, { 16, 16, 1 } }, kBoundingBoxUnimplemented } },
            { { kBoundingBoxUnimplemented, kBoundingBoxUnimplemented } },
            { { { { 0, 16, 1 }, { 32, 16, 1 } }, kBoundingBoxUnimplemented } },
            { { { { 0, 6, kCoordsZStep + 1 }, { 32, 20, 1 } }, kBoundingBoxUnimplemented } },
        } },
    } };

...
#pragma region trackBlocks
    ...
    constexpr auto kTEDLeftTwistDownToUpBanked = TrackElementDescriptor{
        ...
        .flags = { TrackElementFlag::normalToInversion, TrackElementFlag::inversionToNormal },
        .definition = { TrackGroup::twistBanked, TrackPitch::none, TrackPitch::none, TrackRoll::upsideDown, TrackRoll::left,
                        0 },
        .lateralFactor = EvaluatorConst<98>,
        .sequenceData = { 3, { kLeftTwistDownToUpSeq0, kLeftTwistDownToUpSeq1, kLeftTwistDownToUpSeq2 } },
    };
    ...
    constexpr auto kTEDRightTwistDownToUpBanked = TrackElementDescriptor{
        ...
        .flags = { TrackElementFlag::normalToInversion, TrackElementFlag::inversionToNormal },
        .definition = { TrackGroup::twistBanked, TrackPitch::none, TrackPitch::none, TrackRoll::upsideDown, TrackRoll::right,
                        0 },
        .lateralFactor = EvaluatorConst<-98>,
        .sequenceData = { 3, { kRightTwistDownToUpSeq0, kRightTwistDownToUpSeq1, kRightTwistDownToUpSeq2 } },
    };
    ...
    constexpr auto kTEDLeftTwistUpToDownBanked = TrackElementDescriptor{
        ...
        .flags = { TrackElementFlag::inversionToNormal },
        .definition = { TrackGroup::twistBanked, TrackPitch::none, TrackPitch::none, TrackRoll::right, TrackRoll::upsideDown,
                        0 },
        .lateralFactor = EvaluatorConst<98>,
        .sequenceData = { 3, { kLeftTwistUpToDownSeq0, kLeftTwistUpToDownSeq1, kLeftTwistUpToDownSeq2 } },
    };
    ...
    constexpr auto kTEDRightTwistUpToDownBanked = TrackElementDescriptor{
        ...
        .flags = { TrackElementFlag::inversionToNormal },
        .definition = { TrackGroup::twistBanked, TrackPitch::none, TrackPitch::none, TrackRoll::left, TrackRoll::upsideDown,
                        0 },
        .lateralFactor = EvaluatorConst<-98>,
        .sequenceData = { 3, { kRightTwistUpToDownSeq0, kRightTwistUpToDownSeq1, kRightTwistUpToDownSeq2 } },
    };
    ...
    constexpr auto kTEDLeftBarrelRollUpToDownBanked = TrackElementDescriptor{
        ...
        .flags = { TrackElementFlag::normalToInversion, TrackElementFlag::inversionToNormal },
        .definition = { TrackGroup::barrelRollBanked, TrackPitch::none, TrackPitch::none, TrackRoll::upsideDown,
                        TrackRoll::left, 0 },
        .verticalFactor = EvaluatorConst<170>,
        .lateralFactor = EvaluatorConst<115>,
        .sequenceData = { 3, { kLeftBarrelRollUpToDownSeq0, kLeftBarrelRollUpToDownSeq1, kLeftBarrelRollUpToDownSeq2 } },
    ...
    constexpr auto kTEDLeftBarrelRollDownToUpBanked = TrackElementDescriptor{
        ...
        .flags = { TrackElementFlag::inversionToNormal },
        .definition = { TrackGroup::barrelRollBanked, TrackPitch::none, TrackPitch::none, TrackRoll::right,
    ...
    constexpr auto kTEDRightBarrelRollDownToUpBanked = TrackElementDescriptor{
        ...
        .flags = { TrackElementFlag::inversionToNormal },
        .definition = { TrackGroup::barrelRollBanked, TrackPitch::none, TrackPitch::none, TrackRoll::left,
                        TrackRoll::upsideDown, 0 },
        .verticalFactor = EvaluatorConst<170>,
        .lateralFactor = EvaluatorConst<-115>,
        .sequenceData = { 3, { kRightBarrelRollDownToUpSeq0, kRightBarrelRollDownToUpSeq1, kRightBarrelRollDownToUpSeq2 } },

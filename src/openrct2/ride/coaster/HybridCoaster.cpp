    ...
    if (tileElement->AsTrack()->HasChain())
    {
        ...
        case 1:
            session->WoodenSupportsPrependTo = sub_98197C_rotated(session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_LIFT_TRACK_STEEP + 1), 0, 0, 32, 20, 3, height, 0, 3,
                               height+3);
            sub_98197C_rotated(session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_LIFT_TRACK_STEEP + 2), 0, 0, 32, 2, 43, height, 0, 28,
                               height);
            break;
        case 2:
            session->WoodenSupportsPrependTo = sub_98197C_rotated(session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_LIFT_TRACK_STEEP + 3), 0, 0, 32, 20, 3, height, 0, 3,
                               height+3);
            sub_98197C_rotated(session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_LIFT_TRACK_STEEP + 4), 0, 0, 32, 2, 43, height, 0, 28,
                               height);
            break;
        case 3:
    ...
    else
    {
        ...
        case 1:
            session->WoodenSupportsPrependTo = sub_98197C_rotated(session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_STEEP + 1), 0, 0, 32, 20, 3, height, 0, 6,
                               height);
            sub_98197C_rotated(session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_STEEP + 2), 0, 0, 32, 2, 43, height, 0, 28,
                               height);
            break;
        case 2:
            session->WoodenSupportsPrependTo = sub_98197C_rotated(session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_STEEP + 3), 0, 0, 32, 20, 3, height, 0, 6,
                               height);
            sub_98197C_rotated(session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_STEEP + 4), 0, 0, 32, 2, 43, height, 0, 28,
                               height);
            break;
        case 3:
...
wooden_a_supports_paint_setup(session, 2, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
        break;
    case 2:
        sub_98197C_rotated(session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_STEEP_SMALL_CURVE+4), 0, 0, 28, 3, 48, height, 2, 28,
                           height);
...
wooden_a_supports_paint_setup(session, 4, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
        break;
    case 1:
        sub_98197C_rotated(session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_STEEP_SMALL_CURVE+10), 0, 0, 28, 3, 48, height, 2, 28,
                           height);
                ...
                case 0:
                    sub_98197C_rotated(
                       session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_QUARTER_LOOP+0),  0, 0, 2, 20, 31, height, 4, 6,
                        height + 8);
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_QUARTER_LOOP+1), 0, 0, 32, 1, 48, height, 0, 32,
                        height + 8);
                    break;
                case 1:
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_QUARTER_LOOP+6), 0, 0, 2, 20, 31, height, 26, 4,
                        height + 8);
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_QUARTER_LOOP+7), 0, 0, 32, 1, 48, height, 0, 32,
                        height + 8);
                    break;
                case 2:
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_QUARTER_LOOP+12), 0, 0, 2, 20, 31, height, 26, 4,
                        height + 8);
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_QUARTER_LOOP+13), 0, 0, 32, 1, 48, height, 0, 32,
                        height + 8);
                    break;
                case 3:
                    sub_98197C_rotated(
                        ...
                        height + 8);
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_QUARTER_LOOP+19), 0, 0, 32, 1, 48, height, 0, 32,
                        height + 8);
                    break;
            }
            paint_util_set_segment_support_height(
            ...
            switch (direction)
            {
                case 0:
                    sub_98197C_rotated(
                        ...
                        height);
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_QUARTER_LOOP+3), 0, 0, 32, 1, 64, height, 0, 32,
                        height);
                    break;
                case 1:
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_QUARTER_LOOP+8), 0, 0, 32, 20, 3, height, 0, 6,
                        height);
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_QUARTER_LOOP+9), 0, 0, 32, 1, 64, height, 0, 32,
                        height);
                    break;
                case 2:
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_QUARTER_LOOP+14), 0, 0, 32, 20, 3, height, 0, 6,
                        height);
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_QUARTER_LOOP+15), 0, 0, 32, 1, 64, height, 0, 32,
                        height);
                    break;
                case 3:
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_QUARTER_LOOP+20), 0, 0, 32, 20, 3, height, 0, 6,
                        height);
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_QUARTER_LOOP+21), 0, 0, 32, 1, 64, height, 0, 32,
                        height);
                    break;
            }
wooden_a_supports_paint_setup(session, direction & 1, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
            ...
            switch (direction)
            {
                case 0:
                    sub_98197C_rotated(
                        ...
                        height);
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_QUARTER_LOOP+5), 0, 0, 32, 1, 32, height, 0, 32,
                        height);
                    break;
                case 1:
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_QUARTER_LOOP+10), 0, 0, 32, 20, 3, height, 0, 6,
                        height);
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_QUARTER_LOOP+11), 0, 0, 32, 1, 32, height, 0, 32,
                        height);
                    break;
                case 2:
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_QUARTER_LOOP+16), 0, 0, 32, 20, 3, height, 0, 6,
                        height);
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_QUARTER_LOOP+17), 0, 0, 32, 1, 32, height, 0, 32,
                        height);
                    break;
                case 3:
                    sub_98197C_rotated(
                        ...
                        height);
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_QUARTER_LOOP+23), 0, 0, 32, 1, 32, height, 0, 32,
                        height);
                    break;
            }
wooden_a_supports_paint_setup(session, direction & 1, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
...
wooden_a_supports_paint_setup(session, direction & 1, 58 + direction, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
    ...
    case 3:
        ...
        case 0:
            ...
            break;
        case 1:
            session->WoodenSupportsPrependTo = sub_98197C_rotated(session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_FLAT_TO_STEEP+7), 0, 0, 2, 24, 56, height, 28,
                               4, height-16);
            break;
        case 2:
            session->WoodenSupportsPrependTo = sub_98197C_rotated(session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_FLAT_TO_STEEP+11), 0, 0, 2, 24, 56, height, 28,
                               4, height-16);
            break;
        case 3:
                                                      ...
                                                      uint8_t direction, int32_t height, const TileElement * tileElement)
{
    ...
    case 0:
        ...
        case 0:
            ...
            break;
        case 1:
            session->WoodenSupportsPrependTo = sub_98197C_rotated(session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_FLAT_TO_STEEP+20), 0, 0, 2, 24, 56, height, 28,
                               4, height-16);
            break;
        case 2:
            session->WoodenSupportsPrependTo = sub_98197C_rotated(session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_FLAT_TO_STEEP+24), 0, 0, 2, 24, 56, height, 28,
                               4, height-16);
            break;
        case 3:
    ...
    switch (trackSequence)
    {
        case 0:
		    ...
		    wooden_a_supports_paint_setup(session, 0, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                ...
                case 1:
                    ...
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_TURN_BANK_TRANSITION+3), 0, 6, 34, 1, 26, height, 0, 27,
                        height);
		    wooden_a_supports_paint_setup(session, 1, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                    break;
                case 2:
		    ...
		    wooden_a_supports_paint_setup(session, 0, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                ...
                case 3:
                    sub_98196C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_TURN_BANK_TRANSITION+7), 0, 6, 32, 32, 3, height);
		    wooden_a_supports_paint_setup(session, 1, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                    break;
            }
            if (direction == 0 || direction == 3)
        ...
        case 3:
		    ...
		    wooden_a_supports_paint_setup(session, 1, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                ...
                case 1:
                    sub_98196C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_TURN_BANK_TRANSITION+4), 6, 0, 20, 34, 3, height);
		    wooden_a_supports_paint_setup(session, 0, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                    break;
                case 2:
                    sub_98196C_rotated(
    ...
    switch (trackSequence)
    {
        case 0:
            switch (direction)
            {
                case 0:
                    sub_98196C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_TURN_BANK_TRANSITION+9), 0, 6, 32, 32, 3, height);
		    wooden_a_supports_paint_setup(session, 0, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                    break;
                case 1:
                    sub_98196C_rotated(
		    ...
		    wooden_a_supports_paint_setup(session, 1, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                ...
                case 2:
                    ...
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_TURN_BANK_TRANSITION+14), 0, 6, 34, 1, 26, height, 0, 27,
                        height);
		    wooden_a_supports_paint_setup(session, 0, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                    break;
                case 3:
        ...
        case 3:
		    ...
		    wooden_a_supports_paint_setup(session, 0, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                ...
                case 2:
                    sub_98196C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_TURN_BANK_TRANSITION+15), 6, 0, 20, 34, 3, height);
		    wooden_a_supports_paint_setup(session, 1, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                    break;
                case 3:
                    sub_98196C_rotated(
    ...
    switch (trackSequence)
    {
        case 0:
		    ...
		    wooden_a_supports_paint_setup(session, 0, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                ...
                case 1:
                    sub_98196C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_TURN_BANK_TRANSITION+15), 0, 6, 34, 20, 3, height);
		    wooden_a_supports_paint_setup(session, 1, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                    break;
                case 2:
                    sub_98196C_rotated(
        ...
        case 3:
		    ...
		    wooden_a_supports_paint_setup(session, 1, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                ...
                case 1:
                    ...
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_TURN_BANK_TRANSITION+14), 6, 0, 1, 34, 26, height, 27, 0,
                        height);
		    wooden_a_supports_paint_setup(session, 0, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                    break;
                case 2:
		    ...
		    wooden_a_supports_paint_setup(session, 1, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                ...
                case 3:
                    sub_98196C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_TURN_BANK_TRANSITION+9), 6, 0, 32, 32, 3, height);
		    wooden_a_supports_paint_setup(session, 0, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                    break;
            }
            switch (direction)
    ...
    switch (trackSequence)
    {
        case 0:
		    ...
		    wooden_a_supports_paint_setup(session, 1, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                ...
                case 2:
                    sub_98196C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_TURN_BANK_TRANSITION+4), 0, 6, 34, 20, 3, height);
		    wooden_a_supports_paint_setup(session, 0, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                    break;
                case 3:
                    sub_98196C_rotated(
        ...
        case 3:
            switch (direction)
            {
                case 0:
                    sub_98196C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_TURN_BANK_TRANSITION+7), 6, 0, 32, 32, 3, height);
		    wooden_a_supports_paint_setup(session, 1, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                    break;
                case 1:
                    sub_98196C_rotated(
		    ...
		    wooden_a_supports_paint_setup(session, 0, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                ...
                case 2:
                    ...
                    sub_98197C_rotated(
                        session, direction, hybrid_rc_get_track_colour(session) | (SPR_G2_HYBRID_TRACK_TURN_BANK_TRANSITION+3), 6, 0, 1, 34, 26, height, 27, 0,
                        height);
		    wooden_a_supports_paint_setup(session, 1, 0, height, session->TrackColours[SCHEME_SUPPORTS], nullptr);
                    break;
                case 3:

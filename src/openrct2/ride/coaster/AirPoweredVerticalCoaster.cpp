...
namespace OpenRCT2
{
        ...
        const TrackElement& trackElement)
    {
        ...
        auto supportsImageId = AirPoweredVerticalRCGetSupportColour(session).WithIndex(
        ...
        const TrackElement& trackElement)
    {
        ...
        switch (trackSequence)
        {
            ...
            case 1:
                ...
                {
                    PaintAddImageAsParentRotated(
                        session, direction, imageId, { 0, 0, height }, { 2, 20, 79 }, { 0, 6, height });
                }
                else
                {
                    PaintAddImageAsParentRotated(
                        session, direction, imageId, { 0, 0, height }, { 2, 20, 79 }, { 30, 6, height });
                }
        ...
        const TrackElement& trackElement)
    {
        ...
        switch (trackSequence)
        {
            case 0:
                ...
                {
                    PaintAddImageAsParentRotated(
                        session, direction, imageIdS, { 0, 0, height }, { 32, 20, 15 }, { 0, 6, height });
                    PaintAddImageAsChildRotated(
                        session, direction, imageIdT, { 0, 0, height }, { 31, 20, 15 }, { 1, 6, height });
                }
                else
                {
                    PaintAddImageAsParentRotated(
                        session, direction, imageIdS, { 0, 0, height }, { 5, 20, 1 }, { 24, 6, height });
                    PaintAddImageAsChildRotated(
                        session, direction, imageIdT, { 0, 0, height }, { 5, 20, 1 }, { 24, 6, height });
                }
                break;
            case 1:
                ...
                {
                    PaintAddImageAsParentRotated(
                        session, direction, imageIdT, { 0, 0, height }, { 2, 20, 15 }, { 0, 6, height });
                }
                else
                {
                    PaintAddImageAsParentRotated(
                        session, direction, imageIdT, { 0, 0, height }, { 2, 20, 1 }, { 33, 6, height });
                }
                PaintUtilSetVerticalTunnel(session, height + 80);
                break;
            case 2:
            ...
            case 3:
                ...
                else
                {
                    PaintAddImageAsParentRotated(
                        session, direction, imageIdS, { 0, 0, height }, { 32, 20, 15 }, { 0, 6, height });
                    PaintAddImageAsChildRotated(
                        session, direction, imageIdT, { 0, 0, height }, { 32, 20, 15 }, { 0, 6, height });
                }
                break;
        }

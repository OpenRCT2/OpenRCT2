...
/** rct2: 0x00792D88 */
static void multi_dimension_rc_track_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                          rct_map_element * mapElement)
{
    ...
    else
    {
        ...
        paint_util_set_segment_support_height(paint_util_rotate_segments(SEGMENT_C4 | SEGMENT_CC | SEGMENT_D0, direction),
                                              0xFFFF, 0);
        if (track_paint_util_should_paint_supports(gPaintMapPosition))
        {
...
static void multi_dimension_rc_track_station(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                             rct_map_element * mapElement)
{
    ...
    {
        sub_98197C_rotated(direction, imageIds[direction][1] | gTrackColours[SCHEME_TRACK], 0, 0, 32, 26, 1, height, 0, 3,
                           height + 3);
    }
    else
    {
        sub_98197C_rotated(direction, imageIds[direction][0] | gTrackColours[SCHEME_TRACK], 0, 0, 32, 26, 1, height, 0, 3,
                           height + 3);
    }
...
/** rct2: 0x00792D98 */
static void multi_dimension_rc_track_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                               rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        if (track_paint_util_should_paint_supports(gPaintMapPosition))
        {
            ...
            case 0:
                ...
                break;
            case 1:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 8, 0, height + 54, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 7, 0, height + 54, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 3:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 5, 0, height + 54, gTrackColours[SCHEME_SUPPORTS]);
                break;
            }
        }
...
/** rct2: 0x00792DA8 */
static void multi_dimension_rc_track_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                               rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00792DB8 */
static void multi_dimension_rc_track_flat_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00792DC8 */
static void multi_dimension_rc_track_25_deg_up_to_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26261, 0, 0, 32, 10, 49, height + 24, 0, 10,
                               height + 6);
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26258, 0, 0, 32, 2, 49, height + 24, 0, 4, height + 6);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26262, 0, 0, 32, 10, 49, height + 24, 0, 10,
                               height + 6);
...
/** rct2: 0x00792DD8 */
static void multi_dimension_rc_track_60_deg_up_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26267, 0, 0, 32, 10, 49, height + 24, 0, 10,
                               height + 6);
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26264, 0, 0, 32, 2, 49, height + 24, 0, 4, height + 6);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26268, 0, 0, 32, 10, 49, height + 24, 0, 10,
                               height + 6);
        ...
        if (track_paint_util_should_paint_supports(gPaintMapPosition))
        {
            ...
            case 0:
                ...
                break;
            case 1:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 8, 0, height + 68, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 7, 0, height + 68, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 3:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 5, 0, height + 68, gTrackColours[SCHEME_SUPPORTS]);
                break;
            }
        }
...
/** rct2: 0x00792DE8 */
static void multi_dimension_rc_track_25_deg_up_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        if (track_paint_util_should_paint_supports(gPaintMapPosition))
        {
            ...
            case 0:
                ...
                break;
            case 1:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 8, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 7, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 3:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 5, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
                break;
            }
        }
...
/** rct2: 0x00792DF8 */
static void multi_dimension_rc_track_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
...
/** rct2: 0x00792E08 */
static void multi_dimension_rc_track_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
...
/** rct2: 0x00792E18 */
static void multi_dimension_rc_track_flat_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
...
/** rct2: 0x00792E28 */
static void multi_dimension_rc_track_25_deg_down_to_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                int height, rct_map_element * mapElement)
{
    multi_dimension_rc_track_60_deg_up_to_25_deg_up(rideIndex, trackSequence, (direction + 2) & 3, height, mapElement);
}

/** rct2: 0x00792E38 */
static void multi_dimension_rc_track_60_deg_down_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                int height, rct_map_element * mapElement)
{
...
/** rct2: 0x00792E48 */
static void multi_dimension_rc_track_25_deg_down_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
...
/** rct2: 0x00792E58 */
static void multi_dimension_rc_track_left_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 2:
            ...
            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_B8 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_CC | SEGMENT_D0,
                                           direction),
                0xFFFF, 0);
            paint_util_set_general_support_height(height + 32, 0x20);
            break;
        case 3:
            ...
            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_BC | SEGMENT_C4 | SEGMENT_CC | SEGMENT_D4, direction), 0xFFFF, 0);
            paint_util_set_general_support_height(height + 32, 0x20);
            break;
        case 4:
            paint_util_set_general_support_height(height + 32, 0x20);
        ...
        case 5:
            ...
            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_B8 | SEGMENT_C0 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_D0 | SEGMENT_D4,
                                           direction),
                0xFFFF, 0);
            paint_util_set_general_support_height(height + 32, 0x20);
            break;
        case 6:
            ...
            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_C0 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_D4, direction), 0xFFFF, 0);
            paint_util_set_general_support_height(height + 32, 0x20);
            break;
        }
    }
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26310, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26315, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26320, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26305, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            }

            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_C4 | SEGMENT_CC | SEGMENT_D0 | SEGMENT_D4, direction), 0xFFFF,
                0);
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 4, 0, height + 36, gTrackColours[SCHEME_SUPPORTS]);
        ...
        case 2:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26309, 0, 0, 32, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26314, 0, 0, 32, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26319, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26304, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26308, 0, 0, 16, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26313, 0, 0, 16, 16, 3, height + 24, 16, 16,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26318, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26303, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 5:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26307, 0, 0, 16, 32, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26312, 0, 0, 16, 32, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26317, 0, 0, 16, 32, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26302, 0, 0, 16, 32, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 6:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26306, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26311, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26316, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26301, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            }

            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_C0 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_CC | SEGMENT_D4, direction), 0xFFFF,
                0);
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 4, 0, height + 36, gTrackColours[SCHEME_SUPPORTS]);
...
/** rct2: 0x00792E68 */
static void multi_dimension_rc_track_right_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
...
/** rct2: 0x00792E78 */
static void multi_dimension_rc_track_flat_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00792E88 */
static void multi_dimension_rc_track_flat_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00792E98 */
static void multi_dimension_rc_track_left_bank_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00792EA8 */
static void multi_dimension_rc_track_right_bank_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00792EB8 */
static void multi_dimension_rc_track_banked_left_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                int height, rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 3:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 15944, 0, 0, 16, 16, 1, height, 16, 16,
                                   height + 27);
                break;
            case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26354, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 24);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26359, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 24);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26364, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 24);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26349, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 24);
                break;
            }
        ...
        case 2:
            ...
            case 1:
                ...
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26363, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 24);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26348, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 24);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26352, 0, 0, 16, 16, 3, height + 24, 0, 16,
                                   height + 24);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26357, 0, 0, 16, 16, 3, height + 24, 16, 16,
                                   height + 24);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26362, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 24);
                break;
            case 3:
        ...
        case 5:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26351, 0, 0, 16, 32, 3, height + 24, 16, 0,
                                   height + 24);
                break;
            case 1:
            ...
            case 2:
                ...
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26346, 0, 0, 16, 32, 3, height + 24, 16, 0,
                                   height + 24);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 6:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26350, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 24);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26355, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 24);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26360, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 24);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26345, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 24);
                break;
            }
...
/** rct2: 0x00792EC8 */
static void multi_dimension_rc_track_banked_right_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                 int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn5TilesToRightQuarterTurn5Tiles[trackSequence];
...
/** rct2: 0x00792ED8 */
static void multi_dimension_rc_track_left_bank_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00792EE8 */
static void multi_dimension_rc_track_right_bank_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00792EF8 */
static void multi_dimension_rc_track_25_deg_up_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00792F08 */
static void multi_dimension_rc_track_25_deg_up_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00792F18 */
static void multi_dimension_rc_track_left_bank_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
...
/** rct2: 0x00792F28 */
static void multi_dimension_rc_track_right_bank_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
...
/** rct2: 0x00792F38 */
static void multi_dimension_rc_track_25_deg_down_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
...
/** rct2: 0x00792F48 */
static void multi_dimension_rc_track_25_deg_down_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
...
/** rct2: 0x00792F58 */
static void multi_dimension_rc_track_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                               rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00792F68 */
static void multi_dimension_rc_track_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
...
/** rct2: 0x00792F78 */
static void multi_dimension_rc_track_s_bend_left(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 1:
            ...
            case 1:
                ...
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 6, 1, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26229, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26233, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26232, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26236, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            }

            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_C4 | SEGMENT_CC | SEGMENT_D0, direction), 0xFFFF, 0);
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 4, 0, height + 36, gTrackColours[SCHEME_SUPPORTS]);
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26230, 0, 0, 32, 26, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26234, 0, 0, 32, 26, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26231, 0, 0, 32, 26, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26235, 0, 0, 32, 26, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            }
            ...
            {
            case 0:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 5, 0, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 1:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 6, 0, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            }
        ...
        case 2:
            ...
            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_BC | SEGMENT_C0 | SEGMENT_C4 | SEGMENT_CC | SEGMENT_D0 | SEGMENT_D4,
                                           direction),
                0xFFFF, 0);
            switch (direction)
            {
        ...
        case 3:
            ...
            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_C0 | SEGMENT_C4 | SEGMENT_CC | SEGMENT_D0, direction), 0xFFFF, 0);
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 4, 0, height + 36, gTrackColours[SCHEME_SUPPORTS]);
...
/** rct2: 0x00792F88 */
static void multi_dimension_rc_track_s_bend_right(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26237, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26241, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26240, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26244, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            }

            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_BC | SEGMENT_C4 | SEGMENT_CC | SEGMENT_D0, direction), 0xFFFF, 0);
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 4, 0, height + 36, gTrackColours[SCHEME_SUPPORTS]);
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26238, 0, 0, 32, 26, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26242, 0, 0, 32, 26, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26239, 0, 0, 32, 26, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26243, 0, 0, 32, 26, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            }
            ...
            {
            case 0:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 8, 0, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 1:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 7, 0, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            }
        ...
        case 3:
            ...
            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_B8 | SEGMENT_C4 | SEGMENT_CC | SEGMENT_D0, direction), 0xFFFF, 0);
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 4, 0, height + 36, gTrackColours[SCHEME_SUPPORTS]);
...
/** rct2: 0x00792FC8 */
static void multi_dimension_rc_track_left_quarter_turn_3(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 2:
            ...
            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_B8 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_D0, direction), 0xFFFF, 0);
            paint_util_set_general_support_height(height + 32, 0x20);
            break;
        case 3:
            switch (direction)
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26326, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26329, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26332, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26323, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            }
        ...
        case 2:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26325, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26328, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26331, 0, 0, 16, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26322, 0, 0, 16, 16, 3, height + 24, 16, 16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26324, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26327, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26330, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26321, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            }
...
/** rct2: 0x00792FD8 */
static void multi_dimension_rc_track_right_quarter_turn_3(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
...
/** rct2: 0x00792FE8 */
static void multi_dimension_rc_track_left_quarter_turn_3_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26338, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26341, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26344, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26335, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            }
        ...
        case 2:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26337, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26340, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26343, 0, 0, 16, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26334, 0, 0, 16, 16, 3, height + 24, 16, 16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26336, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26339, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26342, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26333, 0, 0, 20, 32, 3, height + 24, 6, 0,
                                   height + 22);
                break;
            }
...
/** rct2: 0x00792FF8 */
static void multi_dimension_rc_track_right_quarter_turn_3_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
...
/** rct2: 0x00793008 */
static void multi_dimension_rc_track_left_half_banked_helix_up_small(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                     int height, rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            ...
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 4, 2, height, gTrackColours[SCHEME_SUPPORTS]);
            if (direction == 0 || direction == 3)
            {
                paint_util_push_tunnel_rotated(direction, height, TUNNEL_6);
            }
        ...
        case 3:
            ...
            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_C0 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_D0 | SEGMENT_D4, direction), 0xFFFF,
                0);
            paint_util_set_general_support_height(height + 32, 0x20);
            break;
        case 4:
        ...
        case 6:
            ...
            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_C0 | SEGMENT_C4 | SEGMENT_D0 | SEGMENT_D4, direction), 0xFFFF, 0);
            paint_util_set_general_support_height(height + 32, 0x20);
            break;
        case 7:
            switch (direction)
...
/** rct2: 0x00793018 */
static void multi_dimension_rc_track_right_half_banked_helix_up_small(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                      int height, rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00793028 */
static void multi_dimension_rc_track_left_half_banked_helix_down_small(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                       int height, rct_map_element * mapElement)
{
    if (trackSequence >= 4)
    {
    ...
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
    multi_dimension_rc_track_right_half_banked_helix_up_small(rideIndex, trackSequence, (direction + 1) & 3, height,
                                                              mapElement);
}

/** rct2: 0x00793038 */
static void multi_dimension_rc_track_right_half_banked_helix_down_small(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                        int height, rct_map_element * mapElement)
{
    if (trackSequence >= 4)
    {
...
/** rct2: 0x00793048 */
static void multi_dimension_rc_track_left_half_banked_helix_up_large(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                     int height, rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            ...
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 4, 1, height, gTrackColours[SCHEME_SUPPORTS]);
            if (direction == 0 || direction == 3)
            {
                paint_util_push_tunnel_rotated(direction, height, TUNNEL_6);
            }
        ...
        case 3:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16168, 0, 0, 16, 16, 1, height, 16, 16,
                                   height + 27);
                break;
            case 2:
        ...
        case 6:
            ...
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 4, 7, height, gTrackColours[SCHEME_SUPPORTS]);
            switch (direction)
            {
            case 2:
                paint_util_push_tunnel_right(height + 8, TUNNEL_6);
        ...
        case 10:
            ...
            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_CC, direction), 0xFFFF, 0);
            paint_util_set_general_support_height(height + 32, 0x20);
            break;
        case 11:
            paint_util_set_general_support_height(height + 32, 0x20);
...
/** rct2: 0x00793058 */
static void multi_dimension_rc_track_right_half_banked_helix_up_large(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                      int height, rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 3:
            ...
            case 1:
                ...
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16146, 0, 0, 16, 16, 1, height, 16, 16,
                                   height + 27);
                break;
            case 3:
...
/** rct2: 0x00793068 */
static void multi_dimension_rc_track_left_half_banked_helix_down_large(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                       int height, rct_map_element * mapElement)
{
    if (trackSequence >= 7)
    {
    ...
    trackSequence = mapLeftQuarterTurn5TilesToRightQuarterTurn5Tiles[trackSequence];
    multi_dimension_rc_track_right_half_banked_helix_up_large(rideIndex, trackSequence, (direction + 1) & 3, height,
                                                              mapElement);
}

/** rct2: 0x00793078 */
static void multi_dimension_rc_track_right_half_banked_helix_down_large(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                        int height, rct_map_element * mapElement)
{
    if (trackSequence >= 7)
    {
...
/** rct2: 0x00793088 */
static void multi_dimension_rc_track_brakes(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                            rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00793098 */
static void multi_dimension_rc_track_on_ride_photo(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00793328 */
static void multi_dimension_rc_track_90_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                               rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26533, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 56);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26534, 0, 0, 32, 2, 31, height + 24, 0, 4,
                                   height + 6);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26535, 0, 0, 32, 2, 31, height + 24, 0, 4,
                                   height + 6);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26536, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 56);
                break;
            }
            paint_util_set_vertical_tunnel(height + 32);
...
/** rct2: 0x00793338 */
static void multi_dimension_rc_track_90_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
...
/** rct2: 0x00793348 */
static void multi_dimension_rc_track_60_deg_up_to_90_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26525, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 80);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26526, 0, 0, 32, 2, 55, height + 24, 0, 4,
                                   height + 6);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26527, 0, 0, 32, 2, 55, height + 24, 0, 4,
                                   height + 6);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26528, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 80);
                break;
            }
            if (direction == 0 || direction == 3)
...
/** rct2: 0x00793358 */
static void multi_dimension_rc_track_90_deg_down_to_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                int height, rct_map_element * mapElement)
{
...
/** rct2: 0x00793368 */
static void multi_dimension_rc_track_90_deg_up_to_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00793378 */
static void multi_dimension_rc_track_60_deg_down_to_90_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                int height, rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26531, 0, 0, 32, 2, 55, height + 24, 0, 4,
                                   height + 6);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26532, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 80);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26529, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 80);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26530, 0, 0, 32, 2, 55, height + 24, 0, 4,
                                   height + 6);
                break;
            }
            if (direction == 0 || direction == 3)
...
/** rct2: 0x007930B8 */
static void multi_dimension_rc_track_left_eighth_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 2:
            ...
            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_BC | SEGMENT_C0 | SEGMENT_C4 | SEGMENT_CC | SEGMENT_D4, direction), 0xFFFF,
                0);
            paint_util_set_general_support_height(height + 32, 0x20);
            break;
        case 3:
        ...
        case 4:
            ...
            case 0:
                ...
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 3, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16003, 0, 0, 16, 18, 3, height, 0, 16, height);
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 1, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16007, 0, 0, 16, 16, 3, height, 0, 0, height);
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16011, 0, 0, 16, 16, 3, height, 16, 0, height);
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 2, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            }
            paint_util_set_segment_support_height(SEGMENTS_ALL, 0xFFFF, 0);
            paint_util_set_general_support_height(height + 32, 0x20);
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26405, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26409, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26413, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26417, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            }
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26406, 0, 0, 32, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26410, 0, 0, 34, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26414, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26418, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26407, 0, 0, 16, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26411, 0, 0, 16, 16, 3, height + 24, 16, 16,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26415, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26419, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 4:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26408, 0, 0, 16, 16, 3, height + 24, 16, 16,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26412, 0, 0, 16, 18, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26416, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26420, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            }

            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_C0 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_CC | SEGMENT_D0 | SEGMENT_D4,
                                           direction),
                0xFFFF, 0);
            switch (direction)
            {
            case 0:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 3, 0, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 1:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 1, 0, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 0, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 3:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 2, 0, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            }
...
/** rct2: 0x007930C8 */
static void multi_dimension_rc_track_right_eighth_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 2:
            ...
            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_B8 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_CC, direction), 0xFFFF,
                0);
            paint_util_set_general_support_height(height + 32, 0x20);
            break;
        case 3:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26389, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26393, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26397, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26401, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            }
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26390, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26394, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26398, 0, 0, 34, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26402, 0, 0, 32, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26391, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26395, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26399, 0, 0, 28, 28, 3, height + 24, 4, 4,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26403, 0, 0, 16, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 4:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26392, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26396, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26400, 0, 0, 16, 18, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26404, 0, 0, 16, 16, 3, height + 24, 16, 16,
                                   height + 22);
                break;
            }

            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_B8 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_CC | SEGMENT_D0 | SEGMENT_D4,
                                           direction),
                0xFFFF, 0);
            switch (direction)
            {
...
/** rct2: 0x007930D8 */
static void multi_dimension_rc_track_left_eighth_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
...
/** rct2: 0x007930E8 */
static void multi_dimension_rc_track_right_eighth_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftEighthTurnToOrthogonal[trackSequence];
...
/** rct2: 0x007930F8 */
static void multi_dimension_rc_track_left_eighth_bank_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 2:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16034, 0, 0, 16, 16, 0, height, 16, 16,
                                   height + 27);
                break;
            case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26437, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26441, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26445, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26449, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            }

            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_C4 | SEGMENT_CC | SEGMENT_D0 | SEGMENT_D4, direction), 0xFFFF, 0);
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 4, 0, height + 36, gTrackColours[SCHEME_SUPPORTS]);
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26438, 0, 0, 32, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26442, 0, 0, 34, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26446, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26450, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26439, 0, 0, 16, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26443, 0, 0, 16, 16, 3, height + 24, 16, 16,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26447, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26451, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 4:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26440, 0, 0, 16, 16, 3, height + 24, 16, 16,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26444, 0, 0, 16, 18, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26448, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26452, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            }

            paint_util_set_segment_support_height(paint_util_rotate_segments(SEGMENT_BC | SEGMENT_C0 | SEGMENT_C4 | SEGMENT_C8 |
                                                                                 SEGMENT_CC | SEGMENT_D0 | SEGMENT_D4,
                                                                             direction),
                                                  0xFFFF, 0);
            switch (direction)
            {
...
/** rct2: 0x00793108 */
static void multi_dimension_rc_track_right_eighth_bank_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26421, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26425, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26429, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26433, 0, 0, 32, 20, 3, height + 24, 0, 6,
                                   height + 22);
                break;
            }

            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_C4 | SEGMENT_C8 | SEGMENT_CC | SEGMENT_D0, direction), 0xFFFF, 0);
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 4, 0, height + 36, gTrackColours[SCHEME_SUPPORTS]);
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26422, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26426, 0, 0, 32, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26430, 0, 0, 34, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26434, 0, 0, 32, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26423, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26427, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26431, 0, 0, 28, 28, 3, height + 24, 4, 4,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26435, 0, 0, 16, 16, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 4:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26424, 0, 0, 16, 16, 3, height + 24, 16, 0,
                                   height + 22);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26428, 0, 0, 16, 16, 3, height + 24, 0, 0,
                                   height + 22);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26432, 0, 0, 16, 18, 3, height + 24, 0, 16,
                                   height + 22);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26436, 0, 0, 16, 16, 3, height + 24, 16, 16,
                                   height + 22);
                break;
            }

            paint_util_set_segment_support_height(paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_B8 | SEGMENT_C4 | SEGMENT_C8 |
                                                                                 SEGMENT_CC | SEGMENT_D0 | SEGMENT_D4,
                                                                             direction),
                                                  0xFFFF, 0);
            switch (direction)
...
/** rct2: 0x00793118 */
static void multi_dimension_rc_track_left_eighth_bank_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                    int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftEighthTurnToOrthogonal[trackSequence];
...
/** rct2: 0x00793128 */
static void multi_dimension_rc_track_right_eighth_bank_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                     int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftEighthTurnToOrthogonal[trackSequence];
...
/** rct2: 0x007930A8 */
static void multi_dimension_rc_track_diag_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                               rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16109, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16047, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 1:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16106, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16044, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 2:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16108, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16046, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 3:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16107, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 2:
            ...
            else
            {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16045, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 2:
    ...
    else
    {
        ...
        case 0:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26484, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 22);
                    break;
                }
            }
            else
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26456, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 22);
                    break;
                }
            }
        ...
        case 1:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26481, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 22);
                    break;
                }
            }
            else
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26453, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 22);
                    break;
                }
            }
        ...
        case 2:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26483, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 22);
                    break;
                }
            }
            else
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26455, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 22);
                    break;
                }
            }
        ...
        case 3:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26482, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 22);
                    break;
                }
            }
            else
            {
                ...
                {
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26454, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 22);
                    break;
                }
            }
...
/** rct2: 0x00793158 */
static void multi_dimension_rc_track_diag_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                    rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16121, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16059, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 1:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16118, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16056, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 2:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16120, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16058, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 3:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 1, 8, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16119, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 8, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 2:
                    metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 2, 8, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 3:
                    metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 3, 8, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                }
            }
            else
            {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16057, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 8, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 2:
    ...
    else
    {
        ...
        case 0:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26496, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 40);
                    break;
                }
            }
            else
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26468, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 40);
                    break;
                }
            }
        ...
        case 1:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26493, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 40);
                    break;
                }
            }
            else
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26465, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 40);
                    break;
                }
            }
        ...
        case 2:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26495, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 40);
                    break;
                }
            }
            else
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26467, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 40);
                    break;
                }
            }
        ...
        case 3:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26494, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 40);
                    break;
                }
            }
            else
            {
                ...
                {
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26466, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 40);
                    break;
                }
            }
            ...
            {
            case 0:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 1, 0, height + 48, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 1:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 0, height + 48, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 2, 0, height + 48, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 3:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 3, 0, height + 48, gTrackColours[SCHEME_SUPPORTS]);
                break;
            }
...
/** rct2: 0x007931B8 */
static void multi_dimension_rc_track_diag_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                    rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16071, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16068, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16070, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 0:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 1, 32, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16069, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 36, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 2, 32, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 3:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 3, 36, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            }
            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_B8 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_D0, direction), 0xFFFF, 0);
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26480, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 88);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26477, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 88);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26479, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 88);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26478, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 24);
                break;
            }
            ...
            {
            case 0:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 1, 32, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 1:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 36, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 2, 32, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 3:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 3, 36, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            }
...
/** rct2: 0x00793138 */
static void multi_dimension_rc_track_diag_flat_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16113, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16051, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 1:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16110, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16048, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 2:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16112, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16050, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 3:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 1, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16111, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 2:
                    metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 2, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 3:
                    metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 3, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                }
            }
            else
            {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16049, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 2:
    ...
    else
    {
        ...
        case 0:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26488, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
            else
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26460, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
        ...
        case 1:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26485, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
            else
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26457, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
        ...
        case 2:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26487, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
            else
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26459, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
        ...
        case 3:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26486, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
            else
            {
                ...
                {
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26458, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
            ...
            {
            case 0:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 1, 0, height + 40, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 1:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 0, height + 40, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 2, 0, height + 40, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 3:
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 3, 0, height + 40, gTrackColours[SCHEME_SUPPORTS]);
                break;
            }
...
/** rct2: 0x00793198 */
static void multi_dimension_rc_track_diag_25_deg_up_to_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                 int height, rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16063, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16060, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16062, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 0:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 1, 16, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16061, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 16, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 2, 16, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 3:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 3, 16, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            }
            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_B8 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_D0, direction), 0xFFFF, 0);
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26472, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 56);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26469, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 56);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26471, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 56);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26470, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 56);
                break;
            }
            ...
            {
            case 0:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 1, 16, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 1:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 16, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 2, 16, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 3:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 3, 16, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            }
...
/** rct2: 0x007931A8 */
static void multi_dimension_rc_track_diag_60_deg_up_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                 int height, rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16067, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16064, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16066, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 0:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 1, 21, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16065, -16, -16, 16, 16, 3, height, 0, 0, height);
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 21, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 2, 21, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 3:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 3, 21, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            }
            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_B8 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_D0, direction), 0xFFFF, 0);
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26476, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 56);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26473, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 56);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26475, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 56);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26474, -16, -16, 16, 16, 3, height + 24, 0, 0,
                                   height + 56);
                break;
            }
            ...
            {
            case 0:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 1, 21, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 1:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 21, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 2, 21, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 3:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 3, 21, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            }
...
/** rct2: 0x00793148 */
static void multi_dimension_rc_track_diag_25_deg_up_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16117, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16055, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 1:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16114, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16052, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 2:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16116, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
            else
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16054, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    break;
                }
            }
        ...
        case 3:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 1, 4, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16115, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 4, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 2:
                    metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 2, 4, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 3:
                    metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 3, 4, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                }
            }
            else
            {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16053, -16, -16, 32, 32, 3, height, -16, -16,
                                       height);
                    metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 4, height, gTrackColours[SCHEME_SUPPORTS]);
                    break;
                case 2:
    ...
    else
    {
        ...
        case 0:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26492, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
            else
            {
                ...
                {
                case 3:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26464, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
        ...
        case 1:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26489, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
            else
            {
                ...
                {
                case 0:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26461, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
        ...
        case 2:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26491, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
            else
            {
                ...
                {
                case 2:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26463, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
        ...
        case 3:
            if (track_element_is_lift_hill(mapElement))
            {
                ...
                {
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26490, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
            else
            {
                ...
                {
                case 1:
                    sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26462, -16, -16, 32, 32, 3, height + 24, -16,
                                       -16, height + 32);
                    break;
                }
            }
...
/** rct2: 0x00793188 */
static void multi_dimension_rc_track_diag_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                      rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26466, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 40);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26467, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 40);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26465, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 40);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26468, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 40);
                break;
            }
...
/** rct2: 0x007931E8 */
static void multi_dimension_rc_track_diag_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                      rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 3:
            ...
            {
            case 0:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 1, 24, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16071, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 28, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 2, 24, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 3:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 3, 28, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            }
            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_B8 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_D0, direction), 0xFFFF, 0);
    ...
    else
    {
        ...
        case 3:
            ...
            {
            case 0:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 1, 24, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 1:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 28, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 2, 24, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 3:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 3, 28, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            }
...
/** rct2: 0x00793168 */
static void multi_dimension_rc_track_diag_flat_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26462, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26463, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26461, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26464, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
...
/** rct2: 0x007931C8 */
static void multi_dimension_rc_track_diag_25_deg_down_to_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                     int height, rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 3:
            ...
            {
            case 0:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 1, 17, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16067, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 17, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 2, 17, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 3:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 3, 17, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            }
            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_B8 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_D0, direction), 0xFFFF, 0);
    ...
    else
    {
        ...
        case 3:
            ...
            {
            case 0:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 1, 17, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 1:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 17, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 2, 17, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 3:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 3, 17, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            }
...
/** rct2: 0x007931D8 */
static void multi_dimension_rc_track_diag_60_deg_down_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                     int height, rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 3:
            ...
            {
            case 0:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 1, 8, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 1:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 8, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 2, 8, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 3:
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 3, 8, height + 36, gTrackColours[SCHEME_SUPPORTS]);
                break;
            }
...
/** rct2: 0x00793178 */
static void multi_dimension_rc_track_diag_25_deg_down_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26458, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26459, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26457, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26460, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
...
/** rct2: 0x00793218 */
static void multi_dimension_rc_track_diag_flat_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16079, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16076, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16080, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 27);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16078, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16077, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26504, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26501, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26503, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26502, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }

            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_B8 | SEGMENT_C0 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_D0, direction), 0xFFFF,
                0);
            switch (direction)
            {
            case 0:
...
/** rct2: 0x00793228 */
static void multi_dimension_rc_track_diag_flat_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16084, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16081, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16083, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16085, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 27);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16082, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26508, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26505, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26507, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26506, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }

            paint_util_set_segment_support_height(
                paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_B8 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_D0, direction), 0xFFFF,
                0);
            switch (direction)
            {
            case 0:
...
/** rct2: 0x00793238 */
static void multi_dimension_rc_track_diag_left_bank_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00793248 */
static void multi_dimension_rc_track_diag_right_bank_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00793278 */
static void multi_dimension_rc_track_diag_left_bank_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                 int height, rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16099, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16096, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16100, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16098, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16097, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26520, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26517, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26519, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26518, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
...
/** rct2: 0x00793288 */
static void multi_dimension_rc_track_diag_right_bank_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                  int height, rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16104, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16101, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16103, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16105, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16102, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26524, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26521, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26523, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26522, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
...
/** rct2: 0x00793258 */
static void multi_dimension_rc_track_diag_25_deg_up_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                 int height, rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16089, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16086, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16090, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16088, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16087, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 4, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26512, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26509, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26511, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26510, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
...
/** rct2: 0x00793268 */
static void multi_dimension_rc_track_diag_25_deg_up_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                  int height, rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16094, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16091, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16093, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16095, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16092, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 4, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26516, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26513, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26515, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26514, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 32);
                break;
            }
...
/** rct2: 0x00793298 */
static void multi_dimension_rc_track_diag_left_bank_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                   int height, rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x007932A8 */
static void multi_dimension_rc_track_diag_right_bank_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                    int height, rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x007932B8 */
static void multi_dimension_rc_track_diag_25_deg_down_to_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                   int height, rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x007932C8 */
static void multi_dimension_rc_track_diag_25_deg_down_to_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                    int height, rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x007931F8 */
static void multi_dimension_rc_track_diag_left_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                    rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16075, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16072, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 27);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16074, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 16073, -16, -16, 32, 32, 3, height, -16, -16,
                                   height);
                metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES_INVERTED, 0, 0, height, gTrackColours[SCHEME_SUPPORTS]);
                break;
            case 2:
    ...
    else
    {
        ...
        case 0:
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26500, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26497, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 2:
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26499, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
            paint_util_set_segment_support_height(
        ...
        case 3:
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26498, -16, -16, 32, 32, 3, height + 24, -16, -16,
                                   height + 22);
                break;
            }
...
/** rct2: 0x00793208 */
static void multi_dimension_rc_track_diag_right_bank(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x007932D8 */
static void multi_dimension_rc_track_left_flyer_twist_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26369, 0, 6, 32, 20, 3, height + 24, 0, 6,
                                   height + 24);
                break;
            case 1:
        ...
        case 2:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26370, 0, 6, 32, 20, 3, height + 24, 0, 6,
                                   height + 24);
                break;
            case 1:
...
/** rct2: 0x007932E8 */
static void multi_dimension_rc_track_right_flyer_twist_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x007932F8 */
static void multi_dimension_rc_track_left_flyer_twist_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00793308 */
static void multi_dimension_rc_track_right_flyer_twist_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00793398 */
static void multi_dimension_rc_track_multidim_inverted_flat_to_90_deg_quarter_loop_down(uint8 rideIndex, uint8 trackSequence,
                                                                                        uint8 direction, int height,
                                                                                        rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
        ...
        case 0:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26539, 0, 0, 32, 20, 3, height + 16, 0, 6,
                                   height + 16);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26542, 0, 0, 2, 20, 3, height + 16, 0, 6,
                                   height + 18);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26545, 0, 0, 2, 20, 3, height + 16, 0, 6,
                                   height + 18);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26548, 0, 0, 32, 20, 3, height + 16, 0, 6,
                                   height + 16);
                break;
            }
            if (direction == 0 || direction == 3)
            ...
            paint_util_set_segment_support_height(paint_util_rotate_segments(SEGMENT_C4 | SEGMENT_C8 | SEGMENT_D4, direction),
                                                  0xFFFF, 0);
            paint_util_set_general_support_height(height + 64, 0x20);
            break;
        case 1:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26538, 0, 0, 2, 20, 31, height + 16, 24, 6,
                                   height + 16);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26541, 0, 0, 2, 20, 3, height + 16, 0, 6,
                                   height + 18);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26544, 0, 0, 2, 20, 3, height + 16, 0, 6,
                                   height + 18);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26547, 0, 0, 2, 20, 31, height + 16, 24, 6,
                                   height + 16);
                break;
            }
            paint_util_set_segment_support_height(paint_util_rotate_segments(SEGMENT_C4 | SEGMENT_C8 | SEGMENT_D4, direction),
        ...
        case 2:
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26537, 0, 0, 2, 20, 31, height + 16, 28, 6,
                                   height + 24);
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26540, 0, 0, 2, 20, 31, height + 16, 0, 6,
                                   height + 24);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26543, 0, 0, 2, 20, 31, height + 16, 0, 6,
                                   height + 24);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26546, 0, 0, 2, 20, 31, height + 16, 29, 6,
                                   height + 24);
                break;
            }
            paint_util_set_segment_support_height(paint_util_rotate_segments(SEGMENT_C4 | SEGMENT_C8 | SEGMENT_D4, direction),
...
/** rct2: 0x00793318 */
static void multi_dimension_rc_track_block_brakes(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {
...
/** rct2: 0x00793388 */
static void multi_dimension_rc_track_multidim_90_deg_up_to_inverted_flat_quarter_loop(uint8 rideIndex, uint8 trackSequence,
                                                                                      uint8 direction, int height,
                                                                                      rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    ...
    else
    {
        ...
        case 0:
            ...
            case 2:
                ...
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26546, 0, 0, 2, 20, 31, height - 16, 28, 6,
                                   height - 8);
                break;
            }
            paint_util_set_segment_support_height(paint_util_rotate_segments(SEGMENT_C4 | SEGMENT_C8 | SEGMENT_D4, direction),
        ...
        case 1:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26541, 0, 0, 2, 20, 63, height - 16, 0, 6,
                                   height - 8);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26544, 0, 0, 2, 20, 63, height - 16, 0, 6,
                                   height - 8);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26547, 0, 0, 2, 20, 31, height - 16, 24, 6,
        ...
        case 2:
            ...
            case 0:
                ...
                break;
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26542, 0, 0, 2, 20, 31, height - 16, 0, 6,
                                   height - 8);
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26545, 0, 0, 2, 20, 31, height - 16, 0, 6,
                                   height - 8);
                break;
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26548, 0, 0, 32, 20, 3, height - 16, 0, 6,
...
/** rct2: 0x00793398 */
static void multi_dimension_rc_track_multidim_flat_to_90_deg_down_quarter_loop(uint8 rideIndex, uint8 trackSequence,
                                                                               uint8 direction, int height,
                                                                               rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
...
/** rct2: 0x00793388 */
static void multi_dimension_rc_track_elem_255(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                              rct_map_element * mapElement)
{
    if (!track_element_is_inverted(mapElement))
    {

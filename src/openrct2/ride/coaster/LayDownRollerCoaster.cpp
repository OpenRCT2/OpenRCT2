    ...
    const TrackElement& trackElement)
{
    ...
    if (trackElement.IsInverted())
    {
        TrackPaintUtilDiagTilesPaint(
            session, -3, height + 24, direction, trackSequence, session.TrackColours, LaydownDiagBrakeImages[1],
    ...
    {
        TrackPaintUtilDiagTilesPaint(
            session, 3, height, direction, trackSequence, session.TrackColours, LaydownDiagBrakeImages[0],
            defaultDiagTileOffsets, defaultDiagBoundLengths, nullptr);

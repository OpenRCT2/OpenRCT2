    ...
    const TileElement* tileElement)
{
    ...
    else
    {
        switch (direction)
        {
            ...
            case 2:
                sub_98197C_rotated(
                    session, direction, session->TrackColours[SCHEME_TRACK] | 26551, 0, 0, 32, 20, 3, height + 24, 0, 6,
                    height + 24);
                break;
            case 1:
            case 3:
                sub_98197C_rotated(
                    session, direction, session->TrackColours[SCHEME_TRACK] | 26552, 0, 0, 32, 20, 3, height + 24, 0, 6,
                    height + 24);
                break;
        }
...
TRACK_PAINT_FUNCTION get_track_paint_function_multi_dimension_rc(int32_t trackType, Direction direction)
{
    switch (trackType)
    {

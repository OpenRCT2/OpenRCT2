...
/** rct2: 0x0087694C */
static void heartline_twister_rc_track_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
...
static void heartline_twister_rc_track_station(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                               rct_map_element * mapElement)
{
...
/** rct2: 0x0087695C */
static void heartline_twister_rc_track_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
...
/** rct2: 0x008769FC */
static void heartline_twister_rc_track_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                 rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
...
/** rct2: 0x0087696C */
static void heartline_twister_rc_track_flat_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
...
/** rct2: 0x008769BC */
static void heartline_twister_rc_track_25_deg_up_to_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
...
/** rct2: 0x008769CC */
static void heartline_twister_rc_track_60_deg_up_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
...
/** rct2: 0x0087697C */
static void heartline_twister_rc_track_25_deg_up_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
...
/** rct2: 0x0087698C */
static void heartline_twister_rc_track_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
...
/** rct2: 0x00876A0C */
static void heartline_twister_rc_track_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                   rct_map_element * mapElement)
{
...
/** rct2: 0x0087699C */
static void heartline_twister_rc_track_flat_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
...
/** rct2: 0x008769DC */
static void heartline_twister_rc_track_25_deg_down_to_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
...
/** rct2: 0x008769EC */
static void heartline_twister_rc_track_60_deg_down_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                  int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008769AC */
static void heartline_twister_rc_track_25_deg_down_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
...
/** rct2: 0x00876A6C */
static void heartline_twister_rc_track_heartline_transfer_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    ...
    case 1:
        ...
        case 0:
            ...
            sub_98199C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21312, 0, 0, 32, 1, 34, height + 16, 0, 27,
                               height + 16);
        ...
        case 1:
            ...
            sub_98199C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21313, 0, 0, 32, 1, 34, height + 16, 0, 27,
                               height + 16);
        ...
        case 2:
            ...
            sub_98199C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21310, 0, 0, 32, 1, 34, height + 16, 0, 27,
                               height + 16);
        ...
        case 3:
            ...
            sub_98199C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21311, 0, 0, 32, 1, 34, height + 16, 0, 27,
                               height + 16);
...
/** rct2: 0x00876A7C */
static void heartline_twister_rc_track_heartline_transfer_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x00876A4C */
static void heartline_twister_rc_track_left_heartline_roll(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                           rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x00876A5C */
static void heartline_twister_rc_track_right_heartline_roll(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    switch (trackSequence)
    {

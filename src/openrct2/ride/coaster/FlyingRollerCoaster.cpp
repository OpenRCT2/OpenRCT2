    ...
    else
    {
        ...
        if (track_paint_util_should_paint_supports(session.MapPosition))
        {
            switch (direction)
            {
                case 0:
                    MetalASupportsPaintSetup(
                        session, MetalSupportsTubesInverted, 6, 0, height + 57, session.TrackColours[SCHEME_SUPPORTS]);
                    break;
                case 1:
                    MetalASupportsPaintSetup(
                        session, MetalSupportsTubesInverted, 8, 0, height + 57, session.TrackColours[SCHEME_SUPPORTS]);
                    break;
                case 2:
                    MetalASupportsPaintSetup(
                        session, MetalSupportsTubesInverted, 7, 0, height + 57, session.TrackColours[SCHEME_SUPPORTS]);
                    break;
                case 3:
                    MetalASupportsPaintSetup(
                        session, MetalSupportsTubesInverted, 5, 0, height + 57, session.TrackColours[SCHEME_SUPPORTS]);
                    break;
            }
        }
    ...
    const TrackElement& trackElement)
{
    if (!trackElement.IsInverted())
    {
        ...
        if (track_paint_util_should_paint_supports(session.MapPosition))
        {
            MetalASupportsPaintSetup(session, MetalSupportsTubesInverted, 4, 32, height, session.TrackColours[SCHEME_SUPPORTS]);
        }
        if (direction == 0 || direction == 3)
        {
            PaintUtilPushTunnelRotated(session, direction, height - 8, TunnelSquare7);
    ...
    const TrackElement& trackElement)
{
    if (!trackElement.IsInverted())
    {
        ...
        if (track_paint_util_should_paint_supports(session.MapPosition))
        {
            MetalASupportsPaintSetup(session, MetalSupportsTubesInverted, 4, 12, height, session.TrackColours[SCHEME_SUPPORTS]);
        }
        if (direction == 0 || direction == 3)
        {
            PaintUtilPushTunnelRotated(session, direction, height - 8, TunnelSquare7);
    ...
    const TrackElement& trackElement)
{
    if (!trackElement.IsInverted())
    {
        ...
        if (track_paint_util_should_paint_supports(session.MapPosition))
        {
            MetalASupportsPaintSetup(session, MetalSupportsTubesInverted, 4, 20, height, session.TrackColours[SCHEME_SUPPORTS]);
        }
        if (direction == 0 || direction == 3)
        {
            PaintUtilPushTunnelRotated(session, direction, height - 8, TunnelSquare7);
    ...
    else
    {
        ...
        if (track_paint_util_should_paint_supports(session.MapPosition))
        {
            switch (direction)
            {
                case 0:
                    MetalASupportsPaintSetup(
                        session, MetalSupportsTubesInverted, 6, 0, height + 71, session.TrackColours[SCHEME_SUPPORTS]);
                    break;
                case 1:
                    MetalASupportsPaintSetup(
                        session, MetalSupportsTubesInverted, 8, 0, height + 71, session.TrackColours[SCHEME_SUPPORTS]);
                    break;
                case 2:
                    MetalASupportsPaintSetup(
                        session, MetalSupportsTubesInverted, 7, 0, height + 71, session.TrackColours[SCHEME_SUPPORTS]);
                    break;
                case 3:
                    MetalASupportsPaintSetup(
                        session, MetalSupportsTubesInverted, 5, 0, height + 71, session.TrackColours[SCHEME_SUPPORTS]);
                    break;
            }
        }
    ...
    else
    {
        ...
        if (track_paint_util_should_paint_supports(session.MapPosition))
        {
            switch (direction)
            {
                case 0:
                    MetalASupportsPaintSetup(
                        session, MetalSupportsTubesInverted, 6, 0, height + 47, session.TrackColours[SCHEME_SUPPORTS]);
                    break;
                case 1:
                    MetalASupportsPaintSetup(
                        session, MetalSupportsTubesInverted, 8, 0, height + 47, session.TrackColours[SCHEME_SUPPORTS]);
                    break;
                case 2:
                    MetalASupportsPaintSetup(
                        session, MetalSupportsTubesInverted, 7, 0, height + 47, session.TrackColours[SCHEME_SUPPORTS]);
                    break;
                case 3:
                    MetalASupportsPaintSetup(
                        session, MetalSupportsTubesInverted, 5, 0, height + 47, session.TrackColours[SCHEME_SUPPORTS]);
                    break;
            }
        }
        ...
        switch (trackSequence)
        {
            case 0:
                ...
                PaintUtilSetSegmentSupportHeight(
                    ...
                    0xFFFF, 0);
                MetalASupportsPaintSetup(
                    session, MetalSupportsTubesInverted, 4, 0, height + 49, session.TrackColours[SCHEME_SUPPORTS]);
        ...
        switch (trackSequence)
        {
            ...
            case 1:
                ...
                switch (direction)
                {
                    case 0:
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 5, 0, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 6, 0, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                }
        ...
        switch (trackSequence)
        {
            ...
            case 1:
                ...
                switch (direction)
                {
                    case 0:
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 8, 0, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 7, 0, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                }
        ...
        switch (trackSequence)
        {
            case 0:
                ...
                PaintUtilSetSegmentSupportHeight(
                    ...
                    0xFFFF, 0);
                MetalASupportsPaintSetup(
                    session, MetalSupportsTubesInverted, 4, 0, height + 47, session.TrackColours[SCHEME_SUPPORTS]);
    ...
    const TrackElement& trackElement)
{
    if (!trackElement.IsInverted())
    {
        bolliger_mabillard_track_booster<MetalSupportsTubesInverted>(
    ...
    switch (trackSequence)
    {
        ...
        case 6:
            ...
            PaintUtilSetSegmentSupportHeight(
                ...
                0);
            MetalASupportsPaintSetup(
                session, MetalSupportsTubesInverted, 4, 0, height + 53, session.TrackColours[SCHEME_SUPPORTS]);

            switch (direction)
            {
                case 2:
                    PaintUtilPushTunnelRight(session, height + 16, TunnelSquareInverted9);
                    break;
                case 3:
                    PaintUtilPushTunnelLeft(session, height + 16, TunnelSquareInverted9);
                    break;
            }
            PaintUtilSetGeneralSupportHeight(session, height + 48, 0x20);
            break;
    ...
    const TrackElement& trackElement)
{
    switch (trackSequence)
    {
        case 0:
            ...
            if (direction == 0 || direction == 3)
            {
                PaintUtilPushTunnelRotated(session, direction, height + 16, TunnelSquareInverted9);
            }
            PaintUtilSetGeneralSupportHeight(session, height + 48, 0x20);
            break;
        case 1:
        ...
        switch (trackSequence)
        {
            ...
            case 3:
                ...
                switch (direction)
                {
                    case 0:
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 1, 0, height + 51, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 0, 0, height + 51, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 2, 0, height + 51, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 3:
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 3, 0, height + 51, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                }
        ...
        switch (trackSequence)
        {
            ...
            case 3:
                ...
                switch (direction)
                {
                    case 0:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 1, 32, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 0, 36, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 2, 32, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 3:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 3, 36, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                }
        ...
        switch (trackSequence)
        {
            ...
            case 3:
                ...
                switch (direction)
                {
                    case 0:
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 1, 0, height + 43, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 0, 0, height + 43, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 2, 0, height + 43, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 3:
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 3, 0, height + 43, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                }
        ...
        switch (trackSequence)
        {
            ...
            case 3:
                ...
                switch (direction)
                {
                    case 0:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 1, 16, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 0, 16, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 2, 16, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 3:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 3, 16, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                }
        ...
        switch (trackSequence)
        {
            ...
            case 3:
                ...
                switch (direction)
                {
                    case 0:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 1, 21, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 0, 21, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 2, 21, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 3:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 3, 21, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                }
        ...
        switch (trackSequence)
        {
            ...
            case 3:
                ...
                switch (direction)
                {
                    case 0:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 1, 24, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 0, 28, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 2, 24, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 3:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 3, 28, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                }
        ...
        switch (trackSequence)
        {
            ...
            case 3:
                ...
                switch (direction)
                {
                    case 0:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 1, 17, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 0, 17, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 2, 17, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 3:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 3, 17, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                }
        ...
        switch (trackSequence)
        {
            ...
            case 3:
                ...
                switch (direction)
                {
                    case 0:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 1, 8, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 0, 8, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 2, 8, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 3:
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubesInverted, 3, 8, height + 39, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                }
    ...
    const TrackElement& trackElement)
{
    switch (trackSequence)
    {
        case 0:
            ...
            MetalASupportsPaintSetup(
                session, MetalSupportsTubesInverted, 4, 0, height - 5, session.TrackColours[SCHEME_SUPPORTS]);
            if (direction == 0 || direction == 3)
            {
                PaintUtilPushTunnelRotated(session, direction, height, TunnelSquareFlat);
            }
    ...
    const TrackElement& trackElement)
{
    if (trackElement.IsInverted())
        return;
    bolliger_mabillard_track_flat_to_60_deg_up_long_base<MetalSupportsTubesInverted>(
        session, ride, trackSequence, direction, height, trackElement);
}
    ...
    const TrackElement& trackElement)
{
    if (trackElement.IsInverted())
        return;
    bolliger_mabillard_track_60_deg_up_to_flat_long_base<MetalSupportsTubesInverted>(
        session, ride, trackSequence, direction, height, trackElement);
}
...
TRACK_PAINT_FUNCTION get_track_paint_function_flying_rc(int32_t trackType)
{
    switch (trackType)
    {
        ...
        case TrackElemType::LeftFlyerLargeHalfLoopUninvertedUp:
            return bolliger_mabillard_track_left_large_half_loop_up<MetalSupportsTubesInverted>;
        case TrackElemType::RightFlyerLargeHalfLoopUninvertedUp:
            return bolliger_mabillard_track_right_large_half_loop_up<MetalSupportsTubesInverted>;
        case TrackElemType::RightFlyerLargeHalfLoopInvertedDown:
            return bolliger_mabillard_track_right_large_half_loop_down<MetalSupportsTubesInverted>;
        case TrackElemType::LeftFlyerLargeHalfLoopInvertedDown:
            return bolliger_mabillard_track_left_large_half_loop_down<MetalSupportsTubesInverted>;

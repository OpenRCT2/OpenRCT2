 ...
 */
static constexpr uint32_t InMaTriangleDiagBrakeImages[2][2][NumOrthogonalDirections] = {
    {
        // Open
        {
            // Background
    ...
    const TrackElement& trackElement)
{
    TrackPaintUtilDiagTilesPaint(
        ...
        InMaTriangleDiagBrakeImages[trackElement.IsBrakeClosed()][0], defaultDiagTileOffsets, defaultDiagBoundLengths, nullptr);

    TrackPaintUtilDiagTilesPaint(
        session, 3, height, direction, trackSequence, session.TrackColours[SCHEME_TRACK],
        InMaTriangleDiagBrakeImages[trackElement.IsBrakeClosed()][1], defaultDiagTileOffsets, defaultDiagBoundLengths,
...
TRACK_PAINT_FUNCTION GetTrackPaintFunctionInMaTriangleRC(int32_t trackType)
{
    switch (trackType)
    {

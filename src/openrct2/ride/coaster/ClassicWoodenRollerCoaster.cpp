    ...
    const TrackElement& trackElement)
{
    ...
    static constexpr const int blockedSegments[7] = {
        ...
        SegmentB4 | SegmentC8 | SegmentCC,
        SegmentB8 | SegmentC0 | SegmentC4 | SegmentC8 | SegmentD0 | SegmentD4,
        SegmentB4 | SegmentB8 | SegmentBC | SegmentC0 | SegmentC4 | SegmentC8 | SegmentCC | SegmentD0 | SegmentD4,
    };

    wooden_rc_track_paint_bb<true>(session, &imageIds[direction][trackSequence][0], height);
    wooden_rc_track_paint_bb<true>(session, &imageIds[direction][trackSequence][1], height);
    track_paint_util_right_quarter_turn_5_tiles_tunnel(session, height, direction, trackSequence, TunnelSquareFlat);
    ...
    const TrackElement& trackElement)
{
    ...
    static constexpr const int blockedSegments[4] = {
        SegmentB4 | SegmentB8 | SegmentBC | SegmentC0 | SegmentC4 | SegmentC8 | SegmentCC | SegmentD0 | SegmentD4,
        0,
        SegmentB8 | SegmentC4 | SegmentC8 | SegmentD0,
        SegmentB4 | SegmentB8 | SegmentBC | SegmentC4 | SegmentC8 | SegmentCC | SegmentD0 | SegmentD4,
    };

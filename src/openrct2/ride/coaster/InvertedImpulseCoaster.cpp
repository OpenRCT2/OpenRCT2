...
static void inverted_impulse_rc_track_25_deg_down(
    ...
    const TileElement* tileElement)
{
    inverted_impulse_rc_track_25_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void inverted_impulse_rc_track_60_deg_down(
    ...
    const TileElement* tileElement)
{
    inverted_impulse_rc_track_60_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void inverted_impulse_rc_track_flat_to_25_deg_down(
    ...
    const TileElement* tileElement)
{
    inverted_impulse_rc_track_25_deg_up_to_flat(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void inverted_impulse_rc_track_25_deg_down_to_60_deg_down(
    ...
    const TileElement* tileElement)
{
    inverted_impulse_rc_track_60_deg_up_to_25_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void inverted_impulse_rc_track_60_deg_down_to_25_deg_down(
    ...
    const TileElement* tileElement)
{
    inverted_impulse_rc_track_25_deg_up_to_60_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void inverted_impulse_rc_track_25_deg_down_to_flat(
    ...
    const TileElement* tileElement)
{
    inverted_impulse_rc_track_flat_to_25_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void inverted_impulse_rc_track_90_deg_down(
    ...
    const TileElement* tileElement)
{
    inverted_impulse_rc_track_90_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void inverted_impulse_rc_track_90_deg_down_to_60_deg_down(
    ...
    const TileElement* tileElement)
{
    inverted_impulse_rc_track_60_deg_up_to_90_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}

    ...
    const TrackElement& trackElement)
{
    ...
    {
        PaintUtilPushTunnelRotated(session, direction, height + 24, TunnelSquareFlat);
    }
    PaintUtilSetSegmentSupportHeight(session, PaintUtilRotateSegments(SegmentC4 | SegmentCC | SegmentD0, direction), 0xFFFF, 0);
    PaintUtilSetGeneralSupportHeight(session, height + 72, 0x20);
}
    ...
    const TrackElement& trackElement)
{
    switch (trackSequence)
    {
        ...
        case 2:
            ...
            {
                case 1:
                    PaintUtilPushTunnelRight(session, height - 32, TunnelSquareFlat);
                    break;
                case 2:
                    PaintUtilPushTunnelLeft(session, height - 32, TunnelSquareFlat);
                    break;
            }
            PaintUtilSetGeneralSupportHeight(session, height + 32, 0x20);
            break;
    ...
    const TrackElement& trackElement)
{
    switch (trackSequence)
    {
        ...
        case 2:
            ...
            {
                case 1:
                    PaintUtilPushTunnelRight(session, height - 16, TunnelSquareFlat);
                    break;
                case 2:
                    PaintUtilPushTunnelLeft(session, height - 16, TunnelSquareFlat);
                    break;
            }
            PaintUtilSetGeneralSupportHeight(session, height + 32, 0x20);
            break;

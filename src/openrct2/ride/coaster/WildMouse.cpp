...
static constexpr const uint32 _wild_mouse_brakes_image_ids[4] = {
...
static constexpr const uint32 _wild_mouse_block_brakes_image_ids[4] = {
                                     ...
                                     sint32 height, rct_tile_element * tileElement)
{
    ...
    {
        sub_98199C_rotated(session, direction,
                           _wild_mouse_block_brakes_image_ids[direction] | session->TrackColours[SCHEME_TRACK], 0, 0, 32, 20, 2,
                           height, 0, 0, height);
    }
    else
    {
        sub_98199C_rotated(session, direction, _wild_mouse_brakes_image_ids[direction] | session->TrackColours[SCHEME_TRACK], 0,
                                                    ...
                                                    uint8 direction, sint32 height, rct_tile_element * tileElement)
{
    ...
    static constexpr const uint32 frontImageIds[4][2] = {
        { 0, 0 },
                                                              ...
                                                              uint8 direction, sint32 height, rct_tile_element * tileElement)
{
    ...
    static constexpr const sint16 generalSupportHeights[] = { 72, 56, 56, 72 };
                                                            ...
                                                            uint8 direction, sint32 height, rct_tile_element * tileElement)
{
    ...
    case 3:
        if (direction == 2)
        {
            metal_a_supports_paint_setup(session, METAL_SUPPORTS_TUBES, 4, -11, height, session->TrackColours[SCHEME_SUPPORTS]);
        }
        else
        {
            metal_a_supports_paint_setup(session, METAL_SUPPORTS_TUBES, 4, -9, height, session->TrackColours[SCHEME_SUPPORTS]);

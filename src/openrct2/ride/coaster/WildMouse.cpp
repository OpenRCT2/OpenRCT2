    ...
    const TrackElement& trackElement)
{
    ...
    {
        case 0:
            blockedSegments = kSegmentRightCorner | kSegmentCentre | kSegmentTopRightSide | kSegmentBottomLeftSide;
            break;
        case 2:
            blockedSegments = kSegmentBottomCorner | kSegmentCentre | kSegmentBottomLeftSide | kSegmentBottomRightSide;
            break;
        case 3:
            blockedSegments = kSegmentLeftCorner | kSegmentCentre | kSegmentTopLeftSide | kSegmentBottomRightSide;
            break;
    }

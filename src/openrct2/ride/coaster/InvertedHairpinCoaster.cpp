        ...
        switch (direction)
        {
            case 0:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17030,
                    0,
                    0,
                    32,
                    20,
            ...
            case 1:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17031,
                    0,
                    0,
                    32,
                    20,
            ...
            case 2:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17032,
                    0,
                    0,
                    32,
                    20,
            ...
            case 3:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17033,
                    0,
                    0,
                    32,
                    20,
        ...
        switch (direction)
        {
            ...
            case 2:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17026,
                    0,
                    0,
                    32,
                    20,
            ...
            case 3:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17027,
                    0,
                    0,
                    32,
                    20,
        ...
        switch (direction)
        {
            case 0:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17070,
                    0,
                    0,
                    32,
                    20,
            ...
            case 1:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17071,
                    0,
                    0,
                    32,
                    20,
            ...
            case 2:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17072,
                    0,
                    0,
                    32,
                    20,
            ...
            case 3:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17073,
                    0,
                    0,
                    32,
                    20,
        ...
        switch (direction)
        {
            case 0:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17042,
                    0,
                    0,
                    32,
                    20,
            ...
            case 1:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17043,
                    0,
                    0,
                    32,
                    20,
            ...
            case 2:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17044,
                    0,
                    0,
                    32,
                    20,
            ...
            case 3:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17045,
                    0,
                    0,
                    32,
                    20,
        ...
        switch (direction)
        {
            case 0:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17086,
                    0,
                    0,
                    32,
                    20,
            ...
            case 1:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17087,
                    0,
                    0,
                    32,
                    2,
            ...
            case 2:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17088,
                    0,
                    0,
                    32,
                    2,
            ...
            case 3:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17089,
                    0,
                    0,
                    32,
                    20,
        ...
        switch (direction)
        {
            case 0:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17058,
                    0,
                    0,
                    32,
                    20,
            ...
            case 1:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17059,
                    0,
                    0,
                    32,
                    2,
            ...
            case 2:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17060,
                    0,
                    0,
                    32,
                    2,
            ...
            case 3:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17061,
                    0,
                    0,
                    32,
                    20,
        ...
        switch (direction)
        {
            case 0:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17062,
                    0,
                    0,
                    32,
                    20,
            ...
            case 1:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17063,
                    0,
                    0,
                    32,
                    20,
            ...
            case 2:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17064,
                    0,
                    0,
                    32,
                    20,
            ...
            case 3:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17065,
                    0,
                    0,
                    32,
                    20,
        ...
        switch (direction)
        {
            case 0:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17034,
                    0,
                    0,
                    32,
                    20,
            ...
            case 1:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17035,
                    0,
                    0,
                    32,
                    20,
            ...
            case 2:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17036,
                    0,
                    0,
                    32,
                    20,
            ...
            case 3:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17037,
                    0,
                    0,
                    32,
                    20,
        ...
        switch (direction)
        {
            case 0:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17074,
                    0,
                    0,
                    32,
                    20,
            ...
            case 1:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17078,
                    0,
                    0,
                    32,
                    10,
                ...
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17075,
                    0,
                    0,
                    32,
                    2,
            ...
            case 2:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17079,
                    0,
                    0,
                    32,
                    10,
                ...
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17076,
                    0,
                    0,
                    32,
                    2,
            ...
            case 3:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17077,
                    0,
                    0,
                    32,
                    20,
        ...
        switch (direction)
        {
            case 0:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17046,
                    0,
                    0,
                    32,
                    20,
            ...
            case 1:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17050,
                    0,
                    0,
                    32,
                    10,
                ...
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17047,
                    0,
                    0,
                    32,
                    2,
            ...
            case 2:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17051,
                    0,
                    0,
                    32,
                    10,
                ...
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17048,
                    0,
                    0,
                    32,
                    2,
            ...
            case 3:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17049,
                    0,
                    0,
                    32,
                    20,
        ...
        switch (direction)
        {
            case 0:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17080,
                    0,
                    0,
                    32,
                    20,
            ...
            case 1:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17084,
                    0,
                    0,
                    32,
                    10,
                ...
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17081,
                    0,
                    0,
                    32,
                    2,
            ...
            case 2:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17085,
                    0,
                    0,
                    32,
                    10,
                ...
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17082,
                    0,
                    0,
                    32,
                    2,
            ...
            case 3:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17083,
                    0,
                    0,
                    32,
                    20,
        ...
        switch (direction)
        {
            case 0:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17052,
                    0,
                    0,
                    32,
                    20,
            ...
            case 1:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17056,
                    0,
                    0,
                    32,
                    10,
                ...
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17053,
                    0,
                    0,
                    32,
                    2,
            ...
            case 2:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17057,
                    0,
                    0,
                    32,
                    10,
                ...
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17054,
                    0,
                    0,
                    32,
                    2,
            ...
            case 3:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17055,
                    0,
                    0,
                    32,
                    20,
        ...
        switch (direction)
        {
            case 0:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17066,
                    0,
                    0,
                    32,
                    20,
            ...
            case 1:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17067,
                    0,
                    0,
                    32,
                    20,
            ...
            case 2:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17068,
                    0,
                    0,
                    32,
                    20,
            ...
            case 3:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17069,
                    0,
                    0,
                    32,
                    20,
        ...
        switch (direction)
        {
            case 0:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17038,
                    0,
                    0,
                    32,
                    20,
            ...
            case 1:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17039,
                    0,
                    0,
                    32,
                    20,
            ...
            case 2:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17040,
                    0,
                    0,
                    32,
                    20,
            ...
            case 3:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17041,
                    0,
                    0,
                    32,
                    20,
            ...
            switch (direction)
            {
                case 0:
                    sub_98197C_rotated(
                        session,
                        direction,
                        session->TrackColours[SCHEME_TRACK] | 17123,
                        0,
                        0,
                        32,
                        20,
                ...
                case 1:
                    sub_98197C_rotated(
                        session,
                        direction,
                        session->TrackColours[SCHEME_TRACK] | 17126,
                        0,
                        0,
                        32,
                        20,
                ...
                case 2:
                    sub_98197C_rotated(
                        session,
                        direction,
                        session->TrackColours[SCHEME_TRACK] | 17129,
                        0,
                        0,
                        32,
                        20,
                ...
                case 3:
                    sub_98197C_rotated(
                        session,
                        direction,
                        session->TrackColours[SCHEME_TRACK] | 17120,
                        0,
                        0,
                        32,
                        20,
            ...
            switch (direction)
            {
                case 0:
                    sub_98197C_rotated(
                        session,
                        direction,
                        session->TrackColours[SCHEME_TRACK] | 17122,
                        0,
                        0,
                        16,
                        16,
                ...
                case 1:
                    sub_98197C_rotated(
                        session,
                        direction,
                        session->TrackColours[SCHEME_TRACK] | 17125,
                        0,
                        0,
                        16,
                        16,
                ...
                case 2:
                    sub_98197C_rotated(
                        session,
                        direction,
                        session->TrackColours[SCHEME_TRACK] | 17128,
                        0,
                        0,
                        16,
                        16,
                ...
                case 3:
                    sub_98197C_rotated(
                        session,
                        direction,
                        session->TrackColours[SCHEME_TRACK] | 17119,
                        0,
                        0,
                        16,
                        16,
            ...
            switch (direction)
            {
                case 0:
                    sub_98197C_rotated(
                        session,
                        direction,
                        session->TrackColours[SCHEME_TRACK] | 17121,
                        0,
                        0,
                        20,
                        32,
                ...
                case 1:
                    sub_98197C_rotated(
                        session,
                        direction,
                        session->TrackColours[SCHEME_TRACK] | 17124,
                        0,
                        0,
                        20,
                        32,
                ...
                case 2:
                    sub_98197C_rotated(
                        session,
                        direction,
                        session->TrackColours[SCHEME_TRACK] | 17127,
                        0,
                        0,
                        20,
                        32,
                ...
                case 3:
                    sub_98197C_rotated(
                        session,
                        direction,
                        session->TrackColours[SCHEME_TRACK] | 17118,
                        0,
                        0,
                        20,
                        32,
    ...
    switch (direction)
    {
        case 0:
            sub_98197C_rotated(
                session,
                direction,
                session->TrackColours[SCHEME_TRACK] | 17114,
                0,
                0,
                26,
                24,
        ...
        case 1:
            sub_98197C_rotated(
                session,
                direction,
                session->TrackColours[SCHEME_TRACK] | 17115,
                0,
                0,
                26,
                26,
        ...
        case 2:
            sub_98197C_rotated(
                session,
                direction,
                session->TrackColours[SCHEME_TRACK] | 17116,
                0,
                0,
                24,
                26,
        ...
        case 3:
            sub_98197C_rotated(
                session,
                direction,
                session->TrackColours[SCHEME_TRACK] | 17117,
                0,
                0,
                24,
                24,
        ...
        switch (direction)
        {
            case 0:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17102,
                    0,
                    0,
                    30,
                    20,
            ...
            case 1:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17106,
                    0,
                    0,
                    32,
                    10,
                ...
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17103,
                    0,
                    0,
                    32,
                    2,
            ...
            case 2:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17107,
                    0,
                    0,
                    32,
                    10,
                ...
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17104,
                    0,
                    0,
                    32,
                    2,
            ...
            case 3:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17105,
                    0,
                    0,
                    30,
                    20,
        ...
        switch (direction)
        {
            case 0:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17090,
                    0,
                    0,
                    30,
                    20,
            ...
            case 1:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17094,
                    0,
                    0,
                    32,
                    10,
                ...
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17091,
                    0,
                    0,
                    32,
                    2,
            ...
            case 2:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17095,
                    0,
                    0,
                    32,
                    10,
                ...
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17092,
                    0,
                    0,
                    32,
                    2,
            ...
            case 3:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17093,
                    0,
                    0,
                    30,
                    20,
        ...
        switch (direction)
        {
            case 0:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17108,
                    0,
                    0,
                    30,
                    20,
            ...
            case 1:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17112,
                    0,
                    0,
                    32,
                    10,
                ...
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17109,
                    0,
                    0,
                    32,
                    2,
            ...
            case 2:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17113,
                    0,
                    0,
                    32,
                    10,
                ...
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17110,
                    0,
                    0,
                    32,
                    2,
            ...
            case 3:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17111,
                    0,
                    0,
                    30,
                    20,
        ...
        switch (direction)
        {
            case 0:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17096,
                    0,
                    0,
                    30,
                    20,
            ...
            case 1:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17100,
                    0,
                    0,
                    32,
                    10,
                ...
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17097,
                    0,
                    0,
                    32,
                    2,
            ...
            case 2:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17101,
                    0,
                    0,
                    32,
                    10,
                ...
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17098,
                    0,
                    0,
                    32,
                    2,
            ...
            case 3:
                sub_98197C_rotated(
                    session,
                    direction,
                    session->TrackColours[SCHEME_TRACK] | 17099,
                    0,
                    0,
                    30,
                    20,
    ...
    switch (direction)
    {
        ...
        case 2:
            sub_98197C_rotated(
                session,
                direction,
                session->TrackColours[SCHEME_TRACK] | 17028,
                0,
                0,
                32,
                20,
        ...
        case 3:
            sub_98197C_rotated(
                session,
                direction,
                session->TrackColours[SCHEME_TRACK] | 17029,
                0,
                0,
                32,
                20,

...
static void inverted_hairpin_rc_track_25_deg_down(
    ...
    const TileElement* tileElement)
{
    inverted_hairpin_rc_track_25_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void inverted_hairpin_rc_track_60_deg_down(
    ...
    const TileElement* tileElement)
{
    inverted_hairpin_rc_track_60_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void inverted_hairpin_rc_track_flat_to_25_deg_down(
    ...
    const TileElement* tileElement)
{
    inverted_hairpin_rc_track_25_deg_up_to_flat(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void inverted_hairpin_rc_track_25_deg_down_to_60_deg_down(
    ...
    const TileElement* tileElement)
{
    inverted_hairpin_rc_track_60_deg_up_to_25_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void inverted_hairpin_rc_track_60_deg_down_to_25_deg_down(
    ...
    const TileElement* tileElement)
{
    inverted_hairpin_rc_track_25_deg_up_to_60_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void inverted_hairpin_rc_track_25_deg_down_to_flat(
    ...
    const TileElement* tileElement)
{
    inverted_hairpin_rc_track_flat_to_25_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
    ...
    const TileElement* tileElement)
{
    ...
    inverted_hairpin_rc_track_left_quarter_turn_3(session, ride, trackSequence, (direction - 1) & 3, height, tileElement);
}
...
static void inverted_hairpin_rc_track_right_quarter_turn_1(
    ...
    const TileElement* tileElement)
{
    inverted_hairpin_rc_track_left_quarter_turn_1(session, ride, trackSequence, (direction - 1) & 3, height, tileElement);
}
...
static void inverted_hairpin_rc_track_flat_to_60_deg_down(
    ...
    const TileElement* tileElement)
{
    inverted_hairpin_rc_track_60_deg_up_to_flat(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}
...
static void inverted_hairpin_rc_track_60_deg_down_to_flat(
    ...
    const TileElement* tileElement)
{
    inverted_hairpin_rc_track_flat_to_60_deg_up(session, ride, trackSequence, (direction + 2) & 3, height, tileElement);
}

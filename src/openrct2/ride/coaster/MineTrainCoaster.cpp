    ...
    const TrackElement& trackElement)
{
    switch (trackSequence)
    {
        case 0:
            ...
            PaintUtilSetSegmentSupportHeight(
                session, PaintUtilRotateSegments(SegmentB8 | SegmentBC | SegmentC0 | SegmentD4, direction), 48, 0x20);
            PaintUtilSetSegmentSupportHeight(
        ...
        case 3:
            ...
            PaintUtilSetSegmentSupportHeight(
                session, PaintUtilRotateSegments(SegmentB4 | SegmentB8 | SegmentBC | SegmentCC, direction), 48, 0x20);
            PaintUtilSetSegmentSupportHeight(
        ...
        case 4:
            ...
            PaintUtilSetSegmentSupportHeight(
                session, PaintUtilRotateSegments(SegmentB4 | SegmentBC | SegmentC0 | SegmentCC, direction), 48, 0x20);
            PaintUtilSetSegmentSupportHeight(
        ...
        case 7:
            ...
            PaintUtilSetSegmentSupportHeight(
                session, PaintUtilRotateSegments(SegmentB4 | SegmentB8 | SegmentC0 | SegmentC8, direction), 48, 0x20);
            PaintUtilSetSegmentSupportHeight(
    ...
    const TrackElement& trackElement)
{
    switch (trackSequence)
    {
        ...
        case 1:
            PaintUtilSetSegmentSupportHeight(
                session, PaintUtilRotateSegments(SegmentBC | SegmentCC | SegmentD4, direction), 48, 0x20);
            PaintUtilSetGeneralSupportHeight(session, height + 32, 0x20);
            break;
        case 2:
            switch (direction)
        ...
        case 3:
            ...
            PaintUtilSetSegmentSupportHeight(
                session, PaintUtilRotateSegments(SegmentB4 | SegmentC0 | SegmentC8 | SegmentD0, direction), 48, 0x20);
            PaintUtilSetSegmentSupportHeight(
        ...
        case 8:
            PaintUtilSetSegmentSupportHeight(
                session, PaintUtilRotateSegments(SegmentB4 | SegmentC8 | SegmentCC, direction), 48, 0x20);
            PaintUtilSetGeneralSupportHeight(session, height + 32, 0x20);
            break;
        case 9:
            switch (direction)
        ...
        case 10:
            ...
            PaintUtilSetSegmentSupportHeight(
                session, PaintUtilRotateSegments(SegmentB8 | SegmentBC | SegmentD0 | SegmentD4, direction), 48, 0x20);
            PaintUtilSetSegmentSupportHeight(

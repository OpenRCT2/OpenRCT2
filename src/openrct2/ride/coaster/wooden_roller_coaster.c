...
static paint_struct * wooden_rc_track_paint(uint32 imageIdTrack, uint32 imageIdRails, uint8 direction, sint8 x_offset,
                                            ...
                                            sint16 bound_box_offset_y, sint16 bound_box_offset_z)
{
    ...
    return sub_98199C_rotated(direction, railsImageId, x_offset, y_offset, bound_box_length_x, bound_box_length_y,
                                      ...
                                      rct_map_element * mapElement)
{
    ...
    {
        gWoodenSupportsPrependTo = wooden_rc_track_paint(imageIds[direction][0], imageIds[direction][1], direction, 0, 0, 2, 24,
                                                         93, height, 28, 4, height - 16);
    }
                                                   ...
                                                   rct_map_element * mapElement)
{
    ...
    {
        gWoodenSupportsPrependTo = wooden_rc_track_paint(imageIds[direction][0], imageIds[direction][1], direction, 0, 0, 24, 1,
                                                         61, height, 4, 28, height - 16);
        wooden_rc_track_paint(imageIds[direction][2], imageIds[direction][3], direction, 0, 0, 32, 2, 43, height, 0, 4, height);
    }

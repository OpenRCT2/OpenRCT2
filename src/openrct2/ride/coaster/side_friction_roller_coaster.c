...
/** rct2: 0x0077839C */
static void side_friction_rc_track_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
...
static void side_friction_rc_track_station(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                           rct_map_element * mapElement)
{
    static const uint32 imageIds[4] = {
        21610, 21611, 21610, 21611,
    };
...
/** rct2: 0x007783AC */
static void side_friction_rc_track_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                             rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
...
/** rct2: 0x007783CC */
static void side_friction_rc_track_flat_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
...
/** rct2: 0x007783FC */
static void side_friction_rc_track_25_deg_up_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
...
/** rct2: 0x0077840C */
static void side_friction_rc_track_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                               rct_map_element * mapElement)
{
...
/** rct2: 0x0077842C */
static void side_friction_rc_track_flat_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
...
/** rct2: 0x0077845C */
static void side_friction_rc_track_25_deg_down_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
...
/** rct2: 0x0077846C */
static void side_friction_rc_track_left_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
...
/** rct2: 0x0077847C */
static void side_friction_rc_track_right_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
...
/** rct2: 0x0077848C */
static void side_friction_rc_track_s_bend_left(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                               rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x0077849C */
static void side_friction_rc_track_s_bend_right(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x007784DC */
static void side_friction_rc_track_left_quarter_turn_3(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x007784EC */
static void side_friction_rc_track_right_quarter_turn_3(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
...
/** rct2: 0x007784FC */
static void side_friction_rc_track_brakes(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                          rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x007785DC */
static void side_friction_rc_track_left_eighth_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x007785EC */
static void side_friction_rc_track_right_eighth_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                        rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x007785FC */
static void side_friction_rc_track_left_eighth_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
...
/** rct2: 0x0077860C */
static void side_friction_rc_track_right_eighth_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                              rct_map_element * mapElement)
{
    trackSequence = mapLeftEighthTurnToOrthogonal[trackSequence];
...
/** rct2: 0x0077850C */
static void side_friction_rc_track_diag_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                             rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21849, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
        else
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21825, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
    ...
    case 1:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21846, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21850, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 27);
                wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 1:
        ...
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21822, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21826, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 27);
                wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 1:
    ...
    case 2:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            case 1:
                ...
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21848, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21851, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 27);
                wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 3:
        ...
        else
        {
            ...
            case 1:
                ...
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21824, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21827, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 27);
                wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 3:
    ...
    case 3:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21847, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
        else
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21823, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
...
/** rct2: 0x0077853C */
static void side_friction_rc_track_diag_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21867, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
        else
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21843, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
    ...
    case 1:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21864, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21868, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 43);
        ...
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21840, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21844, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 43);
                wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 1:
    ...
    case 2:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            case 1:
                ...
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21866, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21869, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 43);
                wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 3:
        ...
        else
        {
            ...
            case 1:
                ...
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21842, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21845, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 43);
                wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 3:
    ...
    case 3:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21865, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
        else
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21841, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
...
/** rct2: 0x0077851C */
static void side_friction_rc_track_diag_flat_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21855, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
        else
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21831, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
    ...
    case 1:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21852, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21856, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 1:
        ...
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21828, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21832, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 1:
    ...
    case 2:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            case 1:
                ...
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21854, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21857, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 3:
        ...
        else
        {
            ...
            case 1:
                ...
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21830, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21833, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                wooden_a_supports_paint_setup(2, 0, height, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 3:
    ...
    case 3:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21853, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
        else
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21829, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
...
/** rct2: 0x0077852C */
static void side_friction_rc_track_diag_25_deg_up_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21861, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
        else
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21837, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
    ...
    case 1:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21858, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21862, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 1:
        ...
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21834, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21838, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 1:
    ...
    case 2:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            case 1:
                ...
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21860, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21863, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 3:
        ...
        else
        {
            ...
            case 1:
                ...
                break;
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21836, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21839, -16, -16, 32, 32, 0, height, -16, -16,
                                   height + 35);
                wooden_b_supports_paint_setup(2, 0, height + 16, gTrackColours[SCHEME_SUPPORTS], NULL);
                break;
            case 3:
    ...
    case 3:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21859, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
        else
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 21835, -16, -16, 32, 32, 2, height, -16, -16,
                                   height);
                break;
            }
        }
...
/** rct2: 0x0077859C */
static void side_friction_rc_track_diag_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                    rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x0077857C */
static void side_friction_rc_track_diag_flat_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x0077858C */
static void side_friction_rc_track_diag_25_deg_down_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    switch (trackSequence)
    {

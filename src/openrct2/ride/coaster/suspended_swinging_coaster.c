...
/** rct2: 0x008A8958 */
static void suspended_swinging_rc_track_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
...
static void suspended_swinging_rc_track_station(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                rct_map_element * mapElement)
{
...
/** rct2: 0x008A8968 */
static void suspended_swinging_rc_track_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
    ...
    if (track_paint_util_should_paint_supports(gPaintMapPosition))
    {
        ...
        case 0:
            ...
            break;
        case 1:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 8, 0, height + 62, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 7, 0, height + 62, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 5, 0, height + 62, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
    }
...
/** rct2: 0x008A8978 */
static void suspended_swinging_rc_track_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A8988 */
static void suspended_swinging_rc_track_flat_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
    ...
    if (track_paint_util_should_paint_supports(gPaintMapPosition))
    {
        ...
        case 0:
            ...
            break;
        case 1:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 8, 0, height + 54, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 7, 0, height + 54, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 5, 0, height + 54, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
    }
...
/** rct2: 0x008A8998 */
static void suspended_swinging_rc_track_25_deg_up_to_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
...
/** rct2: 0x008A89A8 */
static void suspended_swinging_rc_track_60_deg_up_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 25987, 0, 0, 32, 10, 49, height + 29, 0, 10,
                               height + 11);
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26090, 0, 0, 32, 2, 49, height + 29, 0, 4, height + 11);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 25988, 0, 0, 32, 10, 49, height + 29, 0, 10,
                               height + 11);
    ...
    if (track_paint_util_should_paint_supports(gPaintMapPosition))
    {
        ...
        case 0:
            ...
            break;
        case 1:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 8, 0, height + 76, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 7, 0, height + 76, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 5, 0, height + 76, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
    }
...
/** rct2: 0x008A89B8 */
static void suspended_swinging_rc_track_25_deg_up_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                          rct_map_element * mapElement)
{
    if (track_element_is_lift_hill(mapElement))
    {
    ...
    if (track_paint_util_should_paint_supports(gPaintMapPosition))
    {
        ...
        case 0:
            ...
            break;
        case 1:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 8, 0, height + 52, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 7, 0, height + 52, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 5, 0, height + 52, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
    }
...
/** rct2: 0x008A89C8 */
static void suspended_swinging_rc_track_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                    rct_map_element * mapElement)
{
...
/** rct2: 0x008A89D8 */
static void suspended_swinging_rc_track_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                    rct_map_element * mapElement)
{
...
/** rct2: 0x008A89E8 */
static void suspended_swinging_rc_track_flat_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
...
/** rct2: 0x008A89F8 */
static void suspended_swinging_rc_track_25_deg_down_to_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                   int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008A8A08 */
static void suspended_swinging_rc_track_60_deg_down_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                   int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008A8A18 */
static void suspended_swinging_rc_track_25_deg_down_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
...
/** rct2: 0x008A8A28 */
static void suspended_swinging_rc_track_left_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    ...
    case 2:
        ...
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26023, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26008, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26012, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26017, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26022, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 3:
    ...
    case 5:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26011, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 1:
        ...
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26006, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008A8A38 */
static void suspended_swinging_rc_track_right_quarter_turn_5(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
...
/** rct2: 0x008A8A48 */
static void suspended_swinging_rc_track_left_quarter_turn_5_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                      int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_C4 | SEGMENT_CC | SEGMENT_D0 | SEGMENT_D4, direction), 0xFFFF, 0);
        metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 4, 0, height + 54, gTrackColours[SCHEME_SUPPORTS]);
    ...
    case 5:
        ...
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26115, 16, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 37);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008A8A58 */
static void suspended_swinging_rc_track_right_quarter_turn_5_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                       int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 5:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26080, 16, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 37);
            break;
        case 1:
...
/** rct2: 0x008A8A68 */
static void suspended_swinging_rc_track_left_quarter_turn_5_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                        int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn5TilesToRightQuarterTurn5Tiles[trackSequence];
    suspended_swinging_rc_track_right_quarter_turn_5_25_deg_up(rideIndex, trackSequence, (direction + 1) & 3, height,
                                                               mapElement);
}

/** rct2: 0x008A8A78 */
static void suspended_swinging_rc_track_right_quarter_turn_5_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                         int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn5TilesToRightQuarterTurn5Tiles[trackSequence];
    suspended_swinging_rc_track_left_quarter_turn_5_25_deg_up(rideIndex, trackSequence, (direction - 1) & 3, height,
                                                              mapElement);
}

/** rct2: 0x008A8A88 */
static void suspended_swinging_rc_track_s_bend_left(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                    rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        {
        case 0:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 5, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 6, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008A8A98 */
static void suspended_swinging_rc_track_s_bend_right(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        {
        case 0:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 8, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 7, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008A8AD8 */
static void suspended_swinging_rc_track_left_quarter_turn_3(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26069, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26075, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26066, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008A8AE8 */
static void suspended_swinging_rc_track_right_quarter_turn_3(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
...
/** rct2: 0x008A8AF8 */
static void suspended_swinging_rc_track_left_quarter_turn_3_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                      int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A8B08 */
static void suspended_swinging_rc_track_right_quarter_turn_3_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                       int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A8B18 */
static void suspended_swinging_rc_track_left_quarter_turn_3_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                        int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
    suspended_swinging_rc_track_right_quarter_turn_3_25_deg_up(rideIndex, trackSequence, (direction + 1) & 3, height,
                                                               mapElement);
}

/** rct2: 0x008A8B28 */
static void suspended_swinging_rc_track_right_quarter_turn_3_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                         int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
    suspended_swinging_rc_track_left_quarter_turn_3_25_deg_up(rideIndex, trackSequence, (direction - 1) & 3, height,
                                                              mapElement);
}

/** rct2: 0x008A8B38 */
static void suspended_swinging_rc_track_brakes(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                               rct_map_element * mapElement)
{
    switch (direction)
    {
...
/** rct2: 0x008A8B48 */
static void suspended_swinging_rc_track_left_quarter_helix_large_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                    int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_B4 | SEGMENT_C4 | SEGMENT_CC | SEGMENT_D0 | SEGMENT_D4, direction), 0xFFFF, 0);
        metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 4, 0, height + 46, gTrackColours[SCHEME_SUPPORTS]);
    ...
    case 2:
        ...
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26063, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26048, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26052, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26057, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 43);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26062, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 3:
    ...
    case 5:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26051, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 1:
        ...
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26046, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 6:
        ...
        paint_util_set_segment_support_height(
            paint_util_rotate_segments(SEGMENT_C0 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_CC | SEGMENT_D4, direction), 0xFFFF, 0);
        metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 4, 0, height + 58, gTrackColours[SCHEME_SUPPORTS]);
...
/** rct2: 0x008A8B58 */
static void suspended_swinging_rc_track_right_quarter_helix_large_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                     int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26026, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26031, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 2:
    ...
    case 3:
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26032, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26037, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 43);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26042, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 5:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26028, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 1:
        ...
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26043, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008A8B68 */
static void suspended_swinging_rc_track_left_quarter_helix_large_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                      int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 2:
        ...
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26043, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26028, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26032, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26037, 0, 0, 16, 16, 3, height + 29, 16, 16,
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26042, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26027, 0, 0, 16, 16, 3, height + 29, 0, 0, height + 43);
    ...
    case 5:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26031, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 1:
        ...
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26026, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008A8B78 */
static void suspended_swinging_rc_track_right_quarter_helix_large_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                       int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26046, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26051, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        case 2:
    ...
    case 3:
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26052, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26057, 0, 0, 16, 16, 3, height + 29, 16, 16,
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26062, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 5:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26048, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        case 1:
        ...
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26063, 0, 0, 16, 32, 3, height + 29, 16, 0,
                               height + 43);
            break;
        }
        paint_util_set_segment_support_height(
...
/** rct2: 0x008A8B88 */
static void suspended_swinging_rc_track_left_eighth_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                            rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26176, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26180, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26169, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26173, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26177, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 3:
    ...
    case 4:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26170, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26174, 0, 0, 16, 18, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26182, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        }
        ...
        {
        case 0:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 3, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 1, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 0, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 2, 0, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008A8B98 */
static void suspended_swinging_rc_track_right_eighth_to_diag(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                             rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26152, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26156, 0, 0, 32, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 2:
    ...
    case 2:
        ...
        case 0:
            ...
            break;
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26157, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 2:
            ...
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26165, 0, 0, 16, 16, 3, height + 29, 0, 16,
                               height + 29);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 4:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26154, 0, 0, 16, 16, 3, height + 29, 16, 0,
                               height + 29);
            break;
        case 1:
            ...
            break;
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26162, 0, 0, 16, 18, 3, height + 29, 0, 16,
                               height + 29);
            break;
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26166, 0, 0, 16, 16, 3, height + 29, 16, 16,
                               height + 29);
            break;
        }
...
/** rct2: 0x008A8BA8 */
static void suspended_swinging_rc_track_left_eighth_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                  int height, rct_map_element * mapElement)
{
...
/** rct2: 0x008A8BB8 */
static void suspended_swinging_rc_track_right_eighth_to_orthogonal(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                   int height, rct_map_element * mapElement)
{
    trackSequence = mapLeftEighthTurnToOrthogonal[trackSequence];
...
/** rct2: 0x008A8BC8 */
static void suspended_swinging_rc_track_diag_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                  rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26214, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
        else
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26186, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
    ...
    case 1:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26211, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26183, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
    ...
    case 2:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26213, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
        else
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26185, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
    ...
    case 3:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26212, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
        else
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26184, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 29);
                break;
            }
        }
...
/** rct2: 0x008A8BF8 */
static void suspended_swinging_rc_track_diag_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26226, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
        else
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26198, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
    ...
    case 1:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26223, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26195, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
    ...
    case 2:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26225, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
        else
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26197, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
    ...
    case 3:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26224, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
        else
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26196, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 45);
                break;
            }
        }
        ...
        {
        case 0:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 1, 0, height + 56, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 0, 0, height + 56, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 2, 0, height + 56, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 3, 0, height + 56, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008A8C58 */
static void suspended_swinging_rc_track_diag_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                       rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26210, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 93);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26207, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 93);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26209, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 93);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26208, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 29);
            break;
        }
        ...
        {
        case 0:
            metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES, 1, 32, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES, 0, 36, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES, 2, 32, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES, 3, 36, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008A8BD8 */
static void suspended_swinging_rc_track_diag_flat_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26218, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26190, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
    ...
    case 1:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26215, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26187, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
    ...
    case 2:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26217, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26189, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
    ...
    case 3:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26216, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26188, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        ...
        {
        case 0:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 1, 0, height + 48, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 0, 0, height + 48, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 2, 0, height + 48, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 3, 0, height + 48, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008A8C38 */
static void suspended_swinging_rc_track_diag_25_deg_up_to_60_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                    int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26202, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 61);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26199, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 61);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26201, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 61);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26200, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 61);
            break;
        }
        ...
        {
        case 0:
            metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES, 1, 16, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES, 0, 16, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES, 2, 16, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES, 3, 16, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008A8C48 */
static void suspended_swinging_rc_track_diag_60_deg_up_to_25_deg_up(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                    int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        ...
        {
        case 3:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26206, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 61);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 1:
        ...
        {
        case 0:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26203, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 61);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 2:
        ...
        {
        case 2:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26205, -16, -16, 32, 32, 3, height + 29, -16, -16,
                               height + 61);
            break;
        }
        paint_util_set_segment_support_height(
    ...
    case 3:
        ...
        {
        case 1:
            sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26204, -16, -16, 16, 16, 3, height + 29, 0, 0,
                               height + 61);
            break;
        }
        ...
        {
        case 0:
            metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES, 1, 21, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES, 0, 21, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES, 2, 21, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES, 3, 21, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008A8BE8 */
static void suspended_swinging_rc_track_diag_25_deg_up_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                               int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    case 0:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26222, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 3:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26194, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
    ...
    case 1:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26219, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 0:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26191, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
    ...
    case 2:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26221, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 2:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26193, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
    ...
    case 3:
        if (track_element_is_lift_hill(mapElement))
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26220, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        else
        {
            ...
            {
            case 1:
                sub_98197C_rotated(direction, gTrackColours[SCHEME_TRACK] | 26192, -16, -16, 32, 32, 3, height + 29, -16, -16,
                                   height + 37);
                break;
            }
        }
        ...
        {
        case 0:
            metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES, 1, 0, height + 50, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 0, 0, height + 50, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 2, 0, height + 50, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 3, 0, height + 50, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008A8C28 */
static void suspended_swinging_rc_track_diag_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A8C88 */
static void suspended_swinging_rc_track_diag_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                         rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A8C08 */
static void suspended_swinging_rc_track_diag_flat_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                 int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 3:
        ...
        {
        case 0:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 1, 0, height + 50, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_a_supports_paint_setup(METAL_SUPPORTS_TUBES, 0, 0, height + 50, gTrackColours[SCHEME_SUPPORTS]);
            break;
...
/** rct2: 0x008A8C68 */
static void suspended_swinging_rc_track_diag_25_deg_down_to_60_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                        int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 3:
        ...
        {
        case 0:
            metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES, 1, 17, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES, 0, 17, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES, 2, 17, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES, 3, 17, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008A8C78 */
static void suspended_swinging_rc_track_diag_60_deg_down_to_25_deg_down(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                        int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
    ...
    case 3:
        ...
        {
        case 0:
            metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES, 1, 8, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 1:
            metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES, 0, 8, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 2:
            metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES, 2, 8, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        case 3:
            metal_b_supports_paint_setup(METAL_SUPPORTS_TUBES, 3, 8, height + 44, gTrackColours[SCHEME_SUPPORTS]);
            break;
        }
...
/** rct2: 0x008A8C18 */
static void suspended_swinging_rc_track_diag_25_deg_down_to_flat(uint8 rideIndex, uint8 trackSequence, uint8 direction,
                                                                 int height, rct_map_element * mapElement)
{
    switch (trackSequence)
    {
...
/** rct2: 0x008A8B38 */
static void suspended_swinging_rc_track_block_brakes(uint8 rideIndex, uint8 trackSequence, uint8 direction, int height,
                                                     rct_map_element * mapElement)
{
    switch (direction)
    {

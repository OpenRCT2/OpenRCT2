            ...
            else
            {
                switch (direction)
                {
                    ...
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_FLAT + 0)), { 0, 0, height },
                            { 32, 20, 3 }, { 0, 6, height });
                        break;
                    case 1:
                    case 3:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_FLAT + 1)), { 0, 0, height },
                            { 32, 20, 3 }, { 0, 6, height });
                        break;
                }
                if (TrackPaintUtilShouldPaintSupports(session.MapPosition))
            ...
            else
            {
                switch (direction)
                {
                    case 0:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_GENTLE + 8)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        break;
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_GENTLE + 9)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_GENTLE + 10)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        break;
                    case 3:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_GENTLE + 11)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        break;
                }
                if (TrackPaintUtilShouldPaintSupports(session.MapPosition))
            ...
            else
            {
                switch (direction)
                {
                    case 0:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_STEEP + 12)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        break;
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_STEEP + 13)),
                            { 0, 0, height }, { 32, 1, 98 }, { 0, 27, height });
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_STEEP + 14)),
                            { 0, 0, height }, { 32, 1, 98 }, { 0, 27, height });
                        break;
                    case 3:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_STEEP + 15)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        break;
                }
                if (TrackPaintUtilShouldPaintSupports(session.MapPosition))
            ...
            else
            {
                switch (direction)
                {
                    case 0:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_GENTLE + 0)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        break;
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_GENTLE + 1)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_GENTLE + 2)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        break;
                    case 3:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_GENTLE + 3)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        break;
                }
                if (TrackPaintUtilShouldPaintSupports(session.MapPosition))
            ...
            else
            {
                switch (direction)
                {
                    case 0:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_STEEP + 0)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        break;
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_STEEP + 1)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_STEEP + 2)),
                            { 0, 0, height }, { 32, 1, 66 }, { 0, 27, height });
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_STEEP + 3)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_STEEP + 4)),
                            { 0, 0, height }, { 32, 1, 66 }, { 0, 27, height });
                        break;
                    case 3:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_STEEP + 5)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        break;
                }
                if (TrackPaintUtilShouldPaintSupports(session.MapPosition))
            ...
            else
            {
                switch (direction)
                {
                    case 0:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_STEEP + 6)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        break;
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_STEEP + 7)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_STEEP + 8)),
                            { 0, 0, height }, { 32, 1, 66 }, { 0, 27, height });
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_STEEP + 9)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_STEEP + 10)),
                            { 0, 0, height }, { 32, 1, 66 }, { 0, 27, height });
                        break;
                    case 3:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_STEEP + 11)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        break;
                }
                if (TrackPaintUtilShouldPaintSupports(session.MapPosition))
            ...
            else
            {
                switch (direction)
                {
                    case 0:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_GENTLE + 4)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        break;
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_GENTLE + 5)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_GENTLE + 6)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        break;
                    case 3:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_GENTLE + 7)),
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        break;
                }
                if (TrackPaintUtilShouldPaintSupports(session.MapPosition))
            ...
            const TrackElement& trackElement)
        {
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        session, direction,
                        session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_VERTICAL + 4)), { 0, 0, height },
                        { 32, 20, 3 }, { 0, 6, height + 8 });
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                        session, direction,
                        session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_VERTICAL + 5)), { 0, 0, height },
                        { 2, 20, 31 }, { 24, 6, height + 8 });
                    break;
                case 2:
                    PaintAddImageAsParentRotated(
                        session, direction,
                        session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_VERTICAL + 6)), { 0, 0, height },
                        { 2, 20, 31 }, { 24, 6, height + 8 });
                    break;
                case 3:
                    PaintAddImageAsParentRotated(
                        session, direction,
                        session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_VERTICAL + 7)), { 0, 0, height },
                        { 32, 20, 3 }, { 0, 6, height + 8 });
                    break;
            }
            switch (direction)
                    ...
                    switch (direction)
                    {
                        ...
                        case 3:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_SMALL_CURVE_BANKED + 11)),
                                { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                            break;
                    }
                    MetalASupportsPaintSetup(
                    ...
                    switch (direction)
                    {
                        ...
                        case 3:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_SMALL_CURVE_BANKED + 12)),
                                { 0, 0, height }, { 16, 16, 3 }, { 16, 16, height });
                            break;
                    }
                    PaintUtilSetSegmentSupportHeight(
                    ...
                    switch (direction)
                    {
                        ...
                        case 2:
                            ...
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_SMALL_CURVE_BANKED + 10)),
                                { 0, 0, height }, { 1, 32, 26 }, { 27, 0, height });
                            break;
                        case 3:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_SMALL_CURVE_BANKED + 13)),
                                { 0, 0, height }, { 20, 32, 3 }, { 6, 0, height });
                            break;
                    }
                    MetalASupportsPaintSetup(
                    ...
                    switch (direction)
                    {
                        case 0:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 0)),
                                { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 1)),
                                { 0, 0, height }, { 32, 1, 26 }, { 0, 27, height });
                            break;
                        case 1:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 6)),
                                { 0, 0, height }, { 32, 1, 26 }, { 0, 27, height });
                            break;
                        case 2:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 11)),
                                { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                            break;
                        case 3:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 17)),
                                { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                            break;
                    }
                    MetalASupportsPaintSetup(
                    ...
                    switch (direction)
                    {
                        case 0:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 2)),
                                { 0, 0, height }, { 32, 16, 3 }, { 0, 0, height });
                            break;
                        case 1:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 7)),
                        ...
                        case 2:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 12)),
                                { 0, 0, height }, { 32, 16, 3 }, { 0, 16, height });
                            break;
                        case 3:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 18)),
                                { 0, 0, height }, { 32, 16, 3 }, { 0, 16, height });
                            break;
                    }
                    PaintUtilSetSegmentSupportHeight(
                    ...
                    switch (direction)
                    {
                        case 0:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 3)),
                                { 0, 0, height }, { 16, 16, 3 }, { 0, 16, height });
                            break;
                        case 1:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 8)),
                        ...
                        case 2:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 13)),
                                { 0, 0, height }, { 16, 16, 3 }, { 16, 0, height });
                            break;
                        case 3:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 19)),
                                { 0, 0, height }, { 16, 16, 3 }, { 0, 0, height });
                            break;
                    }
                    PaintUtilSetSegmentSupportHeight(
                    ...
                    switch (direction)
                    {
                        case 0:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 4)),
                                { 0, 0, height }, { 16, 32, 3 }, { 16, 0, height });
                            break;
                        case 1:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 9)),
                        ...
                        case 2:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 14)),
                                { 0, 0, height }, { 16, 32, 3 }, { 0, 0, height });
                            break;
                        case 3:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 20)),
                                { 0, 0, height }, { 16, 32, 3 }, { 16, 0, height });
                            break;
                    }
                    PaintUtilSetSegmentSupportHeight(
                    ...
                    switch (direction)
                    {
                        case 0:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 5)),
                                { 0, 0, height }, { 20, 32, 3 }, { 6, 0, height });
                            break;
                        case 1:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 10)),
                                { 0, 0, height }, { 1, 32, 26 }, { 27, 0, height });
                            break;
                        case 2:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 15)),
                                { 0, 0, height }, { 20, 32, 3 }, { 6, 0, height });
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 16)),
                                { 0, 0, height }, { 1, 32, 26 }, { 27, 0, height });
                            break;
                        case 3:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_MEDIUM_CURVE_BANKED + 21)),
                                { 0, 0, height }, { 20, 32, 3 }, { 6, 0, height });
                            break;
                    }
                    MetalASupportsPaintSetup(
            ...
            const TrackElement& trackElement)
        {
            switch (trackSequence)
            {
                ...
                case 2:
                    ...
                    PaintUtilSetSegmentSupportHeight(
                        session,
                        PaintUtilRotateSegments(SEGMENT_C0 | SEGMENT_C4 | SEGMENT_CC | SEGMENT_D0 | SEGMENT_D4, direction),
                        0xFFFF, 0);
                    PaintUtilSetGeneralSupportHeight(session, height + 48, 0x20);
                    break;
            }
            ...
            const TrackElement& trackElement)
        {
            switch (trackSequence)
            {
                ...
                case 2:
                    ...
                    PaintUtilSetSegmentSupportHeight(
                        session,
                        PaintUtilRotateSegments(SEGMENT_B8 | SEGMENT_C4 | SEGMENT_C8 | SEGMENT_CC | SEGMENT_D0, direction),
                        0xFFFF, 0);
                    PaintUtilSetGeneralSupportHeight(session, height + 48, 0x20);
                    break;
            }
            ...
            const TrackElement& trackElement)
        {
            switch (direction)
            {
                ...
                case 2:
                    PaintAddImageAsParentRotated(
                        session, direction,
                        session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_BLOCK_BRAKE + 0)),
                        { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                    break;
                case 1:
                case 3:
                    PaintAddImageAsParentRotated(
                        session, direction,
                        session.TrackColours[SCHEME_TRACK].WithIndex((SPR_G2_SINGLE_RAIL_TRACK_BLOCK_BRAKE + 1)),
                        { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                    break;
            }
            if (TrackPaintUtilShouldPaintSupports(session.MapPosition))
            ...
            const TrackElement& trackElement)
        {
            switch (trackSequence)
            {
                case 0:
                    ...
                    PaintUtilSetSegmentSupportHeight(
                        session,
                        PaintUtilRotateSegments(SEGMENT_D4 | SEGMENT_C4 | SEGMENT_BC | SEGMENT_CC | SEGMENT_D0, direction),
                        0xFFFF, 0);
                    PaintUtilSetGeneralSupportHeight(session, height + 40, 0x20);
                    break;
                case 1:
                ...
                case 2:
                    ...
                    PaintUtilSetSegmentSupportHeight(
                        session, PaintUtilRotateSegments(SEGMENT_C0 | SEGMENT_C4 | SEGMENT_D4 | SEGMENT_D0, direction), 0xFFFF,
                        0);
                    PaintUtilSetGeneralSupportHeight(session, height + 48, 0x20);
                    break;
                case 3:
            ...
            const TrackElement& trackElement)
        {
            switch (trackSequence)
            {
                ...
                case 2:
                    ...
                    PaintUtilSetSegmentSupportHeight(
                        session, PaintUtilRotateSegments(SEGMENT_B8 | SEGMENT_C8 | SEGMENT_C4 | SEGMENT_D0, direction), 0xFFFF,
                        0);
                ...
                case 3:
                    ...
                    PaintUtilSetSegmentSupportHeight(
                        session, PaintUtilRotateSegments(SEGMENT_C0 | SEGMENT_D4 | SEGMENT_C4 | SEGMENT_D0, direction), 0xFFFF,
                        0);
                    PaintUtilSetGeneralSupportHeight(session, height + 144, 0x20);
                    break;
                case 4:
                    ...
                    switch (direction)
                    {
                        case 0:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_TURN_BANK_TRANSITION + 0)),
                                { 0, 6, height }, { 32, 20, 3 });
                            break;
                        case 1:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_TURN_BANK_TRANSITION + 2)),
                                { 0, 6, height }, { 32, 20, 3 });
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_TURN_BANK_TRANSITION + 3)),
                        ...
                        case 2:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_TURN_BANK_TRANSITION + 5)),
                                { 0, 6, height }, { 32, 20, 3 });
                            break;
                        case 3:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_TURN_BANK_TRANSITION + 7)),
                                { 0, 6, height }, { 32, 20, 3 });
                            break;
                    }
                    MetalASupportsPaintSetup(
                    ...
                    switch (direction)
                    {
                        case 0:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_TURN_BANK_TRANSITION + 1)),
                        ...
                        case 1:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_TURN_BANK_TRANSITION + 4)),
                                { 6, 0, height }, { 20, 32, 3 }, { 0, 6, height - 6 });
                            break;
                        case 2:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_TURN_BANK_TRANSITION + 6)),
                                { 6, 0, height }, { 20, 32, 3 }, { 0, 6, height - 6 });
                            break;
                        case 3:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_TURN_BANK_TRANSITION + 8)),
                                { 6, 0, height }, { 20, 32, 3 }, { 0, 6, height - 6 });
                            break;
                    }
                    MetalASupportsPaintSetup(
                    ...
                    switch (direction)
                    {
                        case 0:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_TURN_BANK_TRANSITION + 9)),
                                { 0, 6, height }, { 32, 20, 3 });
                            break;
                        case 1:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_TURN_BANK_TRANSITION + 11)),
                                { 0, 6, height }, { 32, 20, 3 });
                            break;
                        case 2:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_TURN_BANK_TRANSITION + 13)),
                                { 0, 6, height }, { 32, 20, 3 });
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_TURN_BANK_TRANSITION + 14)),
                                { 0, 6, height }, { 32, 1, 26 }, { 0, 27, height });
                            break;
                        case 3:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_TURN_BANK_TRANSITION + 16)),
                                { 0, 6, height }, { 32, 20, 3 });
                            break;
                    }
                    MetalASupportsPaintSetup(
                    ...
                    switch (direction)
                    {
                        case 0:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_TURN_BANK_TRANSITION + 10)),
                                { 6, 0, height }, { 20, 32, 3 }, { 0, 6, height - 6 });
                            break;
                        case 1:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_TURN_BANK_TRANSITION + 12)),
                                { 6, 0, height }, { 20, 32, 3 }, { 0, 6, height - 6 });
                            break;
                        case 2:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_TURN_BANK_TRANSITION + 15)),
                                { 6, 0, height }, { 20, 32, 3 }, { 0, 6, height - 6 });
                            break;
                        case 3:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                session.TrackColours[SCHEME_TRACK].WithIndex(
                                    (SPR_G2_SINGLE_RAIL_TRACK_TURN_BANK_TRANSITION + 17)),
                                { 6, 0, height }, { 20, 32, 3 }, { 0, 6, height - 6 });
                            break;
                    }
                    MetalASupportsPaintSetup(
                ...
                switch (direction)
                {
                    case 0:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex(
                                (SPR_G2_SINGLE_RAIL_LIFT_TRACK_SMALL_FLAT_TO_STEEP + 0)),
                    ...
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex(
                                (SPR_G2_SINGLE_RAIL_LIFT_TRACK_SMALL_FLAT_TO_STEEP + 2)),
                            { 0, 0, height }, { 1, 24, 43 }, { 29, 4, height + 2 });
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex(
                                (SPR_G2_SINGLE_RAIL_LIFT_TRACK_SMALL_FLAT_TO_STEEP + 1)),
                    ...
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex(
                                (SPR_G2_SINGLE_RAIL_LIFT_TRACK_SMALL_FLAT_TO_STEEP + 4)),
                            { 0, 0, height }, { 1, 24, 43 }, { 29, 4, height + 2 });
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex(
                                (SPR_G2_SINGLE_RAIL_LIFT_TRACK_SMALL_FLAT_TO_STEEP + 3)),
                            { 0, 0, height }, { 32, 2, 43 }, { 0, 4, height });
                        MetalASupportsPaintSetup(
                            session, METAL_SUPPORTS_TUBES, 4, 0, height + 4, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 3:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex(
                                (SPR_G2_SINGLE_RAIL_LIFT_TRACK_SMALL_FLAT_TO_STEEP + 5)),
                            { 0, 0, height }, { 32, 27, 4 }, { 0, 2, height });
                        MetalASupportsPaintSetup(
                            session, METAL_SUPPORTS_TUBES, 4, 3, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                ...
                switch (direction)
                {
                    case 0:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex(
                                (SPR_G2_SINGLE_RAIL_LIFT_TRACK_SMALL_FLAT_TO_STEEP + 6)),
                            { 0, 0, height }, { 32, 27, 4 }, { 0, 2, height });
                        break;
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex(
                                (SPR_G2_SINGLE_RAIL_LIFT_TRACK_SMALL_FLAT_TO_STEEP + 7)),
                            { 0, 0, height }, { 1, 24, 43 }, { 29, 4, height + 2 });
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex(
                                (SPR_G2_SINGLE_RAIL_LIFT_TRACK_SMALL_FLAT_TO_STEEP + 8)),
                            { 0, 0, height }, { 32, 2, 43 }, { 0, 4, height });
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex(
                                (SPR_G2_SINGLE_RAIL_LIFT_TRACK_SMALL_FLAT_TO_STEEP + 10)),
                            { 0, 0, height }, { 1, 24, 43 }, { 29, 4, height + 2 });
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex(
                                (SPR_G2_SINGLE_RAIL_LIFT_TRACK_SMALL_FLAT_TO_STEEP + 9)),
                            { 0, 0, height }, { 32, 2, 43 }, { 0, 4, height });
                        break;
                    case 3:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            session.TrackColours[SCHEME_TRACK].WithIndex(
                                (SPR_G2_SINGLE_RAIL_LIFT_TRACK_SMALL_FLAT_TO_STEEP + 11)),
                            { 0, 0, height }, { 32, 27, 4 }, { 0, 2, height });
                        break;
                }

...
namespace SingleRailRC
{
        ...
        const TrackElement& trackElement)
    {
        switch (trackSequence)
        {
            case 0:
                ...
                if (track_paint_util_should_paint_supports(session.MapPosition))
                {
                    MetalASupportsPaintSetup(session, MetalSupportsTubes, 4, 36, height, session.TrackColours[SCHEME_SUPPORTS]);
                }
                if (direction == 0 || direction == 3)
                {
                    PaintUtilPushTunnelRotated(session, direction, height - 8, Tunnel1);
                    ...
                    switch (direction)
                    {
                        case 0:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 1, 9, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 1:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                ...
                                { -16, -16, height }, { 32, 32, 3 }, { -16, -16, height });
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 0, 9, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 2:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 2, 9, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 3:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 3, 9, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                    }
                }
                else
            ...
            case 3:
                if (trackElement.HasChain())
                {
                    switch (direction)
                    {
                        case 0:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 1, 6, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 1:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                ...
                                { -16, -16, height }, { 32, 32, 3 }, { -16, -16, height });
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 0, 6, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 2:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 2, 6, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 3:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 3, 6, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                    }
                }
                else
            ...
            case 3:
                if (trackElement.HasChain())
                {
                    switch (direction)
                    {
                        case 0:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 1, 0, height + 2, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 1:
                            PaintAddImageAsParentRotated(
                                session, direction,
                        ...
                        case 2:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 2, 0, height + 2, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 3:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 3, 0, height, session.TrackColours[SCHEME_SUPPORTS]);
                ...
                else
                {
                    switch (direction)
                    {
                        case 0:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 1, 2, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 1:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                ...
                                { -16, -16, height }, { 32, 32, 3 }, { -16, -16, height });
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 0, 2, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 2:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 2, 2, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 3:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 3, 2, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                    }
                }
                PaintUtilSetSegmentSupportHeight(
            ...
            case 3:
                if (trackElement.HasChain())
                {
                    switch (direction)
                    {
                        case 0:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 1, 38, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 1:
                            PaintAddImageAsParentRotated(
                                session, direction,
                        ...
                        case 2:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 2, 38, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 3:
                            MetalBSupportsPaintSetup(
                ...
                switch (direction)
                {
                    case 0:
                        PaintAddImageAsParentRotated(
                            ...
                            { 0, 0, height }, { 32, 26, 3 });
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 5, 0, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            ...
                            { 0, 0, height }, { 32, 26, 3 });
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 6, 1, height - 1, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
                ...
                switch (direction)
                {
                    case 0:
                        PaintAddImageAsParentRotated(
                            ...
                            { 0, 0, height }, { 32, 26, 3 }, { 0, 6, height });
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 8, 0, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            ...
                            { 0, 0, height }, { 32, 26, 3 }, { 0, 6, height });
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 7, 0, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
        ...
        const TrackElement& trackElement)
    {
        switch (trackSequence)
        {
            ...
            case 3:
                ...
                PaintUtilSetSegmentSupportHeight(
                    session, PaintUtilRotateSegments(SegmentC0 | SegmentC4 | SegmentC8 | SegmentD0 | SegmentD4, direction),
                    0xFFFF, 0);
                PaintUtilSetGeneralSupportHeight(session, height + 32, 0x20);
                break;
            case 4:
                ...
                PaintUtilSetSegmentSupportHeight(
                    session, PaintUtilRotateSegments(SegmentB8 | SegmentC4 | SegmentC8 | SegmentD0 | SegmentD4, direction),
                    0xFFFF, 0);
                PaintUtilSetGeneralSupportHeight(session, height + 32, 0x20);
                break;
            case 5:
            ...
            case 7:
                ...
                PaintUtilSetSegmentSupportHeight(
                    session, PaintUtilRotateSegments(SegmentBC | SegmentC4 | SegmentCC | SegmentD0 | SegmentD4, direction),
                    0xFFFF, 0);
                PaintUtilSetGeneralSupportHeight(session, height + 32, 0x20);
                break;
        }
                ...
                switch (direction)
                {
                    case 0:
                        PaintAddImageAsParentRotated(
                            ...
                            { 0, 0, height }, { 20, 32, 3 }, { 6, 0, height + 8 });
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 4, 7, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction,
                        ...
                        PaintAddImageAsParentRotated(
                            ...
                            { 0, 0, height }, { 1, 32, 26 }, { 27, 0, height });
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 4, 3, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
        ...
        const TrackElement& trackElement)
    {
        switch (trackSequence)
        {
            case 0:
                switch (direction)
                {
                    case 0:
                        ...
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 2, 4, height + 1, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction,
                        ...
                        PaintAddImageAsParentRotated(
                            ...
                            { 0, 0, height }, { 32, 20, 0 }, { 0, 6, height + 28 });
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 3, 4, height + 1, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
                        ...
                        PaintAddImageAsParentRotated(
                            ...
                            { 0, 0, height }, { 32, 20, 0 }, { 0, 6, height + 28 });
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 1, 0, height + 1, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 3:
                        PaintAddImageAsParentRotated(
                            session, direction,
            ...
            case 2:
                ...
                PaintUtilSetSegmentSupportHeight(
                    session, PaintUtilRotateSegments(SegmentC0 | SegmentC4 | SegmentCC | SegmentD0 | SegmentD4, direction),
                    0xFFFF, 0);
                PaintUtilSetGeneralSupportHeight(session, height + 48, 0x20);
                break;
        }
        ...
        const TrackElement& trackElement)
    {
        switch (trackSequence)
        {
                ...
                switch (direction)
                {
                    ...
                    case 1:
                        ...
                        PaintAddImageAsParentRotated(
                            ...
                            { 0, 0, height }, { 32, 20, 0 }, { 0, 6, height + 28 });
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 2, 0, height + 1, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
                    ...
                    case 3:
                        ...
                        PaintAddImageAsParentRotated(
                            ...
                            { 0, 0, height }, { 32, 20, 0 }, { 0, 6, height + 28 });
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 1, 4, height + 1, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                }
                if (direction == 0 || direction == 3)
                {
            ...
            case 2:
                ...
                PaintUtilSetSegmentSupportHeight(
                    session, PaintUtilRotateSegments(SegmentB8 | SegmentC4 | SegmentC8 | SegmentCC | SegmentD0, direction),
                    0xFFFF, 0);
                PaintUtilSetGeneralSupportHeight(session, height + 48, 0x20);
                break;
        }
                ...
                switch (direction)
                {
                    case 0:
                        PaintAddImageAsParentRotated(
                            ...
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 4, 20, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction,
                        ...
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 4, 15, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
                        ...
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 4, 16, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 3:
                        PaintAddImageAsParentRotated(
                            session, direction,
        ...
        const TrackElement& trackElement)
    {
        switch (trackSequence)
        {
            ...
            case 3:
                ...
                if (track_paint_util_should_paint_supports(session.MapPosition))
                {
                    MetalASupportsPaintSetup(session, MetalSupportsTubes, 4, 19, height, session.TrackColours[SCHEME_SUPPORTS]);
                }
                switch (direction)
                {
                    case 1:
        ...
        const TrackElement& trackElement)
    {
        switch (trackSequence)
        {
            case 0:
                ...
                if (track_paint_util_should_paint_supports(session.MapPosition))
                {
                    MetalASupportsPaintSetup(session, MetalSupportsTubes, 4, 24, height, session.TrackColours[SCHEME_SUPPORTS]);
                }
                if (direction == 0 || direction == 3)
                {
                    PaintUtilPushTunnelRotated(session, direction, height, Tunnel1);
                }
                PaintUtilSetSegmentSupportHeight(
                    session, PaintUtilRotateSegments(SegmentC4 | SegmentCC | SegmentD0, direction), 0xFFFF, 0);
                PaintUtilSetGeneralSupportHeight(session, height + 80, 0x20);
        ...
        switch (trackSequence)
        {
            ...
            case 2:
                ...
                PaintUtilSetSegmentSupportHeight(
                    session, PaintUtilRotateSegments(SegmentB8 | SegmentC4 | SegmentC8 | SegmentD0 | SegmentD4, direction),
                    0xFFFF, 0);
                MetalASupportsPaintSetup(session, MetalSupportsTubes, 4, 0, height + 33, session.TrackColours[SCHEME_SUPPORTS]);
        ...
        const TrackElement& trackElement)
    {
        switch (trackSequence)
        {
                ...
                switch (direction)
                {
                    case 0:
                        PaintAddImageAsParentRotated(
                            ...
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubes, 6, 34, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction,
                        ...
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubes, 8, 22, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
                        ...
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubes, 7, 24, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 3:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            ...
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubes, 5, 16, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                }
                PaintUtilSetSegmentSupportHeight(
                    session,
            ...
            case 4:
                PaintUtilSetSegmentSupportHeight(
                    session,
                    PaintUtilRotateSegments(SegmentB8 | SegmentD0 | SegmentC0 | SegmentC8 | SegmentC4 | SegmentD4, direction),
                    0xFFFF, 0);
                switch (direction)
                {
                    case 0:
                        ...
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 5, 0, height + 56, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            ...
                            { 0, 0, height }, { 28, 28, 0 }, { 2, 2, height + 50 });
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 6, 0, height + 56, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
                        ...
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 8, 0, height + 56, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 3:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            ...
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 7, 0, height + 56, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                }
        ...
        const TrackElement& trackElement)
    {
        switch (trackSequence)
        {
            case 0:
                ...
                PaintUtilSetSegmentSupportHeight(
                    session, PaintUtilRotateSegments(SegmentD4 | SegmentC4 | SegmentBC | SegmentCC | SegmentD0, direction),
                    0xFFFF, 0);
                PaintUtilSetGeneralSupportHeight(session, height + 40, 0x20);
                break;
            case 1:
                switch (direction)
                {
                    case 0:
                        PaintAddImageAsParentRotated(
                            ...
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubes, 6, 16, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            ...
                            { 0, 0, height }, { 20, 20, 3 }, { 0, 6, height });
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubes, 8, 24, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            ...
                            { 0, 0, height }, { 26, 1, 32 }, { 0, 29, height });
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubes, 7, 22, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 3:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            ...
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubes, 5, 34, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                }
                PaintUtilSetSegmentSupportHeight(
                    session,
                    PaintUtilRotateSegments(SegmentBC | SegmentC0 | SegmentC4 | SegmentD4 | SegmentCC | SegmentD0, direction),
                    0xFFFF, 0);
                PaintUtilSetGeneralSupportHeight(session, height + 56, 0x20);
                break;
            case 2:
                ...
                PaintUtilSetSegmentSupportHeight(
                    session, PaintUtilRotateSegments(SegmentC0 | SegmentC4 | SegmentD4 | SegmentD0, direction), 0xFFFF, 0);
                PaintUtilSetGeneralSupportHeight(session, height + 48, 0x20);
                break;
            case 3:
                PaintUtilSetGeneralSupportHeight(session, height + 48, 0x20);
    ...
    // SEGMENT_B4 | SegmentB8 | SegmentBC | SegmentC0 | SegmentC4 | SegmentC8 | SEGMENT_CC | SegmentD0 | SegmentD4;
    //    b4
    //  c8  cc
    // b8  c4  bc
    //  d0  d4
        ...
        const TrackElement& trackElement)
    {
        switch (trackSequence)
        {
            ...
            case 1:
                ...
                PaintUtilSetSegmentSupportHeight(
                    session,
                    PaintUtilRotateSegments(SegmentB8 | SegmentC8 | SegmentC4 | SegmentCC | SegmentD0 | SegmentB4, direction),
                    0xFFFF, 0);
                PaintUtilSetGeneralSupportHeight(session, height + 72, 0x20);
                break;
            case 2:
                switch (direction)
                {
                    case 0:
                        ...
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubes, 5, 14, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction,
                    ...
                    case 2:
                        ...
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubes, 8, 18, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 3:
                        PaintAddImageAsParentRotated(
                            session, direction,
                        ...
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubes, 7, 14, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                }
                PaintUtilSetSegmentSupportHeight(
            ...
            case 3:
                ...
                PaintUtilSetSegmentSupportHeight(
                    session, PaintUtilRotateSegments(SegmentC0 | SegmentD4 | SegmentC4 | SegmentD0, direction), 0xFFFF, 0);
                PaintUtilSetGeneralSupportHeight(session, height + 144, 0x20);
                break;
            case 4:
                switch (direction)
                ...
                PaintUtilSetSegmentSupportHeight(
                    session,
                    PaintUtilRotateSegments(SegmentCC | SegmentC4 | SegmentD0 | SegmentC0 | SegmentD4 | SegmentBC, direction),
                    0xFFFF, 0);
                ...
                switch (direction)
                {
                    case 0:
                        PaintAddImageAsParentRotated(
                            ...
                            { 0, 0, height }, { 32, 32, 0 }, { 0, 0, height });
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubes, 8, 14, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction,
                        ...
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubes, 7, 18, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
                    ...
                    case 3:
                        PaintAddImageAsParentRotated(
                            ...
                            { 0, 0, height }, { 32, 32, 0 }, { 0, 0, height + 2 });
                        MetalBSupportsPaintSetup(
                            session, MetalSupportsTubes, 6, 14, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                }
                PaintUtilSetSegmentSupportHeight(
                    session, PaintUtilRotateSegments(SegmentC0 | SegmentD4 | SegmentC4 | SegmentD0, direction), 0xFFFF, 0);
        ...
        switch (trackSequence)
        {
            case 0:
                switch (direction)
                {
                    ...
                    case 1:
                        ...
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 4, 6, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
                    ...
                    case 3:
                        PaintAddImageAsParentRotated(
                            ...
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height });
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 4, 14, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                }
            ...
            case 2:
                ...
                PaintUtilSetSegmentSupportHeight(
                    ...
                    PaintUtilRotateSegments(SegmentB8 | SegmentC8 | SegmentB4 | SegmentD0 | SegmentC4 | SegmentCC, direction),
                    0xFFFF, 0);
                MetalASupportsPaintSetup(session, MetalSupportsTubes, 4, 0, height + 38, session.TrackColours[SCHEME_SUPPORTS]);
                PaintUtilSetGeneralSupportHeight(session, height + 40, 0x20);
                break;
        }
    }
        ...
        const TrackElement& trackElement)
    {
        switch (trackSequence)
        {
            case 0:
                ...
                MetalASupportsPaintSetup(session, MetalSupportsTubes, 4, 25, height, session.TrackColours[SCHEME_SUPPORTS]);
                if (direction == 0 || direction == 3)
                {
                    PaintUtilPushTunnelRotated(session, direction, height - 8, Tunnel1);
                }
            ...
            case 3:
                ...
                switch (direction)
                {
                    case 0:
                        ...
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 7, 0, height + 28, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction,
                            ...
                            { 0, 0, height }, { 26, 0, 20 }, { 0, 26, height });
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 5, 0, height + 28, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
                        ...
                        PaintAddImageAsParentRotated(
                            ...
                            { 0, 0, height }, { 32, 20, 3 }, { 0, 6, height + 40 });
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 6, 0, height + 28, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 3:
                        PaintAddImageAsParentRotated(
                            session, direction,
                        ...
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 8, 0, height + 28, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                }
                switch (direction)
                {
        ...
        const TrackElement& trackElement)
    {
        switch (trackSequence)
        {
            ...
            case 3:
                ...
                MetalASupportsPaintSetup(session, MetalSupportsTubes, 4, 8, height - 6, session.TrackColours[SCHEME_SUPPORTS]);
                switch (direction)
                {
                    case 2:
            ...
            case 1:
                switch (direction)
                {
                    ...
                    case 1:
                        ...
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 4, 9, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
                ...
                switch (direction)
                {
                    case 0:
                        PaintAddImageAsParentRotated(
                            ...
                            { 0, 0, height }, { 32, 16, 3 }, { 0, 0, height });
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 5, 28, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction,
                        ...
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 6, 28, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
                            session, direction,
                    ...
                    case 3:
                        PaintAddImageAsParentRotated(
                            ...
                            { 0, 0, height }, { 32, 16, 3 }, { 0, 16, height });
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 7, 28, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                }
                PaintUtilSetSegmentSupportHeight(
                    session,
                ...
                switch (direction)
                {
                    case 0:
                        PaintAddImageAsParentRotated(
                            ...
                            { 0, 0, height }, { 32, 16, 3 }, { 0, 16, height });
                        MetalASupportsPaintSetup(
                            session, MetalSupportsTubes, 8, 28, height, session.TrackColours[SCHEME_SUPPORTS]);
                        break;
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction,
        ...
        if (trackElement.HasChain())
        {
            switch (direction)
            {
                ...
                case 1:
                    ...
                    MetalASupportsPaintSetup(
                        session, MetalSupportsTubes, 4, 0, height + 4, session.TrackColours[SCHEME_SUPPORTS]);
                    break;
                case 2:
                    PaintAddImageAsParentRotated(
                        session, direction,
            ...
            case 3:
                if (trackElement.HasChain())
                {
                    switch (direction)
                    {
                        case 0:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 1, 7, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 1:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                ...
                                { -16, -16, height }, { 32, 32, 4 }, { -16, -16, height });
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 0, 7, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 2:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 2, 7, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 3:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 3, 7, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                    }
                }
                else
            ...
            case 3:
                if (trackElement.HasChain())
                {
                    switch (direction)
                    {
                        case 0:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 1, 20, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 1:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                ...
                                { -16, -16, height }, { 32, 32, 4 }, { -16, -16, height });
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 0, 20, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 2:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 2, 20, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 3:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 3, 20, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                    }
                }
                else
            ...
            case 3:
                if (trackElement.HasChain())
                {
                    switch (direction)
                    {
                        case 0:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 1, 5, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 1:
                            PaintAddImageAsParentRotated(
                                session, direction,
                                ...
                                { -16, -16, height }, { 32, 32, 4 }, { -16, -16, height });
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 0, 5, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 2:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 2, 5, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                        case 3:
                            MetalBSupportsPaintSetup(
                                session, MetalSupportsTubes, 3, 5, height, session.TrackColours[SCHEME_SUPPORTS]);
                            break;
                    }
                }
                else

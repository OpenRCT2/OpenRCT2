...
// clang-format off
constexpr const RideTypeDescriptor T_REXCoasterRTD =
{
    ...
    SET_FIELD(TrackPaintFunction, GetTrackPaintFunctionT_REXRC),
    ...
    SET_FIELD(Naming, { STR_RIDE_NAME_T_REX_COASTER, STR_RIDE_DESCRIPTION_T_REX_COASTER }),
    SET_FIELD(NameConvention, { RideComponentType::Train, RideComponentType::Track, RideComponentType::Station }),
    SET_FIELD(EnumName, nameof(RIDE_TYPE_T_REX_COASTER)),
    ...
    SET_FIELD(ColourPreview, { SPR_RIDE_DESIGN_PREVIEW_T_REX_COASTER_TRACK, SPR_RIDE_DESIGN_PREVIEW_T_REX_COASTER_SUPPORTS }),
    SET_FIELD(ColourKey, RideColourKey::Ride),
    SET_FIELD(Name, "T_REX_rc"),

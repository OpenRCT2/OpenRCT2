...
constexpr RideTypeDescriptor TwisterRollerCoasterRTD =
{
    ...
    SET_FIELD(ExtraTrackPieces, {TRACK_LIFT_HILL_STEEP, TRACK_BRAKE_FOR_DROP, TRACK_ZERO_G_ROLL, TRACK_ZERO_G_ROLL_LARGE, TRACK_SLOPE_CURVE_LARGE, TRACK_HALF_LOOP_MEDIUM, TRACK_CORKSCREW_LARGE}),

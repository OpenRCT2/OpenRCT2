...
constexpr RideTypeDescriptor kSingleRailRollerCoasterRTD =
{
    ...
    .Flags = kRideTypeFagsTrackHas3Colours | RIDE_TYPE_FLAG_HAS_TRACK_COLOUR_SUPPORTS | RIDE_TYPE_FLAG_HAS_LEAVE_WHEN_ANOTHER_VEHICLE_ARRIVES_AT_STATION |
    ...
    .kEnumName = nameof(RIDE_TYPE_SINGLE_RAIL_ROLLER_COASTER),

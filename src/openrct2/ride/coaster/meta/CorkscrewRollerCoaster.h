...
constexpr const RideTypeDescriptor CorkscrewRollerCoasterRTD =
{
    ...
    SET_FIELD(RideModes, (1ULL << static_cast<uint8_t>(RideMode::ContinuousCircuit)) | (1ULL << static_cast<uint8_t>(RideMode::ContinuousCircuitBlockSectioned)) | (1ULL << static_cast<uint8_t>(RideMode::PoweredLaunchPasstrough)) | (1ULL << static_cast<uint8_t>(RideMode::PoweredLaunch)) | (1ULL << static_cast<uint8_t>(RideMode::ReverseInclineLaunchedShuttle))),

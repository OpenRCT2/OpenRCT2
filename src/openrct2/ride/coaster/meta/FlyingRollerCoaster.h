...
constexpr const RideTypeDescriptor FlyingRollerCoasterRTD =
{
    ...
    SET_FIELD(ExtraTrackPieces, (1ULL << TRACK_CORKSCREW_UNINVERTED) | (1ULL << TRACK_SLOPE_STEEP_LONG) | (1ULL << TRACK_BARREL_ROLL) | (1ULL << TRACK_POWERED_LIFT) | (1ULL << TRACK_HALF_LOOP_LARGE) | (1ULL << TRACK_QUARTER_LOOP_UNINVERTED) | (1ULL << TRACK_LIFT_HILL_STEEP) | (1ULL << TRACK_BRAKE_FOR_DROP) | (1ULL << TRACK_SLOPE_VERTICAL) | (1ULL << TRACK_VERTICAL_LOOP) | (1ULL << TRACK_BOOSTER)),

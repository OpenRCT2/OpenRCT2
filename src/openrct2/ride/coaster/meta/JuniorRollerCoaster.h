...
namespace OpenRCT2
{
    namespace RideType
    {
        ...
        {
            ObjectEntryIndex JuniorRollerCoaster(uint8_t rct2RideType, const rct_ride_entry* rideEntry);
        }
    }
}
...
constexpr const RideTypeDescriptor JuniorRollerCoasterRTD =
{
    ...
    SET_FIELD(RCT2ToOpenRCT2ConvertFunction, RCT2ToOpenRCT2::JuniorRollerCoaster),
};
// clang-format on

...
constexpr const RideTypeDescriptor StandUpRollerCoasterRTD =
{
    ...
    SET_FIELD(RideModes, (1ULL << static_cast<uint8_t>(RideMode::CONTINUOUS_CIRCUIT)) | (1ULL << static_cast<uint8_t>(RideMode::CONTINUOUS_CIRCUIT_BLOCK_SECTIONED)) | (1ULL << static_cast<uint8_t>(RideMode::REVERSE_INCLINE_LAUNCHED_SHUTTLE)) | (1ULL << static_cast<uint8_t>(RideMode::POWERED_LAUNCH_PASSTROUGH)) | (1ULL << static_cast<uint8_t>(RideMode::POWERED_LAUNCH))),

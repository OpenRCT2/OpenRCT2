...
namespace OpenRCT2
{
    namespace RideType
    {
        ...
        {
            ObjectEntryIndex SteelWildMouse(uint8_t rct2RideType, const rct_ride_entry* rideEntry);
        }
    }
}
...
constexpr const RideTypeDescriptor SteelWildMouseRTD =
{
    ...
    SET_FIELD(RCT2ToOpenRCT2ConvertFunction, RCT2ToOpenRCT2::SteelWildMouse),
};
// clang-format on

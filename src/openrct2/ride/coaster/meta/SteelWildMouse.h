...
// clang-format off
constexpr RideTypeDescriptor kSteelWildMouseRTD =
{
    ...
    .Flags = kRideTypeFagsTrackHas3Colours | RIDE_TYPE_FLAG_HAS_LEAVE_WHEN_ANOTHER_VEHICLE_ARRIVES_AT_STATION |
                     kRideTypeFlagsCommonCoaster | kRideTypeFlagsCommonCoasterNonAlt | RIDE_TYPE_FLAG_ALLOW_DOORS_ON_TRACK |
    ...
    .kEnumName = nameof(RIDE_TYPE_STEEL_WILD_MOUSE),

...
constexpr RideTypeDescriptor SpinningRollerCoasterRTD =
{
    ...
    SET_FIELD(ExtraTrackPieces, { TRACK_POWERED_LIFT, TRACK_SLOPE_STEEP_LONG, TRACK_CORKSCREW, TRACK_BARREL_ROLL, TRACK_BARREL_ROLL, TRACK_QUARTER_LOOP, TRACK_HALF_LOOP, TRACK_HALF_LOOP_MEDIUM, TRACK_HALF_LOOP_LARGE, TRACK_VERTICAL_LOOP, TRACK_CORKSCREW_LARGE, TRACK_ZERO_G_ROLL, TRACK_ZERO_G_ROLL_LARGE, TRACK_TWIST, TRACK_CURVE_VERY_SMALL}),

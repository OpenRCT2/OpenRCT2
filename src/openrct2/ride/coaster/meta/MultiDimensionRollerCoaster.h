...
constexpr const RideTypeDescriptor MultiDimensionRollerCoasterRTD =
{
    ...
    SET_FIELD(RideModes, (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_CONTINUOUS_CIRCUIT)) | (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_CONTINUOUS_CIRCUIT_BLOCK_SECTIONED))),

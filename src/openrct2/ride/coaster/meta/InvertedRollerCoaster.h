...
constexpr const RideTypeDescriptor InvertedRollerCoasterRTD =
{
    ...
    SET_FIELD(RideModes, (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_CONTINUOUS_CIRCUIT)) | (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_CONTINUOUS_CIRCUIT_BLOCK_SECTIONED)) | (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_POWERED_LAUNCH_PASSTROUGH)) | (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_POWERED_LAUNCH))),

...
constexpr const RideTypeDescriptor ReverseFreefallCoasterRTD =
{
    ...
    SET_FIELD(RideModes, (1ULL << static_cast<uint8_t>(RideMode::RIDE_MODE_LIM_POWERED_LAUNCH))),
    SET_FIELD(DefaultMode, static_cast<uint8_t>(RideMode::RIDE_MODE_LIM_POWERED_LAUNCH)),

...
constexpr const RideTypeDescriptor BobsleighCoasterRTD =
{
    ...
    SET_FIELD(EnabledTrackPieces, {TRACK_STRAIGHT, TRACK_STATION_END, TRACK_LIFT_HILL, TRACK_FLAT_ROLL_BANKING, TRACK_SLOPE, TRACK_S_BEND, TRACK_CURVE_SMALL, TRACK_CURVE,TRACK_HELIX_SMALL, TRACK_BRAKES,TRACK_BLOCK_BRAKES, TRACK_ON_RIDE_PHOTO}),
    ...
    SET_FIELD(RatingsData,
    {
        ...
        SET_FIELD(BaseRatings, { RIDE_RATING(2, 80), RIDE_RATING(3, 20), RIDE_RATING(2, 50) }),
        SET_FIELD(Unreliability, 16),
        SET_FIELD(RelaxRequirementsIfInversions, false),
        SET_FIELD(Modifiers, {
            { RatingsModifierType::BonusLength,           6000,             764, 0, 0 },
            { RatingsModifierType::BonusSynchronization,  0,                RIDE_RATING(0, 20), RIDE_RATING(0, 00), 0 },

...
// clang-format off
constexpr RideTypeDescriptor kWaterCoasterRTD =
{
    ...
    .CoveredTrackPieces = {TrackElemType::kFlat, TrackElemType::kLeftQuarterTurn5Tiles, TrackElemType::kRightQuarterTurn5Tiles, TrackElemType::kSBendLeft, TrackElemType::kSBendRight},
    ...
    .kEnumName = nameof(RIDE_TYPE_WATER_COASTER),

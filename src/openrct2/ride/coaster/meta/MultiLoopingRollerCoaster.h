...
constexpr RideTypeDescriptor MultiLoopingRollerCoasterRTD =
{
    ...
    SET_FIELD(TrackPaintFunction, GetTrackPaintFunctionInMaTriangleAlt),
    ...
    SET_FIELD(Naming, { STR_RIDE_NAME_MULTI_LOOPING_ROLLER_COASTER, STR_RIDE_DESCRIPTION_MULTI_LOOPING_ROLLER_COASTER }),
    SET_FIELD(NameConvention, { RideComponentType::Train, RideComponentType::Track, RideComponentType::Station }),
    SET_FIELD(EnumName, nameof(RIDE_TYPE_MULTI_LOOPING_ROLLER_COASTER)),
    SET_FIELD(AvailableBreakdowns, (1 << BREAKDOWN_SAFETY_CUT_OUT) | (1 << BREAKDOWN_RESTRAINTS_STUCK_CLOSED) | (1 << BREAKDOWN_RESTRAINTS_STUCK_OPEN) | (1 << BREAKDOWN_VEHICLE_MALFUNCTION) | (1 << BREAKDOWN_BRAKES_FAILURE)),
    SET_FIELD(Heights, { 40, 24, 9, 11, }),
    ...
    SET_FIELD(DefaultMusic, MUSIC_OBJECT_MECHANICAL),
    ...
    SET_FIELD(RatingsData,
    {
        ...
        false,
        {
            ...
            { RatingsModifierType::BonusInversions,       6,                42069, -20000, -15000 },

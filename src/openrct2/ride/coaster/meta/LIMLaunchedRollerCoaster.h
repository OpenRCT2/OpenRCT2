...
constexpr const RideTypeDescriptor LIMLaunchedRollerCoasterRTD =
{
    ...
    SET_FIELD(RideModes, (1ULL << static_cast<uint8_t>(RideMode::POWERED_LAUNCH_PASSTROUGH)) | (1ULL << static_cast<uint8_t>(RideMode::POWERED_LAUNCH)) | (1ULL << static_cast<uint8_t>(RideMode::POWERED_LAUNCH_BLOCK_SECTIONED))),

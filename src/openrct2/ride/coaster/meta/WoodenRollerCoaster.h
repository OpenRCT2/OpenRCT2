...
constexpr const RideTypeDescriptor WoodenRollerCoasterRTD =
{
    ...
    SET_FIELD(RideModes, (1ULL << static_cast<uint8_t>(RideMode::ContinuousCircuit)) | (1ULL << static_cast<uint8_t>(RideMode::ContinuousCircuitBlockSectioned)) | (1ULL << static_cast<uint8_t>(RideMode::ReverseInclineLaunchedShuttle) )),

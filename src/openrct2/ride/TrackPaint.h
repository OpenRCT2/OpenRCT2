...
void track_paint_util_draw_pier(
    paint_session* session, Ride* ride, const StationObject* stationObject, LocationXY16 position, Direction direction,
...
using TRACK_PAINT_FUNCTION = void (*)(
    ...
    const TileElement* tileElement);
using TRACK_PAINT_FUNCTION_GETTER = TRACK_PAINT_FUNCTION (*)(int32_t trackType, Direction direction);

TRACK_PAINT_FUNCTION get_track_paint_function_stand_up_rc(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_suspended_swinging_rc(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_inverted_rc(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_junior_rc(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_monorail(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_mini_suspended_rc(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_miniature_railway(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_boat_hire(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_wooden_wild_mouse(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_steeplechase(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_car_ride(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_launched_freefall(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_bobsleigh_rc(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_observation_tower(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_looping_rc(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_dinghy_slide(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_mine_train_rc(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_chairlift(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_corkscrew_rc(int32_t trackType, Direction direction);
...
TRACK_PAINT_FUNCTION get_track_paint_function_go_karts(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_log_flume(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_river_rapids(int32_t trackType, Direction direction);
...
TRACK_PAINT_FUNCTION get_track_paint_function_ferris_wheel(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_motionsimulator(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_3d_cinema(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_topspin(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_space_rings(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_reverse_freefall_rc(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_lift(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_vertical_drop_rc(int32_t trackType, Direction direction);
...
TRACK_PAINT_FUNCTION get_track_paint_function_facility(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_twist(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_haunted_house(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_circus_show(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_ghost_train(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_twister_rc(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_side_friction_rc(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_wooden_rc(int32_t trackType, Direction direction);
...
TRACK_PAINT_FUNCTION get_track_paint_function_flying_rc(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_virginia_reel(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_splash_boats(int32_t trackType, Direction direction);
...
TRACK_PAINT_FUNCTION get_track_paint_function_suspended_monorail(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_reverser_rc(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_heartline_twister_rc(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_mini_golf(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_giga_rc(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_roto_drop(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_flying_saucers(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_crooked_house(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_monorail_cycles(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_compact_inverted_rc(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_water_rc(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_air_powered_vertical_rc(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_inverted_hairpin_rc(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_magic_carpet(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_submarine_ride(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_enterprise(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_inverted_impulse_rc(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_mini_rc(int32_t trackType, Direction direction);
TRACK_PAINT_FUNCTION get_track_paint_function_mine_ride(int32_t trackType, Direction direction);

...
enum
{
    RIDE_DEPART_WAIT_FOR_LOAD_MASK = 0b00000111,
    RIDE_DEPART_WAIT_FOR_LOAD = 0b00001000,
    RIDE_DEPART_LEAVE_WHEN_ANOTHER_ARRIVES = 0b00010000,
    RIDE_DEPART_SYNCHRONISE_WITH_ADJACENT_STATIONS = 0b00100000,
    RIDE_DEPART_WAIT_FOR_MINIMUM_LENGTH = 0b01000000,
    RIDE_DEPART_WAIT_FOR_MAXIMUM_LENGTH = 0b10000000
};
...
#define STATION_DEPART_FLAG 0b10000000
#define STATION_DEPART_MASK 0b01111111

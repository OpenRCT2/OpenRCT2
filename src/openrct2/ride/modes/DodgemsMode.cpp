...
#include "DodgemsMode.h"
#include "../Vehicle.h"
#include "../../entity/Peep.h"
#include "../../entity/EntityRegistry.h"
#include "../../entity/Guest.h"

rct_string_id OpenRCT2::RideModes::Dodgems::GetOperationErrorMessage(Ride* ride) const
{
    return STR_CANT_CHANGE_TIME_LIMIT;
}

bool OpenRCT2::RideModes::Dodgems::FindVehicleToEnter(Guest* guest, Ride* ride, std::vector<uint8_t>& car_array) const
{

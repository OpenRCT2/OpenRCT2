...
#include "ContinuousCircuitBlockSectionedMode.h"
#include "../../Game.h"
...
bool OpenRCT2::RideModes::ContinuousCircuitBlockSectioned::CreateCableLift(RideId rideIndex, bool isApplying) const
{

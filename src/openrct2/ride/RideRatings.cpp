...
#pragma region Ride rating calculation helpers
    ...
    static void ride_ratings_apply_length(
        RatingTuple* ratings, const Ride& ride, int32_t maxLength, int32_t excitementMultiplier)
    {
        ride_ratings_add(ratings, (std::min(ride.GetTotalLength() >> 16, maxLength) * excitementMultiplier) >> 16, 0, 0);
    }

    static void ride_ratings_apply_synchronisation(
        RatingTuple* ratings, const Ride& ride, int32_t excitement, int32_t intensity)
    {
    ...
    static void ride_ratings_apply_highest_drop_height_penalty(
        RatingTuple* ratings, const Ride& ride, int32_t minHighestDropHeight, int32_t excitementPenalty,

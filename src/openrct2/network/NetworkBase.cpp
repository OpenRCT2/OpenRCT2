...
void NetworkBase::BeginChatLog()
{
    ...
    _chat_log_fs.open(std::filesystem::u8path(_chatLogPath), std::ios::out | std::ios::app);
}
...
void NetworkBase::BeginServerLog()
{
    ...
    _server_log_fs.open(std::filesystem::u8path(_serverLogPath), std::ios::out | std::ios::app | std::ios::binary);

...
namespace OpenRCT2::Scripting
{
    ...
    static const DukEnumMap<VehicleStatus> VehicleStatusMap({
        { "moving_to_end_of_station", VehicleStatus::MovingToEndOfStation },
        { "waiting_for_passengers", VehicleStatus::WaitingForPassengers },
        { "waiting_to_depart", VehicleStatus::WaitingToDepart },
        { "departing", VehicleStatus::Departing },
        { "travelling", VehicleStatus::Travelling },
        { "arriving", VehicleStatus::Arriving },
        { "unloading_passengers", VehicleStatus::UnloadingPassengers },
        { "travelling_boat", VehicleStatus::TravellingBoat },
        { "crashing", VehicleStatus::Crashing },
        { "crashed", VehicleStatus::Crashed },
        { "travelling_dodgems", VehicleStatus::TravellingDodgems },
        { "swinging", VehicleStatus::Swinging },
        { "rotating", VehicleStatus::Rotating },
        { "ferris_wheel_rotating", VehicleStatus::FerrisWheelRotating },
        { "simulator_operating", VehicleStatus::SimulatorOperating },
        { "showing_film", VehicleStatus::ShowingFilm },
        { "space_rings_operating", VehicleStatus::SpaceRingsOperating },
        { "top_spin_operating", VehicleStatus::TopSpinOperating },
        { "haunted_house_operating", VehicleStatus::HauntedHouseOperating },
        { "doing_circus_show", VehicleStatus::DoingCircusShow },
        { "crooked_house_operating", VehicleStatus::CrookedHouseOperating },
        { "waiting_for_cable_lift", VehicleStatus::WaitingForCableLift },
        { "travelling_cable_lift", VehicleStatus::TravellingCableLift },
        { "stopping", VehicleStatus::Stopping },
        { "waiting_for_passengers_17", VehicleStatus::WaitingForPassengers17 },
        { "waiting_to_start", VehicleStatus::WaitingToStart },
        { "starting", VehicleStatus::Starting },
        { "operating_1a", VehicleStatus::Operating1A },
        { "stopping_1b", VehicleStatus::Stopping1B },
        { "unloading_passengers_1c", VehicleStatus::UnloadingPassengers1C },
        { "stopped_by_block_brake", VehicleStatus::StoppedByBlockBrakes },
    });

...
static const EnumMap<HOOK_TYPE> HooksLookupTable({
    ...
    { "guest.drown", HOOK_TYPE::GUEST_DROWN },
    { "guest.enter_park", HOOK_TYPE::GUEST_ENTER_PARK },
    { "guest.leave_park", HOOK_TYPE::GUEST_LEAVE_PARK },
    { "guest.thought", HOOK_TYPE::GUEST_THOUGHT },
    { "guest.join_queue", HOOK_TYPE::GUEST_JOIN_QUEUE },
    { "guest.enter_ride", HOOK_TYPE::GUEST_ENTER_RIDE },
    { "guest.leave_ride", HOOK_TYPE::GUEST_LEAVE_RIDE },
    { "guest.use_facility", HOOK_TYPE::GUEST_USE_FACILITY },
    { "guest.buy_item", HOOK_TYPE::GUEST_BUY_ITEM },

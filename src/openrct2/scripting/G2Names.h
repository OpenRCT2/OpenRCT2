...
static const EnumMap<uint32_t> G2SpriteLookupTable = {
    ...
    { "sideways-tab", SPR_G2_SIDEWAYS_TAB },
    { "sideways-tab-active", SPR_G2_SIDEWAYS_TAB_ACTIVE },
...
std::map<int32_t, int32_t> LegacyIconMap{
...
int32_t GetSpriteIndex(int32_t& input)
{

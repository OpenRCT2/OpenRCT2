...
enum : ImageIndex
{
    ...
    SPR_G2_LATTICE_TRIANGLE_TRACK_FLAT_TO_STEEP_DIAGONAL = SPR_G2_OPAQUE_WATER_OVERLAY + 5,
    SPR_G2_LATTICE_TRIANGLE_TRACK_DIVE_LOOP = SPR_G2_LATTICE_TRIANGLE_TRACK_FLAT_TO_STEEP_DIAGONAL + 24,
    SPR_G2_BM_TRACK_FLAT_TO_STEEP_DIAGONAL = SPR_G2_LATTICE_TRIANGLE_TRACK_DIVE_LOOP + 64,
    SPR_G2_BM_TRACK_DIVE_LOOP = SPR_G2_BM_TRACK_FLAT_TO_STEEP_DIAGONAL + 24,
    SPR_G2_SINGLE_RAIL_TRACK_FLAT_TO_STEEP_DIAGONAL = SPR_G2_BM_TRACK_DIVE_LOOP + 64,
    SPR_G2_SINGLE_RAIL_TRACK_DIVE_LOOP = SPR_G2_SINGLE_RAIL_TRACK_FLAT_TO_STEEP_DIAGONAL + 24,
    SPR_G2_CORKSCREW_TRACK_FLAT_TO_STEEP_DIAGONAL = SPR_G2_SINGLE_RAIL_TRACK_DIVE_LOOP + 64,
    SPR_G2_CORKSCREW_TRACK_DIVE_LOOP = SPR_G2_CORKSCREW_TRACK_FLAT_TO_STEEP_DIAGONAL + 24,
    SPR_G2_END = SPR_G2_CORKSCREW_TRACK_DIVE_LOOP + 64,

...
enum
{
    ...
    SPR_G2_LEFT_CURLY_BRACKET,
    SPR_G2_RIGHT_CURLY_BRACKET,
    SPR_G2_VERTICAL_BAR,
    SPR_G2_TILDE,
    SPR_G2_QUOTATION_MARK,
    SPR_G2_APOSTROPHE,
    SPR_G2_WHITE_SQUARE,
    SPR_G2_REPLACEMENT_CHARACTER,

    SPR_G2_GLYPH_COUNT = (SPR_G2_REPLACEMENT_CHARACTER - SPR_G2_CHAR_BEGIN) + 1,

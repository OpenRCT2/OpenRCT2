...
enum : ImageIndex
{
    ...
    SPR_G2_MINI_TRACK_FLAT_TO_STEEP_DIAGONAL = SPR_G2_MINI_TRACK_INLINE_TWIST + 48,
    SPR_G2_MINI_TRACK_DIVE_LOOP = SPR_G2_MINI_TRACK_FLAT_TO_STEEP_DIAGONAL + 24,
    SPR_G2_MINI_RC_END = SPR_G2_MINI_TRACK_DIVE_LOOP + 32,

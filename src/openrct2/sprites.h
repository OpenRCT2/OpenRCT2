...
enum
{
    ...
    SPR_RIDE_DESIGN_PREVIEW_HYBRID_COASTER_TRACK = SPR_G2_PLACEHOLDER,    //TODO: make sprites for preview
    SPR_RIDE_DESIGN_PREVIEW_HYBRID_COASTER_SUPPORTS = SPR_G2_PLACEHOLDER,

...
enum
{
    ...
    SPR_RIDE_CONSTRUCTION_SQUARE_TRACK = SPR_G2_ALPINE_END,
    SPR_RIDE_CONSTRUCTION_TRIANGLE_TRACK = SPR_RIDE_CONSTRUCTION_SQUARE_TRACK + 1,

    SPR_G2_END = SPR_RIDE_CONSTRUCTION_TRIANGLE_TRACK + 1,

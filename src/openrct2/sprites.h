...
enum
{
    ...
    SPR_JUNIOR_RC_60_DEG_UP_TO_FLAT_CHAIN_NE_SW_PART_0_2, // 56, maybe insert more Junior Coaster track here.

    SPR_G2_TAB_NEWS = SPR_G2_SANDBOX + 25,
    SPR_G2_LOCKED,
    SPR_G2_MENU_MULTIPLAYER,

    // 60 to 75 are more Junior Coaster additions

    SPR_G2_SORT = SPR_G2_MENU_MULTIPLAYER + 17,
    SPR_G2_COPY,
    SPR_G2_PASTE,
    ...
    SPR_G2_MINIATURE_RAILWAY_GRAVEL_SW_NE, // 92

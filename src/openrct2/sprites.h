...
enum
{
    ...
    SPR_G2_BM_BLOCK_CLOSED = SPR_G2_ALPINE_END,
    SPR_G2_BM_BLOCK_OPEN = SPR_G2_BM_BLOCK_CLOSED + 1,
    SPR_G2_BM_BRAKE = SPR_G2_BM_BLOCK_OPEN + 1,
    SPR_G2_BM_FLAT = SPR_G2_BM_BRAKE + 1,
    SPR_G2_BM_STATION = SPR_G2_BM_FLAT + 1,

    SPR_G2_END = SPR_G2_BM_STATION + 1,

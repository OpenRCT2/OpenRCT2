...
static void peep_update_falling(rct_peep * peep)
{
    ...
    rct_tile_element * saved_map    = NULL;
...
static void peep_go_to_ride_entrance(rct_peep * peep, Ride * ride)
{
    ...
    uint8 direction = (tile_element == NULL ? 0 : tile_element_get_direction(tile_element));
...
static void peep_update_ride_sub_state_1(rct_peep * peep)
{
    ...
    if (ride_type_has_flag(ride->type, RIDE_TYPE_FLAG_NO_VEHICLES))
    {
        ...
        uint8 direction_entrance = (tile_element == NULL ? 0 : tile_element_get_direction(tile_element));
        ...
        uint8 direction_track = (tile_element == NULL ? 0 : tile_element_get_direction(tile_element));
...
static void peep_update_ride_sub_state_7(rct_peep * peep)
{
    ...
    if (!(vehicle_entry->flags & VEHICLE_ENTRY_FLAG_26))
    {
        ...
        uint8 exit_direction = (tile_element == NULL ? 0 : tile_element_get_direction(tile_element));
        exit_direction ^= (1 << 1);
    ...
    uint8 station_direction = (tile_element == NULL ? 0 : tile_element_get_direction(tile_element));
...
static void peep_update_watering(rct_peep * peep)
{
    ...
    else if (peep->sub_state == 1)
    {
        ...
        do
        {
            ...
            if (!scenery_small_has_flag(scenery_entry, SMALL_SCENERY_FLAG_CAN_BE_WATERED))
                continue;
...
static sint32 peep_update_patrolling_find_watering(rct_peep * peep)
{
    ...
    for (sint32 i = 0; i < 8; ++i, ++chosen_position)
    {
        ...
        do
        {
            ...
            if (sceneryEntry == nullptr || !scenery_small_has_flag(sceneryEntry, SMALL_SCENERY_FLAG_CAN_BE_WATERED))
            {
                continue;
            }
...
sint32 peep_pathfind_choose_direction(sint16 x, sint16 y, uint8 z, rct_peep * peep)
{
    ...
    rct_tile_element * first_tile_element = NULL;

...
static struct
{
    ...
    { PEEP_ACTION_SHAKE_HEAD, PEEP_THOUGHT_ACTION_FLAG_1 },
    { PEEP_ACTION_EMPTY_POCKETS, 0 },
    { PEEP_ACTION_NONE_2, 0 },
    { PEEP_ACTION_NONE_2, 0 },
    { PEEP_ACTION_NONE_2, PEEP_THOUGHT_ACTION_FLAG_1 },
    { PEEP_ACTION_WOW, PEEP_THOUGHT_ACTION_FLAG_1 },
    { PEEP_ACTION_NONE_2, PEEP_THOUGHT_ACTION_FLAG_2 },
    { PEEP_ACTION_NONE_2, PEEP_THOUGHT_ACTION_FLAG_1 },
    { PEEP_ACTION_NONE_2, PEEP_THOUGHT_ACTION_FLAG_1 },
    { PEEP_ACTION_NONE_2, 0 },
    { PEEP_ACTION_NONE_2, PEEP_THOUGHT_ACTION_FLAG_1 },
    ...
    { PEEP_ACTION_NONE_2, 0 },
    { PEEP_ACTION_WAVE, 0 },
    { PEEP_ACTION_JOY, PEEP_THOUGHT_ACTION_FLAG_1 },
    { PEEP_ACTION_CHECK_TIME, PEEP_THOUGHT_ACTION_FLAG_1 },
    { PEEP_ACTION_NONE_2, 0 },
    { PEEP_ACTION_NONE_2, 0 },
    { PEEP_ACTION_NONE_2, 0 },
    { PEEP_ACTION_NONE_2, 0 },
    { PEEP_ACTION_WAVE, PEEP_THOUGHT_ACTION_FLAG_1 },
    { PEEP_ACTION_NONE_2, PEEP_THOUGHT_ACTION_FLAG_1 },
    { PEEP_ACTION_NONE_2, PEEP_THOUGHT_ACTION_FLAG_1 },
    { PEEP_ACTION_NONE_2, 0 },
    { PEEP_ACTION_WAVE, 0 },

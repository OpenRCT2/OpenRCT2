...
const rct_string_id StaffCostumeNames[] = {
    ...
    STR_STAFF_OPTION_COSTUME_ROMAN,   STR_STAFF_OPTION_COSTUME_GORILLA,   STR_STAFF_OPTION_COSTUME_SNOWMAN,
    STR_STAFF_OPTION_COSTUME_KNIGHT,  STR_STAFF_OPTION_COSTUME_ASTRONAUT, STR_STAFF_OPTION_COSTUME_BANDIT,
    STR_STAFF_OPTION_COSTUME_SHERIFF, STR_STAFF_OPTION_COSTUME_PIRATE,
};
...
static uint8 staff_mechanic_direction_surface(rct_peep * peep)
{
    ...
    if ((peep->state == PEEP_STATE_ANSWERING || peep->state == PEEP_STATE_HEADING_TO_INSPECTION) && scenario_rand() & 1)
    {
        ...
        rct_xy16 chosenTile = { .x = location.x * 32, .y = location.y * 32 };

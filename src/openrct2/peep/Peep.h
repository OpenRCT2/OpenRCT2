...
enum class PeepThoughtType : uint8_t
{
    ...
    TooIntense = 5,           // "X looks too intense for me"
    HaventFinished = 6,       // "I haven't finished my X yet"
    MakesMeFeelSick = 7,      // "Just looking at X makes me feel sick"
    RideTooExpensive = 8,     // "I'm not paying that much to go on X"
    WantToGoHome = 9,         // "I want to go home"
    GoodValue = 10,           // "X is really good value"
    AlreadyGot = 11,          // "I've already got"
    CantAfford = 12,          // "I can't afford"
    ...
    ToiletsTooExpensive = 24, // "I'm not paying that much to use X"
    ...
    WantToGetOff = 28,        // "I want to get off X"
    WantToGetOut = 29,        // "I want to get out of X"
    NotSafe = 30,             // "I'm not going on X - it isn't safe"
    Disgusting = 31,          // "This path is disgusting"
    Crowded = 32,             // "It's too crowded here"
    Vandalism = 33,           // "The vandalism here is really bad"
    GreatScenery = 34,        // "Great scenery!"
    VeryClean = 35,           // "This park is very clean and tidy"
    Fountains = 36,           // "The jumping fountains are great"
    Music = 37,               // "The music is nice here"
    BalloonGoodValue = 38,    // "This balloon from X is really good value"
    ToyGoodValue = 39,        // "This cuddly toy from X is really good value"
    MapGoodValue = 40,
    PhotoGoodValue = 41, // "This on ride photo from X is really good value"
    UmbrellaGoodValue = 42,
    DrinkGoodValue = 43,
    BurgerGoodValue = 44,
    ChipsGoodValue = 45,
    IceCreamGoodValue = 46,
    CandyFlossGoodValue = 47,

    PizzaGoodValue = 51,

    PopcornGoodValue = 53,
    HotDogGoodValue = 54,
    TentacleGoodValue = 55,
    HatGoodValue = 56,
    ToffeeAppleGoodValue = 57,
    TShirtGoodValue = 58,
    DoughnutGoodValue = 59,
    CoffeeGoodValue = 60,

    ChickenGoodValue = 62,
    LemonadeGoodValue = 63,

    Wow = 67, // "Wow!"

    Wow2 = 70,            // "Wow!"
    Watched = 71,         // "I have the strangest feeling someone is watching me"
    BalloonBadValue = 72, // "I'm not paying that much to get a balloon from X"
    ToyBadValue = 73,
    MapBadValue = 74,
    PhotoBadValue = 75,
    UmbrellaBadValue = 76,
    ...
    Photo2GoodValue = 104, // "This on-ride photo from X is really good value"
    Photo3GoodValue = 105,
    Photo4GoodValue = 106,
    PretzelGoodValue = 107,
    HotChocolateGoodValue = 108,
    IcedTeaGoodValue = 109,
    FunnelCakeGoodValue = 110,
    SunglassesGoodValue = 111,
    BeefNoodlesGoodValue = 112,
    FriedRiceNoodlesGoodValue = 113,
    WontonSoupGoodValue = 114,
    MeatballSoupGoodValue = 115,
    FruitJuiceGoodValue = 116,
    SoybeanMilkGoodValue = 117,
    SuJongkwaGoodValue = 118,
    SubSandwichGoodValue = 119,
    CookieGoodValue = 120,

    RoastSausageGoodValue = 124,

    Photo2BadValue = 136,
    Photo3BadValue = 137,
    Photo4BadValue = 138,
    PretzelBadValue = 139,
    HotChocolateBadValue = 140,
    IcedTeaBadValue = 141,
    FunnelCakeBadValue = 142,
    SunglassesBadValue = 143,
    BeefNoodlesBadValue = 144,
    FriedRiceNoodlesBadValue = 145,
    WontonSoupBadValue = 146,
    MeatballSoupBadValue = 147,
    FruitJuiceBadValue = 148,
    SoybeanMilkBadValue = 149,
    SuJongkwaBadValue = 150,
    SubSandwichBadValue = 151,
    CookieBadValue = 152,

    RoastSausageBadValue = 156,

    Help = 168,               // "Help! Put me down!"
    RunningOutOfCash = 169,   // "I'm running out of cash!"
    NewRideBeingBuilt = 170,  // "Wow! A new ride being built!"

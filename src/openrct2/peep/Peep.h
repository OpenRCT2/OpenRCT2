...
enum PEEP_RIDE_SUB_STATE
{
    ...
    PEEP_RIDE_SS_APPROACH_VEHICLE = 4,
    PEEP_RIDE_SS_ENTER_VEHICLE = 5,
    PEEP_RIDE_SS_ON_RIDE = 6,
    PEEP_RIDE_SS_LEAVE_VEHICLE = 7,
    PEEP_RIDE_SS_APPROACH_EXIT = 8,
    PEEP_RIDE_SS_IN_EXIT = 9,
    // 10, 11 not used
    PEEP_RIDE_SS_APPROACH_VEHICLE_WAYPOINTS = 12,
    PEEP_RIDE_SS_APPROACH_EXIT_WAYPOINTS = 13,
    PEEP_RIDE_SS_APPROACH_SPIRAL_SLIDE = 14,
    PEEP_RIDE_SS_ON_SPIRAL_SLIDE = 15,
    PEEP_RIDE_SS_LEAVE_SPIRAL_SLIDE = 16,
    PEEP_RIDE_SS_MAZE_PATHFINDING = 17,
    PEEP_RIDE_SS_LEAVE_EXIT = 18,
    PEEP_SHOP_SS_APPROACH = 19,
    PEEP_SHOP_SS_INTERACT = 20,
    PEEP_SHOP_SS_LEAVE = 21
};

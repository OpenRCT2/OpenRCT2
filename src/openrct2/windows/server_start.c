...
static rct_window_event_list window_server_start_events = { window_server_start_close,
...
void window_server_start_open()
{
    ...
    window->enabled_widgets =
        ((1 << WIDX_CLOSE) | (1 << WIDX_PORT_INPUT) | (1 << WIDX_NAME_INPUT) | (1 << WIDX_PASSWORD_INPUT) |
         (1 << WIDX_MAXPLAYERS) | (1 << WIDX_MAXPLAYERS_INCREASE) | (1 << WIDX_MAXPLAYERS_DECREASE) |
         (1 << WIDX_ADVERTISE_CHECKBOX) | (1 << WIDX_START_SERVER) | (1 << WIDX_LOAD_SERVER));

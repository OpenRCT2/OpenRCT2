...
static rct_window_event_list window_install_track_events = { window_install_track_close,
...
static void window_install_track_design(rct_window * w)
{
    ...
    if (platform_file_exists(destPath))
    {
        ...
        window_text_input_raw_open(w, WIDX_INSTALL, STR_SELECT_NEW_NAME_FOR_TRACK_DESIGN,
                                   STR_AN_EXISTING_TRACK_DESIGN_ALREADY_HAS_THIS_NAME, _trackName, 255);
    }
    else
    {

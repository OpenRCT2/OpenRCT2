...
static rct_window_event_list window_changelog_events = { window_changelog_close,
...
rct_window * window_changelog_open()
{
    ...
    window =
        window_create_centred(screenWidth * 4 / 5, screenHeight * 4 / 5, &window_changelog_events, WC_CHANGELOG, WF_RESIZABLE);

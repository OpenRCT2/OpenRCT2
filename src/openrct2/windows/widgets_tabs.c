...
const tab_animation *_animations[] = {
    ...
    &TAB_GRAPH,
    &TAB_ADMISSION,
    &TAB_FINANCES_SUMMARY,
    &TAB_THOUGHTS,
    &TAB_STATS,
    &TAB_PEEP_LARGE_FACE_VERY_SICK,
    &TAB_PEEP_LARGE_FACE_VERY_VERY_SICK,
    &TAB_PEEP_LARGE_FACE_ANGRY,
    &TAB_STAFF_OPTIONS,
    &TAB_FINANCES_RESEARCH,
    &TAB_MUSIC,
    &TAB_SHOPS_AND_STALLS,
    &TAB_KIOSKS_AND_FACILITIES,
    &TAB_FINANCES_FINANCIAL_GRAPH,
    &TAB_FINANCES_PROFIT_GRAPH,
    &TAB_FINANCES_VALUE_GRAPH,
    &TAB_FINANCES_MARKETING,
    &TAB_RIDE,
    &TAB_OBJECTIVE,
    &TAB_RIDES_SHOP,
    &TAB_RIDES_TRANSPORT,
    &TAB_RIDES_GENTLE,
    &TAB_RIDES_ROLLER_COASTERS,
    &TAB_RIDES_WATER,
    &TAB_RIDES_THRILL,
    &TAB_GUESTS,
};

...
static rct_widget * window_editor_scenario_options_widgets[] = { window_editor_scenario_options_financial_widgets,
...
// 0x0097EB60
static rct_window_event_list window_scenario_options_financial_events = { NULL,
...
// 0x0097EBD0
static rct_window_event_list window_scenario_options_guests_events = { NULL,
...
// 0x0097EC40
static rct_window_event_list window_scenario_options_park_events = { NULL,
...
static rct_window_event_list * window_editor_scenario_options_page_events[] = { &window_scenario_options_financial_events,
...
static uint64 window_editor_scenario_options_page_enabled_widgets[] = { 0x001DB6F4, 0x001EDB74, 0x007F7B74 };

static uint32 window_editor_scenario_options_page_hold_down_widgets[] = { 0x000DB600, 0x0006DB00, 0x00031B00 };
...
static void window_editor_scenario_options_park_mousedown(int widgetIndex, rct_window * w, rct_widget * widget)
{
    ...
    case WIDX_PAY_FOR_PARK_OR_RIDES_DROPDOWN:
        ...
        window_dropdown_show_text_custom_width(w->x + dropdownWidget->left, w->y + dropdownWidget->top,
                                               ...
                                               DROPDOWN_FLAG_STAY_OPEN, 2, dropdownWidget->right - dropdownWidget->left - 3);

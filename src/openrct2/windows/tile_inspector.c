...
static const rct_string_id terrainEdgeTypeStringIds[] = {
    STR_TILE_INSPECTOR_TERRAIN_EDGE_ROCK, STR_TILE_INSPECTOR_TERRAIN_EDGE_WOOD_RED, STR_TILE_INSPECTOR_TERRAIN_EDGE_WOOD_BLACK,
    STR_TILE_INSPECTOR_TERRAIN_EDGE_ICE,

};

static const rct_string_id entranceTypeStringIds[] = {
    STR_TILE_INSPECTOR_ENTRANCE_TYPE_RIDE_ENTRANCE, STR_TILE_INSPECTOR_ENTRANCE_TYPE_RIDE_EXIT,
    STR_TILE_INSPECTOR_ENTRANCE_TYPE_PARK_ENTRANC,
};

static const rct_string_id parkEntrancePartStringIds[] = { STR_TILE_INSPECTOR_ENTRANCE_MIDDLE, STR_TILE_INSPECTOR_ENTRANCE_LEFT,
                                                           STR_TILE_INSPECTOR_ENTRANCE_RIGHT };

static const rct_string_id fenceSlopeStringIds[] = { STR_TILE_INSPECTOR_FENCE_FLAT, STR_TILE_INSPECTOR_FENCE_SLOPED_LEFT,
...
#define MAIN_TILE_INSPECTOR_WIDGETS                                                                                            \
    { WWT_FRAME, 0, 0, WW - 1, 0, WH - 1, 0xFFFFFFFF, STR_NONE },                                  /* panel / background */    \
        ...
        { WWT_DROPDOWN_BUTTON, 1, 108, 117, 29, 33, STR_NUMERIC_DOWN, STR_NONE }, /* decrease Y */ /* Buttons */               \
        { WWT_FLATBTN, 1, BX, BW, BY, BH, SPR_MAP, STR_INSERT_CORRUPT_TIP },                       /* Insert corrupt button */ \
        {                                                                                                                      \
          WWT_FLATBTN, 1, BX - BS * 1, BW - BS * 1, BY, BH, SPR_DEMOLISH, STR_REMOVE_SELECTED_ELEMENT_TIP                      \
        }, /* Remove button */                                                                                                 \
        { WWT_CLOSEBOX, 1, BX - BS * 2, BW - BS * 2, BY, BY + 11, STR_UP, STR_MOVE_SELECTED_ELEMENT_UP_TIP }, /* Move down */  \
        {                                                                                                                      \
          WWT_CLOSEBOX, 1, BX - BS * 2, BW - BS * 2, BH - 11, BH, STR_DOWN, STR_MOVE_SELECTED_ELEMENT_DOWN_TIP                 \
        }, /* Move up */                                                                                                       \
        {                                                                                                                      \
          WWT_FLATBTN, 1, BX - BS * 3, BW - BS * 3, BY, BH, SPR_ROTATE_ARROW, STR_ROTATE_SELECTED_ELEMENT_TIP                  \
        },                                                                                              /* Rotate button */    \
        ...
        { WWT_FLATBTN, 1, BX - BS * 6, BW - BS * 6, BY, BH, SPR_G2_PASTE, STR_TILE_INSPECTOR_PASTE_TIP },                      \
        /* Paste button */                                                                            /* Column headers */     \
        ...
        {                                                                                                                      \
          WWT_13, 1, COL_X_CH, COL_X_GF - 1, 42, 42 + 13, STR_NONE, STR_TILE_INSPECTOR_CLEARANCE_HEIGHT                        \
        },                                                                                            /* Clearance height */   \
    ...
    {                                                                                                                          \
        WWT_GROUPBOX, 1, 6, WW - 6, -1, -1, STR_TILE_INSPECTOR_GROUPBOX_PROPERTIES, STR_NONE                                   \
    } /* Properties group box */

static rct_widget windowTileInspectorWidgets[] = {
    MAIN_TILE_INSPECTOR_WIDGETS, { WIDGETS_END },
};
...
static rct_widget windowTileInspectorWidgetsSurface[] = {
    ...
    { WWT_CLOSEBOX, 1, GBB(WH - SUR_GBPT, 0, 1), STR_TILE_INSPECTOR_SURFACE_REMOVE_FENCES,
      STR_NONE }, // WIDX_SURFACE_BUTTON_REMOVE_FENCES
    { WWT_CLOSEBOX, 1, GBB(WH - SUR_GBPT, 1, 1), STR_TILE_INSPECTOR_SURFACE_RESTORE_FENCES,
      STR_NONE }, // WIDX_SURFACE_BUTTON_RESTORE_FENCES
    { WWT_CHECKBOX, 1, CHK(GBBL(1) + 14 * 1, GBBT(WH - SUR_GBPT, 2) + 7 * 0), STR_NONE,
      STR_NONE }, // WIDX_SURFACE_CHECK_CORNER_N
    { WWT_CHECKBOX, 1, CHK(GBBL(1) + 14 * 2, GBBT(WH - SUR_GBPT, 2) + 7 * 1), STR_NONE,
      STR_NONE }, // WIDX_SURFACE_CHECK_CORNER_E
    { WWT_CHECKBOX, 1, CHK(GBBL(1) + 14 * 1, GBBT(WH - SUR_GBPT, 2) + 7 * 2), STR_NONE,
      STR_NONE }, // WIDX_SURFACE_CHECK_CORNER_S
    { WWT_CHECKBOX, 1, CHK(GBBL(1) + 14 * 0, GBBT(WH - SUR_GBPT, 2) + 7 * 1), STR_NONE,
      STR_NONE }, // WIDX_SURFACE_CHECK_CORNER_W
    { WWT_CHECKBOX, 1, GBBF(WH - SUR_GBPT, 0, 4), STR_TILE_INSPECTOR_SURFACE_DIAGONAL,
      STR_NONE }, // WIDX_SURFACE_CHECK_DIAGONAL
    { WIDGETS_END },
};
...
static rct_widget windowTileInspectorWidgetsTrack[] = {
    ...
    { WWT_CHECKBOX, 1, GBBF(WH - TRA_GBPT, 0, 0), STR_TILE_INSPECTOR_TRACK_ENTIRE_TRACK_PIECE,
      STR_NONE },                                                                      // WIDX_TRACK_CHECK_APPLY_TO_ALL
    ...
    { WWT_CHECKBOX, 1, GBBF(WH - TRA_GBPT, 0, 2), STR_TILE_INSPECTOR_TRACK_CHAIN_LIFT,
      STR_NONE }, // WIDX_TRACK_CHECK_CHAIN_LIFT
    { WIDGETS_END },
};
...
static rct_widget windowTileInspectorWidgetsScenery[] = {
    ...
    { WWT_CHECKBOX, 1, CHK(GBBL(1) + 14 * 1, GBBT(WH - SCE_GBPT, 1) + 7 * 0), STR_NONE,
      STR_NONE }, // WIDX_SCENERY_CHECK_QUARTER_N
    { WWT_CHECKBOX, 1, CHK(GBBL(1) + 14 * 2, GBBT(WH - SCE_GBPT, 1) + 7 * 1), STR_NONE,
      STR_NONE }, // WIDX_SCENERY_CHECK_QUARTER_E
    { WWT_CHECKBOX, 1, CHK(GBBL(1) + 14 * 1, GBBT(WH - SCE_GBPT, 1) + 7 * 2), STR_NONE,
      STR_NONE }, // WIDX_SCENERY_CHECK_QUARTER_S
    { WWT_CHECKBOX, 1, CHK(GBBL(1) + 14 * 0, GBBT(WH - SCE_GBPT, 1) + 7 * 1), STR_NONE,
      STR_NONE }, // WIDX_SCENERY_CHECK_QUARTER_W
    { WWT_CHECKBOX, 1, CHK(GBBL(1) + 14 * 1, GBBT(WH - SCE_GBPT, 2) + 7 * 0), STR_NONE,
      STR_NONE }, // WIDX_SCENERY_CHECK_COLLISION_N
    { WWT_CHECKBOX, 1, CHK(GBBL(1) + 14 * 2, GBBT(WH - SCE_GBPT, 2) + 7 * 1), STR_NONE,
      STR_NONE }, // WIDX_SCENERY_CHECK_COLLISION_E
    { WWT_CHECKBOX, 1, CHK(GBBL(1) + 14 * 1, GBBT(WH - SCE_GBPT, 2) + 7 * 2), STR_NONE,
      STR_NONE }, // WIDX_SCENERY_CHECK_COLLISION_S
    { WWT_CHECKBOX, 1, CHK(GBBL(1) + 14 * 0, GBBT(WH - SCE_GBPT, 2) + 7 * 1), STR_NONE,
      STR_NONE }, // WIDX_SCENERY_CHECK_COLLISION_W
    { WIDGETS_END },
};
...
static rct_widget windowTileInspectorWidgetsLargeScenery[] = {
    ...
    { WWT_DROPDOWN_BUTTON, 1, GBSI(WH - LAR_GBPT, 1, 0), STR_NUMERIC_UP,
      STR_NONE }, // WIDX_LARGE_SCENERY_SPINNER_HEIGHT_INCREASE
    { WWT_DROPDOWN_BUTTON, 1, GBSD(WH - LAR_GBPT, 1, 0), STR_NUMERIC_DOWN,
      STR_NONE }, // WIDX_LARGE_SCENERY_SPINNER_HEIGHT_DECREASE
    { WIDGETS_END },
};
...
static rct_widget windowTileInspectorWidgetsBanner[] = {
    ...
    { WWT_CHECKBOX, 1, CHK(GBBL(1) + 14 * 3, GBBT(WH - BAN_GBPT, 1) + 7 * 1), STR_NONE,
      STR_NONE }, // WIDX_BANNER_CHECK_BLOCK_NE
    { WWT_CHECKBOX, 1, CHK(GBBL(1) + 14 * 3, GBBT(WH - BAN_GBPT, 1) + 7 * 3), STR_NONE,
      STR_NONE }, // WIDX_BANNER_CHECK_BLOCK_SE
    { WWT_CHECKBOX, 1, CHK(GBBL(1) + 14 * 1, GBBT(WH - BAN_GBPT, 1) + 7 * 3), STR_NONE,
      STR_NONE }, // WIDX_BANNER_CHECK_BLOCK_SW
    { WWT_CHECKBOX, 1, CHK(GBBL(1) + 14 * 1, GBBT(WH - BAN_GBPT, 1) + 7 * 1), STR_NONE,
      STR_NONE }, // WIDX_BANNER_CHECK_BLOCK_NW
...
static rct_widget windowTileInspectorWidgetsCorrupt[] = {
    ...
    { WWT_CLOSEBOX, 1, GBB(WH - SUR_GBPT, 0, 1), STR_TILE_INSPECTOR_CLAMP_TO_NEXT,
      STR_TILE_INSPECTOR_CLAMP_TO_NEXT_TIP }, // WIDX_CORRUPT_BUTTON_CLAMP
    { WIDGETS_END },
};

static rct_widget * tileInspectorWidgets[] = {
    windowTileInspectorWidgets,        windowTileInspectorWidgetsSurface,      windowTileInspectorWidgetsPath,
    windowTileInspectorWidgetsTrack,   windowTileInspectorWidgetsScenery,      windowTileInspectorWidgetsEntrance,
    windowTileInspectorWidgetsFence,   windowTileInspectorWidgetsLargeScenery, windowTileInspectorWidgetsBanner,
...
} pageGroupBoxSettings[] = { { SUR_GBDT, SUR_GBDB, SUR_GBPT, SUR_GBPB, STR_TILE_INSPECTOR_GROUPBOX_SURFACE_INFO },
...
static rct_window_event_list windowTileInspectorEvents = { NULL,
...
static uint64 windowTileInspectorEnabledWidgets[] = {
    ...
    (1ULL << WIDX_CLOSE) | (1ULL << WIDX_BUTTON_CORRUPT) | (1ULL << WIDX_BUTTON_REMOVE) | (1ULL << WIDX_BUTTON_ROTATE) |
        (1ULL << WIDX_BUTTON_COPY) | (1ULL << WIDX_SURFACE_SPINNER_HEIGHT_INCREASE) |
        (1ULL << WIDX_SURFACE_SPINNER_HEIGHT_DECREASE) | (1ULL << WIDX_SURFACE_BUTTON_REMOVE_FENCES) |
        (1ULL << WIDX_SURFACE_BUTTON_RESTORE_FENCES) | (1ULL << WIDX_SURFACE_CHECK_CORNER_N) |
        (1ULL << WIDX_SURFACE_CHECK_CORNER_E) | (1ULL << WIDX_SURFACE_CHECK_CORNER_S) | (1ULL << WIDX_SURFACE_CHECK_CORNER_W) |
        (1ULL << WIDX_SURFACE_CHECK_DIAGONAL),
    (1ULL << WIDX_CLOSE) | (1ULL << WIDX_BUTTON_CORRUPT) | (1ULL << WIDX_BUTTON_REMOVE) | (1ULL << WIDX_BUTTON_ROTATE) |
        (1ULL << WIDX_BUTTON_COPY) | (1ULL << WIDX_PATH_SPINNER_HEIGHT_INCREASE) | (1ULL << WIDX_PATH_SPINNER_HEIGHT_DECREASE) |
        (1ULL << WIDX_PATH_CHECK_EDGE_N) | (1ULL << WIDX_PATH_CHECK_EDGE_NE) | (1ULL << WIDX_PATH_CHECK_EDGE_E) |
        (1ULL << WIDX_PATH_CHECK_EDGE_SE) | (1ULL << WIDX_PATH_CHECK_EDGE_S) | (1ULL << WIDX_PATH_CHECK_EDGE_SW) |
        (1ULL << WIDX_PATH_CHECK_EDGE_W) | (1ULL << WIDX_PATH_CHECK_EDGE_NW),
    (1ULL << WIDX_CLOSE) | (1ULL << WIDX_BUTTON_CORRUPT) | (1ULL << WIDX_BUTTON_REMOVE) | (1ULL << WIDX_BUTTON_ROTATE) |
        (1ULL << WIDX_BUTTON_COPY) | (1ULL << WIDX_TRACK_CHECK_APPLY_TO_ALL) | (1ULL << WIDX_TRACK_SPINNER_HEIGHT_INCREASE) |
        (1ULL << WIDX_TRACK_SPINNER_HEIGHT_DECREASE) | (1ULL << WIDX_TRACK_CHECK_CHAIN_LIFT),
    (1ULL << WIDX_CLOSE) | (1ULL << WIDX_BUTTON_CORRUPT) | (1ULL << WIDX_BUTTON_REMOVE) | (1ULL << WIDX_BUTTON_ROTATE) |
        (1ULL << WIDX_BUTTON_COPY) | (1ULL << WIDX_SCENERY_SPINNER_HEIGHT_INCREASE) |
        (1ULL << WIDX_SCENERY_SPINNER_HEIGHT_DECREASE) | (1ULL << WIDX_SCENERY_CHECK_QUARTER_N) |
        (1ULL << WIDX_SCENERY_CHECK_QUARTER_E) | (1ULL << WIDX_SCENERY_CHECK_QUARTER_S) |
        (1ULL << WIDX_SCENERY_CHECK_QUARTER_W) | (1ULL << WIDX_SCENERY_CHECK_COLLISION_N) |
        (1ULL << WIDX_SCENERY_CHECK_COLLISION_E) | (1ULL << WIDX_SCENERY_CHECK_COLLISION_S) |
        (1ULL << WIDX_SCENERY_CHECK_COLLISION_W),
    (1ULL << WIDX_CLOSE) | (1ULL << WIDX_BUTTON_CORRUPT) | (1ULL << WIDX_BUTTON_REMOVE) | (1ULL << WIDX_BUTTON_ROTATE) |
        (1ULL << WIDX_BUTTON_COPY) | (1ULL << WIDX_ENTRANCE_SPINNER_HEIGHT_INCREASE) |
        (1ULL << WIDX_ENTRANCE_SPINNER_HEIGHT_DECREASE),
    (1ULL << WIDX_CLOSE) | (1ULL << WIDX_BUTTON_CORRUPT) | (1ULL << WIDX_BUTTON_REMOVE) | (1ULL << WIDX_BUTTON_ROTATE) |
        (1ULL << WIDX_BUTTON_COPY) | (1ULL << WIDX_FENCE_SPINNER_HEIGHT_INCREASE) |
        (1ULL << WIDX_FENCE_SPINNER_HEIGHT_DECREASE) | (1ULL << WIDX_FENCE_DROPDOWN_SLOPE) |
        (1ULL << WIDX_FENCE_DROPDOWN_SLOPE_BUTTON),
    (1ULL << WIDX_CLOSE) | (1ULL << WIDX_BUTTON_CORRUPT) | (1ULL << WIDX_BUTTON_REMOVE) | (1ULL << WIDX_BUTTON_COPY) |
        (1ULL << WIDX_LARGE_SCENERY_SPINNER_HEIGHT) | (1ULL << WIDX_LARGE_SCENERY_SPINNER_HEIGHT_INCREASE) |
        (1ULL << WIDX_LARGE_SCENERY_SPINNER_HEIGHT_DECREASE),
    (1ULL << WIDX_CLOSE) | (1ULL << WIDX_BUTTON_CORRUPT) | (1ULL << WIDX_BUTTON_REMOVE) | (1ULL << WIDX_BUTTON_ROTATE) |
        (1ULL << WIDX_BUTTON_COPY) | (1ULL << WIDX_BANNER_SPINNER_HEIGHT) | (1ULL << WIDX_BANNER_SPINNER_HEIGHT_INCREASE) |
        (1ULL << WIDX_BANNER_SPINNER_HEIGHT_DECREASE) | (1ULL << WIDX_BANNER_CHECK_BLOCK_NE) |
        (1ULL << WIDX_BANNER_CHECK_BLOCK_SE) | (1ULL << WIDX_BANNER_CHECK_BLOCK_SW) | (1ULL << WIDX_BANNER_CHECK_BLOCK_NW),
    (1ULL << WIDX_CLOSE) | (1ULL << WIDX_BUTTON_CORRUPT) | (1ULL << WIDX_BUTTON_REMOVE) | (1ULL << WIDX_BUTTON_COPY) |
        (1ULL << WIDX_CORRUPT_SPINNER_HEIGHT) | (1ULL << WIDX_CORRUPT_SPINNER_HEIGHT_INCREASE) |
        (1ULL << WIDX_CORRUPT_SPINNER_HEIGHT_DECREASE) | (1ULL << WIDX_CORRUPT_BUTTON_CLAMP),
};

static uint64 windowTileInspectorDisabledWidgets[] = {
    (1ULL << WIDX_BUTTON_CORRUPT) | (1ULL << WIDX_BUTTON_MOVE_UP) | (1ULL << WIDX_BUTTON_MOVE_DOWN) |
        (1ULL << WIDX_BUTTON_REMOVE) | (1ULL << WIDX_BUTTON_ROTATE) | (1ULL << WIDX_BUTTON_COPY),
    0, 0, 0, 0, 0, 0, (1ULL << WIDX_BUTTON_ROTATE), 0, (1ULL << WIDX_BUTTON_ROTATE),
};
...
void window_tile_inspector_open()
{
    ...
    window = window_create(0, 29, WW, WH, &windowTileInspectorEvents, WC_TILE_INSPECTOR, WF_RESIZABLE);
...
static void window_tile_inspector_insert_corrupt_element(rct_window * w)
{
    ...
    rct_map_element * curruptElement = map_element_insert(windowTileInspectorTileX, windowTileInspectorTileY, -1,
                                                          0); // Ugly hack: -1 guarantees this to be placed first
    ...
    for (int i = 0; i < w->selected_list_item; i++)
    {
...
static void window_tile_inspector_sort_elements(rct_window * w)
{
    ...
    // Bubble sort
    for (int loopStart = 1; loopStart < windowTileInspectorElementCount; loopStart++)
    {
        int                     currentId      = loopStart;
...
static void window_tile_inspector_paste_element(rct_window * w)
{
    rct_map_element * const pastedElement =
        map_element_insert(windowTileInspectorTileX, windowTileInspectorTileY, tileInspectorCopiedElement.base_height, 0);
...
static void window_tile_inspector_surface_toggle_corner(rct_map_element * mapElement, int cornerIndex)
{
    ...
    if ((mapElement->properties.surface.slope & 0x0F) == 0x0F)
    {
        ...
        if (diagonal)
        {
            ...
            {
            case 0b1011:
                mapElement->properties.surface.slope |= (1 << 0);
                break;
            case 0b0111:
                mapElement->properties.surface.slope |= (1 << 1);
                break;
            case 0b1110:
                mapElement->properties.surface.slope |= (1 << 2);
                break;
            case 0b1101:
                mapElement->properties.surface.slope |= (1 << 3);
                break;
            }
        }
...
static void window_tile_inspector_track_block_height_offset(rct_map_element * mapElement, uint8 offset)
{
    ...
    for (; trackBlock->index != 255; trackBlock++)
    {
        ...
        // track_remove returns here on failure, not sure when this would ever be hit. Only thing I can think of is for when you
...
static void window_tile_inspector_mouseup(rct_window * w, int widgetIndex)
{
    ...
    case PAGE_SURFACE:
        ...
        case WIDX_SURFACE_CHECK_CORNER_W:
            window_tile_inspector_surface_toggle_corner(
                mapElement, ((widgetIndex - WIDX_SURFACE_CHECK_CORNER_N) + 2 - get_current_rotation()) & 3);
            map_invalidate_tile_full(windowTileInspectorTileX << 5, windowTileInspectorTileY << 5);
            window_invalidate(w);
            break;
    ...
    case PAGE_PATH:
        ...
        case WIDX_PATH_CHECK_EDGE_N:
            ...
            mapElement->properties.path.edges ^=
                (1 << (4 + (((widgetIndex - WIDX_PATH_CHECK_EDGE_E) / 2 - get_current_rotation()) & 3))) & 0xF0;
            map_invalidate_tile_full(windowTileInspectorTileX << 5, windowTileInspectorTileY << 5);
            break;
        ...
        case WIDX_PATH_CHECK_EDGE_NW:
            widget_set_checkbox_value(w, widgetIndex, !widget_is_pressed(w, widgetIndex));
            mapElement->properties.path.edges ^=
                (1 << (((widgetIndex - WIDX_PATH_CHECK_EDGE_NE) / 2 - get_current_rotation()) & 3)) & 0x0F;
            map_invalidate_tile_full(windowTileInspectorTileX << 5, windowTileInspectorTileY << 5);
            break;
        } // switch widget index
        break;
    ...
    case PAGE_BANNER:
        ...
        case WIDX_BANNER_CHECK_BLOCK_NW:
            mapElement->properties.banner.flags ^= 1
                                                   << ((widgetIndex - WIDX_BANNER_CHECK_BLOCK_NE - get_current_rotation()) & 3);
            map_invalidate_tile_full(windowTileInspectorTileX << 5, windowTileInspectorTileY << 5);
            widget_invalidate(w, widgetIndex);
            break;
        } // switch widget index
...
static void window_tile_inspector_mousedown(int widgetIndex, rct_window * w, rct_widget * widget)
{
    ...
    case PAGE_FENCE:
        ...
        case WIDX_FENCE_DROPDOWN_SLOPE_BUTTON:
            ...
            window_dropdown_show_text_custom_width(w->x + widget->left, w->y + widget->top, widget->bottom - widget->top + 1,
                                                   w->colours[1], DROPDOWN_FLAG_STAY_OPEN, 3, widget->right - widget->left - 3);
...
static void window_tile_inspector_auto_set_buttons(rct_window * w)
{
    ...
    // Move Down button
    widget_set_enabled(w, WIDX_BUTTON_MOVE_DOWN,
                       (w->selected_list_item != -1 && w->selected_list_item < windowTileInspectorElementCount - 1));
...
static void window_tile_inspector_invalidate(rct_window * w)
{
    ...
    case PAGE_SURFACE:
        ...
        widget_set_checkbox_value(w, WIDX_SURFACE_CHECK_CORNER_N,
                                  mapElement->properties.surface.slope & (1 << ((2 - get_current_rotation()) & 3)));
        widget_set_checkbox_value(w, WIDX_SURFACE_CHECK_CORNER_E,
                                  mapElement->properties.surface.slope & (1 << ((3 - get_current_rotation()) & 3)));
        widget_set_checkbox_value(w, WIDX_SURFACE_CHECK_CORNER_S,
                                  mapElement->properties.surface.slope & (1 << ((0 - get_current_rotation()) & 3)));
        widget_set_checkbox_value(w, WIDX_SURFACE_CHECK_CORNER_W,
                                  mapElement->properties.surface.slope & (1 << ((1 - get_current_rotation()) & 3)));
    ...
    case PAGE_PATH:
        ...
        widget_set_checkbox_value(w, WIDX_PATH_CHECK_EDGE_NE,
                                  mapElement->properties.path.edges & (1 << ((0 - get_current_rotation()) & 3)));
        widget_set_checkbox_value(w, WIDX_PATH_CHECK_EDGE_SE,
                                  mapElement->properties.path.edges & (1 << ((1 - get_current_rotation()) & 3)));
        widget_set_checkbox_value(w, WIDX_PATH_CHECK_EDGE_SW,
                                  mapElement->properties.path.edges & (1 << ((2 - get_current_rotation()) & 3)));
        widget_set_checkbox_value(w, WIDX_PATH_CHECK_EDGE_NW,
                                  mapElement->properties.path.edges & (1 << ((3 - get_current_rotation()) & 3)));
        widget_set_checkbox_value(w, WIDX_PATH_CHECK_EDGE_E,
                                  mapElement->properties.path.edges & (1 << (4 + ((0 - get_current_rotation()) & 3))));
        widget_set_checkbox_value(w, WIDX_PATH_CHECK_EDGE_S,
                                  mapElement->properties.path.edges & (1 << (4 + ((1 - get_current_rotation()) & 3))));
        widget_set_checkbox_value(w, WIDX_PATH_CHECK_EDGE_W,
                                  mapElement->properties.path.edges & (1 << (4 + ((2 - get_current_rotation()) & 3))));
        widget_set_checkbox_value(w, WIDX_PATH_CHECK_EDGE_N,
                                  mapElement->properties.path.edges & (1 << (4 + ((3 - get_current_rotation()) & 3))));
        break;
    case PAGE_TRACK:
    ...
    case PAGE_BANNER:
        ...
        widget_set_checkbox_value(w, WIDX_BANNER_CHECK_BLOCK_NE,
                                  !(mapElement->properties.banner.flags & (1 << ((0 - get_current_rotation()) & 3))));
        widget_set_checkbox_value(w, WIDX_BANNER_CHECK_BLOCK_SE,
                                  !(mapElement->properties.banner.flags & (1 << ((1 - get_current_rotation()) & 3))));
        widget_set_checkbox_value(w, WIDX_BANNER_CHECK_BLOCK_SW,
                                  !(mapElement->properties.banner.flags & (1 << ((2 - get_current_rotation()) & 3))));
        widget_set_checkbox_value(w, WIDX_BANNER_CHECK_BLOCK_NW,
                                  !(mapElement->properties.banner.flags & (1 << ((3 - get_current_rotation()) & 3))));
        break;
    case PAGE_CORRUPT:
...
static void window_tile_inspector_paint(rct_window * w, rct_drawpixelinfo * dpi)
{
    ...
    {
        gfx_draw_string_left_clipped(dpi, STR_TILE_INSPECTOR_ELEMENT_TYPE, gCommonFormatArgs, w->colours[1],
                                     w->x + widget->left + 1, w->y + widget->top + 1, widget->right - widget->left);
    }
    if ((widget = &w->widgets[WIDX_COLUMN_BASEHEIGHT])->type != WWT_EMPTY)
    {
        gfx_draw_string_left_clipped(dpi, STR_TILE_INSPECTOR_BASE_HEIGHT_SHORT, gCommonFormatArgs, w->colours[1],
                                     w->x + widget->left + 1, w->y + widget->top + 1, widget->right - widget->left);
    }
    if ((widget = &w->widgets[WIDX_COLUMN_CLEARANCEHEIGHT])->type != WWT_EMPTY)
    {
        gfx_draw_string_left_clipped(dpi, STR_TILE_INSPECTOR_CLEARANGE_HEIGHT_SHORT, gCommonFormatArgs, w->colours[1],
                                     w->x + widget->left + 1, w->y + widget->top + 1, widget->right - widget->left);
    }
    if ((widget = &w->widgets[WIDX_COLUMN_GHOSTFLAG])->type != WWT_EMPTY)
    {
        gfx_draw_string_left_clipped(dpi, STR_TILE_INSPECTOR_FLAG_GHOST_SHORT, gCommonFormatArgs, w->colours[1],
                                     w->x + widget->left + 1, w->y + widget->top + 1, widget->right - widget->left);
    }
    if ((widget = &w->widgets[WIDX_COLUMN_BROKENFLAG])->type != WWT_EMPTY)
    {
        gfx_draw_string_left_clipped(dpi, STR_TILE_INSPECTOR_FLAG_BROKEN_SHORT, gCommonFormatArgs, w->colours[1],
                                     w->x + widget->left + 1, w->y + widget->top + 1, widget->right - widget->left);
    }
    if ((widget = &w->widgets[WIDX_COLUMN_LASTFLAG])->type != WWT_EMPTY)
    {
        gfx_draw_string_left_clipped(dpi, STR_TILE_INSPECTOR_FLAG_LAST_SHORT, gCommonFormatArgs, w->colours[1],
                                     w->x + widget->left + 1, w->y + widget->top + 1, widget->right - widget->left);
    }
    ...
    if (w->selected_list_item != -1)
    {
        ...
        case PAGE_SURFACE:
        {
            ...
            openrct2_assert(idx < countof(terrainEdgeTypeStringIds),
            ...
            else if (mapElement->properties.surface.ownership & OWNERSHIP_CONSTRUCTION_RIGHTS_OWNED)
        ...
        case PAGE_SCENERY:
        {
            ...
            // Quadrant value
            if (!(get_small_scenery_entry(mapElement->properties.scenery.type)->small_scenery.flags &
                  SMALL_SCENERY_FLAG_FULL_TILE))
            {
                ...
                gfx_draw_string_left(dpi, STR_TILE_INSPECTOR_SCENERY_QUADRANT, &quadrant_string_idx[quadrant],
                                     COLOUR_DARK_GREEN, x, y + 11);
            }
        ...
        case PAGE_ENTRANCE:
        {
            ...
            if (mapElement->properties.entrance.type == ENTRANCE_TYPE_PARK_ENTRANCE)
            {
                ...
                gfx_draw_string_left(dpi, STR_TILE_INSPECTOR_ENTRANCE_ENTRANCE_ID, &parkEntranceIndex, COLOUR_DARK_GREEN, x,
                                     y + 11);
            }
            else
            {
                ...
                {
                    // Ride entrance ID
                    gfx_draw_string_left(dpi, STR_TILE_INSPECTOR_ENTRANCE_ENTRANCE_ID, &rideEntranceIndex, COLOUR_DARK_GREEN, x,
                                         y + 11);
                }
                else
                {
                    // Ride exit ID
                    gfx_draw_string_left(dpi, STR_TILE_INSPECTOR_ENTRANCE_EXIT_ID, &rideEntranceIndex, COLOUR_DARK_GREEN, x,
                                         y + 11);
                }
            }
        ...
        case PAGE_FENCE:
        {
            ...
            {
                gfx_draw_string_left(dpi, STR_TILE_INSPECTOR_ENTRY_BANNER_TEXT,
                                     &gBanners[mapElement->properties.fence.item[0]].string_idx, COLOUR_DARK_GREEN, x, y + 11);
            }
            else
            {
        ...
        case PAGE_LARGE_SCENERY:
        {
            ...
            // Banner info
            rct_scenery_entry * largeSceneryEntry =
                get_large_scenery_entry(mapElement->properties.scenerymultiple.type & MAP_ELEMENT_LARGE_TYPE_MASK);
            if (largeSceneryEntry->large_scenery.var_11 != 0xFF)
            {
                ...
                gfx_draw_string_left(dpi, STR_TILE_INSPECTOR_ENTRY_BANNER_TEXT, &gBanners[bannerIndex].string_idx,
...
static void window_tile_inspector_scrollpaint(rct_window * w, rct_drawpixelinfo * dpi, int scrollIndex)
{
    ...
    do
    {
        ...
        char * typeName;
        int    baseHeight      = mapElement->base_height;
        int    clearanceHeight = mapElement->clearance_height;

        // Fill colour for current list element
        const int listWidth = w->widgets[WIDX_LIST].right - w->widgets[WIDX_LIST].left;
        ...
        case MAP_ELEMENT_TYPE_TRACK:
            ...
            break;
        case MAP_ELEMENT_TYPE_SCENERY:
            snprintf(buffer, sizeof(buffer), "Scenery (%s)",
        ...
        case MAP_ELEMENT_TYPE_ENTRANCE:
            ...
            break;
        case MAP_ELEMENT_TYPE_FENCE:
            snprintf(buffer, sizeof(buffer), "Fence (%s)",
        ...
        case MAP_ELEMENT_TYPE_SCENERY_MULTIPLE:
            ...
            break;
        case MAP_ELEMENT_TYPE_BANNER:
            snprintf(buffer, sizeof(buffer), "Banner (%d)", mapElement->properties.banner.index);
            typeName = buffer;
            break;
        ...
        if (ghost)
            gfx_draw_string(dpi, (char *)CheckBoxMarkString, w->colours[1], x + COL_X_GF, y);
        if (broken)
            gfx_draw_string(dpi, (char *)CheckBoxMarkString, w->colours[1], x + COL_X_BF, y);
        if (last)
            gfx_draw_string(dpi, (char *)CheckBoxMarkString, w->colours[1], x + COL_X_LF, y);

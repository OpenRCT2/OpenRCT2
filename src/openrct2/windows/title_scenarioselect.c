...
static const rct_string_id ScenarioOriginStringIds[] = {
    ...
    STR_SCENARIO_CATEGORY_REAL_PARKS, STR_SCENARIO_CATEGORY_OTHER_PARKS,
};
...
static rct_window_event_list window_scenarioselect_events = { window_scenarioselect_close,
...
void window_scenarioselect_open(scenarioselect_callback callback)
{
    ...
    window = window_create_centred(windowWidth, windowHeight, &window_scenarioselect_events, WC_SCENARIO_SELECT, WF_10);
...
static void window_scenarioselect_invalidate(rct_window * w)
{
    ...
    w->pressed_widgets &= ~((1 << WIDX_CLOSE) | (1 << WIDX_TAB1) | (1 << WIDX_TAB2) | (1 << WIDX_TAB3) | (1 << WIDX_TAB4) |
                            (1 << WIDX_TAB5) | (1 << WIDX_TAB6) | (1 << WIDX_TAB7) | (1 << WIDX_TAB8));
...
static void window_scenarioselect_scrollpaint(rct_window * w, rct_drawpixelinfo * dpi, int scrollIndex)
{
    ...
    for (sc_list_item * listItem = _listItems; listItem->type != LIST_ITEM_TYPE_END; listItem++)
    {
        ...
        case LIST_ITEM_TYPE_HEADING:;
            ...
            draw_category_heading(w, dpi, horizontalRuleMargin, listWidth - horizontalRuleMargin, y + 2,
                                  listItem->heading.string_id);
            y += 18;
            break;
        case LIST_ITEM_TYPE_SCENARIO:;

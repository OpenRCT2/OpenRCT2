...
static rct_window_event_list window_water_events = { window_water_close,
...
void window_water_open()
{
    ...
    window                  = window_create(gScreenWidth - 76, 29, 76, 77, &window_water_events, WC_WATER, 0);
...
static void window_water_invalidate(rct_window * w)
{
    ...
    window_water_widgets[WIDX_PREVIEW].image = gLandToolSize <= 7 ? SPR_LAND_TOOL_SIZE_0 + gLandToolSize : 0xFFFFFFFF;
}

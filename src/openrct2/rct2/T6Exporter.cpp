...
bool T6Exporter::SaveTrack(OpenRCT2::IStream* stream)
{
    ...
    tempStream.WriteArray(_trackDesign->vehicle_colours.data(), RCT12::Limits::RCT12_MAX_VEHICLE_COLOURS);
    ...
    tempStream.WriteArray(_trackDesign->track_spine_colour, RCT12::Limits::RCT12_NUM_COLOUR_SCHEMES);
    tempStream.WriteArray(_trackDesign->track_rail_colour, RCT12::Limits::RCT12_NUM_COLOUR_SCHEMES);
    tempStream.WriteArray(_trackDesign->track_support_colour, RCT12::Limits::RCT12_NUM_COLOUR_SCHEMES);

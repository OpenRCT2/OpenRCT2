...
public:
    ...
    void ValidateGuestEntityIndexs(Guest& guest)
    {
    ...
    void ValidateVehicleEntityIndexs(Vehicle& vehicle)
    {
    ...
    void ValidateRideEntityIndexs(Ride& ride)
    {
    ...
    void ValidateNewsEntityIndexs(News::Item& item)
    {
    ...
    void ValidateEntityIndexs()
    {
        for (auto guest : EntityList<Guest>(EntityListId::Peep))
        {
            ValidateGuestEntityIndexs(*guest);
        }
        ...
        for (size_t i = 0; i < MAX_SPRITES; i++)
        {
            ...
            if (vehicle != nullptr)
            {
                ValidateVehicleEntityIndexs(*vehicle);
            }
        }

        for (auto& ride : GetRideManager())
        {
            ValidateRideEntityIndexs(ride);
        }

        for (auto i = 0; i < News::MaxItems; i++)
        {
            ValidateNewsEntityIndexs(gNewsItems[i]);
        }
    }
};

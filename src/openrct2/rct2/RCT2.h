...
#pragma pack(pop)
    ...
    static constexpr auto kTerrainColours = std::to_array<Drawing::Colour>({
    ...
    static_assert(std::size(kTerrainColours) == std::size(kDefaultTerrainSurfaces) + std::size(OpenRCT2HybridTerrainSurfaces));

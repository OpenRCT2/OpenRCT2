...
constexpr const uint16_t RCT2_OBJECT_ENTRY_COUNT =
    ...
    RCT2::Limits::RCT2_MAX_SMALL_SCENERY_OBJECTS +
    RCT2::Limits::RCT2_MAX_LARGE_SCENERY_OBJECTS +
    RCT2::Limits::RCT2_MAX_WALL_SCENERY_OBJECTS +
    RCT2::Limits::RCT2_MAX_BANNER_OBJECTS +
    RCT2::Limits::RCT2_MAX_PATH_OBJECTS +
    RCT2::Limits::RCT2_MAX_PATH_ADDITION_OBJECTS +
    RCT2::Limits::RCT2_MAX_SCENERY_GROUP_OBJECTS +
    RCT2::Limits::RCT2_MAX_PARK_ENTRANCE_OBJECTS +
    RCT2::Limits::RCT2_MAX_WATER_OBJECTS +
    RCT2::Limits::RCT2_MAX_SCENARIO_TEXT_OBJECTS;
// clang-format on
...
struct rct2_ride
{
    ...
    rct_vehicle_colour vehicle_colours[RCT2::Limits::RCT2_MAX_CARS_PER_TRAIN]; // 0x006
    ...
    uint8_t pad_082[RCT2::Limits::MaxStationsPerRide]; // 0x082, Used to be number of peeps in queue in RCT1, but this
                                                        // has moved.
    uint16_t vehicles[RCT2::Limits::RCT2_MAX_VEHICLES_PER_RIDE + 1]; // 0x086, Points to the first car in the train
    ...
    uint16_t num_customers[RCT2::Limits::RCT2_CUSTOMER_HISTORY_SIZE]; // 0x124
    money16 price;                                      // 0x138
    ...
    uint8_t downtime_history[RCT2::Limits::RCT2_DOWNTIME_HISTORY_SIZE]; // 0x19C
    ...
    uint8_t vehicle_colours_extended[RCT2::Limits::RCT2_MAX_CARS_PER_TRAIN]; // 0x1D4
...
struct rct_track_td6
{
    ...
    rct_vehicle_colour vehicle_colours[RCT2::Limits::RCT2_MAX_CARS_PER_TRAIN]; // 0x08
    union
    {
        uint8_t pad_48;
    ...
    uint8_t vehicle_additional_colour[RCT2::Limits::RCT2_MAX_CARS_PER_TRAIN]; // 0x82
...
struct rct_s6_data
{
    ...
    // SC6[5]
    RCT12TileElement tile_elements[RCT2::Limits::RCT2_MAX_TILE_ELEMENTS];

    // SC6[6]
    uint32_t next_free_tile_element_pointer_index;
    RCT2Sprite sprites[RCT2::Limits::RCT2_MAX_SPRITES];
    ...
    uint32_t researched_ride_types[RCT2::Limits::RCT2_MAX_RESEARCHED_RIDE_TYPE_QUADS];
    uint32_t researched_ride_entries[RCT2::Limits::RCT2_MAX_RESEARCHED_RIDE_ENTRY_QUADS];
    ...
    // Ignored in scenario
    uint32_t researched_scenery_items[RCT2::Limits::RCT2_MAX_RESEARCHED_SCENERY_ITEM_QUADS];
    ...
    RCT12ResearchItem research_items[RCT2::Limits::RCT2_MAX_RESEARCH_ITEMS];
    uint16_t map_base_z;
    ...
    RCT12Banner banners[RCT2::Limits::RCT2_MAX_BANNERS_IN_PARK];
    ...
    RCT12MapAnimation map_animations[RCT2::Limits::RCT2_MAX_ANIMATED_OBJECTS];
    ...
    uint32_t patrol_areas[(RCT2::Limits::RCT2_MAX_STAFF + RCT2::Limits::StaffTypeCount) * RCT2::Limits::PatrolAreaSize];
    RCT2StaffMode staff_modes[RCT2::Limits::RCT2_MAX_STAFF + RCT2::Limits::StaffTypeCount];
    uint8_t pad_13CA73E;
    uint8_t pad_13CA73F;

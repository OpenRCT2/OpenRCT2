 ...
 */
static void viewport_surface_draw_land_side_top(enum edge_t edge, uint8 height, uint8 terrain, struct tile_descriptor self,
 ...
 */
static void viewport_surface_draw_land_side_bottom(enum edge_t edge, uint8 height, uint8 edgeStyle, struct tile_descriptor self,
                                                   struct tile_descriptor neighbour)
{
    registers regs;
 ...
 */
static void viewport_surface_draw_water_side_top(enum edge_t edge, uint8 height, uint8 terrain, struct tile_descriptor self,
                                                 struct tile_descriptor neighbour)
{
    registers regs;
 ...
 */
static void viewport_surface_draw_water_side_bottom(enum edge_t edge, uint8 height, uint8 edgeStyle,

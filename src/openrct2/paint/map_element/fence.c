...
static void fence_paint_door(paint_session * session, uint32 imageId, rct_scenery_entry * sceneryEntry, uint32 imageColourFlags,
                             uint32 tertiaryColour, uint32 dword_141F710, rct_xyz16 offset, rct_xyz16 boundsR1,
                             rct_xyz16 boundsR1_, rct_xyz16 boundsR2, rct_xyz16 boundsR2_, rct_xyz16 boundsL1,
                             rct_xyz16 boundsL1_)
{
    ...
    if (sceneryEntry->wall.flags & WALL_SCENERY_IS_BANNER)
    {
        ...
        ps = sub_98197C(session, imageId, (sint8)offset.x, (sint8)offset.y, boundsR1.x, boundsR1.y, (sint8)boundsR1.z, offset.z,
        ...
        ps = sub_98197C(session, imageId + 1, (sint8)offset.x, (sint8)offset.y, boundsR2.x, boundsR2.y, (sint8)boundsR2.z,
                        offset.z, boundsR2_.x, boundsR2_.y, boundsR2_.z, get_current_rotation());
        if (ps != NULL)
        {
            ps->tertiary_colour = tertiaryColour;
        }
    ...
    else
    {
        ...
        ps = sub_98197C(session, imageId, (sint8)offset.x, (sint8)offset.y, boundsL1.x, boundsL1.y, (sint8)boundsL1.z, offset.z,
        ...
        ps = sub_98199C(session, imageId + 1, (sint8)offset.x, (sint8)offset.y, boundsL1.x, boundsL1.y, (sint8)boundsL1.z,
                        offset.z, boundsL1_.x, boundsL1_.y, boundsL1_.z, get_current_rotation());
        if (ps != NULL)
        {
            ps->tertiary_colour = tertiaryColour;
        }
...
static void fence_paint_wall(paint_session * session, uint32 frameNum, const rct_scenery_entry * sceneryEntry,
                             uint32 dword_141F710, uint32 imageColourFlags, uint32 dword_141F718, uint32 tertiaryColour,
                             uint32 imageOffset, rct_xyz16 offset, rct_xyz16 bounds, rct_xyz16 boundsOffset)
{
...
void fence_paint(paint_session * session, uint8 direction, sint32 height, rct_map_element * map_element)
{
    ...
    if (sceneryEntry->wall.flags & WALL_SCENERY_IS_DOOR)
    {
        ...
        case 0:
            ...
            fence_paint_door(session, imageId, sceneryEntry, imageColourFlags, tertiaryColour, dword_141F710, offset, boundsR1,
    ...
    fence_paint_wall(session, frameNum, sceneryEntry, dword_141F710, imageColourFlags, dword_141F718, tertiaryColour,
                     imageOffset, offset, bounds, boundsOffset);
    ...
    sub_98199C(session, scrolling_text_setup(session, stringId, scroll, scrollingMode), 0, 0, 1, 1, 13, height + 8,
               boundsOffset.x, boundsOffset.y, boundsOffset.z, get_current_rotation());
}

...
void entrance_paint(paint_session* session, Direction direction, int32_t height, const TileElement* tile_element);
void banner_paint(paint_session* session, Direction direction, int32_t height, const TileElement* tile_element);
...
void fence_paint(paint_session* session, Direction direction, int32_t height, const TileElement* tileElement);

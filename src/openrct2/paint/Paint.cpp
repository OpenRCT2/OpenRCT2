...
{
    session->DPI = dpi;
    session->EndOfPaintStructArray = &session->PaintStructs.at(session->PaintStructs.size() - 1);
    ...
    session->PaintStructsSorted.clear();
}
...
static void visitNode(paint_struct* ps, uint32_t& depth)
{

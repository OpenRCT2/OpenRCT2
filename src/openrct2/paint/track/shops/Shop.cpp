...
static constexpr TunnelGroup kShopTunnelGroup = TunnelGroup::Square;
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    if (direction == 1 || direction == 2)
        PaintUtilPushTunnelRotated(session, direction, height, kShopTunnelGroup, TunnelSubType::Flat);
}

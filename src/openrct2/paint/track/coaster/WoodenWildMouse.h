...
namespace OpenRCT2::WoodenWildMouse
{
    // clang-format off
    ...
    kUp25ToUp60Sprites = {{
        {{
            {{ 28540, kImageIndexUndefined, }},
            {{ 28563, 28554, }},
            {{ 28561, 28544, }},
            {{ 28556, kImageIndexUndefined, }},
        }},
        {{
            {{ 28580, kImageIndexUndefined, }},
            {{ 28603, 28594, }},
            {{ 28601, 28584, }},
            {{ 28596, kImageIndexUndefined, }},
        }},
    }};
    ...
    kUp25ToUp60BoundBoxes = {{
        {{ { { 0, 3, 0 }, { 32, 25, 1 } }, {} }},
        {{ { { 4, 28, 2 }, { 24, 2, 43 } }, { { 4, 0, 0 }, { 2, 32, 43 } } }},
        {{ { { 28, 4, 2 }, { 2, 24, 43 } }, { { 0, 4, 0 }, { 32, 2, 43 } } }},
        {{ { { 3, 0, 0 }, { 25, 32, 1 } }, {} }},
    }};
    ...
    kUp60ToUp25Sprites = {{
        {{
            {{ 28548, kImageIndexUndefined, }},
            {{ 28564, 28560, }},
            {{ 28562, 28546, }},
            {{ 28558, kImageIndexUndefined, }},
        }},
        {{
            {{ 28588, kImageIndexUndefined, }},
            {{ 28604, 28600, }},
            {{ 28602, 28586, }},
            {{ 28598, kImageIndexUndefined, }},
        }},
    }};
    ...
    kFlatToUp60Sprites = {{
        {{
            {{ 28565, kImageIndexUndefined, }},
            {{ 28566, 28569, }},
            {{ 28567, 28570, }},
            {{ 28568, kImageIndexUndefined, }},
        }},
        {{
            {{ 28605, kImageIndexUndefined, }},
            {{ 28606, 28609, }},
            {{ 28607, 28610, }},
            {{ 28608, kImageIndexUndefined, }},
        }},
    }};
    ...
    kUp60ToFlatSprites = {{
        {{
            {{ 28571, kImageIndexUndefined, }},
            {{ 28572, 28575, }},
            {{ 28573, 28576, }},
            {{ 28574, kImageIndexUndefined, }},
        }},
        {{
            {{ 28611, kImageIndexUndefined, }},
            {{ 28612, 28615, }},
            {{ 28613, 28616, }},
            {{ 28614, kImageIndexUndefined, }},
        }},
    }};

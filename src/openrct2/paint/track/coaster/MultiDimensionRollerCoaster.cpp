...
static constexpr TunnelGroup kMultiDimensionTunnelGroup = TunnelGroup::Square;
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    if (!trackElement.IsInverted())
    {
        ...
        PaintUtilPushTunnelRotated(session, direction, height, kMultiDimensionTunnelGroup, TunnelSubType::Flat);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    if (!trackElement.IsInverted())
    {
        ...
        {
            PaintUtilPushTunnelRotated(session, direction, height - 8, kMultiDimensionTunnelGroup, TunnelSubType::SlopeStart);
        }
        else
        {
            PaintUtilPushTunnelRotated(session, direction, height + 8, kMultiDimensionTunnelGroup, TunnelSubType::SlopeEnd);
        }
        PaintUtilSetSegmentSupportHeight(session, kSegmentsAll, 0xFFFF, 0);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    if (!trackElement.IsInverted())
    {
        ...
        {
            PaintUtilPushTunnelRotated(session, direction, height + 56, kMultiDimensionTunnelGroup, TunnelSubType::SlopeEnd);
        }
        PaintUtilSetSegmentSupportHeight(session, kSegmentsAll, 0xFFFF, 0);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    if (!trackElement.IsInverted())
    {
        ...
        {
            PaintUtilPushTunnelRotated(session, direction, height, kMultiDimensionTunnelGroup, TunnelSubType::SlopeEnd);
        }
        PaintUtilSetSegmentSupportHeight(session, kSegmentsAll, 0xFFFF, 0);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    if (!trackElement.IsInverted())
    {
        ...
        {
            PaintUtilPushTunnelRotated(session, direction, height + 24, kMultiDimensionTunnelGroup, TunnelSubType::SlopeEnd);
        }
        PaintUtilSetSegmentSupportHeight(session, kSegmentsAll, 0xFFFF, 0);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    if (!trackElement.IsInverted())
    {
        ...
        if (direction == 0 || direction == 3)
        {
            PaintUtilPushTunnelRotated(session, direction, height - 8, kMultiDimensionTunnelGroup, TunnelSubType::Flat);
        }
        else
        {
            PaintUtilPushTunnelRotated(session, direction, height + 8, kMultiDimensionTunnelGroup, TunnelSubType::FlatTo25Deg);
        }
        PaintUtilSetSegmentSupportHeight(session, kSegmentsAll, 0xFFFF, 0);
    ...
    if (!trackElement.IsInverted())
    {
        switch (trackSequence)
        {
            ...
            case 6:
                ...
                {
                    case 2:
                        PaintUtilPushTunnelRight(session, height, kMultiDimensionTunnelGroup, TunnelSubType::Flat);
                        break;
                    case 3:
                        PaintUtilPushTunnelLeft(session, height, kMultiDimensionTunnelGroup, TunnelSubType::Flat);
                        break;
                }
                PaintUtilSetSegmentSupportHeight(
                    session,
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    switch (trackSequence)
    {
        ...
        case 3:
            ...
            {
                case 2:
                    PaintUtilPushTunnelRight(session, height + 8, kMultiDimensionTunnelGroup, TunnelSubType::Flat);
                    break;
                case 3:
                    PaintUtilPushTunnelLeft(session, height + 8, kMultiDimensionTunnelGroup, TunnelSubType::Flat);
                    break;
            }
            PaintUtilSetSegmentSupportHeight(
                session,
            ...
            case 0:
                ...
                if (direction == 0 || direction == 3)
                {
                    PaintUtilPushTunnelRotated(
                        session, direction, height - 8, kMultiDimensionTunnelGroup, TunnelSubType::SlopeStart);
                }
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    if (!trackElement.IsInverted())
    {
        ...
        {
            case 1:
                PaintUtilPushTunnelRight(session, height + 48, kMultiDimensionTunnelGroup, TunnelSubType::SlopeEnd);
                break;
            case 2:
                PaintUtilPushTunnelLeft(session, height + 48, kMultiDimensionTunnelGroup, TunnelSubType::SlopeEnd);
                break;
        }
        PaintUtilSetSegmentSupportHeight(
            session, PaintUtilRotateSegments(BlockedSegments::kStraightFlat, direction), 0xFFFF, 0);
    ...
    if (!trackElement.IsInverted())
    {
        switch (trackSequence)
        {
            case 0:
                ...
                {
                    PaintUtilPushTunnelRotated(
                        session, direction, height + 48, kMultiDimensionTunnelGroup, TunnelSubType::SlopeEnd);
                }
                PaintUtilSetSegmentSupportHeight(
                    session, PaintUtilRotateSegments(BlockedSegments::kStraightFlat, direction), 0xFFFF, 0);
                PaintUtilSetGeneralSupportHeight(session, height + 80);
    ...
    if (!trackElement.IsInverted())
    {
        switch (trackSequence)
        {
            case 0:
                ...
                {
                    PaintUtilPushTunnelRotated(
                        session, direction, height + 32, kMultiDimensionTunnelGroup, TunnelSubType::Flat);
                }
                PaintUtilSetSegmentSupportHeight(
                    session, PaintUtilRotateSegments(BlockedSegments::kStraightFlat, direction), 0xFFFF, 0);
    ...
    else
    {
        switch (trackSequence)
        {
            case 0:
                ...
                {
                    PaintUtilPushTunnelRotated(
                        session, direction, height + 16, kMultiDimensionTunnelGroup, TunnelSubType::Flat);
                }
                PaintUtilSetSegmentSupportHeight(
                    session, PaintUtilRotateSegments(BlockedSegments::kStraightFlat, direction), 0xFFFF, 0);
                PaintUtilSetGeneralSupportHeight(session, height + 48);

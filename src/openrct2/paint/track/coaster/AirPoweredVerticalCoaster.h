...
namespace OpenRCT2::AirPoweredVerticalCoaster
{
    // clang-format off
    ...
    kFlatToLeftBankSprites = {{
        {{ 22334, 22342, }},
        {{ 22335, 22343, }},
        {{ 22336, kImageIndexUndefined, }},
        {{ 22337, kImageIndexUndefined, }},
    }};
    ...
    kFlatToRightBankSprites = {{
        {{ 22338, kImageIndexUndefined, }},
        {{ 22339, kImageIndexUndefined, }},
        {{ 22340, 22344, }},
        {{ 22341, 22345, }},
    }};
    ...
    kBankedRightQuarterTurn5TilesSprites = {{
        {{
            {{ 22312, kImageIndexUndefined, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ 22313, kImageIndexUndefined, }},
            {{ 22314, kImageIndexUndefined, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ 22315, kImageIndexUndefined, }},
            {{ 22316, kImageIndexUndefined, }},
        }},
        {{
            {{ 22317, kImageIndexUndefined, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ 22318, kImageIndexUndefined, }},
            {{ 22319, kImageIndexUndefined, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ 22320, kImageIndexUndefined, }},
            {{ 22321, 22332, }},
        }},
        {{
            {{ 22322, kImageIndexUndefined, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ 22323, kImageIndexUndefined, }},
            {{ 22324, kImageIndexUndefined, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ 22325, kImageIndexUndefined, }},
            {{ 22326, kImageIndexUndefined, }},
        }},
        {{
            {{ 22327, 22333, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ 22328, kImageIndexUndefined, }},
            {{ 22329, kImageIndexUndefined, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ 22330, kImageIndexUndefined, }},
            {{ 22331, kImageIndexUndefined, }},
        }},
    }};
    ...
    kAirThrustTopCapSprites = {{
        {{
            {{ 22358, 22351, }},
            {{ kImageIndexUndefined, 22350, }},
            {{ kImageIndexUndefined, 22353, }},
            {{ 22360, 22352, }},
        }},
        {{
            {{ 22359, 22355, }},
            {{ kImageIndexUndefined, 22354, }},
            {{ kImageIndexUndefined, 22357, }},
            {{ 22361, 22356, }},
        }},
        {{
            {{ 22360, 22352, }},
    ...
    kAirThrustTopCapBoundBoxes = {{
        {{
            {{ { { 0, 6, 0 }, { 32, 20, 15 } }, { { 1, 6, 0 }, { 31, 20, 15 } } }},
            {{ { { 0, 6, 0 }, { 2, 20, 15 } }, {} }},
            {{ { { 33, 6, 0 }, { 2, 20, 1 } }, {} }},
            {{ { { 24, 6, 0 }, { 5, 20, 1 } }, { { 24, 6, 0 }, { 5, 20, 1 } } }},
        }},
        {{
            {{ { { 6, 24, 0 }, { 20, 5, 1 } }, { { 6, 24, 0 }, { 20, 5, 1 } } }},
            {{ { { 6, 33, 0 }, { 20, 2, 1 } }, {} }},
            {{ { { 6, 0, 0 }, { 20, 2, 15 } }, {} }},
            {{ { { 6, 0, 0 }, { 20, 32, 15 } }, { { 6, 0, 0 }, { 20, 32, 15 } } }},
        }},
        {{
            {{ { { 24, 6, 0 }, { 5, 20, 1 } }, { { 24, 6, 0 }, { 5, 20, 1 } } }},
            {{ { { 33, 6, 0 }, { 2, 20, 1 } }, {} }},
    ...
    constexpr std::array<TrackElementSprites, EnumValue(OpenRCT2::TrackElemType::Count)> kSprites = { {
        ...
        { &kFlatSprites[0], nullptr, &kFlatBoundBoxes[0], false }, // OnRidePhoto
        ...
        { &kAirThrustTopCapSprites[0][0][0], nullptr, &kAirThrustTopCapBoundBoxes[0][0][0], false }, // AirThrustTopCap

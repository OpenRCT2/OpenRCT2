...
static constexpr TunnelGroup kMineTrainTunnelGroup = TunnelGroup::Square;
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    PaintUtilPushTunnelRotated(session, direction, height, kMineTrainTunnelGroup, TunnelSubType::Flat);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    {
        PaintUtilPushTunnelRotated(session, direction, height - 8, kMineTrainTunnelGroup, TunnelSubType::SlopeStart);
    }
    else
    {
        PaintUtilPushTunnelRotated(session, direction, height + 8, kMineTrainTunnelGroup, TunnelSubType::SlopeEnd);
    }
    PaintUtilSetSegmentSupportHeight(session, kSegmentsAll, 0xFFFF, 0);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    {
        PaintUtilPushTunnelRotated(session, direction, height + 56, kMineTrainTunnelGroup, TunnelSubType::SlopeEnd);
    }
    PaintUtilSetSegmentSupportHeight(session, kSegmentsAll, 0xFFFF, 0);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    {
        PaintUtilPushTunnelRotated(session, direction, height, kMineTrainTunnelGroup, TunnelSubType::SlopeEnd);
    }
    PaintUtilSetSegmentSupportHeight(session, kSegmentsAll, 0xFFFF, 0);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    {
        PaintUtilPushTunnelRotated(session, direction, height + 24, kMineTrainTunnelGroup, TunnelSubType::SlopeEnd);
    }
    PaintUtilSetSegmentSupportHeight(session, kSegmentsAll, 0xFFFF, 0);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    if (direction == 0 || direction == 3)
    {
        PaintUtilPushTunnelRotated(session, direction, height - 8, kMineTrainTunnelGroup, TunnelSubType::Flat);
    }
    else
    {
        PaintUtilPushTunnelRotated(session, direction, height + 8, kMineTrainTunnelGroup, TunnelSubType::FlatTo25Deg);
    }
    PaintUtilSetSegmentSupportHeight(session, kSegmentsAll, 0xFFFF, 0);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    switch (trackSequence)
    {
        ...
        case 6:
            ...
            {
                case 2:
                    PaintUtilPushTunnelRight(session, height, kMineTrainTunnelGroup, TunnelSubType::Flat);
                    break;
                case 3:
                    PaintUtilPushTunnelLeft(session, height, kMineTrainTunnelGroup, TunnelSubType::Flat);
                    break;
            }
            PaintUtilSetSegmentSupportHeight(session, kSegmentsAll, 0xFFFF, 0);
            PaintUtilSetGeneralSupportHeight(session, height + kDefaultGeneralSupportHeight);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    switch (trackSequence)
    {
        ...
        case 6:
            ...
            {
                case 2:
                    PaintUtilPushTunnelRight(session, height + 8, kMineTrainTunnelGroup, TunnelSubType::SlopeEnd);
                    break;
                case 3:
                    PaintUtilPushTunnelLeft(session, height + 8, kMineTrainTunnelGroup, TunnelSubType::SlopeEnd);
                    break;
            }
            PaintUtilSetSegmentSupportHeight(session, kSegmentsAll, 0xFFFF, 0);
            PaintUtilSetGeneralSupportHeight(session, height + 72);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    switch (trackSequence)
    {
        ...
        case 3:
            ...
            {
                case 2:
                    PaintUtilPushTunnelRight(session, height + 8, kMineTrainTunnelGroup, TunnelSubType::Flat);
                    break;
                case 3:
                    PaintUtilPushTunnelLeft(session, height + 8, kMineTrainTunnelGroup, TunnelSubType::Flat);
                    break;
            }
            PaintUtilSetSegmentSupportHeight(
                session,
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    switch (trackSequence)
    {
        ...
        case 3:
            ...
            {
                case 1:
                    PaintUtilPushTunnelRight(session, height + 24, kMineTrainTunnelGroup, TunnelSubType::SlopeEnd);
                    break;
                case 2:
                    PaintUtilPushTunnelLeft(session, height + 24, kMineTrainTunnelGroup, TunnelSubType::SlopeEnd);
                    break;
            }
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    switch (trackSequence)
    {
        case 0:
            ...
            if (direction == 0 || direction == 3)
            {
                PaintUtilPushTunnelRotated(session, direction, height, kMineTrainTunnelGroup, TunnelSubType::SlopeStart);
            }
            PaintUtilSetGeneralSupportHeight(session, height + 80);
            break;
        case 1:
        ...
        case 3:
            ...
            {
                case 1:
                    PaintUtilPushTunnelRight(session, height + 8, kMineTrainTunnelGroup, TunnelSubType::FlatTo25Deg);
                    break;
                case 2:
                    PaintUtilPushTunnelLeft(session, height + 8, kMineTrainTunnelGroup, TunnelSubType::FlatTo25Deg);
                    break;
            }
            PaintUtilSetGeneralSupportHeight(session, height + 40);
            break;

...
static constexpr const uint32_t SpinningRCDiagBrakeImages[NumOrthogonalDirections] = {
...
static constexpr const uint32_t SpinningRCDiagBlockBrakeImages[2][NumOrthogonalDirections] = {

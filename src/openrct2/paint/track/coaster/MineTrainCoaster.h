...
namespace OpenRCT2::MineTrainCoaster
{
    ...
    constexpr std::array<TrackElementSprites, EnumValue(OpenRCT2::TrackElemType::Count)> kSprites = { {
        { &kFlatSprites[0][0], nullptr, &kFlatBoundBoxes[0] },                                      // Flat
        { &kEndStationSprites[0][0], nullptr, &kStationBoundBoxes[0] },                             // EndStation
        { &kStationSprites[0], nullptr, &kStationBoundBoxes[0] },                                   // BeginStation
        { &kStationSprites[0], nullptr, &kStationBoundBoxes[0] },                                   // MiddleStation
        { &kUp25Sprites[0][0], nullptr, &kUp25BoundBoxes[0] },                                      // Up25
        { &kUp60Sprites[0], nullptr, &kUp60BoundBoxes[0] },                                         // Up60
        { &kFlatToUp25Sprites[0][0], nullptr, &kFlatToUp25BoundBoxes[0] },                          // FlatToUp25
        { &kUp25ToUp60Sprites[0][0], nullptr, &kUp25ToUp60BoundBoxes[0][0] },                       // Up25ToUp60
        { &kUp60ToUp25Sprites[0][0], nullptr, &kUp60ToUp25BoundBoxes[0][0] },                       // Up60ToUp25
        { &kUp25ToFlatSprites[0][0], nullptr, &kUp25ToFlatBoundBoxes[0] },                          // Up25ToFlat
        ...
        { &kLeftQuarterTurn5TilesSprites[0][0], nullptr, &kLeftQuarterTurn5TilesBoundBoxes[0][0] }, // LeftQuarterTurn5Tiles
        { nullptr, nullptr, nullptr },                                                              // RightQuarterTurn5Tiles
        { &kFlatToLeftBankSprites[0][0], nullptr, &kFlatToLeftBankBoundBoxes[0][0] },               // FlatToLeftBank
        { &kFlatToRightBankSprites[0][0], nullptr, &kFlatToRightBankBoundBoxes[0][0] },             // FlatToRightBank
        { nullptr, nullptr, nullptr },                                                              // LeftBankToFlat
        { nullptr, nullptr, nullptr },                                                              // RightBankToFlat
        { &kBankedLeftQuarterTurn5TilesSprites[0][0][0], nullptr,
          &kBankedLeftQuarterTurn5TilesBoundBoxes[0][0][0] },                           // BankedLeftQuarterTurn5Tiles
        { nullptr, nullptr, nullptr },                                                  // BankedRightQuarterTurn5Tiles
        { &kLeftBankToUp25Sprites[0][0], nullptr, &kLeftBankToUp25BoundBoxes[0][0] },   // LeftBankToUp25
        { &kRightBankToUp25Sprites[0][0], nullptr, &kRightBankToUp25BoundBoxes[0][0] }, // RightBankToUp25
        { &kUp25ToLeftBankSprites[0][0], nullptr, &kUp25ToLeftBankBoundBoxes[0][0] },   // Up25ToLeftBank
        { &kUp25ToRightBankSprites[0][0], nullptr, &kUp25ToRightBankBoundBoxes[0][0] }, // Up25ToRightBank
        ...
        { &kLeftBankSprites[0], nullptr, &kLeftBankBoundBoxes[0] },                     // LeftBank
        { nullptr, nullptr, nullptr },                                                  // RightBank
        { &kLeftQuarterTurn5TilesUp25Sprites[0][0], nullptr,
          &kLeftQuarterTurn5TilesUp25BoundBoxes[0][0] }, // LeftQuarterTurn5TilesUp25
        { &kRightQuarterTurn5TilesUp25Sprites[0][0], nullptr,
          &kRightQuarterTurn5TilesUp25BoundBoxes[0][0] },                     // RightQuarterTurn5TilesUp25
        { nullptr, nullptr, nullptr },                                        // LeftQuarterTurn5TilesDown25
        { nullptr, nullptr, nullptr },                                        // RightQuarterTurn5TilesDown25
        { &kSBendLeftSprites[0][0], nullptr, &kSBendLeftBoundBoxes[0][0] },   // SBendLeft
        { &kSBendRightSprites[0][0], nullptr, &kSBendRightBoundBoxes[0][0] }, // SBendRight
        ...
        { &kLeftBankedQuarterTurn3TilesSprites[0][0][0], nullptr,
          &kLeftBankedQuarterTurn3TilesBoundBoxes[0][0][0] }, // LeftBankedQuarterTurn3Tiles
        ...
        { &kLeftHalfBankedHelixUpSmallSprites[0][0][0], nullptr,
          &kLeftHalfBankedHelixUpSmallBoundBoxes[0][0][0] }, // LeftHalfBankedHelixUpSmall
        { &kRightHalfBankedHelixUpSmallSprites[0][0][0], nullptr,
          &kRightHalfBankedHelixUpSmallBoundBoxes[0][0][0] }, // RightHalfBankedHelixUpSmall
        { nullptr, nullptr, nullptr },                        // LeftHalfBankedHelixDownSmall
        { nullptr, nullptr, nullptr },                        // RightHalfBankedHelixDownSmall
        { &kLeftHalfBankedHelixUpLargeSprites[0][0][0], nullptr,
          &kLeftHalfBankedHelixUpLargeBoundBoxes[0][0][0] }, // LeftHalfBankedHelixUpLarge
        { &kRightHalfBankedHelixUpLargeSprites[0][0][0], nullptr,
          &kRightHalfBankedHelixUpLargeBoundBoxes[0][0][0] },   // RightHalfBankedHelixUpLarge
        ...
        { &kBrakesSprites[0], nullptr, &kBrakesBoundBoxes[0] }, // Brakes
        ...
        { &kFlatSprites[0][0], nullptr, &kFlatBoundBoxes[0] },  // OnRidePhoto
        { nullptr, nullptr, nullptr },                          // Down25LeftBanked
        { nullptr, nullptr, nullptr },                          // Down25RightBanked
        { nullptr, nullptr, nullptr },                          // Watersplash
        { &kFlatToUp60LongBaseSprites[0][0], nullptr, &kFlatToUp60LongBaseBoundBoxes[0][0] },       // FlatToUp60LongBase
        { &kUp60ToFlatLongBaseSprites[0][0], nullptr, &kUp60ToFlatLongBaseBoundBoxes[0][0] },       // Up60ToFlatLongBase
        ...
        { &kLeftEighthToDiagSprites[0][0], nullptr, &kLeftEighthToDiagBoundBoxes[0][0] },           // LeftEighthToDiag
        { &kRightEighthToDiagSprites[0][0], nullptr, &kRightEighthToDiagBoundBoxes[0][0] },         // RightEighthToDiag
        { nullptr, nullptr, nullptr },                                                              // LeftEighthToOrthogonal
        { nullptr, nullptr, nullptr },                                                              // RightEighthToOrthogonal
        { &kLeftEighthBankToDiagSprites[0][0], nullptr, &kLeftEighthBankToDiagBoundBoxes[0][0] },   // LeftEighthBankToDiag
        { &kRightEighthBankToDiagSprites[0][0], nullptr, &kRightEighthBankToDiagBoundBoxes[0][0] }, // RightEighthBankToDiag
        { nullptr, nullptr, nullptr },                                                       // LeftEighthBankToOrthogonal
        { nullptr, nullptr, nullptr },                                                       // RightEighthBankToOrthogonal
        { &kDiagFlatSprites[0][0][0], &kDiagFlatOffsets[0][0], &kDiagFlatBoundBoxes[0][0] }, // DiagFlat
        { &kDiagUp25Sprites[0][0][0], &kDiagUp25Offsets[0][0], &kDiagUp25BoundBoxes[0][0] }, // DiagUp25
        { &kDiagUp60Sprites[0][0], &kDiagUp60Offsets[0][0], &kDiagUp60BoundBoxes[0][0] },    // DiagUp60
        { &kDiagFlatToUp25Sprites[0][0][0], &kDiagFlatToUp25Offsets[0][0], &kDiagFlatToUp25BoundBoxes[0][0] }, // DiagFlatToUp25
        { &kDiagUp25ToUp60Sprites[0][0], &kDiagUp25ToUp60Offsets[0][0], &kDiagUp25ToUp60BoundBoxes[0][0] },    // DiagUp25ToUp60
        { &kDiagUp60ToUp25Sprites[0][0], &kDiagUp60ToUp25Offsets[0][0], &kDiagUp60ToUp25BoundBoxes[0][0] },    // DiagUp60ToUp25
        { &kDiagUp25ToFlatSprites[0][0][0], &kDiagUp25ToFlatOffsets[0][0], &kDiagUp25ToFlatBoundBoxes[0][0] }, // DiagUp25ToFlat
        ...
        { &kDiagFlatToLeftBankSprites[0][0][0], &kDiagFlatToLeftBankOffsets[0][0][0],
          &kDiagFlatToLeftBankBoundBoxes[0][0][0] }, // DiagFlatToLeftBank
        { &kDiagFlatToRightBankSprites[0][0][0], &kDiagFlatToRightBankOffsets[0][0][0],
          &kDiagFlatToRightBankBoundBoxes[0][0][0] }, // DiagFlatToRightBank
        { nullptr, nullptr, nullptr },                // DiagLeftBankToFlat
        { nullptr, nullptr, nullptr },                // DiagRightBankToFlat
        { &kDiagLeftBankToUp25Sprites[0][0][0], &kDiagLeftBankToUp25Offsets[0][0][0],
          &kDiagLeftBankToUp25BoundBoxes[0][0][0] }, // DiagLeftBankToUp25
        { &kDiagRightBankToUp25Sprites[0][0][0], &kDiagRightBankToUp25Offsets[0][0][0],
          &kDiagRightBankToUp25BoundBoxes[0][0][0] }, // DiagRightBankToUp25
        { &kDiagUp25ToLeftBankSprites[0][0][0], &kDiagUp25ToLeftBankOffsets[0][0][0],
          &kDiagUp25ToLeftBankBoundBoxes[0][0][0] }, // DiagUp25ToLeftBank
        { &kDiagUp25ToRightBankSprites[0][0][0], &kDiagUp25ToRightBankOffsets[0][0][0],
          &kDiagUp25ToRightBankBoundBoxes[0][0][0] },                                                 // DiagUp25ToRightBank
        ...
        { &kDiagLeftBankSprites[0][0], &kDiagLeftBankOffsets[0][0], &kDiagLeftBankBoundBoxes[0][0] }, // DiagLeftBank
        { nullptr, nullptr, nullptr },                                                                // DiagRightBank
        { nullptr, nullptr, nullptr },                                                                // LogFlumeReverser
        { nullptr, nullptr, nullptr },                                                                // SpinningTunnel
        ...
        { &kBlockBrakesSprites[0][0], nullptr, &kBlockBrakesBoundBoxes[0] }, // BlockBrakes
        ...
        { &kDiagBrakesSprites[0][0], &kDiagBrakesOffsets[0][0], &kDiagBrakesBoundBoxes[0][0] }, // DiagBrakes
        { &kDiagBlockBrakesSprites[0][0][0], &kDiagBlockBrakesOffsets[0][0],
          &kDiagBlockBrakesBoundBoxes[0][0] }, // DiagBlockBrakes

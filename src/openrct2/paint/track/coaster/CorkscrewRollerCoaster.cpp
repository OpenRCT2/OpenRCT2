...
static void CorkscrewRCTrackRightBankToFlat(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    CorkscrewRCTrackFlatToLeftBank(
        session, ride, trackSequence, DirectionReverse(direction), height, trackElement, supportType);
}
...
static void CorkscrewRCTrackDiagFlatTo25DegDown(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    CorkscrewRCTrackDiag25DegUpToFlat(
        session, ride, 3 - trackSequence, DirectionReverse(direction), height, trackElement, supportType);
}
...
static void CorkscrewRCTrackDiag25DegDownTo60DegDown(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    CorkscrewRCTrackDiag60DegUpTo25DegUp(
        session, ride, 3 - trackSequence, DirectionReverse(direction), height, trackElement, supportType);
}
...
static void CorkscrewRCTrackDiag60DegDownTo25DegDown(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    CorkscrewRCTrackDiag25DegUpTo60DegUp(
        session, ride, 3 - trackSequence, DirectionReverse(direction), height, trackElement, supportType);
}
...
static void CorkscrewRCTrackDiag25DegDownToFlat(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    CorkscrewRCTrackDiagFlatTo25DegUp(
        session, ride, 3 - trackSequence, DirectionReverse(direction), height, trackElement, supportType);
}
...
static void CorkscrewRCTrackDiagLeftBankToFlat(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    CorkscrewRCTrackDiagFlatToRightBank(
        session, ride, 3 - trackSequence, DirectionReverse(direction), height, trackElement, supportType);
}
...
static void CorkscrewRCTrackDiagRightBankToFlat(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    CorkscrewRCTrackDiagFlatToLeftBank(
        session, ride, 3 - trackSequence, DirectionReverse(direction), height, trackElement, supportType);
}
...
static void CorkscrewRCTrackDiagLeftBankTo25DegDown(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    CorkscrewRCTrackDiag25DegUpToRightBank(
        session, ride, 3 - trackSequence, DirectionReverse(direction), height, trackElement, supportType);
}
...
static void CorkscrewRCTrackDiagRightBankTo25DegDown(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    CorkscrewRCTrackDiag25DegUpToLeftBank(
        session, ride, 3 - trackSequence, DirectionReverse(direction), height, trackElement, supportType);
}
...
static void CorkscrewRCTrackDiag25DegDownToLeftBank(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    CorkscrewRCTrackDiagRightBankTo25DegUp(
        session, ride, 3 - trackSequence, DirectionReverse(direction), height, trackElement, supportType);
}
...
static void CorkscrewRCTrackDiag25DegDownToRightBank(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    CorkscrewRCTrackDiagLeftBankTo25DegUp(
        session, ride, 3 - trackSequence, DirectionReverse(direction), height, trackElement, supportType);
}
...
static void CorkscrewRCTrackLeftTwistUpToDown(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    CorkscrewRCTrackLeftTwistDownToUp(
...
static void CorkscrewRCTrackRightTwistUpToDown(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    CorkscrewRCTrackRightTwistDownToUp(
        session, ride, 2 - trackSequence, DirectionReverse(direction), height, trackElement, supportType);
}
...
static void CorkscrewRCTrackDiagFlatTo60DegDown(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    CorkscrewRCTrackDiag60DegUpToFlat(
        session, ride, 3 - trackSequence, DirectionReverse(direction), height, trackElement, supportType);
}
...
static void CorkscrewRCTrackDiag60DegDownToFlat(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    CorkscrewRCTrackDiagFlatTo60DegUp(
        session, ride, 3 - trackSequence, DirectionReverse(direction), height, trackElement, supportType);
}
...
{
    trackSequence = kMapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
    CorkscrewRCTrackRightBankToRightQuarterTurn325DegUp(
        session, ride, trackSequence, (direction + 1) & 3, height, trackElement, supportType);
}
...
{
    trackSequence = kMapLeftQuarterTurn3TilesToRightQuarterTurn3Tiles[trackSequence];
    CorkscrewRCTrackLeftBankToLeftQuarterTurn325DegUp(
        session, ride, trackSequence, (direction - 1) & 3, height, trackElement, supportType);
}
...
static void CorkscrewRCTrackDiagFlatTo60DegDownLongBase(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    CorkscrewRCTrackDiag60DegUpToFlatLongBase(
...
static void CorkscrewRCTrackDiag60DegDownToFlatLongBase(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    CorkscrewRCTrackDiagFlatTo60DegUpLongBase(
        session, ride, 9 - trackSequence, DirectionReverse(direction), height, trackElement, supportType);
}

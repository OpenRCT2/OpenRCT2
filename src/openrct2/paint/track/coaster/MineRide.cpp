...
static constexpr TunnelGroup kMineRideTunnelGroup = TunnelGroup::Square;
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    PaintUtilPushTunnelRotated(session, direction, height, kMineRideTunnelGroup, TunnelSubType::Flat);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    {
        PaintUtilPushTunnelRotated(session, direction, height - 8, kMineRideTunnelGroup, TunnelSubType::SlopeStart);
    }
    else
    {
        PaintUtilPushTunnelRotated(session, direction, height + 8, kMineRideTunnelGroup, TunnelSubType::SlopeEnd);
    }
    PaintUtilSetSegmentSupportHeight(session, PaintUtilRotateSegments(BlockedSegments::kStraightFlat, direction), 0xFFFF, 0);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    {
        PaintUtilPushTunnelRotated(session, direction, height, kMineRideTunnelGroup, TunnelSubType::SlopeEnd);
    }
    PaintUtilSetSegmentSupportHeight(session, PaintUtilRotateSegments(BlockedSegments::kStraightFlat, direction), 0xFFFF, 0);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    if (direction == 0 || direction == 3)
    {
        PaintUtilPushTunnelRotated(session, direction, height - 8, kMineRideTunnelGroup, TunnelSubType::Flat);
    }
    else
    {
        PaintUtilPushTunnelRotated(session, direction, height + 8, kMineRideTunnelGroup, TunnelSubType::FlatTo25Deg);
    }
    PaintUtilSetSegmentSupportHeight(session, PaintUtilRotateSegments(BlockedSegments::kStraightFlat, direction), 0xFFFF, 0);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    switch (trackSequence)
    {
        ...
        case 6:
            ...
            {
                case 2:
                    PaintUtilPushTunnelRight(session, height, kMineRideTunnelGroup, TunnelSubType::Flat);
                    break;
                case 3:
                    PaintUtilPushTunnelLeft(session, height, kMineRideTunnelGroup, TunnelSubType::Flat);
                    break;
            }
            PaintUtilSetSegmentSupportHeight(
                session,
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    switch (trackSequence)
    {
        ...
        case 3:
            ...
            {
                case 2:
                    PaintUtilPushTunnelRight(session, height + 8, kMineRideTunnelGroup, TunnelSubType::Flat);
                    break;
                case 3:
                    PaintUtilPushTunnelLeft(session, height + 8, kMineRideTunnelGroup, TunnelSubType::Flat);
                    break;
            }
            PaintUtilSetSegmentSupportHeight(
                session,

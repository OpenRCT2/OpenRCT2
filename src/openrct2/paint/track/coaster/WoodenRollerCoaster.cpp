    ...
    switch (trackSequence)
    {
        case 0:
            ...
            MetalASupportsPaintSetup(
                session, MetalSupportType::Boxed, MetalSupportPlace::Centre, 8, height, true, session.SupportColours);
            if (direction == 0 || direction == 3)
            {
                PaintUtilPushTunnelRotated(session, direction, height - 8, kTunnelGroup, TunnelSubType::SlopeStart);
            }
        ...
        case 1:
            switch (direction)
            {
                case 0:
                    ...
                    MetalASupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::Centre, 20, height, true, session.SupportColours);
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                        session, direction, WoodenRCGetRailsColour(session).WithIndex(23462), { 0, 14, height }, { 32, 2, 63 });
                    MetalASupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::Centre, 9, height, true, session.SupportColours);
                    break;
                case 2:
                    PaintAddImageAsParentRotated(
                        session, direction, WoodenRCGetRailsColour(session).WithIndex(23459), { 0, 6, height }, { 32, 26, 3 });
                    MetalASupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::Centre, 16, height, true, session.SupportColours);
                    break;
                case 3:
                    PaintAddImageAsParentRotated(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    switch (trackSequence)
    {
        case 0:
            ...
            MetalASupportsPaintSetup(
                session, MetalSupportType::Boxed, MetalSupportPlace::Centre, 7, height, true, session.SupportColours);
            ...
            switch (direction)
            {
                case 0:
                    ...
                    MetalBSupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::TopLeftSide, 14, height, false,
                ...
                case 1:
                    ...
                    MetalBSupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::TopRightSide, 16, height, false,
                        session.SupportColours);
                    break;
                case 2:
                    PaintAddImageAsParentRotated(
                    ...
                    MetalBSupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::BottomRightSide, 18, height, false,
                        session.SupportColours);
                    break;
                case 3:
                    PaintAddImageAsParentRotated(
                    ...
                    MetalBSupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::BottomLeftSide, 14, height, false,
                        session.SupportColours);
                    break;
            }
            PaintUtilSetSegmentSupportHeight(
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height }, { { 0, 0, height }, { 32, 32, 0 } });
                    MetalBSupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::BottomRightSide, 14, height, false,
                        session.SupportColours);
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                    ...
                    MetalBSupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::BottomLeftSide, 18, height, false,
                        session.SupportColours);
                    break;
                case 2:
                    PaintAddImageAsParentRotated(
                    ...
                    MetalBSupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::TopLeftSide, 16, height, false,
                        session.SupportColours);
                    break;
                case 3:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height }, { { 0, 0, height + 2 }, { 32, 32, 0 } });
                    MetalBSupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::TopRightSide, 14, height, false,
                        session.SupportColours);
                    break;
            }
            PaintUtilSetSegmentSupportHeight(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    switch (trackSequence)
    {
        case 0:
            ...
            MetalASupportsPaintSetup(
                session, MetalSupportType::Boxed, MetalSupportPlace::Centre, 5, height, true, session.SupportColours);
            if (direction == 0 || direction == 3)
            {
                PaintUtilPushTunnelRotated(session, direction, height - 8, kTunnelGroup, TunnelSubType::SlopeStart);
            }
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height }, { { 0, 6, height }, { 32, 20, 3 } });
                    MetalASupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::Centre, 12, height, true, session.SupportColours);
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                    ...
                    MetalASupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::Centre, 6, height, true, session.SupportColours);
                    break;
                case 2:
                    PaintAddImageAsParentRotated(
                    ...
                    MetalASupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::Centre, 0, height, false, session.SupportColours);
                    break;
                case 3:
                    PaintAddImageAsParentRotated(
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height }, { { 0, 0, height }, { 32, 16, 3 } });
                    MetalASupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::TopLeftSide, 22, height, true,
                        session.SupportColours);
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                    ...
                    MetalASupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::TopRightSide, 14, height + 8, true,
                        session.SupportColours);
                    break;
                case 2:
                    PaintAddImageAsParentRotated(
                    ...
                    MetalASupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::BottomRightSide, 0, height + 21, false,
                        session.SupportColours);
                    break;
                case 3:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height }, { { 0, 16, height }, { 32, 16, 3 } });
                    MetalASupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::BottomLeftSide, 22, height, true,
                        session.SupportColours);
                    break;
            }
            PaintUtilSetSegmentSupportHeight(
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height }, { { 0, 16, height }, { 32, 16, 3 } });
                    MetalASupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::BottomRightSide, 22, height, true,
                        session.SupportColours);
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height }, { { 0, 16, height + 200 }, { 32, 16, 0 } });
                    MetalASupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::BottomLeftSide, 0, height + 21, false,
                        session.SupportColours);
                    break;
                case 2:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height }, { { 0, 0, height + 200 }, { 32, 16, 0 } });
                    MetalASupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::TopLeftSide, 14, height + 8, true,
                        session.SupportColours);
                    break;
                case 3:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height }, { { 0, 0, height }, { 32, 16, 3 } });
                    MetalASupportsPaintSetup(
                        session, MetalSupportType::Boxed, MetalSupportPlace::TopRightSide, 22, height, true,
                        session.SupportColours);
                    break;
            }
            PaintUtilSetSegmentSupportHeight(

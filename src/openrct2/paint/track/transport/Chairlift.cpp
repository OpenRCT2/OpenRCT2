...
static constexpr TunnelGroup kChairliftTunnelGroup = TunnelGroup::Square;
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    PaintUtilPushTunnelLeft(session, height, kChairliftTunnelGroup, TunnelSubType::Flat);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    PaintUtilPushTunnelRight(session, height, kChairliftTunnelGroup, TunnelSubType::Flat);
    PaintUtilSetSegmentSupportHeight(session, kSegmentsAll, 0xFFFF, 0);
    PaintUtilSetGeneralSupportHeight(session, height + kDefaultGeneralSupportHeight);
}
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    switch (direction)
    {
        case 0:
            ...
            PaintAddImageAsParent(session, imageId, { 0, 0, height }, { { 0, 13, height + 28 }, { 32, 6, 2 } });
            PaintUtilPushTunnelLeft(session, height - 8, kChairliftTunnelGroup, TunnelSubType::SlopeStart);
            break;

        case 1:
            imageId = session.TrackColours.WithIndex(SPR_CHAIRLIFT_CABLE_UP_NW_SE);
            PaintAddImageAsParent(session, imageId, { 0, 0, height }, { { 13, 0, height + 28 }, { 6, 32, 2 } });
            PaintUtilPushTunnelRight(session, height + 8, kChairliftTunnelGroup, TunnelSubType::SlopeEnd);
            break;

        case 2:
            imageId = session.TrackColours.WithIndex(SPR_CHAIRLIFT_CABLE_UP_NE_SW);
            PaintAddImageAsParent(session, imageId, { 0, 0, height }, { { 0, 13, height + 28 }, { 32, 6, 2 } });
            PaintUtilPushTunnelLeft(session, height + 8, kChairliftTunnelGroup, TunnelSubType::SlopeEnd);
            break;

        case 3:
            imageId = session.TrackColours.WithIndex(SPR_CHAIRLIFT_CABLE_UP_SE_NW);
            PaintAddImageAsParent(session, imageId, { 0, 0, height }, { { 13, 0, height + 28 }, { 6, 32, 2 } });
            PaintUtilPushTunnelRight(session, height - 8, kChairliftTunnelGroup, TunnelSubType::SlopeStart);
            break;
    }
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    switch (direction)
    {
        ...
        case 1:
            ...
            PaintUtilPushTunnelRight(session, height, kChairliftTunnelGroup, TunnelSubType::SlopeEnd);
            break;
        ...
        case 2:
            ...
            PaintUtilPushTunnelLeft(session, height, kChairliftTunnelGroup, TunnelSubType::SlopeEnd);
            break;
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    switch (direction)
    {
        case 0:
            ...
            PaintUtilPushTunnelLeft(session, height - 8, kChairliftTunnelGroup, TunnelSubType::Flat);
            break;
        ...
        case 1:
            ...
            PaintUtilPushTunnelRight(session, height + 8, kChairliftTunnelGroup, TunnelSubType::FlatTo25Deg);
            break;
        ...
        case 2:
            ...
            PaintUtilPushTunnelLeft(session, height + 8, kChairliftTunnelGroup, TunnelSubType::FlatTo25Deg);
            break;
        ...
        case 3:
            ...
            PaintUtilPushTunnelRight(session, height - 8, kChairliftTunnelGroup, TunnelSubType::Flat);
            break;
    }

...
namespace OpenRCT2::RiverRapids
{
    // clang-format off
    ...
    kFlatBoundBoxes = {{
        {{ { { 0, 4, 0 }, { 32, 24, 11 } }, { { 10, 10, 0 }, { 1, 2, 5 } } }},
        {{ { { 4, 0, 0 }, { 24, 32, 11 } }, { { 10, 10, 0 }, { 1, 2, 5 } } }},
        {{ { { 0, 4, 0 }, { 32, 24, 11 } }, { { 10, 10, 0 }, { 1, 2, 5 } } }},
        {{ { { 4, 0, 0 }, { 24, 32, 11 } }, { { 10, 10, 0 }, { 1, 2, 5 } } }},
    }};
    ...
    static constexpr std::array<std::array<BoundBoxXYZ, 2>, kNumOrthogonalDirections>
    kUp25BoundBoxes = {{
        {{ { { 0, 4, 0 }, { 32, 24, 4 } }, { { 0, 27, 16 }, { 32, 1, 34 } } }},
        {{ { { 4, 0, 0 }, { 24, 32, 4 } }, { { 27, 0, 16 }, { 1, 32, 34 } } }},
        {{ { { 0, 4, 0 }, { 32, 24, 4 } }, { { 0, 27, 16 }, { 32, 1, 34 } } }},
        {{ { { 4, 0, 0 }, { 24, 32, 4 } }, { { 27, 0, 16 }, { 1, 32, 34 } } }},
    }};
    ...
    kFlatToUp25BoundBoxes = {{
        {{ { { 0, 4, 0 }, { 32, 24, 11 } }, { { 0, 27, 16 }, { 32, 1, 26 } } }},
        {{ { { 4, 0, 0 }, { 24, 32, 11 } }, { { 27, 0, 16 }, { 1, 32, 26 } } }},
        {{ { { 0, 4, 0 }, { 32, 24, 11 } }, { { 0, 27, 16 }, { 32, 1, 26 } } }},
        {{ { { 4, 0, 0 }, { 24, 32, 11 } }, { { 27, 0, 16 }, { 1, 32, 26 } } }},
    }};
    ...
    kUp25ToFlatBoundBoxes = {{
        {{ { { 0, 4, 0 }, { 32, 24, 4 } }, { { 0, 27, 16 }, { 32, 1, 18 } } }},
        {{ { { 4, 0, 0 }, { 24, 32, 4 } }, { { 27, 0, 16 }, { 1, 32, 18 } } }},
        {{ { { 0, 4, 0 }, { 32, 24, 4 } }, { { 0, 27, 0 }, { 32, 1, 18 } } }},
        {{ { { 4, 0, 0 }, { 24, 32, 4 } }, { { 27, 0, 16 }, { 1, 32, 18 } } }},
    }};
    ...
    kLeftQuarterTurn1TileSprites = {{
        {{ 21193, 21201, kImageIndexUndefined, }},
        {{ 21194, 21198, 21202, }},
        {{ 21195, 21203, kImageIndexUndefined, }},
        {{ 21192, 21200, kImageIndexUndefined, }},
    }};

    static constexpr std::array<std::array<BoundBoxXYZ, 3>, kNumOrthogonalDirections>
    kLeftQuarterTurn1TileBoundBoxes = {{
        {{ { { 4, 2, 0 }, { 28, 26, 11 } }, { { 28, 27, 0 }, { 2, 1, 7 } }, {} }},
        {{ { { 0, 0, 0 }, { 25, 25, 5 } }, { { 27, 1, 0 }, { 1, 30, 7 } }, { { 1, 27, 0 }, { 30, 1, 7 } } }},
        {{ { { 2, 4, 0 }, { 26, 28, 11 } }, { { 10, 10, 0 }, { 1, 2, 5 } }, {} }},
        {{ { { 4, 4, 0 }, { 28, 28, 11 } }, { { 28, 28, 0 }, { 1, 1, 7 } }, {} }},
    }};
    
    static constexpr std::array<std::array<ImageIndex, 3>, kNumOrthogonalDirections>
    kRightQuarterTurn1TileSprites = {{
        {{ 21188, 21196, kImageIndexUndefined, }},
        {{ 21189, 21197, kImageIndexUndefined, }},
        {{ 21190, 21198, 21202, }},
        {{ 21191, 21199, kImageIndexUndefined, }},
    }};
    
    static constexpr std::array<std::array<BoundBoxXYZ, 3>, kNumOrthogonalDirections>
    kRightQuarterTurn1TileBoundBoxes = flipTrackSequenceBoundBoxesXAxis(kLeftQuarterTurn1TileBoundBoxes);
    
    static constexpr std::array<std::array<ImageIndex, 5>, kNumOrthogonalDirections>
    kWaterfallSprites = {{
        {{ 21204, 21212, 21244, 21208, 21228, }},
        {{ 21205, 21220, 21252, 21209, 21236, }},
        {{ 21206, 21212, 21244, 21210, 21228, }},
        {{ 21207, 21220, 21252, 21211, 21236, }},
    }};
    
    static constexpr std::array<std::array<BoundBoxXYZ, 5>, kNumOrthogonalDirections>
    kWaterfallBoundBoxes = {{
        {{ { { 0, 4, 0 }, { 32, 24, 11 } }, { { 0, 4, 0 }, { 32, 24, 11 } }, { { 0, 4, 17 }, { 32, 1, 27 } }, { { 0, 27, 17 }, { 32, 1, 27 } }, { { 0, 27, 17 }, { 32, 1, 27 } } }},
        {{ { { 4, 0, 0 }, { 24, 32, 11 } }, { { 4, 0, 0 }, { 24, 32, 11 } }, { { 4, 0, 17 }, { 1, 32, 27 } }, { { 27, 0, 17 }, { 1, 32, 27 } }, { { 27, 0, 17 }, { 1, 32, 27 } } }},
        {{ { { 0, 4, 0 }, { 32, 24, 11 } }, { { 0, 4, 0 }, { 32, 24, 11 } }, { { 0, 4, 17 }, { 32, 1, 27 } }, { { 0, 27, 17 }, { 32, 1, 27 } }, { { 0, 27, 17 }, { 32, 1, 27 } } }},
        {{ { { 4, 0, 0 }, { 24, 32, 11 } }, { { 4, 0, 0 }, { 24, 32, 11 } }, { { 4, 0, 17 }, { 1, 32, 27 } }, { { 27, 0, 17 }, { 1, 32, 27 } }, { { 27, 0, 17 }, { 1, 32, 27 } } }},
    }};
    ...
    static constexpr std::array<std::array<BoundBoxXYZ, 2>, kNumOrthogonalDirections>
    kRapidsBoundBoxes = {{
        {{ { { 0, 4, 0 }, { 32, 24, 11 } }, { { 0, 27, 17 }, { 32, 1, 11 } } }},
        {{ { { 4, 0, 0 }, { 24, 32, 11 } }, { { 27, 0, 17 }, { 1, 32, 11 } } }},
        {{ { { 0, 4, 0 }, { 32, 24, 11 } }, { { 0, 27, 17 }, { 32, 1, 11 } } }},
        {{ { { 4, 0, 0 }, { 24, 32, 11 } }, { { 27, 0, 17 }, { 1, 32, 11 } } }},
    }};
    ...
    static constexpr std::array<std::array<BoundBoxXYZ, 3>, kNumOrthogonalDirections>
    kWhirlpoolBoundBoxes = {{
        {{ { { 0, 4, 0 }, { 32, 24, 11 } }, { { 0, 4, 0 }, { 32, 24, 11 } }, { { 10, 10, 0 }, { 1, 2, 5 } } }},
        {{ { { 4, 0, 0 }, { 24, 32, 11 } }, { { 4, 0, 0 }, { 24, 32, 11 } }, { { 10, 10, 0 }, { 1, 2, 5 } } }},
        {{ { { 0, 4, 0 }, { 32, 24, 11 } }, { { 0, 4, 0 }, { 32, 24, 11 } }, { { 10, 10, 0 }, { 1, 2, 5 } } }},
        {{ { { 4, 0, 0 }, { 24, 32, 11 } }, { { 4, 0, 0 }, { 24, 32, 11 } }, { { 10, 10, 0 }, { 1, 2, 5 } } }},
    }};
    ...
    constexpr std::array<TrackElementSprites, EnumValue(OpenRCT2::TrackElemType::Count)> kSprites = { {
        ...
        { &kFlatSprites[0][0], nullptr, &kFlatBoundBoxes[0][0], false }, // EndStation
        { &kFlatSprites[0][0], nullptr, &kFlatBoundBoxes[0][0], false }, // BeginStation
        { &kFlatSprites[0][0], nullptr, &kFlatBoundBoxes[0][0], false }, // MiddleStation
        ...
        { &kRightQuarterTurn1TileSprites[0][0], nullptr, &kRightQuarterTurn1TileBoundBoxes[0][0], false }, // RightQuarterTurn1Tile
        ...
        { &kWaterfallSprites[0][0], nullptr, &kWaterfallBoundBoxes[0][0], false }, // Waterfall
        { &kRapidsSprites[0][0], nullptr, &kRapidsBoundBoxes[0][0], false }, // Rapids
        ...
        { &kWhirlpoolSprites[0][0], nullptr, &kWhirlpoolBoundBoxes[0][0], false }, // Whirlpool

...
static constexpr uint32_t river_rapids_track_pieces_flat_to_25_deg_up[][2] = {
    { SPR_TRACKS_RAPIDS_WATER_FLAT_25_REVERSED_1, SPR_RIVER_RAPIDS_FLAT_TO_25_DEG_UP_FRONT_SW_NE },
    { SPR_TRACKS_RAPIDS_WATER_FLAT_25_REVERSED_2, SPR_RIVER_RAPIDS_FLAT_TO_25_DEG_UP_FRONT_NW_SE },
    { SPR_TRACKS_RAPIDS_WATER_FLAT_25_REVERSED_3, SPR_RIVER_RAPIDS_FLAT_TO_25_DEG_UP_FRONT_NE_SW },
    { SPR_TRACKS_RAPIDS_WATER_FLAT_25_REVERSED_4, SPR_RIVER_RAPIDS_FLAT_TO_25_DEG_UP_FRONT_SE_NW },
};
static constexpr uint32_t river_rapids_track_pieces_25_deg_up_to_flat[][2] = {
    { SPR_TRACKS_RAPIDS_WATER_FLAT_25_REVERSED_5, SPR_RIVER_RAPIDS_25_DEG_UP_TO_FLAT_FRONT_SW_NE },
    { SPR_TRACKS_RAPIDS_WATER_FLAT_25_REVERSED_6, SPR_RIVER_RAPIDS_25_DEG_UP_TO_FLAT_FRONT_NW_SE },
    { SPR_TRACKS_RAPIDS_WATER_FLAT_25_REVERSED_7, SPR_RIVER_RAPIDS_25_DEG_UP_TO_FLAT_FRONT_NE_SW },
    { SPR_TRACKS_RAPIDS_WATER_FLAT_25_REVERSED_8, SPR_RIVER_RAPIDS_25_DEG_UP_TO_FLAT_FRONT_SE_NW },
};

...
namespace OpenRCT2::BoatHire
{
    ...
    kFlatBoundBoxes = {{
        {{ { { 0, 4, 0 }, { 32, 1, 3 } }, { { 0, 28, 0 }, { 32, 1, 3 } } }},
        {{ { { 4, 0, 0 }, { 1, 32, 3 } }, { { 28, 0, 0 }, { 1, 32, 3 } } }},
        {{ { { 0, 4, 0 }, { 32, 1, 3 } }, { { 0, 28, 0 }, { 32, 1, 3 } } }},
        {{ { { 4, 0, 0 }, { 1, 32, 3 } }, { { 28, 0, 0 }, { 1, 32, 3 } } }},
    }};
    ...
    kLeftQuarterTurn5TilesSprites = {{
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 0, SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 1, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 2, SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 3, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 4, SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 5, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 6, SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 7, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 8, SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 9, }},
        }},
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 10, SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 11, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 12, SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 13, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 14, SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 15, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 16, SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 17, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 18, SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 19, }},
        }},
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 20, SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 21, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 22, SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 23, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 24, SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 25, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 26, SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 27, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 28, SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 29, }},
        }},
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 30, SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 31, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 32, SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 33, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 34, SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 35, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 36, SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 37, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 38, SPR_G2_BOAT_HIRE_TRACK_MEDIUM_CURVE + 39, }},
        }},
    }};
    ...
    kLeftQuarterTurn5TilesBoundBoxes = {{
        {{
            {{ { { 0, 6, 0 }, { 32, 20, 1 } }, { { 0, 6, 15 }, { 32, 20, 0 } } }},
            {{ {}, {} }},
            {{ { { 0, 0, 0 }, { 32, 16, 1 } }, { { 0, 0, 15 }, { 32, 16, 0 } } }},
            {{ { { 0, 16, 0 }, { 16, 16, 1 } }, { { 0, 16, 15 }, { 16, 16, 0 } } }},
            {{ {}, {} }},
            {{ { { 16, 0, 0 }, { 16, 32, 1 } }, { { 16, 0, 15 }, { 16, 32, 0 } } }},
            {{ { { 6, 0, 0 }, { 20, 32, 1 } }, { { 6, 0, 15 }, { 20, 32, 0 } } }},
        }},
        {{
            {{ { { 6, 0, 0 }, { 20, 32, 1 } }, { { 6, 0, 15 }, { 20, 32, 0 } } }},
            {{ {}, {} }},
            {{ { { 0, 0, 0 }, { 16, 32, 1 } }, { { 0, 0, 15 }, { 16, 32, 0 } } }},
            {{ { { 16, 16, 0 }, { 16, 16, 1 } }, { { 16, 16, 15 }, { 16, 16, 0 } } }},
            {{ {}, {} }},
            {{ { { 0, 0, 0 }, { 32, 16, 1 } }, { { 0, 0, 15 }, { 32, 16, 0 } } }},
            {{ { { 0, 6, 0 }, { 32, 20, 1 } }, { { 0, 6, 15 }, { 32, 20, 0 } } }},
        }},
        {{
            {{ { { 0, 6, 0 }, { 32, 20, 1 } }, { { 0, 6, 15 }, { 32, 20, 0 } } }},
            {{ {}, {} }},
            {{ { { 0, 16, 0 }, { 32, 16, 1 } }, { { 0, 16, 15 }, { 32, 16, 0 } } }},
            {{ { { 16, 0, 0 }, { 16, 16, 1 } }, { { 16, 0, 15 }, { 16, 16, 0 } } }},
            {{ {}, {} }},
            {{ { { 0, 0, 0 }, { 16, 32, 1 } }, { { 0, 0, 15 }, { 16, 32, 0 } } }},
            {{ { { 6, 0, 0 }, { 20, 32, 1 } }, { { 6, 0, 15 }, { 20, 32, 0 } } }},
        }},
    ...
    kSBendLeftSprites = {{
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_S_BEND + 0, SPR_G2_BOAT_HIRE_TRACK_S_BEND + 1, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_S_BEND + 2, SPR_G2_BOAT_HIRE_TRACK_S_BEND + 3, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_S_BEND + 4, SPR_G2_BOAT_HIRE_TRACK_S_BEND + 5, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_S_BEND + 6, SPR_G2_BOAT_HIRE_TRACK_S_BEND + 7, }},
        }},
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_S_BEND + 8, SPR_G2_BOAT_HIRE_TRACK_S_BEND + 9, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_S_BEND + 10, SPR_G2_BOAT_HIRE_TRACK_S_BEND + 11, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_S_BEND + 12, SPR_G2_BOAT_HIRE_TRACK_S_BEND + 13, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_S_BEND + 14, SPR_G2_BOAT_HIRE_TRACK_S_BEND + 15, }},
        }},
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_S_BEND + 6, SPR_G2_BOAT_HIRE_TRACK_S_BEND + 7, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_S_BEND + 4, SPR_G2_BOAT_HIRE_TRACK_S_BEND + 5, }},
    ...
    kSBendLeftBoundBoxes = {{
        {{
            {{ { { 0, 6, 0 }, { 32, 20, 1 } }, { { 0, 6, 15 }, { 32, 20, 0 } } }},
            {{ { { 0, 0, 0 }, { 32, 26, 1 } }, { { 0, 0, 15 }, { 32, 26, 0 } } }},
            {{ { { 0, 6, 0 }, { 32, 26, 1 } }, { { 0, 6, 15 }, { 32, 26, 0 } } }},
            {{ { { 0, 6, 0 }, { 32, 20, 1 } }, { { 0, 6, 15 }, { 32, 20, 0 } } }},
        }},
        {{
            {{ { { 6, 0, 0 }, { 20, 32, 1 } }, { { 6, 0, 15 }, { 20, 32, 0 } } }},
            {{ { { 0, 0, 0 }, { 26, 32, 1 } }, { { 0, 0, 15 }, { 26, 32, 0 } } }},
            {{ { { 6, 0, 0 }, { 26, 32, 1 } }, { { 6, 0, 15 }, { 26, 32, 0 } } }},
            {{ { { 6, 0, 0 }, { 20, 32, 1 } }, { { 6, 0, 15 }, { 20, 32, 0 } } }},
        }},
        {{
            {{ { { 0, 6, 0 }, { 32, 20, 1 } }, { { 0, 6, 15 }, { 32, 20, 0 } } }},
    ...
    kSBendRightSprites = {{
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_S_BEND + 16, SPR_G2_BOAT_HIRE_TRACK_S_BEND + 17, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_S_BEND + 18, SPR_G2_BOAT_HIRE_TRACK_S_BEND + 19, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_S_BEND + 20, SPR_G2_BOAT_HIRE_TRACK_S_BEND + 21, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_S_BEND + 22, SPR_G2_BOAT_HIRE_TRACK_S_BEND + 23, }},
        }},
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_S_BEND + 24, SPR_G2_BOAT_HIRE_TRACK_S_BEND + 25, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_S_BEND + 26, SPR_G2_BOAT_HIRE_TRACK_S_BEND + 27, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_S_BEND + 28, SPR_G2_BOAT_HIRE_TRACK_S_BEND + 29, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_S_BEND + 30, SPR_G2_BOAT_HIRE_TRACK_S_BEND + 31, }},
        }},
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_S_BEND + 22, SPR_G2_BOAT_HIRE_TRACK_S_BEND + 23, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_S_BEND + 20, SPR_G2_BOAT_HIRE_TRACK_S_BEND + 21, }},
    ...
    kLeftQuarterTurn3TilesSprites = {{
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 0, SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 1, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 2, SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 3, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 4, SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 5, }},
        }},
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 6, SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 7, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 8, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 9, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 10, SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 11, }},
        }},
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 12, SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 13, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 14, SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 15, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 16, SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 17, }},
        }},
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 18, SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 19, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 21, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 20, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 22, SPR_G2_BOAT_HIRE_TRACK_SMALL_CURVE + 23, }},
        }},
    }};
    ...
    kLeftQuarterTurn1TileBoundBoxes = {{
        {{ { { 0, 0, 0 }, { 32, 32, 1 } }, { { 28, 28, 2 }, { 3, 3, 3 } } }},
        {{ { { 0, 0, 0 }, { 32, 32, 1 } }, { { 28, 28, 2 }, { 3, 3, 3 } } }},
        {{ { { 0, 0, 0 }, { 32, 32, 1 } }, { { 28, 28, 2 }, { 3, 3, 3 } } }},
        {{ { { 28, 28, 2 }, { 3, 3, 3 } }, { { 0, 0, 0 }, { 32, 32, 1 } } }},
    }};
    
    static constexpr std::array<std::array<std::array<ImageIndex, 2>, 5>, kNumOrthogonalDirections>
    kLeftEighthToDiagSprites = {{
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 0, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 1, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 2, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 3, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 4, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 5, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 6, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 7, }},
        }},
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 8, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 9, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 10, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 11, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 12, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 13, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 14, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 15, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 16, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 17, }},
        }},
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 18, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 19, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 20, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 21, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 22, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 23, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 24, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 25, }},
        }},
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 26, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 27, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 28, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 29, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 30, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 31, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 32, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 33, }},
        }},
    }};
    ...
    kLeftEighthToDiagBoundBoxes = {{
        {{
            ...
            {{ { { 0, 16, 0 }, { 16, 16, 1 } }, { { 0, 16, 15 }, { 16, 16, 0 } } }},
            {{ {}, {} }},
            {{ { { 16, 16, 0 }, { 16, 16, 1 } }, { { 16, 16, 0 }, { 16, 16, 1 } } }},
        }},
        {{
            {{ { { 6, 0, 0 }, { 20, 32, 1 } }, { { 6, 0, 15 }, { 20, 32, 0 } } }},
            {{ { { 0, 0, 0 }, { 16, 32, 1 } }, { { 0, 0, 15 }, { 16, 32, 0 } } }},
            {{ { { 16, 16, 0 }, { 16, 16, 1 } }, { { 16, 16, 15 }, { 16, 16, 0 } } }},
            {{ { { 0, 0, 0 }, { 16, 16, 1 } }, { { 0, 0, 15 }, { 16, 16, 0 } } }},
            {{ { { 16, 0, 0 }, { 18, 16, 1 } }, { { 16, 0, 15 }, { 16, 16, 0 } } }},
        }},
        {{
            {{ { { 0, 6, 0 }, { 32, 20, 1 } }, { { 0, 6, 15 }, { 32, 20, 0 } } }},
            {{ { { 0, 16, 0 }, { 32, 16, 1 } }, { { 0, 16, 15 }, { 32, 16, 0 } } }},
    ...
    kRightEighthToDiagSprites = {{
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 34, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 35, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 36, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 37, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 38, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 39, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 40, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 41, }},
        }},
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 42, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 43, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 44, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 45, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 46, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 47, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 48, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 49, }},
        }},
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 50, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 51, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 52, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 53, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 54, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 55, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 56, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 57, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 58, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 59, }},
        }},
        {{
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 60, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 61, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 62, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 63, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 64, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 65, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 66, SPR_G2_BOAT_HIRE_TRACK_LARGE_CURVE + 67, }},
        }},
    }};
    ...
    kDiagFlatSprites = {{
        {{
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_FLAT_DIAGONAL + 0, SPR_G2_BOAT_HIRE_TRACK_FLAT_DIAGONAL + 1, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
        }},
        {{
            ...
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ SPR_G2_BOAT_HIRE_TRACK_FLAT_DIAGONAL + 2, kImageIndexUndefined, }},
        }},
        {{
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
            {{ kImageIndexUndefined, kImageIndexUndefined, }},
    ...
    kDiagFlatBoundBoxes = {{
        {{
            {{ {}, {} }},
            {{ { { -16, -16, 0 }, { 32, 32, 1 } }, { { -16, -16, 15 }, { 32, 32, 0 } } }},
            {{ {}, {} }},
            {{ {}, {} }},
        }},
        {{
    ...
    constexpr std::array<TrackElementSprites, EnumValue(OpenRCT2::TrackElemType::Count)> kSprites = { {
        ...
        { &kDiagFlatSprites[0][0][0], &kDiagFlatOffsets[0][0][0], &kDiagFlatBoundBoxes[0][0][0], false }, // DiagFlat

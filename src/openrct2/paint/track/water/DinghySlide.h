...
namespace OpenRCT2::DinghySlide
{
    // clang-format off
    ...
    constexpr std::array<TrackElementSprites, EnumValue(OpenRCT2::TrackElemType::Count)> kSprites = { {
        ...
        { &kRightQuarterTurn5TilesSprites[0][0][0], &kRightQuarterTurn5TilesOffsets[0][0][0], &kRightQuarterTurn5TilesBoundBoxes[0][0][0], false }, // RightQuarterTurn5Tiles

...
namespace OpenRCT2::BlockedSegments
{
    ...
    namespace Narrow
    {
        ...
        constexpr uint16_t kUp90ToInvertedFlatQuarterLoopSeq0 = kFlatSeq0;
        constexpr uint16_t kUp90ToInvertedFlatQuarterLoopSeq1 = kFlatSeq0;
        constexpr uint16_t kUp90ToInvertedFlatQuarterLoopSeq2 = kFlatSeq0;
        constexpr uint16_t kInvertedFlatToDown90QuarterLoopSeq0 = kFlatSeq0;
        constexpr uint16_t kInvertedFlatToDown90QuarterLoopSeq1 = kFlatSeq0;
        constexpr uint16_t kInvertedFlatToDown90QuarterLoopSeq2 = kFlatSeq0;

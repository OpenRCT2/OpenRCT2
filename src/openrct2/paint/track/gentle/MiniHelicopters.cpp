...
static constexpr TunnelGroup kMiniHelicoptersTunnelGroup = TunnelGroup::Standard;
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    if (direction & 1)
    {
        ...
        PaintUtilPushTunnelRight(session, height, kMiniHelicoptersTunnelGroup, TunnelSubType::Flat);
    }
    else
    {
        imageId = session.TrackColours.WithIndex(SPR_TRACK_SUBMARINE_RIDE_MINI_HELICOPTERS_FLAT_NE_SW);
        PaintAddImageAsParent(session, imageId, { 0, 0, height }, { { 0, 6, height }, { 32, 20, 3 } });
        PaintUtilPushTunnelLeft(session, height, kMiniHelicoptersTunnelGroup, TunnelSubType::Flat);
    }
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    switch (direction)
    {
        ...
        case 1:
            ...
            PaintAddImageAsParent(session, imageId, { 0, 0, height }, { { 6, 0, height }, { 20, 32, 3 } });
            PaintUtilPushTunnelRight(session, height, kMiniHelicoptersTunnelGroup, TunnelSubType::SlopeEnd);
            break;
        case 2:
            imageId = session.TrackColours.WithIndex(SPR_TRACK_SUBMARINE_RIDE_MINI_HELICOPTERS_FLAT_TO_25_DEG_UP_NE_SW);
            PaintAddImageAsParent(session, imageId, { 0, 0, height }, { { 0, 6, height }, { 32, 20, 3 } });
            PaintUtilPushTunnelLeft(session, height, kMiniHelicoptersTunnelGroup, TunnelSubType::SlopeEnd);
            break;
        case 3:
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    switch (direction)
    {
        case 0:
            ...
            PaintAddImageAsParent(session, imageId, { 0, 0, height }, { { 0, 6, height }, { 32, 20, 3 } });
            PaintUtilPushTunnelLeft(session, height - 8, kMiniHelicoptersTunnelGroup, TunnelSubType::SlopeStart);
            break;
        case 1:
            imageId = session.TrackColours.WithIndex(SPR_TRACK_SUBMARINE_RIDE_MINI_HELICOPTERS_25_DEG_UP_NW_SE);
            PaintAddImageAsParent(session, imageId, { 0, 0, height }, { { 6, 0, height }, { 20, 32, 3 } });
            PaintUtilPushTunnelRight(session, height + 8, kMiniHelicoptersTunnelGroup, TunnelSubType::SlopeEnd);
            break;
        case 2:
            imageId = session.TrackColours.WithIndex(SPR_TRACK_SUBMARINE_RIDE_MINI_HELICOPTERS_25_DEG_UP_NE_SW);
            PaintAddImageAsParent(session, imageId, { 0, 0, height }, { { 0, 6, height }, { 32, 20, 3 } });
            PaintUtilPushTunnelLeft(session, height + 8, kMiniHelicoptersTunnelGroup, TunnelSubType::SlopeEnd);
            break;
        case 3:
            imageId = session.TrackColours.WithIndex(SPR_TRACK_SUBMARINE_RIDE_MINI_HELICOPTERS_25_DEG_UP_SE_NW);
            PaintAddImageAsParent(session, imageId, { 0, 0, height }, { { 6, 0, height }, { 20, 32, 3 } });
            PaintUtilPushTunnelRight(session, height - 8, kMiniHelicoptersTunnelGroup, TunnelSubType::SlopeStart);
            break;
    }
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    switch (direction)
    {
        case 0:
            ...
            PaintAddImageAsParent(session, imageId, { 0, 0, height }, { { 0, 6, height }, { 32, 20, 3 } });
            PaintUtilPushTunnelLeft(session, height - 8, kMiniHelicoptersTunnelGroup, TunnelSubType::Flat);
            break;
        case 1:
            imageId = session.TrackColours.WithIndex(SPR_TRACK_SUBMARINE_RIDE_MINI_HELICOPTERS_25_DEG_UP_TO_FLAT_NW_SE);
            PaintAddImageAsParent(session, imageId, { 0, 0, height }, { { 6, 0, height }, { 20, 32, 3 } });
            PaintUtilPushTunnelRight(session, height + 8, kMiniHelicoptersTunnelGroup, TunnelSubType::FlatTo25Deg);
            break;
        case 2:
            imageId = session.TrackColours.WithIndex(SPR_TRACK_SUBMARINE_RIDE_MINI_HELICOPTERS_25_DEG_UP_TO_FLAT_NE_SW);
            PaintAddImageAsParent(session, imageId, { 0, 0, height }, { { 0, 6, height }, { 32, 20, 3 } });
            PaintUtilPushTunnelLeft(session, height + 8, kMiniHelicoptersTunnelGroup, TunnelSubType::FlatTo25Deg);
            break;
        case 3:
            imageId = session.TrackColours.WithIndex(SPR_TRACK_SUBMARINE_RIDE_MINI_HELICOPTERS_25_DEG_UP_TO_FLAT_SE_NW);
            PaintAddImageAsParent(session, imageId, { 0, 0, height }, { { 6, 0, height }, { 20, 32, 3 } });
            PaintUtilPushTunnelRight(session, height - 8, kMiniHelicoptersTunnelGroup, TunnelSubType::Flat);
            break;
    }
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    TrackPaintUtilLeftQuarterTurn3TilesTunnel(
        session, kMiniHelicoptersTunnelGroup, TunnelSubType::Flat, height, direction, trackSequence);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    TrackPaintUtilLeftQuarterTurn1TileTunnel(
        session, kMiniHelicoptersTunnelGroup, direction, height, 0, TunnelSubType::Flat, 0, TunnelSubType::Flat);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    PaintUtilPushTunnelRotated(session, direction, height, kMiniHelicoptersTunnelGroup, TunnelSubType::Flat);

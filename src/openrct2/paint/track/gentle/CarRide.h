...
namespace OpenRCT2::CarRide
{
    ...
    static constexpr std::array<CoordsXYZ, kNumOrthogonalDirections> kFlatOffsets = { {
        { 0, 6, 0 },
        { 6, 0, 0 },
        { 0, 6, 0 },
        { 6, 0, 0 },
    ...
    static constexpr std::array<CoordsXYZ, kNumOrthogonalDirections> kUp25Offsets = { {
        { 0, 2, 0 },
        { 2, 0, 0 },
        { 0, 2, 0 },
        { 2, 0, 0 },
    ...
    static constexpr std::array<CoordsXYZ, kNumOrthogonalDirections> kFlatToUp25Offsets = { {
        { 0, 2, 0 },
        { 2, 0, 0 },
        { 0, 2, 0 },
        { 2, 0, 0 },
    ...
    kUp25ToUp60Sprites = {{
        {{ 28789, kImageIndexUndefined, }},
        {{ 28790, 28793, }},
        {{ 28791, 28794, }},
        {{ 28792, kImageIndexUndefined, }},
    }};
    // clang-format on
    ...
    static constexpr std::array<std::array<ImageIndex, 2>, kNumOrthogonalDirections>
    kUp60ToUp25Sprites = {{
        {{ 28795, kImageIndexUndefined, }},
        {{ 28796, 28799, }},
        {{ 28797, 28800, }},
        {{ 28798, kImageIndexUndefined, }},
    }};
    // clang-format on
    ...
    static constexpr std::array<CoordsXYZ, kNumOrthogonalDirections> kUp25ToFlatOffsets = { {
        { 0, 2, 0 },
        { 2, 0, 0 },
        { 0, 2, 0 },
        { 2, 0, 0 },
    ...
    static constexpr std::array<std::array<CoordsXYZ, 4>, kNumOrthogonalDirections> kRightQuarterTurn3TilesOffsets = { {
        { {
            { 0, 6, 0 },
            {},
            { 16, 16, 0 },
    ...
    static constexpr std::array<CoordsXYZ, kNumOrthogonalDirections> kLeftQuarterTurn1TileOffsets = { {
        { 6, 0, 0 },
        { 0, 0, 0 },
        { 0, 6, 0 },
        { 6, 6, 0 },
    ...
    static constexpr std::array<CoordsXYZ, kNumOrthogonalDirections> kRapidsOffsets = { {
        { 0, 6, 0 },
        { 6, 0, 0 },
        { 0, 6, 0 },
        { 6, 0, 0 },
    ...
    static constexpr std::array<BoundBoxXYZ, kNumOrthogonalDirections> kRapidsBoundBoxes = { {
        { { 0, 6, 0 }, { 32, 20, 1 } },
        { { 6, 0, 0 }, { 20, 32, 1 } },
        { { 0, 6, 0 }, { 32, 20, 1 } },
        { { 6, 0, 0 }, { 20, 32, 1 } },
    ...
    constexpr std::array<TrackElementSprites, EnumValue(OpenRCT2::TrackElemType::Count)> kSprites = { {
        ...
        { &kFlatSprites[0], &kFlatOffsets[0], &kStationBoundBoxes[0], false },                // EndStation
        { &kFlatSprites[0], &kFlatOffsets[0], &kStationBoundBoxes[0], false },                // BeginStation
        { &kFlatSprites[0], &kFlatOffsets[0], &kStationBoundBoxes[0], false },                // MiddleStation
        ...
        { &kRightQuarterTurn3TilesSprites[0][0], &kRightQuarterTurn3TilesOffsets[0][0],
          &kRightQuarterTurn3TilesBoundBoxes[0][0], false }, // RightQuarterTurn3Tiles
        ...
        { &kLeftQuarterTurn1TileSprites[0], &kLeftQuarterTurn1TileOffsets[0], &kLeftQuarterTurn1TileBoundBoxes[0],
        ...
        { &kRapidsSprites[0], &kRapidsOffsets[0], &kRapidsBoundBoxes[0], false }, // Rapids
        ...
        { &kFlatSprites[0], &kFlatOffsets[0], &kFlatBoundBoxes[0], false },       // SpinningTunnel

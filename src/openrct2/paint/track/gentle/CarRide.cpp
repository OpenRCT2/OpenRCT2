...
static constexpr TunnelGroup kCarRideTunnelGroup = TunnelGroup::Standard;
...
static constexpr uint32_t kCarRidePiecesFlat[4] = {
    SprCarRideFlatSwNe,
    SprCarRideFlatNwSe,
    SprCarRideFlatSwNe,
    SprCarRideFlatNwSe,
...
static constexpr uint32_t kCarRidePieces25DegUp[4] = {
...
static constexpr uint32_t kCarRidePiecesFlatTo25DegUp[4] = {
...
static constexpr uint32_t kCarRidePieces25DegUpToFlat[4] = {
...
static constexpr uint32_t kCarRidePieces25DegUpTo60DegUp[4][2] = {
...
{
    auto imageId = session.TrackColours.WithIndex(kCarRidePiecesFlat[direction]);
    ...
    if (direction == 0 || direction == 2)
    {
        PaintUtilPushTunnelLeft(session, height, kCarRideTunnelGroup, TunnelSubType::Flat);
    }
    else
    {
        PaintUtilPushTunnelRight(session, height, kCarRideTunnelGroup, TunnelSubType::Flat);
    }
...
static void PaintCarRideTrack25DegUp(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    auto imageId = session.TrackColours.WithIndex(kCarRidePieces25DegUp[direction]);
    ...
    {
        case 0:
            PaintUtilPushTunnelLeft(session, height - 8, kCarRideTunnelGroup, TunnelSubType::SlopeStart);
            break;
        case 1:
            PaintUtilPushTunnelRight(session, height + 8, kCarRideTunnelGroup, TunnelSubType::SlopeEnd);
            break;
        case 2:
            PaintUtilPushTunnelLeft(session, height + 8, kCarRideTunnelGroup, TunnelSubType::SlopeEnd);
            break;
        case 3:
            PaintUtilPushTunnelRight(session, height - 8, kCarRideTunnelGroup, TunnelSubType::SlopeStart);
            break;
    }
...
static void PaintCarRideTrackFlatTo25DegUp(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    auto imageId = session.TrackColours.WithIndex(kCarRidePiecesFlatTo25DegUp[direction]);
    ...
    switch (direction)
    {
        case 0:
            ...
            break;
        case 1:
            PaintUtilPushTunnelRight(session, height, kCarRideTunnelGroup, TunnelSubType::SlopeEnd);
            break;
        case 2:
            PaintUtilPushTunnelLeft(session, height, kCarRideTunnelGroup, TunnelSubType::SlopeEnd);
            break;
        case 3:
            PaintUtilPushTunnelRight(session, height, kCarRideTunnelGroup, TunnelSubType::Flat);
            break;
...
static void PaintCarRideTrack25DegUpToFlat(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    auto imageId = session.TrackColours.WithIndex(kCarRidePieces25DegUpToFlat[direction]);
    ...
    {
        case 0:
            PaintUtilPushTunnelLeft(session, height - 8, kCarRideTunnelGroup, TunnelSubType::Flat);
            break;
        case 1:
            PaintUtilPushTunnelRight(session, height + 8, kCarRideTunnelGroup, TunnelSubType::FlatTo25Deg);
            break;
        case 2:
            PaintUtilPushTunnelLeft(session, height + 8, kCarRideTunnelGroup, TunnelSubType::FlatTo25Deg);
            break;
        case 3:
            PaintUtilPushTunnelRight(session, height - 8, kCarRideTunnelGroup, TunnelSubType::Flat);
            break;
    }
...
static void PaintCarRideStation(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    const ImageId imageId = session.TrackColours.WithIndex(kCarRidePiecesFlat[direction]);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    TrackPaintUtilRightQuarterTurn3TilesTunnel(
        session, kCarRideTunnelGroup, TunnelSubType::Flat, height, direction, trackSequence);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    TrackPaintUtilLeftQuarterTurn1TileTunnel(
        session, kCarRideTunnelGroup, direction, height, 0, TunnelSubType::Flat, 0, TunnelSubType::Flat);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    switch (direction)
    {
        case 0:
            ...
            break;
        case 1:
            PaintUtilPushTunnelRight(session, height + 56, kCarRideTunnelGroup, TunnelSubType::SlopeEnd);
            break;
        case 2:
            PaintUtilPushTunnelLeft(session, height + 56, kCarRideTunnelGroup, TunnelSubType::SlopeEnd);
            break;
        case 3:
            PaintUtilPushTunnelRight(session, height - 8, kCarRideTunnelGroup, TunnelSubType::SlopeStart);
            break;
...
static void PaintCarRideTrack25DegUpTo60DegUp(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    auto imageId = session.TrackColours.WithIndex(kCarRidePieces25DegUpTo60DegUp[direction][0]);
    ...
    if (kCarRidePieces25DegUpTo60DegUp[direction][1] != 0)
    {
        imageId = session.TrackColours.WithIndex(kCarRidePieces25DegUpTo60DegUp[direction][1]);
    ...
    switch (direction)
    {
        case 0:
            ...
            break;
        case 1:
            PaintUtilPushTunnelRight(session, height + 24, kCarRideTunnelGroup, TunnelSubType::SlopeEnd);
            break;
        case 2:
            PaintUtilPushTunnelLeft(session, height + 24, kCarRideTunnelGroup, TunnelSubType::SlopeEnd);
            break;
        case 3:
            PaintUtilPushTunnelRight(session, height - 8, kCarRideTunnelGroup, TunnelSubType::SlopeStart);
            break;

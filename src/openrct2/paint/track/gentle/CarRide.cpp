    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    MetalASupportsPaintSetup(session, supportType.metal, MetalSupportPlace::Centre, 3, height, true, session.SupportColours);
    PaintUtilSetSegmentSupportHeight(
        session,
        PaintUtilRotateSegments(
            EnumsToFlags(PaintSegment::bottomLeft, PaintSegment::centre, PaintSegment::topRight), direction),
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    MetalASupportsPaintSetup(session, supportType.metal, MetalSupportPlace::Centre, 6, height, true, session.SupportColours);
    PaintUtilSetSegmentSupportHeight(
        session,
        PaintUtilRotateSegments(
            EnumsToFlags(PaintSegment::bottomLeft, PaintSegment::centre, PaintSegment::topRight), direction),

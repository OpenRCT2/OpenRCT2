...
namespace OpenRCT2::MonorailCycles
{
    // clang-format off
    ...
    static constexpr std::array<std::array<BoundBoxXYZ, 7>, kNumOrthogonalDirections> kRightQuarterTurn5TilesBoundBoxes = { {
        { {
            { { 0, 6, 0 }, { 32, 20, 1 } },
            {},
            { { 0, 16, 0 }, { 32, 16, 1 } },
    ...
    constexpr std::array<TrackElementSprites, EnumValue(OpenRCT2::TrackElemType::Count)> kSprites = { {
        ...
        { &kRightQuarterTurn5TilesSprites[0][0], nullptr, &kRightQuarterTurn5TilesBoundBoxes[0][0],
          false },                                                                   // RightQuarterTurn5Tiles

...
#pragma pack(pop)
    ...
    struct GameStateSnapshot_t
    {
        ...
        void SerialiseSprites(std::function<EntitySnapshot*(const EntityId)> getEntity, const size_t numSprites, bool saving)
        {
            ...
            if (!EntitiesSizeCheck<Vehicle, Guest, Staff, Litter, MoneyEffect, Balloon, Duck, JumpingFountain, SteamParticle>(
                    ds))
            {
...
#define COMPARE_FIELD(struc, field)                                                                                            \
    ...
    {                                                                                                                          \
        ...
        void CompareSpriteDataVehicle(
            const Vehicle& spriteBase, const Vehicle& spriteCmp, GameStateSpriteChange& changeData) const
        {
        ...
        void CompareSpriteDataVehicleCrashParticle(
            ...
            GameStateSpriteChange& changeData) const
        {
        ...
        void CompareSpriteDataBalloon(
            const Balloon& spriteBase, const Balloon& spriteCmp, GameStateSpriteChange& changeData) const
        {
        ...
        void CompareSpriteDataCrashSplash(
            const CrashSplashParticle& spriteBase, const CrashSplashParticle& spriteCmp,
            GameStateSpriteChange& changeData) const
        {
                ...
                switch (spriteBase.base.Type)
                {
                    ...
                    case EntityType::Vehicle:
                        CompareSpriteDataVehicle(
                            static_cast<const Vehicle&>(spriteBase.base), static_cast<const Vehicle&>(spriteCmp.base),
                            changeData);
                        break;
                    case EntityType::Litter:
                        CompareSpriteDataLitter(
                            static_cast<const Litter&>(spriteBase.base), static_cast<const Litter&>(spriteCmp.base),
                            changeData);
                        break;
                    case EntityType::SteamParticle:
                        CompareSpriteDataSteamParticle(
                            static_cast<const SteamParticle&>(spriteBase.base),
                            static_cast<const SteamParticle&>(spriteCmp.base), changeData);
                        break;
                    case EntityType::MoneyEffect:
                    ...
                    case EntityType::ExplosionCloud:
                        CompareSpriteDataExplosionCloud(
                            static_cast<const ExplosionCloud&>(spriteBase.base),
                            static_cast<const ExplosionCloud&>(spriteCmp.base), changeData);
                        break;
                    ...
                    case EntityType::ExplosionFlare:
                        CompareSpriteDataExplosionFlare(
                            static_cast<const ExplosionFlare&>(spriteBase.base),
                            static_cast<const ExplosionFlare&>(spriteCmp.base), changeData);
                        break;
                    case EntityType::JumpingFountain:
                    ...
                    case EntityType::Balloon:
                        CompareSpriteDataBalloon(
                            static_cast<const Balloon&>(spriteBase.base), static_cast<const Balloon&>(spriteCmp.base),
                            changeData);
                        break;
                    case EntityType::Duck:
        ...
        virtual GameStateCompareData Compare(
            const GameStateSnapshot_t& base, const GameStateSnapshot_t& cmp) const override final
        {
        ...
        virtual std::string GetCompareDataText(const GameStateCompareData& cmpData) const override
        {
            ...
            snprintf(
                tempBuffer, sizeof(tempBuffer), "tick left = %08X, tick right = %08X\n", cmpData.tickLeft, cmpData.tickRight);

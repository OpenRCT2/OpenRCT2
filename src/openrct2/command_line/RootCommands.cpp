...
static constexpr CommandLineOptionDefinition StandardOptions[]
{
    ...
    { CMDLINE_TYPE_SWITCH,  &_about,            NAC, "about",              "show information about " openrct2Name                      },
    { CMDLINE_TYPE_SWITCH,  &_verbose,          NAC, "verbose",            "log verbose messages"                                       },
    { CMDLINE_TYPE_SWITCH,  &_headless,         NAC, "headless",           "run " openrct2Name " headless" IMPLIES_SILENT_BREAKPAD     },
#ifndef DISABLE_NETWORK

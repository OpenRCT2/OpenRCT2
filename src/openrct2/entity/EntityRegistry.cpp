...
{
    auto entityIndex = EntityId::FromUnderlying(entityNumber);
    EntityBase* foundEntity;
    switch (entityType)
    {
        case EntityType::Vehicle:
            foundEntity = TryGetEntity<Vehicle>(entityIndex);
            break;
        case EntityType::Guest:
            foundEntity = TryGetEntity<Guest>(entityIndex);
            break;
        case EntityType::Staff:
            foundEntity = TryGetEntity<Staff>(entityIndex);
            break;
        case EntityType::Litter:
            foundEntity = TryGetEntity<Litter>(entityIndex);
            break;
        case EntityType::SteamParticle:
            foundEntity = TryGetEntity<SteamParticle>(entityIndex);
            break;
        case EntityType::MoneyEffect:
            foundEntity = TryGetEntity<MoneyEffect>(entityIndex);
            break;
        case EntityType::CrashedVehicleParticle:
            foundEntity = TryGetEntity<VehicleCrashParticle>(entityIndex);
            break;
        case EntityType::ExplosionCloud:
            foundEntity = TryGetEntity<ExplosionCloud>(entityIndex);
            break;
        case EntityType::CrashSplash:
            foundEntity = TryGetEntity<CrashSplashParticle>(entityIndex);
            break;
        case EntityType::ExplosionFlare:
            foundEntity = TryGetEntity<ExplosionFlare>(entityIndex);
            break;
        case EntityType::JumpingFountain:
            foundEntity = TryGetEntity<JumpingFountain>(entityIndex);
            break;
        case EntityType::Balloon:
            foundEntity = TryGetEntity<Balloon>(entityIndex);
            break;
        case EntityType::Duck:
            foundEntity = TryGetEntity<Duck>(entityIndex);
            break;
        default:
            foundEntity = TryGetEntity(entityIndex);
            break;
    }
    return foundEntity;
}

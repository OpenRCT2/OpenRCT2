...
enum : ImageIndex
{
    ...
    SPR_TRACKS_SINGLE_RAIL_TRACK_BANKED_S_BEND = SPR_TRACKS_SINGLE_RAIL_LIFT_TRACK_SMALL_FLAT_TO_STEEP + 20,
    ...
    SPR_TRACKS_SINGLE_RAIL_END = SPR_TRACKS_SINGLE_RAIL_TRACK_ZERO_G_ROLL_BANKED + 32,
    ...
    SPR_TRACKS_BM_TRACK_CORKSCREW_DIAGONAL = SPR_TRACKS_LATTICE_TRIANGLE_TRACK_CORKSCREW_DIAGONAL + 40,
    SPR_TRACKS_CORKSCREW_TRACK_CORKSCREW_DIAGONAL =  SPR_TRACKS_BM_TRACK_CORKSCREW_DIAGONAL + 40,
    SPR_TRACKS_SINGLE_RAIL_TRACK_CORKSCREW_DIAGONAL =  SPR_TRACKS_CORKSCREW_TRACK_CORKSCREW_DIAGONAL + 40,

    SPR_TRACKS_END = SPR_TRACKS_SINGLE_RAIL_TRACK_CORKSCREW_DIAGONAL + 40,

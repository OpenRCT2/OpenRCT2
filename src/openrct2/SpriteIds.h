...
enum : ImageIndex
{
    ...
    SPR_TRACKS_PIPELINE_TRACK_FLAT = SPR_TRACKS_PIPELINE_TRACK_STATION + 4,
    ...
    SPR_TRACKS_STATION_BASE_E_SW_NE = SPR_TRACKS_PIPELINE_END,
    SPR_TRACKS_STATION_BASE_E_NW_SE,

    SPR_TRACKS_HYBRID_GENTLE_BRAKE,

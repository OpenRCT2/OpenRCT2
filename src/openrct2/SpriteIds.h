...
enum : ImageIndex
{
    ...
    SPR_RIDE_DESIGN_PREVIEW_PIPELINE_COASTER_TRACK = SPR_TRACKS_ALPINE_END,
    SPR_RIDE_DESIGN_PREVIEW_PIPELINE_COASTER_SUPPORTS,
    SPR_TRACKS_PIPELINE_BEGIN,
    SPR_TRACKS_PIPELINE_TRACK_STATION = SPR_TRACKS_PIPELINE_BEGIN,
    SPR_TRACKS_PIPELINE_TRACK_FLAT = SPR_TRACKS_PIPELINE_TRACK_STATION + 2,
    SPR_TRACKS_PIPELINE_TRACK_BRAKE = SPR_TRACKS_PIPELINE_TRACK_FLAT + 4,
    SPR_TRACKS_PIPELINE_TRACK_BLOCK_BRAKE = SPR_TRACKS_PIPELINE_TRACK_BRAKE + 4,
    SPR_TRACKS_PIPELINE_TRACK_GENTLE = SPR_TRACKS_PIPELINE_TRACK_BLOCK_BRAKE + 4,
    SPR_TRACKS_PIPELINE_TRACK_STEEP = SPR_TRACKS_PIPELINE_TRACK_GENTLE + 24,
    SPR_TRACKS_PIPELINE_TRACK_VERTICAL = SPR_TRACKS_PIPELINE_TRACK_STEEP + 24,
    SPR_TRACKS_PIPELINE_TRACK_SMALL_CURVE = SPR_TRACKS_PIPELINE_TRACK_VERTICAL + 24,
    SPR_TRACKS_PIPELINE_TRACK_MEDIUM_CURVE = SPR_TRACKS_PIPELINE_TRACK_SMALL_CURVE + 24,
    SPR_TRACKS_PIPELINE_TRACK_LARGE_CURVE = SPR_TRACKS_PIPELINE_TRACK_MEDIUM_CURVE + 40,
    SPR_TRACKS_PIPELINE_TRACK_FLAT_DIAGONAL = SPR_TRACKS_PIPELINE_TRACK_LARGE_CURVE + 64,
    SPR_TRACKS_PIPELINE_TRACK_BRAKE_DIAGONAL = SPR_TRACKS_PIPELINE_TRACK_FLAT_DIAGONAL + 8,
    SPR_TRACKS_PIPELINE_TRACK_BLOCK_BRAKE_DIAGONAL = SPR_TRACKS_PIPELINE_TRACK_BRAKE_DIAGONAL + 8,
    SPR_TRACKS_PIPELINE_TRACK_GENTLE_DIAGONAL = SPR_TRACKS_PIPELINE_TRACK_BLOCK_BRAKE_DIAGONAL + 8,
    SPR_TRACKS_PIPELINE_TRACK_STEEP_DIAGONAL = SPR_TRACKS_PIPELINE_TRACK_GENTLE_DIAGONAL + 24,
    SPR_TRACKS_PIPELINE_TRACK_BANK_TRANSITION = SPR_TRACKS_PIPELINE_TRACK_STEEP_DIAGONAL + 24,
    SPR_TRACKS_PIPELINE_TRACK_BANK_TRANSITION_DIAGONAL = SPR_TRACKS_PIPELINE_TRACK_BANK_TRANSITION + 56,
    SPR_TRACKS_PIPELINE_TRACK_SMALL_CURVE_BANKED = SPR_TRACKS_PIPELINE_TRACK_BANK_TRANSITION_DIAGONAL + 56,
    SPR_TRACKS_PIPELINE_TRACK_MEDIUM_CURVE_BANKED = SPR_TRACKS_PIPELINE_TRACK_SMALL_CURVE_BANKED + 24,
    SPR_TRACKS_PIPELINE_TRACK_LARGE_CURVE_BANKED = SPR_TRACKS_PIPELINE_TRACK_MEDIUM_CURVE_BANKED + 40,
    SPR_TRACKS_PIPELINE_TRACK_GENTLE_SMALL_CURVE = SPR_TRACKS_PIPELINE_TRACK_LARGE_CURVE_BANKED + 64,
    SPR_TRACKS_PIPELINE_TRACK_GENTLE_MEDIUM_CURVE = SPR_TRACKS_PIPELINE_TRACK_GENTLE_SMALL_CURVE + 32,
    SPR_TRACKS_PIPELINE_TRACK_STEEP_SMALL_CURVE = SPR_TRACKS_PIPELINE_TRACK_GENTLE_MEDIUM_CURVE + 80,
    SPR_TRACKS_PIPELINE_TRACK_VERTICAL_TWIST = SPR_TRACKS_PIPELINE_TRACK_STEEP_SMALL_CURVE + 16,
    SPR_TRACKS_PIPELINE_TRACK_SLOPE_BANK_TRANSITION = SPR_TRACKS_PIPELINE_TRACK_VERTICAL_TWIST + 16,
    SPR_TRACKS_PIPELINE_TRACK_GENTLE_SMALL_CURVE_BANKED = SPR_TRACKS_PIPELINE_TRACK_SLOPE_BANK_TRANSITION + 112,
    SPR_TRACKS_PIPELINE_TRACK_GENTLE_MEDIUM_CURVE_BANKED = SPR_TRACKS_PIPELINE_TRACK_GENTLE_SMALL_CURVE_BANKED + 32,
    SPR_TRACKS_PIPELINE_TRACK_S_BEND = SPR_TRACKS_PIPELINE_TRACK_GENTLE_MEDIUM_CURVE_BANKED + 80,
    SPR_TRACKS_PIPELINE_TRACK_SMALL_HELIX = SPR_TRACKS_PIPELINE_TRACK_S_BEND + 32,
    SPR_TRACKS_PIPELINE_TRACK_LARGE_HELIX = SPR_TRACKS_PIPELINE_TRACK_SMALL_HELIX + 48,
    SPR_TRACKS_PIPELINE_TRACK_INLINE_TWIST = SPR_TRACKS_PIPELINE_TRACK_LARGE_HELIX + 80,
    SPR_TRACKS_PIPELINE_TRACK_HALF_LOOP = SPR_TRACKS_PIPELINE_TRACK_INLINE_TWIST + 48,
    SPR_TRACKS_PIPELINE_TRACK_FLAT_TO_STEEP = SPR_TRACKS_PIPELINE_TRACK_HALF_LOOP + 32,
    SPR_TRACKS_PIPELINE_TRACK_FLAT_TO_STEEP_DIAGONAL = SPR_TRACKS_PIPELINE_TRACK_FLAT_TO_STEEP + 64,
    SPR_TRACKS_PIPELINE_TRACK_QUARTER_LOOP = SPR_TRACKS_PIPELINE_TRACK_FLAT_TO_STEEP_DIAGONAL + 48,
    SPR_TRACKS_PIPELINE_TRACK_LARGE_CORKSCREW = SPR_TRACKS_PIPELINE_TRACK_QUARTER_LOOP + 24,
    SPR_TRACKS_PIPELINE_TRACK_TURN_BANK_TRANSITION = SPR_TRACKS_PIPELINE_TRACK_LARGE_CORKSCREW + 80,
    SPR_TRACKS_PIPELINE_TRACK_MEDIUM_HALF_LOOP = SPR_TRACKS_PIPELINE_TRACK_TURN_BANK_TRANSITION + 48,
    SPR_TRACKS_PIPELINE_TRACK_GENTLE_LARGE_CURVE = SPR_TRACKS_PIPELINE_TRACK_MEDIUM_HALF_LOOP + 80,
    SPR_TRACKS_PIPELINE_TRACK_GENTLE_LARGE_CURVE_BANKED = SPR_TRACKS_PIPELINE_TRACK_GENTLE_LARGE_CURVE + 128,
    SPR_TRACKS_PIPELINE_LIFT_TRACK_FLAT = SPR_TRACKS_PIPELINE_TRACK_GENTLE_LARGE_CURVE_BANKED + 240,
    SPR_TRACKS_PIPELINE_LIFT_TRACK_GENTLE = SPR_TRACKS_PIPELINE_LIFT_TRACK_FLAT + 8,
    SPR_TRACKS_PIPELINE_LIFT_TRACK_FLAT_DIAGONAL = SPR_TRACKS_PIPELINE_LIFT_TRACK_GENTLE + 24,
    SPR_TRACKS_PIPELINE_LIFT_TRACK_GENTLE_DIAGONAL = SPR_TRACKS_PIPELINE_LIFT_TRACK_FLAT_DIAGONAL + 8,
    SPR_TRACKS_PIPELINE_END = SPR_TRACKS_PIPELINE_LIFT_TRACK_GENTLE_DIAGONAL + 24,

    SPR_TRACKS_STATION_BASE_D_SW_NE = SPR_TRACKS_PIPELINE_END,
    SPR_TRACKS_STATION_BASE_D_NW_SE = SPR_TRACKS_STATION_BASE_D_SW_NE + 2,

    SPR_TRACKS_HYBRID_GENTLE_BRAKE = SPR_TRACKS_STATION_BASE_D_NW_SE + 2,

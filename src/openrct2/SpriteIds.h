...
enum : ImageIndex
{
    ...
    SPR_FONT_BEGIN = SPR_G2_END,
    // Sprite font characters

    SPR_FONT_AE_UPPER = SPR_FONT_BEGIN + 0,
    SPR_FONT_AE_LOWER,
    SPR_FONT_O_STROKE_UPPER,
    SPR_FONT_O_STROKE_LOWER,

    SPR_FONT_CYRILLIC_UKRAINIAN_IE_UPPER,
    SPR_FONT_CYRILLIC_BE_UPPER,
    SPR_FONT_CYRILLIC_GHE_UPPER,
    SPR_FONT_CYRILLIC_DE_UPPER,
    SPR_FONT_CYRILLIC_ZHE_UPPER,
    SPR_FONT_CYRILLIC_ZE_UPPER,
    SPR_FONT_CYRILLIC_I_UPPER,
    SPR_FONT_CYRILLIC_SHORT_I_UPPER,
    SPR_FONT_CYRILLIC_EL_UPPER,
    SPR_FONT_CYRILLIC_PE_UPPER,
    SPR_FONT_CYRILLIC_U_UPPER,
    SPR_FONT_CYRILLIC_EF_UPPER,
    SPR_FONT_CYRILLIC_TSE_UPPER,
    SPR_FONT_CYRILLIC_CHE_UPPER,
    SPR_FONT_CYRILLIC_SHA_UPPER,
    SPR_FONT_CYRILLIC_SHCHA_UPPER,
    SPR_FONT_CYRILLIC_HARD_SIGN_UPPER,
    SPR_FONT_CYRILLIC_YERU_UPPER,
    SPR_FONT_CYRILLIC_SOFT_SIGN_UPPER,
    SPR_FONT_CYRILLIC_E_UPPER,
    SPR_FONT_CYRILLIC_YU_UPPER,
    SPR_FONT_CYRILLIC_YA_UPPER,

    SPR_FONT_CYRILLIC_BE_LOWER,
    SPR_FONT_CYRILLIC_VE_LOWER,
    SPR_FONT_CYRILLIC_GHE_LOWER,
    SPR_FONT_CYRILLIC_DE_LOWER,
    SPR_FONT_CYRILLIC_ZHE_LOWER,
    SPR_FONT_CYRILLIC_ZE_LOWER,
    SPR_FONT_CYRILLIC_I_LOWER,
    SPR_FONT_CYRILLIC_SHORT_I_LOWER,
    SPR_FONT_CYRILLIC_KA_LOWER,
    SPR_FONT_CYRILLIC_EL_LOWER,
    SPR_FONT_CYRILLIC_EM_LOWER,
    SPR_FONT_CYRILLIC_EN_LOWER,
    SPR_FONT_CYRILLIC_PE_LOWER,
    SPR_FONT_CYRILLIC_TE_LOWER,
    SPR_FONT_CYRILLIC_EF_LOWER,
    SPR_FONT_CYRILLIC_TSE_LOWER,
    SPR_FONT_CYRILLIC_CHE_LOWER,
    SPR_FONT_CYRILLIC_SHA_LOWER,
    SPR_FONT_CYRILLIC_SHCHA_LOWER,
    SPR_FONT_CYRILLIC_YERU_LOWER,
    SPR_FONT_CYRILLIC_SOFT_SIGN_LOWER,
    SPR_FONT_CYRILLIC_E_LOWER,
    SPR_FONT_CYRILLIC_YU_LOWER,
    SPR_FONT_CYRILLIC_YA_LOWER,
    SPR_FONT_CYRILLIC_UKRAINIAN_IE_LOWER,
    SPR_FONT_CYRILLIC_GHE_UPTURN_UPPER,
    SPR_FONT_CYRILLIC_GHE_UPTURN_LOWER,

    SPR_FONT_GERMAN_OPENQUOTES,

    SPR_FONT_GUILDER_SIGN,

    SPR_FONT_G_BREVE_UPPER,
    SPR_FONT_I_WITH_DOT_UPPER,
    SPR_FONT_S_CEDILLA_UPPER,
    SPR_FONT_G_BREVE_LOWER,
    SPR_FONT_I_WITHOUT_DOT_LOWER,
    SPR_FONT_S_CEDILLA_LOWER,

    SPR_FONT_INTERPUNCT,

    SPR_FONT_A_BREVE_UPPER,
    SPR_FONT_T_COMMA_UPPER,
    SPR_FONT_T_COMMA_LOWER,

    SPR_FONT_ELLIPSIS,

    SPR_FONT_C_CARON_UPPER,
    SPR_FONT_C_CARON_LOWER,

    SPR_FONT_Y_ACUTE_UPPER,
    SPR_FONT_Y_ACUTE_LOWER,

    SPR_FONT_O_DOUBLE_ACUTE_UPPER,
    SPR_FONT_O_DOUBLE_ACUTE_LOWER,

    SPR_FONT_OE_UPPER,
    SPR_FONT_OE_LOWER,

    SPR_FONT_U_DOUBLE_ACUTE_UPPER,
    SPR_FONT_U_DOUBLE_ACUTE_LOWER,

    SPR_FONT_D_CARON_UPPER,
    SPR_FONT_D_CARON_LOWER,
    SPR_FONT_E_CARON_UPPER,
    SPR_FONT_E_CARON_LOWER,
    SPR_FONT_N_CARON_UPPER,
    SPR_FONT_N_CARON_LOWER,
    SPR_FONT_R_CARON_UPPER,
    SPR_FONT_R_CARON_LOWER,
    SPR_FONT_S_CARON_UPPER,
    SPR_FONT_S_CARON_LOWER,
    SPR_FONT_T_CARON_UPPER,
    SPR_FONT_T_CARON_LOWER,
    SPR_FONT_U_RING_UPPER,
    SPR_FONT_U_RING_LOWER,
    SPR_FONT_W_CIRCUMFLEX_UPPER,
    SPR_FONT_W_CIRCUMFLEX_LOWER,
    SPR_FONT_Y_CIRCUMFLEX_UPPER,
    SPR_FONT_Y_CIRCUMFLEX_LOWER,
    SPR_FONT_Z_CARON_UPPER,
    SPR_FONT_Z_CARON_LOWER,

    SPR_FONT_ROUBLE_SIGN,

    SPR_FONT_J,
    SPR_FONT_L,

    SPR_FONT_C_CIRCUMFLEX_UPPER,
    SPR_FONT_C_CIRCUMFLEX_LOWER,
    SPR_FONT_G_CIRCUMFLEX_UPPER,
    SPR_FONT_G_CIRCUMFLEX_LOWER,
    SPR_FONT_H_CIRCUMFLEX_UPPER,
    SPR_FONT_H_CIRCUMFLEX_LOWER,
    SPR_FONT_J_CIRCUMFLEX_UPPER,
    SPR_FONT_J_CIRCUMFLEX_LOWER,
    SPR_FONT_S_CIRCUMFLEX_UPPER,
    SPR_FONT_S_CIRCUMFLEX_LOWER,
    SPR_FONT_U_BREVE_UPPER,
    SPR_FONT_U_BREVE_LOWER,

    SPR_FONT_LEFT_BRACE,
    SPR_FONT_VERTICAL_BAR,
    SPR_FONT_RIGHT_BRACE,
    SPR_FONT_TILDE,

    SPR_FONT_EYE,

    SPR_FONT_GLYPH_COUNT = (SPR_FONT_EYE - SPR_FONT_BEGIN) + 1,
    SPR_FONT_END = SPR_FONT_BEGIN + SPR_FONT_GLYPH_COUNT * 3,

    SPR_CSG_BEGIN = SPR_FONT_END,
...
constexpr size_t kFontDatSpriteCount = SPR_FONT_END - SPR_FONT_BEGIN;

...
enum : ImageIndex
{
    ...
    SPR_TRACKS_LIM_LAUNCHED_TRACK_DIVE_LOOP = SPR_TRACKS_LIM_LAUNCHED_TRACK_QUARTER_HELIX_RIGHT_BANKED + 20,
    SPR_TRACKS_LIM_LAUNCHED_TRACK_GENTLE_LARGE_CURVE = SPR_TRACKS_LIM_LAUNCHED_TRACK_DIVE_LOOP + 32,
    SPR_TRACKS_LIM_LAUNCHED_TRACK_GENTLE_LARGE_CURVE_BANKED = SPR_TRACKS_LIM_LAUNCHED_TRACK_GENTLE_LARGE_CURVE + 64,
    SPR_TRACKS_LIM_LAUNCHED_TRACK_FLAT_TO_STEEP_DIAGONAL = SPR_TRACKS_LIM_LAUNCHED_TRACK_GENTLE_LARGE_CURVE_BANKED + 128,

    SPR_TRACKS_LIM_LAUNCHED_TRACK_END = SPR_TRACKS_LIM_LAUNCHED_TRACK_FLAT_TO_STEEP_DIAGONAL + 24,

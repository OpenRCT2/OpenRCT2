...
enum : ImageIndex
{
    ...
    SPR_TRACKS_INVERTED_IMPULSE_VERTICAL_HOLDING_BRAKE = SPR_TRACKS_SINGLE_RAIL_GENTLE_DIAG_BRAKE + 4,
    SPR_TRACKS_END = SPR_TRACKS_INVERTED_IMPULSE_VERTICAL_HOLDING_BRAKE + 4,

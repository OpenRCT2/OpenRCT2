...
enum : ImageIndex
{
    ...
    SPR_G1_PALETTE_3100 = SPR_G1_PALETTE_1_START,
    SPR_G1_PALETTE_3101 = 3101,
    SPR_G1_PALETTE_3102 = 3102,
    SPR_G1_PALETTE_3103 = 3103,
    SPR_G1_PALETTE_3104 = 3104,
    SPR_G1_PALETTE_3105 = 3105,
    SPR_G1_PALETTE_3106 = 3106,
    SPR_G1_PALETTE_3107 = 3107,
    SPR_G1_PALETTE_3108 = 3108,
    SPR_G1_PALETTE_3109 = 3109,
    SPR_G1_PALETTE_3110 = 3110,
    SPR_G1_PALETTE_1_END = SPR_G1_PALETTE_3110,
    ...
    SPR_G1_PALETTE_4948 = 4948,
    SPR_G1_PALETTE_4949 = 4949,
    SPR_G1_PALETTE_4950 = 4950,
    SPR_G1_PALETTE_DARKEN_3 = 4951,
    SPR_G1_PALETTE_4952 = 4952,
    SPR_G1_PALETTE_DARKEN_1 = 4953,
    SPR_G1_PALETTE_DARKEN_2 = 4954,
    SPR_G1_PALETTE_4955 = 4955,
    ...
    // G2 Palette maps
    // TODO: rename G2 -> something palette.dat related
    // TODO: reorder to match kPaletteToG1Offset in Drawing.cpp
    SPR_PALETTE_START = SPR_G2_END,
    SPR_G2_DEFAULT_PALETTE = SPR_PALETTE_START,
    SPR_G2_TEXT_PALETTE, // G2 variant; apparently unused, so remove?
    SPR_G2_PALETTE_WATER,
    SPR_G2_PALETTE_WATER_DARKER_1,
    SPR_G2_PALETTE_WATER_DARKER_2,
    SPR_G2_PALETTE_3,
    SPR_G2_PALETTE_3_DARKER_1,
    SPR_G2_PALETTE_3_DARKER_2,
    SPR_G2_PALETTE_4,
    SPR_G2_PALETTE_4_DARKER_1,
    SPR_G2_PALETTE_4_DARKER_2,
    SPR_PALETTE_3100,
    SPR_PALETTE_3101,
    SPR_PALETTE_3102,
    SPR_PALETTE_3103,
    ...
    // TODO: rename to include 'map' or 'swatch'
    SPR_PALETTE_EXT_BEGIN = SPR_PALETTE_END,
    SPR_PALETTE_DARK_OLIVE_DARK = SPR_PALETTE_EXT_BEGIN,
    ...
    SPR_FONTS_BEGIN = SPR_PALETTE_EXT_END,
...
constexpr size_t kPalettesDatSpriteCount = SPR_PALETTE_EXT_END - SPR_PALETTE_START;

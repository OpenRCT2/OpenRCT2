...
enum : ImageIndex
{
    ...
    SPR_TRACKS_LATTICE_TRIANGLE_TRACK_QUARTER_HELIX_RIGHT_BANKED = SPR_TRACKS_LATTICE_TRIANGLE_TRACK_QUARTER_HELIX_LEFT_BANKED
        + 20,
    SPR_TRACKS_LATTICE_TRIANGLE_TRACK_BANKED_S_BEND = SPR_TRACKS_LATTICE_TRIANGLE_TRACK_QUARTER_HELIX_RIGHT_BANKED + 20,
    SPR_TRACKS_LATTICE_TRIANGLE_TRACK_STEEP_BANK_TRANSITION = SPR_TRACKS_LATTICE_TRIANGLE_TRACK_BANKED_S_BEND + 20,
    SPR_TRACKS_LATTICE_TRIANGLE_TRACK_STEEP_MEDIUM_CURVE = SPR_TRACKS_LATTICE_TRIANGLE_TRACK_STEEP_BANK_TRANSITION + 42,
    SPR_TRACKS_LATTICE_TRIANGLE_TRACK_STEEP_LARGE_CURVE = SPR_TRACKS_LATTICE_TRIANGLE_TRACK_STEEP_MEDIUM_CURVE + 20,
    SPR_TRACKS_LATTICE_TRIANGLE_TRACK_BARREL_ROLL_BANKED = SPR_TRACKS_LATTICE_TRIANGLE_TRACK_STEEP_LARGE_CURVE + 64,
    SPR_TRACKS_LATTICE_TRIANGLE_TRACK_ZERO_G_ROLL_BANKED = SPR_TRACKS_LATTICE_TRIANGLE_TRACK_BARREL_ROLL_BANKED + 48,
    SPR_TRACKS_LATTICE_TRIANGLE_TRACK_END = SPR_TRACKS_LATTICE_TRIANGLE_TRACK_ZERO_G_ROLL_BANKED + 32,
    ...
    SPR_TRACKS_BM_TRACK_BANKED_S_BEND = SPR_TRACKS_BM_TRACK_QUARTER_HELIX_RIGHT_BANKED + 20,
    SPR_TRACKS_BM_TRACK_STEEP_BANK_TRANSITION = SPR_TRACKS_BM_TRACK_BANKED_S_BEND + 20,
    SPR_TRACKS_BM_TRACK_STEEP_MEDIUM_CURVE = SPR_TRACKS_BM_TRACK_STEEP_BANK_TRANSITION + 42,
    SPR_TRACKS_BM_TRACK_STEEP_LARGE_CURVE = SPR_TRACKS_BM_TRACK_STEEP_MEDIUM_CURVE + 20,
    SPR_TRACKS_BM_TRACK_BARREL_ROLL_BANKED = SPR_TRACKS_BM_TRACK_STEEP_LARGE_CURVE + 64,
    SPR_TRACKS_BM_TRACK_ZERO_G_ROLL_BANKED = SPR_TRACKS_BM_TRACK_BARREL_ROLL_BANKED + 48,
    SPR_TRACKS_BM_RC_END = SPR_TRACKS_BM_TRACK_ZERO_G_ROLL_BANKED + 32,
    ...
    SPR_TRACKS_CORKSCREW_TRACK_BANKED_S_BEND = SPR_TRACKS_CORKSCREW_TRACK_QUARTER_HELIX_RIGHT_BANKED + 20,
    SPR_TRACKS_CORKSCREW_TRACK_STEEP_BANK_TRANSITION = SPR_TRACKS_CORKSCREW_TRACK_BANKED_S_BEND + 20,
    SPR_TRACKS_CORKSCREW_TRACK_STEEP_MEDIUM_CURVE = SPR_TRACKS_CORKSCREW_TRACK_STEEP_BANK_TRANSITION + 42,
    SPR_TRACKS_CORKSCREW_TRACK_STEEP_LARGE_CURVE = SPR_TRACKS_CORKSCREW_TRACK_STEEP_MEDIUM_CURVE + 20,
    SPR_TRACKS_CORKSCREW_TRACK_BARREL_ROLL_BANKED = SPR_TRACKS_CORKSCREW_TRACK_STEEP_LARGE_CURVE + 64,
    SPR_TRACKS_CORKSCREW_TRACK_ZERO_G_ROLL_BANKED = SPR_TRACKS_CORKSCREW_TRACK_BARREL_ROLL_BANKED + 48,
    SPR_TRACKS_CORKSCREW_RC_END = SPR_TRACKS_CORKSCREW_TRACK_ZERO_G_ROLL_BANKED + 32,
    ...
    SPR_TRACKS_HYBRID_TRACK_BANKED_S_BEND = SPR_TRACKS_HYBRID_TRACK_QUARTER_HELIX_RIGHT_BANKED + 26,
    SPR_TRACKS_HYBRID_TRACK_STEEP_BANK_TRANSITION = SPR_TRACKS_HYBRID_TRACK_BANKED_S_BEND + 20,
    SPR_TRACKS_HYBRID_TRACK_STEEP_MEDIUM_CURVE = SPR_TRACKS_HYBRID_TRACK_STEEP_BANK_TRANSITION + 42,
    SPR_TRACKS_HYBRID_TRACK_STEEP_LARGE_CURVE = SPR_TRACKS_HYBRID_TRACK_STEEP_MEDIUM_CURVE + 20,
    SPR_TRACKS_HYBRID_TRACK_BARREL_ROLL_BANKED = SPR_TRACKS_HYBRID_TRACK_STEEP_LARGE_CURVE + 64,
    SPR_TRACKS_HYBRID_TRACK_FLAT_TO_STEEP_DIAGONAL = SPR_TRACKS_HYBRID_TRACK_BARREL_ROLL_BANKED + 48,
    SPR_TRACKS_HYBRID_TRACK_ZERO_G_ROLL_BANKED = SPR_TRACKS_HYBRID_TRACK_FLAT_TO_STEEP_DIAGONAL + 24,
    SPR_TRACKS_HYBRID_LIFT_BEGIN = SPR_TRACKS_HYBRID_TRACK_ZERO_G_ROLL_BANKED + 32,
    ...
    SPR_TRACKS_SINGLE_RAIL_TRACK_BANKED_S_BEND = SPR_TRACKS_SINGLE_RAIL_TRACK_QUARTER_HELIX_RIGHT_BANKED + 20,
    SPR_TRACKS_SINGLE_RAIL_TRACK_STEEP_BANK_TRANSITION = SPR_TRACKS_SINGLE_RAIL_TRACK_BANKED_S_BEND + 20,
    SPR_TRACKS_SINGLE_RAIL_TRACK_STEEP_MEDIUM_CURVE = SPR_TRACKS_SINGLE_RAIL_TRACK_STEEP_BANK_TRANSITION + 42,
    SPR_TRACKS_SINGLE_RAIL_TRACK_STEEP_LARGE_CURVE = SPR_TRACKS_SINGLE_RAIL_TRACK_STEEP_MEDIUM_CURVE + 20,
    SPR_TRACKS_SINGLE_RAIL_TRACK_BARREL_ROLL_BANKED = SPR_TRACKS_SINGLE_RAIL_TRACK_STEEP_LARGE_CURVE + 64,
    SPR_TRACKS_SINGLE_RAIL_TRACK_ZERO_G_ROLL_BANKED = SPR_TRACKS_SINGLE_RAIL_TRACK_BARREL_ROLL_BANKED + 48,
    SPR_TRACKS_SINGLE_RAIL_LIFT_BEGIN = SPR_TRACKS_SINGLE_RAIL_TRACK_ZERO_G_ROLL_BANKED + 32,
    ...
    SPR_TRACKS_ALPINE_TRACK_BANKED_S_BEND = SPR_TRACKS_ALPINE_TRACK_QUARTER_HELIX_RIGHT_BANKED + 21,
    SPR_TRACKS_ALPINE_LIFT_BEGIN = SPR_TRACKS_ALPINE_TRACK_BANKED_S_BEND + 20,
    ...
    SPR_TRACKS_LATTICE_TRIANGLE_TRACK_CORKSCREW_DIAGONAL = SPR_TRACKS_SINGLE_RAIL_GENTLE_DIAG_BRAKE + 4,
    SPR_TRACKS_LATTICE_TRIANGLE_TRACK_LARGE_CORKSCREW_DIAGONAL = SPR_TRACKS_LATTICE_TRIANGLE_TRACK_CORKSCREW_DIAGONAL + 32, 
    SPR_TRACKS_LATTICE_TRIANGLE_TRACK_HALF_LOOP_DIAGONAL = SPR_TRACKS_LATTICE_TRIANGLE_TRACK_LARGE_CORKSCREW_DIAGONAL + 40,
    SPR_TRACKS_LATTICE_TRIANGLE_TRACK_VERTICAL_LOOP_DIAGONAL = SPR_TRACKS_LATTICE_TRIANGLE_TRACK_HALF_LOOP_DIAGONAL + 16,

    SPR_TRACKS_BM_TRACK_CORKSCREW_DIAGONAL = SPR_TRACKS_LATTICE_TRIANGLE_TRACK_VERTICAL_LOOP_DIAGONAL + 32,
    SPR_TRACKS_BM_TRACK_LARGE_CORKSCREW_DIAGONAL = SPR_TRACKS_BM_TRACK_CORKSCREW_DIAGONAL + 32, 
    SPR_TRACKS_BM_TRACK_HALF_LOOP_DIAGONAL = SPR_TRACKS_BM_TRACK_LARGE_CORKSCREW_DIAGONAL + 40,
    SPR_TRACKS_BM_TRACK_VERTICAL_LOOP_DIAGONAL = SPR_TRACKS_BM_TRACK_HALF_LOOP_DIAGONAL + 16,

    SPR_TRACKS_CORKSCREW_TRACK_CORKSCREW_DIAGONAL = SPR_TRACKS_BM_TRACK_VERTICAL_LOOP_DIAGONAL + 32,
    SPR_TRACKS_CORKSCREW_TRACK_LARGE_CORKSCREW_DIAGONAL = SPR_TRACKS_CORKSCREW_TRACK_CORKSCREW_DIAGONAL + 32, 
    SPR_TRACKS_CORKSCREW_TRACK_HALF_LOOP_DIAGONAL = SPR_TRACKS_CORKSCREW_TRACK_LARGE_CORKSCREW_DIAGONAL + 40,
    SPR_TRACKS_CORKSCREW_TRACK_VERTICAL_LOOP_DIAGONAL = SPR_TRACKS_CORKSCREW_TRACK_HALF_LOOP_DIAGONAL + 16,

    SPR_TRACKS_SINGLE_RAIL_TRACK_CORKSCREW_DIAGONAL = SPR_TRACKS_CORKSCREW_TRACK_VERTICAL_LOOP_DIAGONAL + 32,
    SPR_TRACKS_SINGLE_RAIL_TRACK_LARGE_CORKSCREW_DIAGONAL = SPR_TRACKS_SINGLE_RAIL_TRACK_CORKSCREW_DIAGONAL + 32, 
    SPR_TRACKS_SINGLE_RAIL_TRACK_HALF_LOOP_DIAGONAL = SPR_TRACKS_SINGLE_RAIL_TRACK_LARGE_CORKSCREW_DIAGONAL + 40,
    SPR_TRACKS_SINGLE_RAIL_TRACK_VERTICAL_LOOP_DIAGONAL = SPR_TRACKS_SINGLE_RAIL_TRACK_HALF_LOOP_DIAGONAL + 16,

    SPR_TRACKS_STANDUP_TRACK_FLAT_TO_STEEP_DIAGONAL = SPR_TRACKS_SINGLE_RAIL_TRACK_VERTICAL_LOOP_DIAGONAL + 32,
    SPR_TRACKS_STANDUP_TRACK_BANKED_S_BEND = SPR_TRACKS_STANDUP_TRACK_FLAT_TO_STEEP_DIAGONAL + 24,
    SPR_TRACKS_STANDUP_TRACK_STEEP_BANK_TRANSITION = SPR_TRACKS_STANDUP_TRACK_BANKED_S_BEND + 20,
    SPR_TRACKS_STANDUP_TRACK_STEEP_MEDIUM_CURVE = SPR_TRACKS_STANDUP_TRACK_STEEP_BANK_TRANSITION + 42,
    SPR_TRACKS_STANDUP_TRACK_STEEP_LARGE_CURVE = SPR_TRACKS_STANDUP_TRACK_STEEP_MEDIUM_CURVE + 20,
    SPR_TRACKS_STANDUP_TRACK_BARREL_ROLL_BANKED = SPR_TRACKS_STANDUP_TRACK_STEEP_LARGE_CURVE + 64,
    SPR_TRACKS_STANDUP_TRACK_ZERO_G_ROLL_BANKED = SPR_TRACKS_STANDUP_TRACK_BARREL_ROLL_BANKED + 48,
    SPR_TRACKS_STANDUP_TRACK_DIVE_LOOP = SPR_TRACKS_STANDUP_TRACK_ZERO_G_ROLL_BANKED + 32,
    SPR_TRACKS_STANDUP_TRACK_CORKSCREW_DIAGONAL = SPR_TRACKS_STANDUP_TRACK_DIVE_LOOP + 32,
    SPR_TRACKS_STANDUP_TRACK_LARGE_CORKSCREW_DIAGONAL = SPR_TRACKS_STANDUP_TRACK_CORKSCREW_DIAGONAL + 32, 
    SPR_TRACKS_STANDUP_TRACK_HALF_LOOP_DIAGONAL = SPR_TRACKS_STANDUP_TRACK_LARGE_CORKSCREW_DIAGONAL + 40,
    SPR_TRACKS_STANDUP_TRACK_VERTICAL_LOOP_DIAGONAL = SPR_TRACKS_STANDUP_TRACK_HALF_LOOP_DIAGONAL + 16,
    
    SPR_TRACKS_END = SPR_TRACKS_STANDUP_TRACK_VERTICAL_LOOP_DIAGONAL + 32, 

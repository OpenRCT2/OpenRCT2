...
enum
{
    FILE_VERSION_MASK = 0b00000011,
    FILE_VERSION_RCT1 = 0b00000000,
    FILE_VERSION_RCT1_AA = 0b00000001,
    FILE_VERSION_RCT1_LL = 0b00000010,

    FILE_TYPE_MASK = 0b00001100,
    FILE_TYPE_TD4 = 0b00000000,
    FILE_TYPE_SV4 = 0b00000100,
    FILE_TYPE_SC4 = 0b00001000,
};

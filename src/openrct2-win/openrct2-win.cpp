...
int WINAPI WinMain(HINSTANCE /*hInstance*/, HINSTANCE /*hPrevInstance*/, LPSTR /*lpCmdLine*/, int /*nShowCmd*/)
{
    ...
    // Handle a special Windows-only commandline argument "--console". If present, attach to the parent process console or
    // create our own, and point stdin/stdout at that.
#ifdef DEBUG
...
static void CreateConsole()
{
    // Attach to the parent console, or create a new one if that fails.

...
static rct_widget window_land_rights_widgets[] = {
    ...
    { WWT_TRNBTN, 2, 28, 43, 18, 33, 0x20000000 | SPR_LAND_TOOL_DECREASE,
      STR_ADJUST_SMALLER_LAND_RIGHTS_TIP },                                                                    // decrement size
    ...
    { WWT_FLATBTN, 2, 52, 75, 53, 76, 0x20000000 | SPR_BUY_CONSTRUCTION_RIGHTS,
      STR_BUY_CONSTRUCTION_RIGHTS_TIP }, // construction rights
    { WIDGETS_END },
};
...
static rct_window_event_list window_land_rights_events = { window_land_rights_close,
...
static void window_land_rights_invalidate(rct_window * w)
{
    ...
    window_land_rights_widgets[WIDX_PREVIEW].image = gLandToolSize <= 7 ? SPR_LAND_TOOL_SIZE_0 + gLandToolSize : 0xFFFFFFFF;
...
static void window_land_rights_paint(rct_window * w, rct_drawpixelinfo * dpi)
{
    ...
    if (gLandRightsCost != MONEY32_UNDEFINED && gLandRightsCost != 0)
    {

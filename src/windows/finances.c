...
static rct_widget * window_finances_page_widgets[] = { window_finances_summary_widgets,    window_finances_cash_widgets,
                                                       window_finances_park_value_widgets, window_finances_profit_widgets,
                                                       window_finances_marketing_widgets,  window_finances_research_widgets };
...
// 0x00988EB8
static rct_window_event_list window_finances_summary_events = { NULL,
...
// 0x00988F28
static rct_window_event_list window_finances_financial_graph_events = { NULL,
...
// 0x00988F98
static rct_window_event_list window_finances_value_graph_events = { NULL,
...
// 0x00989008
static rct_window_event_list window_finances_profit_graph_events = { NULL,
...
// 0x00989078
static rct_window_event_list window_finances_marketing_events = { NULL,
...
// 0x009890E8
static rct_window_event_list window_finances_research_events = { NULL,
...
static rct_window_event_list * window_finances_page_events[] = {
    &window_finances_summary_events,      &window_finances_financial_graph_events, &window_finances_value_graph_events,
    &window_finances_profit_graph_events, &window_finances_marketing_events,       &window_finances_research_events
};
...
static uint32 window_finances_page_enabled_widgets[] = {
    (1 << WIDX_CLOSE) | (1 << WIDX_TAB_1) | (1 << WIDX_TAB_2) | (1 << WIDX_TAB_3) | (1 << WIDX_TAB_4) | (1 << WIDX_TAB_5) |
        (1 << WIDX_TAB_6) | (1 << WIDX_LOAN_INCREASE) | (1 << WIDX_LOAN_DECREASE),
    ...
    (1 << WIDX_CLOSE) | (1 << WIDX_TAB_1) | (1 << WIDX_TAB_2) | (1 << WIDX_TAB_3) | (1 << WIDX_TAB_4) | (1 << WIDX_TAB_5) |
        (1 << WIDX_TAB_6) | (1 << WIDX_CAMPAIGN_1) | (1 << WIDX_CAMPAIGN_2) | (1 << WIDX_CAMPAIGN_3) | (1 << WIDX_CAMPAIGN_4) |
        (1 << WIDX_CAMPAIGN_5) | (1 << WIDX_CAMPAIGN_6),

    (1 << WIDX_CLOSE) | (1 << WIDX_TAB_1) | (1 << WIDX_TAB_2) | (1 << WIDX_TAB_3) | (1 << WIDX_TAB_4) | (1 << WIDX_TAB_5) |
        (1 << WIDX_TAB_6) |

        (1 << WIDX_RESEARCH_FUNDING) | (1 << WIDX_RESEARCH_FUNDING_DROPDOWN_BUTTON) | (1 << WIDX_TRANSPORT_RIDES) |
        (1 << WIDX_GENTLE_RIDES) | (1 << WIDX_ROLLER_COASTERS) | (1 << WIDX_THRILL_RIDES) | (1 << WIDX_WATER_RIDES) |
        (1 << WIDX_SHOPS_AND_STALLS) | (1 << WIDX_SCENERY_AND_THEMING)
};

static uint32 window_finances_page_hold_down_widgets[] = { (1 << WIDX_LOAN_INCREASE) | (1 << WIDX_LOAN_DECREASE),
...
static void window_finances_summary_paint(rct_window * w, rct_drawpixelinfo * dpi)
{
    ...
    for (i = 4; i >= 0; i--)
    {
        ...
        draw_string_right_underline(dpi, monthyear == currentMonthYear ? STR_WINDOW_COLOUR_2_STRINGID : STR_BLACK_STRING,
                                    gCommonFormatArgs, COLOUR_BLACK, x + 80, y - 1);
        y += 14;
        ...
        for (j = 0; j < 14; j++)
        {
            ...
            {
                profit += expenditure;
                gfx_draw_string_right(dpi, expenditure >= 0 ? STR_FINANCES_SUMMARY_INCOME_VALUE
                                                            : STR_FINANCES_SUMMARY_EXPENDITURE_VALUE,
                                      &expenditure, COLOUR_BLACK, x + 80, y - 1);
            }
            y += 10;
        }
        y += 4;
        ...
        // Month profit
        gfx_draw_string_right(dpi, profit >= 0 ? STR_FINANCES_SUMMARY_INCOME_VALUE : STR_FINANCES_SUMMARY_LOSS_VALUE, &profit,
                              COLOUR_BLACK, x + 80, y - 1);
    ...
    if (gScenarioObjectiveType == OBJECTIVE_MONTHLY_FOOD_INCOME)
    {
        ...
        gfx_draw_string_left(dpi, STR_LAST_MONTH_PROFIT_FROM_FOOD_DRINK_MERCHANDISE_SALES_LABEL, gCommonFormatArgs,
                             COLOUR_BLACK, w->x + 280, w->y + 229);
    }
    else
    {
...
static void window_finances_financial_graph_paint(rct_window * w, rct_drawpixelinfo * dpi)
{
    ...
    // Cash (less loan)
    money32 cashLessLoan = DECRYPT_MONEY(gCashEncrypted) - gBankLoan;

    gfx_draw_string_left(dpi, cashLessLoan >= 0 ? STR_FINANCES_FINANCIAL_GRAPH_CASH_LESS_LOAN_POSITIVE
...
static void window_finances_profit_graph_paint(rct_window * w, rct_drawpixelinfo * dpi)
{
    ...
    gfx_draw_string_left(dpi, weeklyPofit >= 0 ? STR_FINANCES_WEEKLY_PROFIT_POSITIVE : STR_FINANCES_WEEKLY_PROFIT_LOSS,
                         &weeklyPofit, COLOUR_BLACK, graphLeft, graphTop - 11);

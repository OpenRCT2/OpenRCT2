...
static const notification_def NewsItemOptionDefinitions[] = {
    ...
    { NOTIFICATION_CATEGORY_PARK, STR_NOTIFICATION_PARK_MARKETING_CAMPAIGN_FINISHED,
      offsetof(notification_configuration, park_marketing_campaign_finished) },
    { NOTIFICATION_CATEGORY_PARK, STR_NOTIFICATION_PARK_WARNINGS, offsetof(notification_configuration, park_warnings) },
    { NOTIFICATION_CATEGORY_PARK, STR_NOTIFICATION_PARK_RATING_WARNINGS,
      offsetof(notification_configuration, park_rating_warnings) },
    ...
    { NOTIFICATION_CATEGORY_GUEST, STR_NOTIFICATION_GUEST_QUEUING_FOR_RIDE,
      offsetof(notification_configuration, guest_queuing_for_ride) },
    ...
    { NOTIFICATION_CATEGORY_GUEST, STR_NOTIFICATION_GUEST_BOUGHT_ITEM,
      offsetof(notification_configuration, guest_bought_item) },
    { NOTIFICATION_CATEGORY_GUEST, STR_NOTIFICATION_GUEST_USED_FACILITY,
      offsetof(notification_configuration, guest_used_facility) },
...
static rct_window_event_list window_news_options_events = { NULL,

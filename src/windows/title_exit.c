...
static rct_widget window_title_exit_widgets[] = {
    { WWT_IMGBTN, 2, 0, 39, 0, 63, SPR_MENU_EXIT, STR_EXIT }, { WIDGETS_END },
};
...
static rct_window_event_list window_title_exit_events = { NULL,
...
void window_title_exit_open()
{
    ...
    window = window_create(gScreenWidth - 40, gScreenHeight - 64, 40, 64, &window_title_exit_events, WC_TITLE_EXIT,

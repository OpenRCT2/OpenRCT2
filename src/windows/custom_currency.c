...
static rct_window_event_list _windowCustomCurrencyEvents = { NULL,
...
static void custom_currency_window_mousedown(int widgetIndex, rct_window * w, rct_widget * widget)
{
    ...
    case WIDX_SYMBOL_TEXT:
        window_text_input_raw_open(w, WIDX_SYMBOL_TEXT, STR_CUSTOM_CURRENCY_SYMBOL_INPUT_TITLE,
                                   STR_CUSTOM_CURRENCY_SYMBOL_INPUT_DESC, CurrencyDescriptors[CURRENCY_CUSTOM].symbol_unicode,
...
static void custom_currency_window_mouseup(rct_window * w, int widgetIndex)
{
    ...
    {
    case WIDX_RATE:
        window_text_input_open(w, WIDX_RATE, STR_RATE_INPUT_TITLE, STR_RATE_INPUT_DESC, STR_FORMAT_INTEGER,
                               (uint32)CurrencyDescriptors[CURRENCY_CUSTOM].rate, CURRENCY_RATE_MAX_NUM_DIGITS);
        break;
    }
}
...
static void custom_currency_window_text_input(struct rct_window * w, int widgetIndex, char * text)
{
    ...
    case WIDX_SYMBOL_TEXT:
        ...
        safe_strcpy(gConfigGeneral.custom_currency_symbol, CurrencyDescriptors[CURRENCY_CUSTOM].symbol_unicode,
                    CURRENCY_SYMBOL_MAX_SIZE);

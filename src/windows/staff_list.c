...
void window_staff_list_paint(rct_window * w, rct_drawpixelinfo * dpi)
{
    ...
    gfx_draw_sprite(dpi, i, (window_staff_list_widgets[WIDX_STAFF_LIST_HANDYMEN_TAB].left +
    ...
    gfx_draw_sprite(dpi, i, (window_staff_list_widgets[WIDX_STAFF_LIST_MECHANICS_TAB].left +
    ...
    gfx_draw_sprite(dpi, i, (window_staff_list_widgets[WIDX_STAFF_LIST_SECURITY_TAB].left +
    ...
    if (clip_drawpixelinfo(&sprite_dpi, dpi, window_staff_list_widgets[WIDX_STAFF_LIST_ENTERTAINERS_TAB].left + w->x + 1,
    ...
    if (selectedTab < 3)
    {
        gfx_draw_string_left(dpi, STR_UNIFORM_COLOUR, w, COLOUR_BLACK, w->x + 6,
    ...
    gfx_draw_string_left(dpi, STR_STAFF_LIST_COUNTER, gCommonFormatArgs, COLOUR_BLACK, w->x + 4,
                         window_staff_list_widgets[WIDX_STAFF_LIST_LIST].bottom + w->y + 2);
}

/** rct2: 0x00992A08 */
static const uint32 staffOrderBaseSprites[] = {
    SPR_STAFF_ORDERS_SWEEPING, SPR_STAFF_ORDERS_INSPECT_RIDES, 0, 0,
};

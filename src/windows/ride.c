...
static rct_widget window_ride_graphs_widgets[] = {
    ...
    { WWT_DROPDOWN_BUTTON, 1, 149, 221, 163, 176, STR_RIDE_STATS_VERT_G,
      STR_SHOW_GRAPH_OF_VERTICAL_ACCELERATION_AGAINST_TIME_TIP },
    { WWT_DROPDOWN_BUTTON, 1, 222, 294, 163, 176, STR_RIDE_STATS_LAT_G,
      STR_SHOW_GRAPH_OF_LATERAL_ACCELERATION_AGAINST_TIME_TIP },
    { WIDGETS_END },
};
...
static rct_widget window_ride_customer_widgets[] = {
    ...
    { WWT_FLATBTN, 1, 289, 312, 54, 77, SPR_SHOW_GUESTS_THOUGHTS_ABOUT_THIS_RIDE_ATTRACTION,
    ...
    { WWT_FLATBTN, 1, 289, 312, 102, 125, SPR_SHOW_GUESTS_QUEUING_FOR_THIS_RIDE_ATTRACTION,
      STR_SHOW_GUESTS_QUEUING_FOR_THIS_RIDE_ATTRACTION_TIP },
    { WIDGETS_END },
};

static rct_widget * window_ride_page_widgets[] = { window_ride_main_widgets,         window_ride_vehicle_widgets,
                                                   window_ride_operating_widgets,    window_ride_maintenance_widgets,
                                                   window_ride_colour_widgets,       window_ride_music_widgets,
                                                   window_ride_measurements_widgets, window_ride_graphs_widgets,
                                                   window_ride_income_widgets,       window_ride_customer_widgets };

const uint64 window_ride_page_enabled_widgets[] = { 0x000000003FFDBFF4, 0x00000000007EFFF4, 0x0000019E777DBFF4,
                                                    0x000000000003FFF4, 0x00000003F37F3FF4, 0x000000000001FFF4,
                                                    0x000000000007FFF4, 0x000000000007BFF4, 0x0000000000E73FF4,
                                                    0x000000000001FFF4 };

const uint64 window_ride_page_hold_down_widgets[] = { 0x0000000000000000, 0x00000000007E0000, 0x00000000330D8000,
                                                      0x0000000000000000, 0x0000000000000000, 0x0000000000000000,
                                                      0x0000000000000000, 0x0000000000000000, 0x0000000000630000,
                                                      0x0000000000000000 };
...
// 0x0098DFD4
static rct_window_event_list window_ride_main_events = { NULL,
...
// 0x0098E204
static rct_window_event_list window_ride_vehicle_events = { NULL,
...
// 0x0098E0B4
static rct_window_event_list window_ride_operating_events = { NULL,
...
// 0x0098E124
static rct_window_event_list window_ride_maintenance_events = { NULL,
...
// 0x0098E044
static rct_window_event_list window_ride_colour_events = { window_ride_colour_close,
...
// 0x0098E194
static rct_window_event_list window_ride_music_events = { NULL,
...
// 0x0098DE14
static rct_window_event_list window_ride_measurements_events = { window_ride_measurements_close,
...
// 0x0098DF64
static rct_window_event_list window_ride_graphs_events = { NULL,
...
// 0x0098DEF4
static rct_window_event_list window_ride_income_events = { NULL,
...
// 0x0098DE84
static rct_window_event_list window_ride_customer_events = { NULL,
...
static rct_window_event_list * window_ride_page_events[] = { &window_ride_main_events,         &window_ride_vehicle_events,
                                                             &window_ride_operating_events,    &window_ride_maintenance_events,
                                                             &window_ride_colour_events,       &window_ride_music_events,
                                                             &window_ride_measurements_events, &window_ride_graphs_events,
                                                             &window_ride_income_events,       &window_ride_customer_events };
...
static const rct_string_id RatingNames[] = {
    STR_RATING_LOW, STR_RATING_MEDIUM, STR_RATING_HIGH, STR_RATING_VERY_HIGH, STR_RATING_EXTREME, STR_RATING_ULTRA_EXTREME,
};

static const rct_string_id RideBreakdownReasonNames[] = {
    STR_RIDE_BREAKDOWN_SAFETY_CUT_OUT,     STR_RIDE_BREAKDOWN_RESTRAINTS_STUCK_CLOSED, STR_RIDE_BREAKDOWN_RESTRAINTS_STUCK_OPEN,
    STR_RIDE_BREAKDOWN_DOORS_STUCK_CLOSED, STR_RIDE_BREAKDOWN_DOORS_STUCK_OPEN,        STR_RIDE_BREAKDOWN_VEHICLE_MALFUNCTION,
    STR_RIDE_BREAKDOWN_BRAKES_FAILURE,     STR_RIDE_BREAKDOWN_CONTROL_FAILURE
};

static const rct_string_id ColourSchemeNames[] = {
    STR_MAIN_COLOUR_SCHEME, STR_ALTERNATIVE_COLOUR_SCHEME_1, STR_ALTERNATIVE_COLOUR_SCHEME_2, STR_ALTERNATIVE_COLOUR_SCHEME_3,
};

static const rct_string_id VehicleLoadNames[] = {
    STR_QUARTER_LOAD, STR_HALF_LOAD, STR_THREE_QUARTER_LOAD, STR_FULL_LOAD, STR_ANY_LOAD,
};

static const rct_string_id VehicleColourSchemeNames[] = {
    STR_ALL_VEHICLES_IN_SAME_COLOURS, STR_DIFFERENT_COLOURS_PER, STR_DIFFERENT_COLOURS_PER_VEHICLE,
};
...
static const rct_string_id MusicStyleNames[] = {
    STR_MUSIC_STYLE_DODGEMS_BEAT,   STR_MUSIC_STYLE_FAIRGROUND_ORGAN,
    STR_MUSIC_STYLE_ROMAN_FANFARE,  STR_MUSIC_STYLE_ORIENTAL,
    STR_MUSIC_STYLE_MARTIAN,        STR_MUSIC_STYLE_JUNGLE_DRUMS,
    STR_MUSIC_STYLE_EGYPTIAN,       STR_MUSIC_STYLE_TOYLAND,
    STR_MUSIC_STYLE_CIRCUS_SHOW,    STR_MUSIC_STYLE_SPACE,
    STR_MUSIC_STYLE_HORROR,         STR_MUSIC_STYLE_TECHNO,
    STR_MUSIC_STYLE_GENTLE,         STR_MUSIC_STYLE_SUMMER,
    STR_MUSIC_STYLE_WATER,          STR_MUSIC_STYLE_WILD_WEST,
    STR_MUSIC_STYLE_JURASSIC,       STR_MUSIC_STYLE_ROCK,
    STR_MUSIC_STYLE_RAGTIME,        STR_MUSIC_STYLE_FANTASY,
    STR_MUSIC_STYLE_ROCK_STYLE_2,   STR_MUSIC_STYLE_ICE,
    STR_MUSIC_STYLE_SNOW,           STR_MUSIC_STYLE_CUSTOM_MUSIC_1,
    STR_MUSIC_STYLE_CUSTOM_MUSIC_2, STR_MUSIC_STYLE_MEDIEVAL,
    STR_MUSIC_STYLE_URBAN,          STR_MUSIC_STYLE_ORGAN,
    STR_MUSIC_STYLE_MECHANICAL,     STR_MUSIC_STYLE_MODERN,
    STR_MUSIC_STYLE_PIRATES,        STR_MUSIC_STYLE_ROCK_STYLE_3,
...
static const window_ride_colour_preview TrackColourPreviews[] = {
    ...
    { SPR_RIDE_DESIGN_PREVIEW_VERTICAL_DROP_ROLLER_COASTER_TRACK,
      SPR_RIDE_DESIGN_PREVIEW_VERTICAL_DROP_ROLLER_COASTER_SUPPORTS },
    { 0, 0 }, // CASH_MACHINE
    { 0, 0 }, // TWIST_TRACK
    { 0, 0 }, // HAUNTED_HOUSE
    { 0, 0 }, // FIRST_AID
    ...
    { SPR_RIDE_DESIGN_PREVIEW_MULTI_DIMENSION_ROLLER_COASTER_TRACK,
      SPR_RIDE_DESIGN_PREVIEW_MULTI_DIMENSION_ROLLER_COASTER_SUPPORTS },
    { 0, 0 }, // 38
...
static void window_ride_disable_tabs(rct_window * w)
{
    ...
    if (!ride_type_has_flag(ride_type, RIDE_TYPE_FLAG_HAS_TRACK_COLOUR_MAIN) &&
        ...
        !ride_type_has_flag(ride_type, RIDE_TYPE_FLAG_26) && !(RideData4[ride->type].flags & RIDE_TYPE_FLAG4_HAS_ENTRANCE_EXIT))
    {
...
rct_window * window_ride_open_station(int rideIndex, int stationIndex)
{
    ...
    if (gInputFlags & INPUT_FLAG_TOOL_ACTIVE && gCurrentToolWidget.window_classification == w->classification &&
...
static void window_ride_set_page(rct_window * w, int page)
{
    ...
    listen = 0;
    if (page == WINDOW_RIDE_PAGE_MAIN && w->page == WINDOW_RIDE_PAGE_MAIN && w->viewport != NULL &&
...
static void window_ride_init_viewport(rct_window * w)
{
    ...
    if (!w->viewport && ride->overall_view != 0xFFFF)
    {
        ...
        viewport_create(w, x, y, width, height, focus.coordinate.zoom, focus.coordinate.x,
                        focus.coordinate.y & VIEWPORT_FOCUS_Y_MASK, focus.coordinate.z,
...
static void window_ride_rename(rct_window * w)
{
    ...
    window_text_input_open(w, WIDX_RENAME, STR_RIDE_ATTRACTION_NAME, STR_ENTER_NEW_NAME_FOR_THIS_RIDE_ATTRACTION, ride->name,
                           ride->name_arguments, 32);
}
...
static void window_ride_show_view_dropdown(rct_window * w, rct_widget * widget)
{
    ...
    window_dropdown_show_text_custom_width(w->x + dropdownWidget->left, w->y + dropdownWidget->top,
                                           dropdownWidget->bottom - dropdownWidget->top + 1, w->colours[1], 0, numItems,
...
static void window_ride_show_open_dropdown(rct_window * w, rct_widget * widget)
{
    ...
    window_dropdown_show_text(w->x + widget->left, w->y + widget->top, widget->bottom - widget->top + 1, w->colours[1], 0,
                              numItems);
...
static void window_ride_main_invalidate(rct_window * w)
{
    ...
    uint32 spriteIds[] = {
        SPR_CLOSED, SPR_OPEN, SPR_TESTING,
    };
...
static void window_ride_main_paint(rct_window * w, rct_drawpixelinfo * dpi)
{
    ...
    gfx_draw_string_centred(dpi, STR_WINDOW_COLOUR_2_STRINGID, w->x + (widget->left + widget->right - 11) / 2,
                            w->y + widget->top, COLOUR_BLACK, gCommonFormatArgs);

    // Status
    widget = &window_ride_main_widgets[WIDX_STATUS];
    gfx_draw_string_centred_clipped(dpi, window_ride_get_status(w, gCommonFormatArgs), gCommonFormatArgs, COLOUR_BLACK,
                                    w->x + (widget->left + widget->right) / 2, w->y + widget->top,
...
static void window_ride_vehicle_mousedown(int widgetIndex, rct_window * w, rct_widget * widget)
{
    ...
    case WIDX_VEHICLE_TYPE_DROPDOWN:
        ...
        for (; rideTypeIterator <= rideTypeIteratorMax && numItems <= 63; rideTypeIterator++)
        {
            ...
            for (uint8 * currentRideEntryIndex = rideEntryIndexPtr; *currentRideEntryIndex != 0xFF && numItems <= 63;
        ...
        window_dropdown_show_text_custom_width(w->x + dropdownWidget->left, w->y + dropdownWidget->top,
                                               dropdownWidget->bottom - dropdownWidget->top + 1, w->colours[1],
                                               DROPDOWN_FLAG_STAY_OPEN, numItems, widget->right - dropdownWidget->left);
...
static void window_ride_vehicle_invalidate(rct_window * w)
{
    ...
    if ((w->var_496 <= 1 || (rideEntry->flags & RIDE_ENTRY_FLAG_SEPARATE_RIDE)) &&
        !(gConfigInterface.select_by_track_type || gCheatsShowVehiclesFromOtherTrackTypes))
    {
...
static void window_ride_mode_dropdown(rct_window * w, rct_widget * widget)
{
    ...
    // If the vehicle is not intended for them, hide those two modes (these are usually (or perhaps always) both continuous
    // circuit modes).
    ...
    window_dropdown_show_text_custom_width(w->x + dropdownWidget->left, w->y + dropdownWidget->top,
                                           dropdownWidget->bottom - dropdownWidget->top + 1, w->colours[1],
                                           DROPDOWN_FLAG_STAY_OPEN, numAvailableModes, widget->right - dropdownWidget->left);
...
static void window_ride_load_dropdown(rct_window * w, rct_widget * widget)
{
    ...
    window_dropdown_show_text_custom_width(w->x + dropdownWidget->left, w->y + dropdownWidget->top,
                                           dropdownWidget->bottom - dropdownWidget->top + 1, w->colours[1],
                                           DROPDOWN_FLAG_STAY_OPEN, 5, widget->right - dropdownWidget->left);
...
static void window_ride_operating_mouseup(rct_window * w, int widgetIndex)
{
    ...
    case WIDX_SYNCHRONISE_WITH_ADJACENT_STATIONS_CHECKBOX:
        set_operating_setting(w->number, RIDE_SETTING_DEPARTURE,
...
static void window_ride_operating_mousedown(int widgetIndex, rct_window * w, rct_widget * widget)
{
    ...
    case WIDX_LIFT_HILL_SPEED_INCREASE:
        ...
        set_operating_setting(w->number, RIDE_SETTING_LIFT_HILL_SPEED,
                              clamp(lower_bound, ride->lift_hill_speed + 1, upper_bound));
    ...
    case WIDX_MINIMUM_LENGTH_INCREASE:
        upper_bound = 250;
        lower_bound = 0;
        set_operating_setting(w->number, RIDE_SETTING_MIN_WAITING_TIME,
                              clamp(lower_bound, ride->min_waiting_time + 1, upper_bound));
        break;
    ...
    case WIDX_MAXIMUM_LENGTH_INCREASE:
        upper_bound = 250;
        lower_bound = 0;
        set_operating_setting(w->number, RIDE_SETTING_MAX_WAITING_TIME,
                              clamp(lower_bound, ride->max_waiting_time + 1, upper_bound));
        break;
...
static void window_ride_operating_paint(rct_window * w, rct_drawpixelinfo * dpi)
{
    ...
    gfx_fill_rect_inset(dpi, w->x + window_ride_operating_widgets[WIDX_PAGE_BACKGROUND].left + 4, w->y + 103,
...
static void window_ride_maintenance_mousedown(int widgetIndex, rct_window * w, rct_widget * widget)
{
    ...
    case WIDX_INSPECTION_INTERVAL_DROPDOWN:
        ...
        window_dropdown_show_text_custom_width(w->x + dropdownWidget->left, w->y + dropdownWidget->top,
                                               dropdownWidget->bottom - dropdownWidget->top + 1, w->colours[1],
                                               DROPDOWN_FLAG_STAY_OPEN, 7, widget->right - dropdownWidget->left);
    ...
    case WIDX_FORCE_BREAKDOWN:
        ...
        for (i = 0; i < 8; i++)
        {
            ...
            {
                if (i == BREAKDOWN_BRAKES_FAILURE && (ride->mode == RIDE_MODE_CONTINUOUS_CIRCUIT_BLOCK_SECTIONED ||
                                                      ride->mode == RIDE_MODE_POWERED_LAUNCH_BLOCK_SECTIONED))
                {
                    if (ride->num_vehicles != 1)
                        continue;
        ...
        {
            window_dropdown_show_text(w->x + dropdownWidget->left, w->y + dropdownWidget->top,
                                      dropdownWidget->bottom - dropdownWidget->top + 1, w->colours[1], DROPDOWN_FLAG_STAY_OPEN,
                                      num_items);
                ...
                for (int i = 0; i < ride->num_vehicles; ++i)
                {
                    ...
                    do
                    {
                        ...
                        vehicle->update_flags &=
                            ~(VEHICLE_UPDATE_FLAG_BROKEN_CAR | VEHICLE_UPDATE_FLAG_7 | VEHICLE_UPDATE_FLAG_BROKEN_TRAIN);
...
const uint8 window_ride_entrance_style_list[] = { RIDE_ENTRANCE_STYLE_PLAIN,       RIDE_ENTRANCE_STYLE_CANVAS_TENT,
                                                  RIDE_ENTRANCE_STYLE_WOODEN,      RIDE_ENTRANCE_STYLE_CASTLE_BROWN,
                                                  RIDE_ENTRANCE_STYLE_CASTLE_GREY, RIDE_ENTRANCE_STYLE_LOG_CABIN,
                                                  RIDE_ENTRANCE_STYLE_JUNGLE,      RIDE_ENTRANCE_STYLE_CLASSICAL_ROMAN,
                                                  RIDE_ENTRANCE_STYLE_ABSTRACT,    RIDE_ENTRANCE_STYLE_SNOW_ICE,
                                                  RIDE_ENTRANCE_STYLE_PAGODA,      RIDE_ENTRANCE_STYLE_SPACE,
...
static void window_ride_set_track_colour_scheme(rct_window * w, int x, int y)
{
    ...
    rct_xy16 mapCoord = { 0 };
    get_map_coordinates_from_pos(x, y, VIEWPORT_INTERACTION_MASK_RIDE, &mapCoord.x, &mapCoord.y, &interactionType, &mapElement,
                                 NULL);
    x = mapCoord.x;
    y = mapCoord.y;
...
static void window_ride_colour_mousedown(int widgetIndex, rct_window * w, rct_widget * widget)
{
    ...
    case WIDX_TRACK_COLOUR_SCHEME_DROPDOWN:
        ...
        window_dropdown_show_text_custom_width(w->x + dropdownWidget->left, w->y + dropdownWidget->top,
                                               dropdownWidget->bottom - dropdownWidget->top + 1, w->colours[1],
                                               DROPDOWN_FLAG_STAY_OPEN, 4, widget->right - dropdownWidget->left);
    ...
    case WIDX_ENTRANCE_STYLE_DROPDOWN:
        ...
        window_dropdown_show_text_custom_width(w->x + dropdownWidget->left, w->y + dropdownWidget->top,
                                               dropdownWidget->bottom - dropdownWidget->top + 1, w->colours[1],
                                               DROPDOWN_FLAG_STAY_OPEN, countof(window_ride_entrance_style_list),
                                               widget->right - dropdownWidget->left);
    ...
    case WIDX_VEHICLE_COLOUR_SCHEME_DROPDOWN:
        ...
        window_dropdown_show_text_custom_width(w->x + dropdownWidget->left, w->y + dropdownWidget->top,
                                               dropdownWidget->bottom - dropdownWidget->top + 1, w->colours[1],
                                               DROPDOWN_FLAG_STAY_OPEN, rideEntry->max_cars_in_train > 1 ? 3 : 2,
                                               widget->right - dropdownWidget->left);
    ...
    case WIDX_VEHICLE_COLOUR_INDEX_DROPDOWN:
        ...
        {
            gDropdownItemsFormat[i] = STR_DROPDOWN_MENU_LABEL;
            gDropdownItemsArgs[i]   = ((sint64)(i + 1) << 32) |
...
static void window_ride_colour_dropdown(rct_window * w, int widgetIndex, int dropdownIndex)
{
    ...
    case WIDX_TRACK_COLOUR_SCHEME_DROPDOWN:
        ...
        break;
    case WIDX_TRACK_MAIN_COLOUR:
        game_do_command(0, (0 << 8) | 1, 0, (dropdownIndex << 8) | w->number, GAME_COMMAND_SET_RIDE_APPEARANCE, w->ride_colour,
                        0);
        break;
    case WIDX_TRACK_ADDITIONAL_COLOUR:
        game_do_command(0, (1 << 8) | 1, 0, (dropdownIndex << 8) | w->number, GAME_COMMAND_SET_RIDE_APPEARANCE, w->ride_colour,
                        0);
        break;
    case WIDX_TRACK_SUPPORT_COLOUR:
        game_do_command(0, (4 << 8) | 1, 0, (dropdownIndex << 8) | w->number, GAME_COMMAND_SET_RIDE_APPEARANCE, w->ride_colour,
                        0);
        break;
    case WIDX_MAZE_STYLE_DROPDOWN:
        game_do_command(0, (4 << 8) | 1, 0, (dropdownIndex << 8) | w->number, GAME_COMMAND_SET_RIDE_APPEARANCE, w->ride_colour,
        ...
        break;
    case WIDX_ENTRANCE_STYLE_DROPDOWN:
        game_do_command(0, (6 << 8) | 1, 0, (window_ride_entrance_style_list[dropdownIndex] << 8) | w->number,
...
static void window_ride_colour_invalidate(rct_window * w)
{
    ...
    // Track preview
    if (ride_type_has_flag(ride->type, RIDE_TYPE_FLAG_HAS_TRACK_COLOUR_MAIN | RIDE_TYPE_FLAG_HAS_TRACK_COLOUR_ADDITIONAL |
...
static void window_ride_colour_paint(rct_window * w, rct_drawpixelinfo * dpi)
{
    ...
    if (widget->type != WWT_EMPTY)
        gfx_fill_rect(dpi, w->x + widget->left + 1, w->y + widget->top + 1, w->x + widget->right - 1, w->y + widget->bottom - 1,
                      12);
    ...
    if (widget->type != WWT_EMPTY)
    {
        if (clip_drawpixelinfo(&clippedDpi, dpi, w->x + widget->left + 1, w->y + widget->top + 1, widget->right - widget->left,
...
static void window_ride_colour_scrollpaint(rct_window * w, rct_drawpixelinfo * dpi, int scrollIndex)
{
    ...
    // ?
    trainCarIndex =
        (ride->colour_scheme_type & 3) == RIDE_COLOUR_SCHEME_DIFFERENT_PER_CAR ? w->var_48C : rideEntry->tab_vehicle;
...
static void window_ride_measurements_mousedown(int widgetIndex, rct_window * w, rct_widget * widget)
{
    ...
    window_dropdown_show_text(w->x + widget->left, w->y + widget->top, widget->bottom - widget->top + 1, w->colours[1], 0, 2);
...
static void window_ride_graphs_update(rct_window * w)
{
    ...
    if (!(w->list_information_type & 0x8000))
    {
        ...
        x           = measurement == NULL ? 0 : measurement->current_item - (((widget->right - widget->left) / 4) * 3);
    }
...
static void window_ride_income_invalidate(rct_window * w)
{
    ...
    if ((!(gParkFlags & PARK_FLAGS_PARK_FREE_ENTRY) && rideEntry->shop_item == SHOP_ITEM_NONE &&

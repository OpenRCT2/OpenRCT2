...
rct_widget * window_player_page_widgets[] = { window_player_overview_widgets, window_player_statistics_widgets };
...
static rct_window_event_list window_player_overview_events = { window_player_overview_close,
...
static rct_window_event_list window_player_statistics_events = { window_player_statistics_close,
...
static rct_window_event_list * window_player_page_events[] = { &window_player_overview_events,
...
uint32 window_player_page_enabled_widgets[] = { (1 << WIDX_CLOSE) | (1 << WIDX_TAB_1) | (1 << WIDX_TAB_2) | (1 << WIDX_GROUP) |
                                                    (1 << WIDX_GROUP_DROPDOWN) | (1 << WIDX_LOCATE) | (1 << WIDX_KICK),
...
void window_player_overview_paint(rct_window * w, rct_drawpixelinfo * dpi)
{
    ...
    if (groupindex != -1)
    {
        ...
        gfx_draw_string_centred_clipped(dpi, STR_STRING, gCommonFormatArgs, COLOUR_BLACK,
                                        w->x + (widget->left + widget->right - 11) / 2, w->y + widget->top,

...
// 0x981D0C
rct_widget * window_guest_page_widgets[] = { window_guest_overview_widgets, window_guest_stats_widgets,
                                             window_guest_rides_widgets,    window_guest_finance_widgets,
                                             window_guest_thoughts_widgets, window_guest_inventory_widgets };
...
static rct_window_event_list window_guest_overview_events = { window_guest_overview_close,
...
static rct_window_event_list window_guest_stats_events = { NULL,
...
static rct_window_event_list window_guest_rides_events = { NULL,
                                                           window_guest_mouse_up,
...
static rct_window_event_list window_guest_finance_events = { NULL,
                                                             window_guest_mouse_up,
...
static rct_window_event_list window_guest_thoughts_events = { NULL,
                                                              window_guest_mouse_up,
...
static rct_window_event_list window_guest_inventory_events = { NULL,
                                                               window_guest_mouse_up,
...
// 0x981D24
static rct_window_event_list * window_guest_page_events[] = { &window_guest_overview_events, &window_guest_stats_events,
                                                              &window_guest_rides_events,    &window_guest_finance_events,
                                                              &window_guest_thoughts_events, &window_guest_inventory_events };

void window_guest_set_colours();

// 0x981D3C
uint32 window_guest_page_enabled_widgets[] = {
    (1 << WIDX_CLOSE) | (1 << WIDX_TAB_1) | (1 << WIDX_TAB_2) | (1 << WIDX_TAB_3) | (1 << WIDX_TAB_4) | (1 << WIDX_TAB_5) |
        (1 << WIDX_TAB_6) | (1 << WIDX_RENAME) | (1 << WIDX_PICKUP) | (1 << WIDX_LOCATE) | (1 << WIDX_TRACK),

    (1 << WIDX_CLOSE) | (1 << WIDX_TAB_1) | (1 << WIDX_TAB_2) | (1 << WIDX_TAB_3) | (1 << WIDX_TAB_4) | (1 << WIDX_TAB_5) |
        (1 << WIDX_TAB_6),

    (1 << WIDX_CLOSE) | (1 << WIDX_TAB_1) | (1 << WIDX_TAB_2) | (1 << WIDX_TAB_3) | (1 << WIDX_TAB_4) | (1 << WIDX_TAB_5) |
        (1 << WIDX_TAB_6) | (1 << WIDX_RIDE_SCROLL),
...
void window_guest_overview_mouse_up(rct_window * w, int widgetIndex)
{
    ...
    case WIDX_PICKUP:
        ...
        break;
    case WIDX_RENAME:
        window_text_input_open(w, widgetIndex, STR_GUEST_RENAME_TITLE, STR_GUEST_RENAME_PROMPT, peep->name_string_idx, peep->id,
                               32);
        break;
    case WIDX_LOCATE:
...
void window_guest_viewport_init(rct_window * w)
{
    ...
    if (peep->state != PEEP_STATE_PICKED)
    {
        if (!(w->viewport))
        {
            ...
            viewport_create(w, x, y, width, height, 0, focus.coordinate.x, focus.coordinate.y, focus.coordinate.z,
...
void window_guest_overview_text_input(rct_window * w, int widgetIndex, char * text)
{
    ...
    game_do_command(1, GAME_COMMAND_FLAG_APPLY, w->number, *((int *)(text + 0)), GAME_COMMAND_SET_GUEST_NAME,
                    *((int *)(text + 8)), *((int *)(text + 4)));
    game_do_command(2, GAME_COMMAND_FLAG_APPLY, w->number, *((int *)(text + 12)), GAME_COMMAND_SET_GUEST_NAME,
                    *((int *)(text + 20)), *((int *)(text + 16)));
    game_do_command(0, GAME_COMMAND_FLAG_APPLY, w->number, *((int *)(text + 24)), GAME_COMMAND_SET_GUEST_NAME,
...
void window_guest_stats_paint(rct_window * w, rct_drawpixelinfo * dpi)
{
    ...
    static const rct_string_id nauseaTolerances[] = {
        STR_PEEP_STAT_NAUSEA_TOLERANCE_NONE, STR_PEEP_STAT_NAUSEA_TOLERANCE_LOW, STR_PEEP_STAT_NAUSEA_TOLERANCE_AVERAGE,

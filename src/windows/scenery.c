        ...
        else if (currentSceneryGlobalId >= 0x200)
        {
            ...
            if (clip_drawpixelinfo(&clipdpi, dpi, left + 1, top + 1, 64, 78))
            {
                ...
                if (sceneryEntry->wall.flags & WALL_SCENERY_FLAG2)
                {
                    ...
                    gfx_draw_sprite(&clipdpi, imageId, 0x2F, (sceneryEntry->wall.height * 2) + 0x32, tertiaryColour);
                ...
                else
                {
                    ...
                    {
                        gfx_draw_sprite(&clipdpi, imageId + 1, 0x2F, (sceneryEntry->wall.height * 2) + 0x32, tertiaryColour);
                    }
                }
            }
        }

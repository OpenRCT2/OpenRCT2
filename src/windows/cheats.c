...
static rct_widget window_cheats_misc_widgets[] = {
	...
	{ WWT_CLOSEBOX,			1,		XPL(0),					WPL(0),					YPL(6),			HPL(6),			STR_OWN_ALL_LAND,					STR_NONE },								// Win scenario
	{ WWT_CLOSEBOX,			1,		XPL(1),					WPL(1),					YPL(6),			HPL(6),			STR_INVENT_ALL,						STR_NONE },								// Have fun!
	...
	{ WWT_CHECKBOX,			1,		XPL(0),					WPL(0),					YPL(16),		HPL(16),		STR_CHEAT_DISABLE_PLANT_AGING,		STR_CHEAT_DISABLE_PLANT_AGING_TIP },	// Disable plant aging
...
static void window_cheats_money_mouseup(rct_window *w, int widgetIndex)
{
	...
	case WIDX_IGNORE_MONEY:
		game_do_command(0, GAME_COMMAND_FLAG_APPLY, CHEAT_IGNOREMONEY, 0, GAME_COMMAND_CHEAT, 0, 0);
		break;
	case WIDX_FREE_BUILDING:
		game_do_command(0, GAME_COMMAND_FLAG_APPLY, CHEAT_FREEBUILDING, 0, GAME_COMMAND_CHEAT, 0, 0);
		break;
	}
}

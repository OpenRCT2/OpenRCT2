...
#define MAIN_MULTIPLAYER_WIDGETS                                                                                               \
    ...
    {                                                                                                                          \
        WWT_TAB, 1, 3, 33, 17, 43, 0x20000000 | SPR_TAB, STR_OPTIONS_TIP                                                       \
    } /* tab					*/

static rct_widget window_multiplayer_information_widgets[] = { MAIN_MULTIPLAYER_WIDGETS, { WIDGETS_END } };

static rct_widget window_multiplayer_players_widgets[] = { MAIN_MULTIPLAYER_WIDGETS,
                                                           { WWT_SCROLL, 1, 3, 336, 60, 236, SCROLL_VERTICAL,
                                                             STR_NONE }, // list
                                                           { WIDGETS_END } };
...
static rct_widget window_multiplayer_options_widgets[] = { MAIN_MULTIPLAYER_WIDGETS,
                                                           { WWT_CHECKBOX, 1, 3, 297, 50, 61, STR_LOG_CHAT, STR_LOG_CHAT_TIP },
                                                           { WWT_CHECKBOX, 1, 3, 297, 64, 75, STR_ALLOW_KNOWN_KEYS_ONLY,
                                                             STR_ALLOW_KNOWN_KEYS_ONLY_TIP },
                                                           { WIDGETS_END } };

static rct_widget * window_multiplayer_page_widgets[] = { window_multiplayer_information_widgets,
...
const uint64 window_multiplayer_page_enabled_widgets[] = {
    ...
    (1 << WIDX_CLOSE) | (1 << WIDX_TAB1) | (1 << WIDX_TAB2) | (1 << WIDX_TAB3) | (1 << WIDX_TAB4),
    (1 << WIDX_CLOSE) | (1 << WIDX_TAB1) | (1 << WIDX_TAB2) | (1 << WIDX_TAB3) | (1 << WIDX_TAB4) | (1 << WIDX_DEFAULT_GROUP) |
        (1 << WIDX_DEFAULT_GROUP_DROPDOWN) | (1 << WIDX_ADD_GROUP) | (1 << WIDX_REMOVE_GROUP) | (1 << WIDX_RENAME_GROUP) |
        (1 << WIDX_SELECTED_GROUP) | (1 << WIDX_SELECTED_GROUP_DROPDOWN),
    (1 << WIDX_CLOSE) | (1 << WIDX_TAB1) | (1 << WIDX_TAB2) | (1 << WIDX_TAB3) | (1 << WIDX_TAB4) |
...
static rct_window_event_list window_multiplayer_information_events = { NULL,
...
static rct_window_event_list window_multiplayer_players_events = { NULL,
...
static rct_window_event_list window_multiplayer_groups_events = { NULL,
...
static rct_window_event_list window_multiplayer_options_events = { NULL,
...
static rct_window_event_list * window_multiplayer_page_events[] = { &window_multiplayer_information_events,
...
static void window_multiplayer_groups_dropdown(rct_window * w, int widgetIndex, int dropdownIndex)
{
    ...
    {
    case WIDX_DEFAULT_GROUP_DROPDOWN:
        game_do_command(4 | (network_get_group_id(dropdownIndex) << 8), GAME_COMMAND_FLAG_APPLY, 0, 0,
                        GAME_COMMAND_MODIFY_GROUPS, 0, 0);
        break;
    case WIDX_SELECTED_GROUP_DROPDOWN:
...
static void window_multiplayer_groups_text_input(rct_window * w, int widgetIndex, char * text)
{
    ...
    game_do_command(3 | (_selectedGroup << 8) | (1 << 16), GAME_COMMAND_FLAG_APPLY, w->number, *((int *)(text + 0)),
                    GAME_COMMAND_MODIFY_GROUPS, *((int *)(text + 8)), *((int *)(text + 4)));
    game_do_command(3 | (_selectedGroup << 8) | (2 << 16), GAME_COMMAND_FLAG_APPLY, w->number, *((int *)(text + 12)),
                    GAME_COMMAND_MODIFY_GROUPS, *((int *)(text + 20)), *((int *)(text + 16)));
    game_do_command(3 | (_selectedGroup << 8) | (0 << 16), GAME_COMMAND_FLAG_APPLY, w->number, *((int *)(text + 24)),
                    GAME_COMMAND_MODIFY_GROUPS, *((int *)(text + 32)), *((int *)(text + 28)));
}

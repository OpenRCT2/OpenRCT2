...
// 0x009940EC
static rct_window_event_list window_track_manage_events = { window_track_manage_close,
...
// 0x0099415C
static rct_window_event_list window_track_delete_prompt_events = { NULL,
...
void window_track_manage_open(track_design_file_ref * tdFileRef)
{
    ...
    rct_window * w =
        window_create_centred(250, 44, &window_track_manage_events, WC_MANAGE_TRACK_DESIGN, WF_STICK_TO_FRONT | WF_TRANSPARENT);
...
static void window_track_manage_mouseup(rct_window * w, int widgetIndex)
{
    ...
    case WIDX_CLOSE:
        ...
        break;
    case WIDX_RENAME:
        window_text_input_raw_open(w, widgetIndex, STR_TRACK_DESIGN_RENAME_TITLE, STR_TRACK_DESIGN_RENAME_DESC,
...
static void window_track_delete_prompt_open()
{
    ...
    w = window_create(max(28, (gScreenWidth - 250) / 2), (gScreenHeight - 44) / 2, 250, 74, &window_track_delete_prompt_events,
                      WC_TRACK_DELETE_PROMPT, WF_STICK_TO_FRONT);
...
static void window_track_delete_prompt_paint(rct_window * w, rct_drawpixelinfo * dpi)
{
    ...
    gfx_draw_string_centred_wrapped(dpi, &_trackDesignFileReference->name, w->x + 125, w->y + 28, 246,

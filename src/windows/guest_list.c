...
static const rct_string_id pageNames[] = {
    STR_PAGE_1, STR_PAGE_2, STR_PAGE_3, STR_PAGE_4, STR_PAGE_5,
};

static const rct_string_id filterNames[] = {
    STR_GUESTS_FILTER, STR_GUESTS_FILTER_THINKING, STR_GUESTS_FILTER_THINKING_ABOUT,
};

static const rct_string_id viewNames[VIEW_COUNT] = {
    STR_ACTIONS, STR_THOUGHTS,
};
...
static rct_widget window_guest_list_widgets[] = {
    ...
    { WWT_DROPDOWN_BUTTON, 1, 284, 294, 60, 69, STR_DROPDOWN_GLYPH,
      STR_INFORMATION_TYPE_TIP },                                                      // information type dropdown button
...
static rct_window_event_list window_guest_list_events = { NULL,
...
void window_guest_list_open()
{
    ...
    window->enabled_widgets = (1 << WIDX_CLOSE) | (1 << WIDX_PAGE_DROPDOWN) | (1 << WIDX_PAGE_DROPDOWN_BUTTON) |
                              (1 << WIDX_INFO_TYPE_DROPDOWN) | (1 << WIDX_INFO_TYPE_DROPDOWN_BUTTON) | (1 << WIDX_MAP) |
                              (1 << WIDX_TRACKING) | (1 << WIDX_TAB_1) | (1 << WIDX_TAB_2);
...
static void window_guest_list_mousedown(int widgetIndex, rct_window * w, rct_widget * widget)
{
    ...
    case WIDX_PAGE_DROPDOWN_BUTTON:
        ...
        window_dropdown_show_text_custom_width(w->x + widget->left, w->y + widget->top, widget->bottom - widget->top + 1,
                                               w->colours[1], DROPDOWN_FLAG_STAY_OPEN, _window_guest_list_num_pages,
    ...
    case WIDX_INFO_TYPE_DROPDOWN_BUTTON:
        ...
        window_dropdown_show_text_custom_width(w->x + widget->left, w->y + widget->top, widget->bottom - widget->top + 1,
                                               w->colours[1], DROPDOWN_FLAG_STAY_OPEN, 2, widget->right - widget->left - 3);
...
static void window_guest_list_paint(rct_window * w, rct_drawpixelinfo * dpi)
{
    ...
    gfx_draw_sprite(dpi, SPR_TAB_GUESTS_0 + i, window_guest_list_widgets[WIDX_TAB_2].left + w->x,
    ...
    if (_window_guest_list_selected_tab == PAGE_INDIVIDUAL)
    {
        ...
        gfx_draw_string_left(dpi, (w->var_492 == 1 ? STR_FORMAT_NUM_GUESTS_SINGULAR : STR_FORMAT_NUM_GUESTS_PLURAL),
                             gCommonFormatArgs, COLOUR_BLACK, x, y);
    }
}
...
static void window_guest_list_find_groups()
{
    ...
    FOR_ALL_GUESTS(spriteIndex, peep)
    {
        ...
        get_arguments_from_peep(peep, &_window_guest_list_groups_argument_1[groupIndex],
                                &_window_guest_list_groups_argument_2[groupIndex]);
        ...
        do
        {
            ...
            memcpy(&(_window_guest_list_groups_guest_faces[groupIndex * 56]),

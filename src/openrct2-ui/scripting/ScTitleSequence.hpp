...
namespace OpenRCT2::Scripting
{
    ...
    inline JSValue TitleCommandToJS(JSContext* ctx, const OpenRCT2::Title::TitleCommand& value)
    {
    ...
    inline std::optional<OpenRCT2::Title::TitleCommand> TitleCommandFromJS(JSContext* ctx, JSValue value)
    {
        using namespace OpenRCT2::Title;
    ...
    class ScTitleSequencePark : public ScBase
    {
        ...
        static JSValue fileName_set(JSContext* ctx, JSValue thisVal, JSValue value)
        {
            ...
            auto seq = OpenRCT2::Title::LoadTitleSequence(data->_titleSequencePath);
            if (seq != nullptr)
            {
    ...
    class ScTitleSequence : public ScBase
    {
        ...
        static JSValue parks_get(JSContext* ctx, JSValue thisVal)
        {
            ...
            auto titleSeq = OpenRCT2::Title::LoadTitleSequence(data->_path);
            if (titleSeq != nullptr)
            {

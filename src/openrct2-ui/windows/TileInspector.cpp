...
namespace OpenRCT2::Ui::Windows
{
    ...
    static_assert(kWindowTileInspectorWidgetIdxButtonRotate == WIDX_BUTTON_ROTATE);
    static_assert(kWindowTileInspectorWidgetIdxButtonCopy == WIDX_BUTTON_COPY);
    static_assert(kWindowTileInspectorWidgetIdxButtonPaste == WIDX_BUTTON_PASTE);
    static_assert(kWindowTileInspectorWidgetIdxButtonSort == WIDX_BUTTON_SORT);
    static_assert(kWindowTileInspectorWidgetIdxButtonRemove == WIDX_BUTTON_REMOVE);
    static_assert(kWindowTileInspectorWidgetIdxButtonMoveUp == WIDX_BUTTON_MOVE_UP);
    static_assert(kWindowTileInspectorWidgetIdxButtonMoveDown == WIDX_BUTTON_MOVE_DOWN);
    static_assert(kWindowTileInspectorWidgetIdxSpinnerXIncrease == WIDX_SPINNER_X_INCREASE);
    static_assert(kWindowTileInspectorWidgetIdxSpinnerXDecrease == WIDX_SPINNER_X_DECREASE);
    static_assert(kWindowTileInspectorWidgetIdxSpinnerYIncrease == WIDX_SPINNER_Y_INCREASE);
    static_assert(kWindowTileInspectorWidgetIdxSpinnerYDecrease == WIDX_SPINNER_Y_DECREASE);
    static_assert(kWindowTileInspectorWidgetIdxSurfaceSpinnerHeightIncrease == WIDX_SURFACE_SPINNER_HEIGHT_INCREASE);
    static_assert(kWindowTileInspectorWidgetIdxSurfaceSpinnerHeightDecrease == WIDX_SURFACE_SPINNER_HEIGHT_DECREASE);
    static_assert(kWindowTileInspectorWidgetIdxPathSpinnerHeightIncrease == WIDX_PATH_SPINNER_HEIGHT_INCREASE);
    ...
    static_assert(kWindowTileInspectorWidgetIdxScenerySpinnerHeightIncrease == WIDX_SCENERY_SPINNER_HEIGHT_INCREASE);
    static_assert(kWindowTileInspectorWidgetIdxScenerySpinnerHeightDecrease == WIDX_SCENERY_SPINNER_HEIGHT_DECREASE);
    ...
    static_assert(kWindowTileInspectorWidgetIdxLargeScenerySpinnerHeightIncrease == WIDX_LARGE_SCENERY_SPINNER_HEIGHT_INCREASE);
    static_assert(kWindowTileInspectorWidgetIdxLargeScenerySpinnerHeightDecrease == WIDX_LARGE_SCENERY_SPINNER_HEIGHT_DECREASE);

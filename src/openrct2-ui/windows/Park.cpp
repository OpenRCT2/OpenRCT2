...
#pragma endregion
    ...
    private:
        void SetDisabledTabs()
        {
            ...
            setWidgetDisabled(WIDX_TAB_4, (_parkData.flags & PARK_FLAGS_NO_MONEY) != 0);
        }
...
#pragma region Price page
        ...
        void onMouseDownPrice(WidgetIndex widgetIndex)
        {
            ...
            switch (widgetIndex)
            {
                ...
                case WIDX_PRICE:
                {
                    ...
                    MoneyToString(Park::GetEntranceFee(_parkData), _moneyInputText, kMoneyStringMaxlength, false);
                    WindowTextInputRawOpen(
        ...
        void onPrepareDrawPrice()
        {
            ...
            if ((_parkData.flags & PARK_FLAGS_NO_MONEY) || !Park::EntranceFeeUnlocked(_parkData))
            {
...
#pragma region Objective page
        ...
        void onPrepareDrawObjective()
        {
            ...
            if (_parkData.flags & PARK_FLAGS_SCENARIO_COMPLETE_NAME_INPUT)
            {

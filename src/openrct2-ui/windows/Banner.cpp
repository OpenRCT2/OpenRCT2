...
static rct_widget window_banner_widgets[] = {
    ...
    { WWT_VIEWPORT,         1,  3,          WW - 26,17,     WH - 20,    STR_VIEWPORT,               STR_NONE},                          // tab content panel
    ...
    { WWT_COLOURBTN,        1,  5,          16,     WH - 16,WH - 5,     STR_NONE,                   STR_SELECT_MAIN_SIGN_COLOUR_TIP},   // high money
    { WWT_DROPDOWN,         1,  43,         81,     WH - 16,WH - 5,     STR_NONE,                   STR_NONE},                          // high money

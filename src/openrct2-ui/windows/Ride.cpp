...
static Widget _colourWidgets[] = {
    ...
    MakeWidget({139, 190}, { 80, 12}, WindowWidgetType::Button,    WindowColour::Secondary, STR_RANDOMISE_VEHICLE_COLOURS, STR_RANDOMISE_VEHICLE_COLOURS_TIP  ),
    kWidgetsEnd,
};
        ...
        void ColourOnMouseUp(WidgetIndex widgetIndex)
        {
            switch (widgetIndex)
            {
                ...
                case WIDX_RANDOMISE_VEHICLE_COLOURS:
                {
                    ...
                    {
                        colour = ScenarioRandMax(COLOUR_NUM_NORMAL);

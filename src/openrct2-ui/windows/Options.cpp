    ...
    switch (w->page)
    {
        ...
        case WINDOW_OPTIONS_PAGE_CULTURE:
            switch (widgetIndex)
            {
                ...
                {
                    num_items = CurrencyType::COUNT + 1;                      // All the currencies plus the separator
                    size_t num_ordinary_currencies = CurrencyType::COUNT - 1; // All the currencies except custom currency
                    ...
                    gDropdownItemsArgs[num_ordinary_currencies + 1] = CurrencyDescriptors[CurrencyType::Custom].stringId;
        ...
        case WINDOW_OPTIONS_PAGE_CULTURE:
            switch (widgetIndex)
            {
                case WIDX_HEIGHT_LABELS_DROPDOWN:
                    ...
                    break;
                case WIDX_CURRENCY_DROPDOWN:
                    if (dropdownIndex == CurrencyType::Custom + 1)

    ...
    switch (w->page)
    {
        case WINDOW_OPTIONS_PAGE_DISPLAY:
        {
            gfx_draw_string_left(
                ...
                { w->windowPos.x + 10, w->windowPos.y + window_options_display_widgets[WIDX_FULLSCREEN].top + 1 });
            ...
            gfx_draw_string_left(
                ...
                { w->windowPos.x + 10 + 15, w->windowPos.y + window_options_display_widgets[WIDX_RESOLUTION].top + 1 });

            gfx_draw_string_left(
                dpi, STR_UI_SCALING_DESC, w, w->colours[1],
                { w->windowPos.x + 10, w->windowPos.y + window_options_display_widgets[WIDX_SCALE].top + 1 });
            gfx_draw_string_left(
                dpi, STR_DRAWING_ENGINE, w, w->colours[1],
                { w->windowPos.x + 10, w->windowPos.y + window_options_display_widgets[WIDX_DRAWING_ENGINE].top + 1 });

            int32_t scale = static_cast<int32_t>(gConfigGeneral.window_scale * 100);
            gfx_draw_string_left(
                dpi, STR_WINDOW_OBJECTIVE_VALUE_RATING, &scale, w->colours[1],
                { w->windowPos.x + w->widgets[WIDX_SCALE].left + 1, w->windowPos.y + w->widgets[WIDX_SCALE].top + 1 });
            ...
            gfx_draw_string_left(
                ...
                { w->windowPos.x + 25, w->windowPos.y + window_options_display_widgets[WIDX_SCALE_QUALITY].top + 1 });
            break;
        }
        ...
        case WINDOW_OPTIONS_PAGE_CULTURE:
            gfx_draw_string_left(
                ...
                { w->windowPos.x + 10, w->windowPos.y + window_options_culture_widgets[WIDX_LANGUAGE].top + 1 });
            gfx_draw_string_left(
                dpi, STR_CURRENCY, w, w->colours[1],
                { w->windowPos.x + 10, w->windowPos.y + window_options_culture_widgets[WIDX_CURRENCY].top + 1 });
            gfx_draw_string_left(
                dpi, STR_DISTANCE_AND_SPEED, w, w->colours[1],
                { w->windowPos.x + 10, w->windowPos.y + window_options_culture_widgets[WIDX_DISTANCE].top + 1 });
            gfx_draw_string_left(
                dpi, STR_TEMPERATURE, w, w->colours[1],
                { w->windowPos.x + 10, w->windowPos.y + window_options_culture_widgets[WIDX_TEMPERATURE].top + 1 });
            gfx_draw_string_left(
                dpi, STR_HEIGHT_LABELS, w, w->colours[1],
                { w->windowPos.x + 10, w->windowPos.y + window_options_culture_widgets[WIDX_HEIGHT_LABELS].top + 1 });
            gfx_draw_string_left(
                dpi, STR_DATE_FORMAT, w, w->colours[1],
                { w->windowPos.x + 10, w->windowPos.y + window_options_culture_widgets[WIDX_DATE_FORMAT].top + 1 });
            break;
        ...
        case WINDOW_OPTIONS_PAGE_CONTROLS_AND_INTERFACE:
        {
            ...
            gfx_draw_string_left(
                ...
                { w->windowPos.x + 10, w->windowPos.y + window_options_controls_and_interface_widgets[WIDX_THEMES].top + 1 });
            break;
        }
        ...
        case WINDOW_OPTIONS_PAGE_MISC:
        {
            gfx_draw_string_left(
                ...
                { w->windowPos.x + 10, w->windowPos.y + window_options_misc_widgets[WIDX_TITLE_SEQUENCE].top + 1 });
            gfx_draw_string_left(
                dpi, STR_OPTIONS_SCENARIO_GROUPING, nullptr, w->colours[1],
                { w->windowPos.x + 10, w->windowPos.y + window_options_misc_widgets[WIDX_SCENARIO_GROUPING].top + 1 });
            gfx_draw_string_left(
        ...
        case WINDOW_OPTIONS_PAGE_ADVANCED:
        {
            gfx_draw_string_left(
                ...
                { w->windowPos.x + 24, w->windowPos.y + window_options_advanced_widgets[WIDX_AUTOSAVE].top + 1 });
            gfx_draw_string_left(
            ...
            gfx_draw_string_left(
                ...
                { w->windowPos.x + 24, w->windowPos.y + window_options_advanced_widgets[WIDX_AUTOSAVE_AMOUNT].top + 1 });

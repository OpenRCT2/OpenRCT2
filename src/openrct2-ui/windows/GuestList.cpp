...
static rct_widget window_guest_list_widgets[] = {
    { WWT_FRAME,            0,  0,      349,    0,  329,    STR_NONE,                   STR_NONE },                     // panel / background
    ...
    { WWT_RESIZE,           1,  0,      349,    43, 329,    STR_NONE,                   STR_NONE },                     // tab content panel
    ...
    { WWT_DROPDOWN,         1,  120,    295,    59, 70,     STR_NONE,                   STR_INFORMATION_TYPE_TIP },     // information type dropdown

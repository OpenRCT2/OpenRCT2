...
static rct_widget window_staff_overview_widgets[] = {
    ...
    { WWT_RESIZE,   1, 0,       WW - 1,     43,         WH - 1, STR_NONE,                   STR_NONE },             // Resize
    ...
    { WWT_VIEWPORT, 1, 3,       WW - 26,    47,         WH - 14,STR_NONE,                   STR_NONE},              // Viewport
    { WWT_12,       1, 3,       WW - 26,    WH - 13,    WH - 3, STR_NONE,                   STR_NONE },             // Label at bottom of viewport
...
static rct_widget window_staff_options_widgets[] = {
    ...
    { WWT_TAB,              1, 65,      95,     17,     43,     IMAGE_TYPE_REMAP | SPR_TAB, STR_STAFF_STATS_TIP},   // Tab 3
    { WWT_TAB,              1, 96,      126,    17,     43,     IMAGE_TYPE_REMAP | SPR_TAB, STR_NONE},              // Tab 4
    { WWT_CHECKBOX,         1, 5,       WW - 6, 50,     61,     STR_NONE,                   STR_NONE},              // Checkbox 1
    { WWT_CHECKBOX,         1, 5,       WW - 6, 67,     78,     STR_NONE,                   STR_NONE },             // Checkbox 2
    { WWT_CHECKBOX,         1, 5,       WW - 6, 84,     95,     STR_NONE,                   STR_NONE},              // Checkbox 3
    { WWT_CHECKBOX,         1, 5,       WW - 6, 101,    112,    STR_NONE,                   STR_NONE},              // Checkbox 4
    { WWT_DROPDOWN,         1, 5,       WW - 6, 50,     61,     STR_NONE,                   STR_NONE},              // Costume Dropdown

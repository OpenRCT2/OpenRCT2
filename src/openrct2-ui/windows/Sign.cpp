...
static rct_widget window_sign_widgets[] = {
        ...
        { WWT_COLOURBTN, 1, 5,      16,         WH - 16,    WH - 5,     STR_NONE,       STR_SELECT_MAIN_SIGN_COLOUR_TIP },  // Main colour
        { WWT_COLOURBTN, 1, 17,     28,         WH - 16,    WH - 5,     STR_NONE,       STR_SELECT_TEXT_COLOUR_TIP },       // Text colour
        { WIDGETS_END },
};

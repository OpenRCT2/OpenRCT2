            ...
            switch (widgetIndex)
            {
                ...
                case WIDX_HEIGHT_SOURCE_FIRST_DROPDOWN:
                {
                    ...
                    constexpr ItemExt items[] = {
                        ...
                        ItemExt(3, STR_STRINGID, STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_NW_LAND),
                        ItemExt(4, STR_STRINGID, STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_NW_WATER),
                        ItemExt(5, STR_STRINGID, STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_NW_CLEARANCE),
                        ItemExt(6, STR_STRINGID, STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_NE_LAND),
                        ItemExt(7, STR_STRINGID, STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_NE_WATER),
                        ItemExt(8, STR_STRINGID, STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_NE_CLEARANCE),
                        ItemExt(9, STR_STRINGID, STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_SE_LAND),
                        ItemExt(10, STR_STRINGID, STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_SE_WATER),
                        ItemExt(11, STR_STRINGID, STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_SE_CLEARANCE),
                        ItemExt(12, STR_STRINGID, STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_SW_LAND),
                        ItemExt(13, STR_STRINGID, STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_SW_WATER),
                        ItemExt(14, STR_STRINGID, STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_SW_CLEARANCE),
                        ItemExt(15, STR_STRINGID, STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_GLOBAL_MIN),
                        ItemExt(16, STR_STRINGID, STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_GLOBAL_MAX),

...
using sortFunc_t = bool (*)(const ListItem&, const ListItem&);

static std::vector<ListItem> _listItems;
...
static bool VisibleListSortRideName(const ListItem& a, const ListItem& b)
{
...
static bool VisibleListSortRideType(const ListItem& a, const ListItem& b)
{
...
static void WindowEditorObjectSelectionScrollMousedown(rct_window* w, int32_t scrollIndex, const ScreenCoordsXY& screenCoords)
{
    ...
    ListItem* listItem = &_listItems[selected_object];
...
static void WindowEditorObjectSelectionScrollMouseover(rct_window* w, int32_t scrollIndex, const ScreenCoordsXY& screenCoords)
{
    ...
    if (selectedObject != -1)
    {
        ListItem* listItem = &_listItems[selectedObject];
...
{
    ListItem* listItem = &_listItems[w->selected_list_item];

...
#pragma region Water page
        ...
        void WaterDraw(DrawPixelInfo& dpi)
        {
            ...
            // Water level
            {
                ...
                DrawTextBasic(
                    dpi, windowPos + ScreenCoordsXY{ widget.left + 1, widget.top + 1 }, STR_RIDE_LENGTH_ENTRY, ft,
                    { enabledColour });
            }
            ...
            // Number of riverbeds
            {
                ...
                DrawTextBasic(
                    dpi, windowPos + ScreenCoordsXY{ widget.left + 1, widget.top + 1 }, STR_COMMA16, ft, { textColour });
            }

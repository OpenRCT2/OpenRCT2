...
#define SHARED_WIDGETS \
    ...
    MakeWidget     ({ 0, 43}, {250, 229}, WWT_RESIZE, 1, 0xFFFFFFFF, STR_NONE), /* WIDX_PAGE_BACKGROUND */ \
    MakeRemapWidget({ 3, 17}, { 31,  27}, WWT_TAB,    1, SPR_TAB,    STR_NONE), /* WIDX_TAB_1 */ \
    MakeRemapWidget({34, 17}, { 31,  27}, WWT_TAB,    1, SPR_TAB,    STR_NONE), /* WIDX_TAB_2 */ \
    MakeRemapWidget({65, 17}, { 31,  27}, WWT_TAB,    1, SPR_TAB,    STR_NONE), /* WIDX_TAB_3 */ \
    MakeRemapWidget({96, 17}, { 31,  27}, WWT_TAB,    1, SPR_TAB,    STR_NONE) /* WIDX_TAB_4 */

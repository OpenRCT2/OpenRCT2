...
static StringId window_cheats_page_titles[] = {
        ...
        void onPrepareDraw() override
        {
            ...
            switch (page)
            {
                case WINDOW_CHEATS_PAGE_MONEY:
                {
                    ...
                    auto moneyDisabled = (gameState.parks[0].flags & PARK_FLAGS_NO_MONEY) != 0;
                ...
                case WINDOW_CHEATS_PAGE_PARK:
                    ...
                    if (gameState.parks[0].flags & PARK_FLAGS_PARK_OPEN)
    ...
    private:
        ...
        void onMouseUpMoney(WidgetIndex widgetIndex)
        {
            ...
            {
                case WIDX_NO_MONEY:
                    CheatsSet(CheatType::noMoney, gameState.parks[0].flags & PARK_FLAGS_NO_MONEY ? 0 : 1);
                    break;

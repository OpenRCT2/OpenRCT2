...
static Widget window_land_rights_widgets[] = {
    ...
    MakeRemapWidget({ 22, 53}, { 24, 24}, WindowWidgetType::ImgBtn, WindowColour::Tertiary,  SPR_BUY_LAND_RIGHTS,             STR_BUY_LAND_RIGHTS_TIP                        ), // land rights
    MakeRemapWidget({ 52, 53}, { 24, 24}, WindowWidgetType::ImgBtn, WindowColour::Tertiary,  SPR_BUY_CONSTRUCTION_RIGHTS,     STR_BUY_CONSTRUCTION_RIGHTS_TIP                ), // construction rights
    MakeWidget     ({100, 22}, {100, 12}, WindowWidgetType::Empty,  WindowColour::Secondary, STR_LAND_NOT_OWNED,              STR_SET_LAND_TO_BE_NOT_OWNED_TIP               ),
    MakeWidget     ({100, 38}, {100, 12}, WindowWidgetType::Empty,  WindowColour::Secondary, STR_LAND_SALE,                   STR_SET_LAND_TO_BE_AVAILABLE_TIP               ),
    MakeWidget     ({100, 54}, {100, 12}, WindowWidgetType::Empty,  WindowColour::Secondary, STR_LAND_OWNED,                  STR_SET_LAND_TO_BE_OWNED_TIP                   ),
    MakeWidget     ({100, 70}, {100, 12}, WindowWidgetType::Empty,  WindowColour::Secondary, STR_CONSTRUCTION_RIGHTS_SALE,    STR_SET_CONSTRUCTION_RIGHTS_TO_BE_AVAILABLE_TIP),
    MakeWidget     ({100, 86}, {100, 12}, WindowWidgetType::Empty,  WindowColour::Secondary, STR_CONSTRUCTION_RIGHTS_OWNED,   STR_SET_CONSTRUCTION_RIGHTS_TO_BE_OWNED_TIP    ),
    kWidgetsEnd,
};
    // clang-format on
    ...
    public:
        ...
        void PrepareDrawInGame()
        {
            ...
            // Set widget colours
            widgets[WIDX_DECREMENT].colour = static_cast<uint8_t>(WindowColour::Tertiary);
            widgets[WIDX_INCREMENT].colour = static_cast<uint8_t>(WindowColour::Tertiary);
        ...
        void PrepareDrawSandbox()
        {
            ...
            // Set widget colours
            widgets[WIDX_DECREMENT].colour = static_cast<uint8_t>(WindowColour::Secondary);
            widgets[WIDX_INCREMENT].colour = static_cast<uint8_t>(WindowColour::Secondary);

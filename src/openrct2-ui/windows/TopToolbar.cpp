    ...
    public:
        ...
        void onDraw(Drawing::RenderTarget& rt) override
        {
            ...
            if (widgets[WIDX_CHEATS].type != WidgetType::empty)
            {
                ...
                {
                    auto colour = ColourWithFlags{ OpenRCT2::Drawing::Colour::darkOrange }.withFlag(
            ...
            if (widgets[WIDX_NETWORK].type != WidgetType::empty)
            {
                ...
                auto colour = ColourWithFlags{ OpenRCT2::Drawing::Colour::white }.withFlag(ColourFlag::withOutline, true);

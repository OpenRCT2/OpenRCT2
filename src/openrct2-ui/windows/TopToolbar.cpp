...
#include <openrct2/actions/ScatterToolPlaceAction.h>
    ...
    void SceneryToolDown(const ScreenCoordsXY& screenCoords, WidgetIndex widgetIndex)
    {
        ...
        switch (sceneryType)
        {
            case SCENERY_TYPE_SMALL:
            {
                ...
                if (gWindowSceneryScatterEnabled)
                {
                    scatterItems(quantity, gridPos.x, gridPos.y, selectedScenery, quadrant, gWindowSceneryPrimaryColour, gWindowScenerySecondaryColour, gWindowSceneryTertiaryColour, gWindowSceneryScatterSize);
                }
                else
                {

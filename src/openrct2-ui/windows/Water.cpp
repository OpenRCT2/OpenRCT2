...
enum WINDOW_WATER_WIDGET_IDX {
    ...
    #define TITLEBAR \
        { WWT_CAPTION,  0,   1,  74, 1,  14, STR_WATER,                              STR_WINDOW_TITLE_TIP }, \
        { WWT_CLOSEBOX, 0,  63, 73, 2,  13, STR_CLOSE_X,                            STR_CLOSE_WINDOW_TIP }
#else
    // close button on left of window
    #define TITLEBAR \
        { WWT_CAPTION,  0,   10,  74, 1,  14, STR_WATER,                              STR_WINDOW_TITLE_TIP }, \

...
static rct_widget window_editor_bottom_toolbar_widgets[] = {
    { WWT_IMGBTN, 0, 0, 199, 0, 33, STR_NONE, 0xFFFF },           // 1        0x9A9958
    { WWT_FLATBTN, 0, 2, 197, 2, 31, STR_NONE, 0xFFFF },          // 2        0x9A9968
    { WWT_IMGBTN, 0, 440, 639, 0, 33, STR_NONE, 0xFFFF },         // 4        0x9A9978
    { WWT_FLATBTN, 0, 442, 637, 2, 31, STR_NONE, 0xFFFF },        // 8        0x9A9988
    { WIDGETS_END },
};

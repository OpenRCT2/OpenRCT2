...
namespace OpenRCT2::Ui::Windows
{
    ...
    static std::array<LoaderVehicleStyle, 4> kVehicleStyles = { {
        ...
        {
            ImageId{SPR_G2_LOADER_GO_KARTS_SUPPORTS, COLOUR_BLACK, COLOUR_WHITE },
            ImageId{SPR_G2_LOADER_GO_KARTS_TRACK, COLOUR_BORDEAUX_RED, COLOUR_BLACK },
            ImageId{SPR_G2_LOADER_GO_KARTS_VEHICLES, COLOUR_BRIGHT_RED, COLOUR_BRIGHT_RED, COLOUR_SATURATED_BROWN}
        },
    } };

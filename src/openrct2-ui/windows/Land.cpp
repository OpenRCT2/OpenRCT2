...
static rct_widget window_land_widgets[] = {
    { WWT_FRAME,    0,  0,  97, 0,  159,        STR_NONE,                                   STR_NONE },                     // panel / background
    ...
    { WWT_FLATBTN,  1,  2,  48, 106,    141,    STR_NONE,                                   STR_CHANGE_BASE_LAND_TIP },     // floor texture
    { WWT_FLATBTN,  1,  49, 95, 106,    141,    STR_NONE,                                   STR_CHANGE_VERTICAL_LAND_TIP }, // wall texture
    { WIDGETS_END },
};

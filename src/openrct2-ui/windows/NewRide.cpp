...
static rct_widget window_new_ride_widgets[] = {
    { WWT_FRAME,            0,  0,      600,    0,      369,    STR_NONE,                             STR_NONE                            },
    { WWT_CAPTION,          0,  1,      599,    1,      14,     STR_NONE,                             STR_WINDOW_TITLE_TIP                },
    { WWT_CLOSEBOX,         0,  588,    598,    2,      13,     STR_CLOSE_X,                          STR_CLOSE_WINDOW_TIP                },
    { WWT_RESIZE,           1,  0,      600,    43,     369,    STR_NONE,                             STR_NONE                            },
    ...
    { WWT_FLATBTN,          2,  265,    288,    161,    184,    STR_NONE,                             STR_RESEARCH_SHOW_DETAILS_TIP       },

...
namespace OpenRCT2::Ui::Windows
{
    ...
    public:
        ...
        void onDraw(RenderTarget& rt) override
        {
            ...
            if (Config::Get().general.debuggingTools)
            {
                ...
                drawText(rt, windowPos + ScreenCoordsXY{ kTabPanelWidth + 3, height - 3 - 11 }, shortPath, { colours[1] });
            }
        ...
        void onScrollMouseDownCampaignList(const ScreenCoordsXY& screenCoords)
        {
            ...
            if (mouseTabY >= 0 && mouseTabY < static_cast<int32_t>(_tabEntries.size()))
            {
                ...
                OpenRCT2::Audio::Play(Audio::SoundId::click1, 0, screenCoords.x);
        ...
        void onScrollDrawCampaignList(RenderTarget& rt)
        {
            ...
            for (int32_t i = 0; i < static_cast<int32_t>(_tabEntries.size()); i++)
            {
                ...
                drawTextWrapped(
                    rt, tabXY + tabCenter, 87, format, ft, { Drawing::Colour::lightWater, fontStyle, TextAlignment::centre });
            }
        }
    ...
    private:
        void DrawCategoryHeading(RenderTarget& rt, int32_t left, int32_t right,
            int32_t y, const ScenarioListItem& headerItem) const
        {
            ...
            drawText(rt, { centreX, y }, stringId, ft, { baseColour, TextAlignment::centre });

...
namespace OpenRCT2::Ui::Windows
{
    ...
    public:
        ...
        void onScrollDrawScenarioList(RenderTarget& rt)
        {
    ...
    private:
        void DrawCategoryHeading(RenderTarget& rt, int32_t left, int32_t right, int32_t y, const ScenarioListItem& headerItem) const
        {

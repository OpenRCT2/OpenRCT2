...
namespace OpenRCT2
{
     ...
     */
    constexpr std::array kDropdownOrder = {
    ...
    static_assert(EnumValue(TrackElemType::Count) == 330, "Reminder to add new track element to special dropdown list");
        ...
        RideConstructionState state)
    {
        ...
        for (OpenRCT2::TrackElemType trackType : kDropdownOrder)
        {

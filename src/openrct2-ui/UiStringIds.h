...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_CHEAT_DISABLE_GRASS_GROWING_TIP = 7032,
        ...
        STR_CLEAR_SCENERY_REMOVE_WALLS_TIP = 3187,
        STR_CLEAR_SCENERY_REMOVE_FOOTPATH_ADDITIONS_TIP = 7040,
        ...
        STR_FILE_DIALOG_TITLE_SAVE_MAPGEN_SETTINGS = 7234,
        STR_FILE_DIALOG_TITLE_LOAD_MAPGEN_SETTINGS = 7233,
        ...
        STR_OPENRCT2_MAPGEN_SETTINGS_FILE = 7235,
        ...
        STR_HEIGHTMAP_WARPED_NOISE = 7055,
        STR_HEIGHTMAP_RIDGED_NOISE = 7170,
        STR_HEIGHTMAP_VORONOI_NOISE = 7171,
        STR_HEIGHTMAP_NOISE = 7096,
        STR_HEIGHTMAP_NOISE_TYPE = 7063,
        STR_MAPGEN_TRANSFORM = 7172,
        STR_MAPGEN_TRANSFORM_TYPE = 7173,
        STR_MAPGEN_TRANSFORM_TYPE_NONE = 7174,
        STR_MAPGEN_TRANSFORM_TYPE_BOX = 7175,
        STR_MAPGEN_TRANSFORM_TYPE_GAUSSIAN = 7176,
        STR_MAPGEN_TRANSFORM_TYPE_SHARPEN = 7183,
        STR_MAPGEN_TRANSFORM_TYPE_BILATERAL = 7177,
        STR_MAPGEN_TRANSFORM_TYPE_EROSION = 7178,
        STR_MAPGEN_TRANSFORM_STRENGTH = 7179,
        STR_MAPGEN_SMOOTH_EDGE_NONE = 7180,
        STR_MAPGEN_SMOOTH_EDGE_WEAK = 7181,
        STR_MAPGEN_SMOOTH_EDGE_STRONG = 7182,
        ...
        STR_MAPGEN_BIAS = 7062,
        STR_MAPGEN_BIAS_TYPE = 7063,
        STR_MAPGEN_BIAS_STRENGTH = 7064,
        STR_MAPGEN_BIAS_TYPE_NONE = 7056,
        STR_MAPGEN_BIAS_TYPE_ISLAND = 7057,
        STR_MAPGEN_BIAS_TYPE_VALLEY = 7058,
        STR_MAPGEN_BIAS_TYPE_COASTAL = 7059,
        STR_MAPGEN_BIAS_TYPE_RIVER = 7060,
        STR_MAPGEN_BIAS_TYPE_CANYON = 7061,
        STR_MAPGEN_BIAS_TYPE_MOUNTAIN = 7069,
        STR_MAPGEN_BIAS_TYPE_CLIFF = 7070,
        STR_MAPGEN_BIAS_TYPE_TERRACE = 7184,
        STR_MAPGEN_SETTINGS_SERDE_IMPORT = 7230,
        STR_MAPGEN_SETTINGS_SERDE_EXPORT = 7231,
        STR_MAPGEN_SETTINGS_MISC_MENU = 7232,
        STR_MAPGEN_SETTINGS_RESET = 7229,

        STR_MAPGEN_RULE_COND_ADD = 7118,
        STR_MAPGEN_RULE_COND_EDIT = 7117,
        STR_MAPGEN_RULE_COND_REMOVE = 7116,
        STR_MAPGEN_RULE_CONDITION_BLEND_HEIGHT = 7124,
        STR_MAPGEN_RULE_CONDITION_BLEND_NOISE = 7123,
        STR_MAPGEN_RULE_CONDITION_BLEND_DISTANCE_TO = 7207,
        STR_MAPGEN_RULE_CONDITION_DISTANCE_TO = 7095,
        STR_MAPGEN_RULE_CONDITION_DISTANCE_TO_LABEL = 7222,
        STR_MAPGEN_RULE_CONDITION_DISTANCE_TO_FEATURE_WATER = 7200,
        STR_MAPGEN_RULE_CONDITION_DISTANCE_TO_FEATURE_RIVER = 7201,
        STR_MAPGEN_RULE_CONDITION_DISTANCE_TO_FEATURE_SEA = 7202,
        STR_MAPGEN_RULE_CONDITION_DISTANCE_TO_FEATURE_BORDER = 7203,
        STR_MAPGEN_RULE_CONDITION_DISTANCE_TO_FEATURE_FILL = 7204,
        STR_MAPGEN_RULE_CONDITION_DISTANCE_TO_FEATURE_BREACH = 7205,
        STR_MAPGEN_RULE_CONDITION_DISTANCE_TO_FEATURE_LAND = 7223,
        STR_MAPGEN_RULE_CONDITION_EDIT_WINDOW_TITLE = 7120,
        STR_MAPGEN_RULE_SCENERY_SELECT_WINDOW_TITLE = 7143,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_ABSOLUTE = 7091,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_RELATIVE = 7092,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_VERBOSE_ABSOLUTE = 7093,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_VERBOSE_RELATIVE = 7094,
        STR_MAPGEN_RULE_CONDITION_NOISE = 7096,
        STR_MAPGEN_RULE_CONDITION_NORMAL_ANGLE = 7097,
        STR_MAPGEN_RULE_CONDITION_PRNG = 7098,
        STR_MAPGEN_RULE_CONDITION_LAND_STYLE = 7145,
        STR_MAPGEN_RULE_CONDITION_LAND_STYLE_FMT = 7148,

        STR_MAPGEN_RULE_CONDITION_HEIGHT_MODE = 7240,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_MODE_ABSOLUTE = 7241,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_MODE_RELATIVE = 7242,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_MINUEND = 7243,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_SUBTRAHEND = 7244,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_SELF_LAND = 7245,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_SELF_WATER = 7246,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_SELF_CLEARANCE = 7277,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_NW_LAND = 7247,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_NW_WATER = 7248,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_NW_CLEARANCE = 7278,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_NE_LAND = 7249,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_NE_WATER = 7250,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_NE_CLEARANCE = 7279,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_SE_LAND = 7251,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_SE_WATER = 7252,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_SE_CLEARANCE = 7280,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_SW_LAND = 7253,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_SW_WATER = 7254,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_NEIGHBOUR_SW_CLEARANCE = 7281,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_GLOBAL_MIN = 7255,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_GLOBAL_MAX = 7256,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE_GLOBAL_WATER_LEVEL = 7257,
        STR_MAPGEN_RULE_CONDITION_HEIGHT_SOURCE = 7258,
        STR_MAPGEN_RULE_CONDITION_Z_REPEAT = 7267,

        STR_MAPGEN_RULE_EDGE_HIGH = 7128,
        STR_MAPGEN_RULE_EDGE_LOW = 7127,
        STR_MAPGEN_RULE_FEATURE = 7210,
        STR_MAPGEN_RULE_ENTER_NAME = 7114,
        STR_MAPGEN_RULE_GROUP_IF = 7087,
        STR_MAPGEN_RULE_GROUP_THEN = 7088,
        STR_MAPGEN_RULE_HEADER_CONDITIONS = 7084,
        STR_MAPGEN_RULE_HEADER_EDGE = 7086,
        STR_MAPGEN_RULE_HEADER_ENABLED = 7082,
        STR_MAPGEN_RULE_HEADER_NAME = 7083,
        STR_MAPGEN_RULE_HEADER_ITEMS = 7140,
        STR_MAPGEN_RULE_HEADER_SURFACE = 7085,
        STR_MAPGEN_RULE_TX_HINT = 7119,
        STR_MAPGEN_RULE_SC_HINT = 7142,
        STR_MAPGEN_RULE_NEW = 7081,
        STR_MAPGEN_RULE_PREDICATE_EQUAL = 7099,
        STR_MAPGEN_RULE_PREDICATE_GREATER_THAN = 7102,
        STR_MAPGEN_RULE_PREDICATE_GREATER_THAN_OR_EQUAL = 7104,
        STR_MAPGEN_RULE_PREDICATE_LESS_THAN = 7101,
        STR_MAPGEN_RULE_PREDICATE_LESS_THAN_OR_EQUAL = 7103,
        STR_MAPGEN_RULE_PREDICATE_NOT_EQUAL = 7100,
        STR_MAPGEN_RULE_PREDICATE_IN = 7146,
        STR_MAPGEN_RULE_PREDICATE_NOT_IN = 7147,
        STR_MAPGEN_RULE_PRESET_SC_ARID = 7152,
        STR_MAPGEN_RULE_PRESET_SC_COLD = 7155,
        STR_MAPGEN_RULE_PRESET_SC_RAINFOREST = 7159,
        STR_MAPGEN_RULE_PRESET_SC_MEDITERRANEAN = 7163,
        STR_MAPGEN_RULE_PRESET_TX_LARGE_GRASS_CLUMP_PATCHES = 7109,
        STR_MAPGEN_RULE_PRESET_TX_MEDIUM_DIRT_PATCHES = 7108,
        STR_MAPGEN_RULE_PRESET_TX_MOUNTAIN_PEAKS = 7110,
        STR_MAPGEN_RULE_PRESET_TX_SMALL_ROCK_PATCHES = 7107,
        STR_MAPGEN_RULE_REMOVE = 7090,
        STR_MAPGEN_RULE_RENAME = 7113,
        STR_MAPGEN_RULE_RENAME_TITLE = 7115,
        STR_MAPGEN_RULE_TITLE = 7080,
        STR_MAPGEN_RULE_VALUE_FLOAT = 7106,
        STR_MAPGEN_RULE_VALUE_INTEGER = 7105,
        STR_MAPGEN_RULE_VALUE_LENGTH = 7121,
        STR_MAPGEN_RULE_VALUE_FEATURE_LENGTH = 7206,
        STR_MAPGEN_RULE_VALUE_HEIGHT_RELATIVE_LENGTH = 7264,
        STR_MAPGEN_RULE_VALUE_BLEND_LENGTH = 7125,
        STR_MAPGEN_RULE_VALUE_BLEND_FLOAT = 7126,
        STR_MAPGEN_RULE_VALUE_BLEND_DISTANCE_LENGTH = 7209,
        STR_MAPGEN_RULE_COND_BLEND_HEIGHT_VERBOSE = 7129,
        STR_MAPGEN_RULE_COND_BLEND_NOISE_VERBOSE = 7130,
        STR_MAPGEN_RULE_COND_BLEND_DISTANCE_VERBOSE = 7208,
        STR_MAPGEN_RULE_ENTER_INTEGER = 7131,
        STR_MAPGEN_RULE_ENTER_LENGTH = 7132,
        STR_MAPGEN_RULE_ENTER_FLOAT = 7133,
        STR_MAPGEN_RULE_SELECT = 7141,
        STR_MAPGEN_RULE_SCENERY_ITEM_WEIGHT_TIMES_X = 7144,

        STR_MAPGEN_FORMAT_AREA_METRIC = 7265,
        STR_MAPGEN_FORMAT_AREA_IMPERIAL = 7266,

        STR_MAPGEN_SCENERY_EFFECT_ROTATION_NW = 7268,
        STR_MAPGEN_SCENERY_EFFECT_ROTATION_NE = 7269,
        STR_MAPGEN_SCENERY_EFFECT_ROTATION_SE = 7270,
        STR_MAPGEN_SCENERY_EFFECT_ROTATION_SW = 7271,
        STR_MAPGEN_SCENERY_EFFECT_ROTATION_RND = 7272,
        ...
        STR_MAPGEN_SEED = 7065,
        STR_MAPGEN_SEED_RANDOM = 7066,
        STR_MAPGEN_SEED_OFFSET = 7122,
        ...
        STR_WATER_RIVERS = 7189,
        STR_WATER_RIVERS_ENABLE = 7190,
        STR_WATER_RIVERS_CATCHMENT = 7191,
        STR_WATER_RIVERS_CATCHMENT_ENTER = 7192,
        STR_WATER_RIVERS_WIDTH_MAX = 7211,
        STR_WATER_RIVERS_WIDTH_MAX_ENTER = 7212,
        STR_WATER_RIVERS_GROWTH_EXPONENT = 7213,
        STR_WATER_RIVERS_GROWTH_EXPONENT_ENTER = 7214,
        STR_WATER_RIVERS_PRUNE_THRESHOLD = 7215,
        STR_WATER_RIVERS_PRUNE_THRESHOLD_ENTER = 7216,
        STR_WATER_RIVERS_BREACH_LENGTH = 7217,
        STR_WATER_RIVERS_BREACH_LENGTH_ENTER = 7218,
        STR_WATER_RIVERS_BREACH_DEPTH = 7219,
        STR_WATER_RIVERS_BREACH_DEPTH_ENTER = 7220,
        STR_WATER_RIVERS_BREACH_LABEL = 7221,
        STR_WATER_RIVERS_FRACTIONAL_AGGREGATION = 7274,
        STR_WATER_RIVERS_FRACTIONAL_AGGREGATION_EXPONENT = 7275,
        STR_WATER_RIVERS_FRACTIONAL_AGGREGATION_EXPONENT_ENTER = 7276,
        ...
        STR_WAIT_AND_LOAD_GROUP = 7038,
        STR_WAIT_FOR = 1206,
        STR_WAIT_FOR_PASSENGERS_BEFORE_DEPARTING_TIP = 1209,
        STR_X_CARS_PER_TRAIN = 1025,
        ...
        STR_THEMES_WINDOW_DATE_INFO_PANEL = 7042,
        ...
        STR_THEMES_WINDOW_PARK_INFO_PANEL = 7041,

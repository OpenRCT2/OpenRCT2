...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_COLOUR_GOLD_TIP = 7043,
        STR_COLOUR_AMBER_TIP = 7044,
        STR_COLOUR_AMETHYST_TIP = 7045,
        STR_COLOUR_ASPARAGUS_TIP = 7046,
        STR_COLOUR_BROWN_TIP = 7047,
        STR_COLOUR_BURNT_PINK_TIP = 7048,
        STR_COLOUR_CACTUS_TIP = 7049,
        STR_COLOUR_CARAMEL_TIP = 7050,
        STR_COLOUR_COPPER_TIP = 7051,
        STR_COLOUR_CRIMSON_TIP = 7052,
        STR_COLOUR_DARKER_WATER_TIP = 7053,
        STR_COLOUR_EMERALD_TIP = 7054,
        STR_COLOUR_INDIGO_TIP = 7055,
        STR_COLOUR_PESTO_TIP = 7056,
        STR_COLOUR_PINE_GREEN_TIP = 7057,
        STR_COLOUR_RUBY_TIP = 7058,
        STR_COLOUR_SAPPHIRE_TIP = 7059,
        STR_COLOUR_SILVER_TIP = 7060,
        STR_COLOUR_DEEP_BLUE_TIP = 7061,

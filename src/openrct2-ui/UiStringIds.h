...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_AUDIO_ENGINE_LABEL = 7033,
        STR_AUDIO_ENGINE_TIP = 7034,
        STR_AUDIO_ENGINE_LEGACY = 7035,
        STR_AUDIO_ENGINE_NEW = 7036,
        STR_HIGH_QUALITY_RESAMPLING = 7037,
        STR_HIGH_QUALITY_RESAMPLING_TIP = 7038,

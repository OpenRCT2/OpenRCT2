...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_LAST_INSPECTION = 6752,
        STR_LAST_INSPECTION_LABEL_MINUTE = 6753,
        STR_LAST_INSPECTION_LABEL_MINUTES = 6754,
        STR_LAST_INSPECTION_LABEL_MORE_THAN_FOUR_HOURS = 6755,

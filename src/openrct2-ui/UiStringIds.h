...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_TOUCH_ACTION_BAR = 7054,
        STR_TOUCH_BAR_CANCEL = 7052,
        STR_TOUCH_BAR_CANCEL_TIP = 7053,
        STR_TOUCH_BAR_CONFIRM = 7050,
        STR_TOUCH_BAR_CONFIRM_TIP = 7051,
        STR_TOUCH_BAR_DEMOLISH_TIP = 7055,
        STR_TOUCH_BAR_ROTATE = 7048,
        STR_TOUCH_BAR_ROTATE_TIP = 7049,
        STR_TOUCH_CENTRE_WINDOWS = 7044,
        STR_TOUCH_CENTRE_WINDOWS_TIP = 7045,
        STR_TOUCH_ENHANCEMENTS = 6644,
        STR_TOUCH_ENHANCEMENTS_TIP = 6639,
<<<<<<< HEAD
=======
        STR_TOUCH_HAPTICS = 7046,
        STR_TOUCH_HAPTICS_TIP = 7047,
>>>>>>> 6e97b58ecd6fe8fb04b553c93073eb4069aef2e7

...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_ENTER_BIAS_STRENGTH = 7027,
        STR_ENTER_EROSION_PPT = 7013,
        ...
        STR_MAPGEN_BIAS = 7022,
        STR_MAPGEN_BIAS_TYPE = 7023,
        STR_MAPGEN_BIAS_STRENGTH = 7024,
        STR_MAPGEN_BIAS_TYPE_NONE = 7016,
        STR_MAPGEN_BIAS_TYPE_ISLAND = 7017,
        STR_MAPGEN_BIAS_TYPE_VALLEY = 7018,
        STR_MAPGEN_BIAS_TYPE_COASTAL = 7019,
        STR_MAPGEN_BIAS_TYPE_RIVER = 7020,
        STR_MAPGEN_BIAS_TYPE_CANYON = 7021,
        STR_MAPGEN_BIAS_TYPE_MOUNTAIN = 7029,
        STR_MAPGEN_BIAS_TYPE_CLIFF = 7030,

        STR_MAPGEN_RULE_COND_ADD = 7078,
        STR_MAPGEN_RULE_COND_EDIT = 7077,
        STR_MAPGEN_RULE_COND_REMOVE = 7076,
        STR_MAPGEN_RULE_CONDITION_BLEND_HEIGHT = 7084,
        STR_MAPGEN_RULE_CONDITION_BLEND_NOISE = 7083,
        STR_MAPGEN_RULE_CONDITION_DISTANCE_TO_WATER = 7055,
        STR_MAPGEN_RULE_CONDITION_EDIT_WINDOW_TITLE = 7080,
        STR_MAPGEN_RULE_SCENERY_SELECT_WINDOW_TITLE = 7103,
        STR_MAPGEN_RULE_CONDITION_ELEVATION_ABSOLUTE = 7051,
        STR_MAPGEN_RULE_CONDITION_ELEVATION_RELATIVE_TO_WATER = 7054,
        STR_MAPGEN_RULE_CONDITION_NOISE = 7056,
        STR_MAPGEN_RULE_CONDITION_NORMAL_ANGLE = 7057,
        STR_MAPGEN_RULE_CONDITION_PRNG = 7058,
        STR_MAPGEN_RULE_CONDITION_LAND_STYLE = 7105,
        STR_MAPGEN_RULE_CONDITION_LAND_STYLE_FMT = 7108,
        STR_MAPGEN_RULE_EDGE_HIGH = 7088,
        STR_MAPGEN_RULE_EDGE_LOW = 7087,
        STR_MAPGEN_RULE_ENTER_NAME = 7074,
        STR_MAPGEN_RULE_GROUP_IF = 7047,
        STR_MAPGEN_RULE_GROUP_THEN = 7048,
        STR_MAPGEN_RULE_HEADER_CONDITIONS = 7044,
        STR_MAPGEN_RULE_HEADER_EDGE = 7046,
        STR_MAPGEN_RULE_HEADER_ENABLED = 7042,
        STR_MAPGEN_RULE_HEADER_NAME = 7043,
        STR_MAPGEN_RULE_HEADER_ITEMS = 7100,
        STR_MAPGEN_RULE_HEADER_SURFACE = 7045,
        STR_MAPGEN_RULE_TX_HINT = 7079,
        STR_MAPGEN_RULE_SC_HINT = 7102,
        STR_MAPGEN_RULE_NEW = 7041,
        STR_MAPGEN_RULE_PREDICATE_EQUAL = 7059,
        STR_MAPGEN_RULE_PREDICATE_GREATER_THAN = 7062,
        STR_MAPGEN_RULE_PREDICATE_GREATER_THAN_OR_EQUAL = 7064,
        STR_MAPGEN_RULE_PREDICATE_LESS_THAN = 7061,
        STR_MAPGEN_RULE_PREDICATE_LESS_THAN_OR_EQUAL = 7063,
        STR_MAPGEN_RULE_PREDICATE_NOT_EQUAL = 7060,
        STR_MAPGEN_RULE_PREDICATE_IN = 7106,
        STR_MAPGEN_RULE_PREDICATE_NOT_IN = 7107,
        STR_MAPGEN_RULE_PRESET_SC_ARID = 7112,
        STR_MAPGEN_RULE_PRESET_SC_COLD = 7115,
        STR_MAPGEN_RULE_PRESET_SC_RAINFOREST = 7119,
        STR_MAPGEN_RULE_PRESET_SC_MEDITERRANEAN = 7123,
        STR_MAPGEN_RULE_PRESET_TX_LARGE_GRASS_CLUMP_PATCHES = 7069,
        STR_MAPGEN_RULE_PRESET_TX_MEDIUM_DIRT_PATCHES = 7068,
        STR_MAPGEN_RULE_PRESET_TX_MOUNTAIN_PEAKS = 7070,
        STR_MAPGEN_RULE_PRESET_TX_SMALL_ROCK_PATCHES = 7067,
        STR_MAPGEN_RULE_REMOVE = 7050,
        STR_MAPGEN_RULE_RENAME = 7073,
        STR_MAPGEN_RULE_RENAME_TITLE = 7075,
        STR_MAPGEN_RULE_TITLE = 7040,
        STR_MAPGEN_RULE_VALUE_FLOAT = 7066,
        STR_MAPGEN_RULE_VALUE_INTEGER = 7065,
        STR_MAPGEN_RULE_VALUE_LENGTH = 7081,
        STR_MAPGEN_RULE_VALUE_BLEND_LENGTH = 7085,
        STR_MAPGEN_RULE_VALUE_BLEND_FLOAT = 7086,
        STR_MAPGEN_RULE_COND_BLEND_HEIGHT_VERBOSE = 7089,
        STR_MAPGEN_RULE_COND_BLEND_NOISE_VERBOSE = 7090,
        STR_MAPGEN_RULE_ENTER_INTEGER = 7091,
        STR_MAPGEN_RULE_ENTER_LENGTH = 7092,
        STR_MAPGEN_RULE_ENTER_FLOAT = 7093,
        STR_MAPGEN_RULE_SELECT = 7101,
        STR_MAPGEN_RULE_SCENERY_ITEM_WEIGHT_TIMES_X = 7104,
        ...
        STR_MAPGEN_SEED = 7025,
        STR_MAPGEN_SEED_RANDOM = 7026,
        STR_MAPGEN_SEED_OFFSET = 7082,

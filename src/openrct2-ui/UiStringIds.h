...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_MAPGEN_RULE_PRESET_LARGE_GRASS_CLUMP_PATCHES = 7109,
        STR_MAPGEN_RULE_PRESET_MEDIUM_DIRT_PATCHES = 7108,
        STR_MAPGEN_RULE_PRESET_MOUNTAIN_PEAKS = 7110,
        STR_MAPGEN_RULE_PRESET_SMALL_ROCK_PATCHES = 7107,

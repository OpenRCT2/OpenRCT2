...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_SHORTCUT_CONSTRUCTION_SPECIAL_DROPDOWN = 6778,
        ...
        STR_SHORTCUT_DROPDOWN_SELECT_NEXT_ITEM = 6779,
        STR_SHORTCUT_DROPDOWN_SELECT_PREV_ITEM = 6780,
        STR_SHORTCUT_END = 2560,
        STR_SHORTCUT_ESCAPE = 2552,
        STR_SHORTCUT_EXECUTE = 2568,
        STR_SHORTCUT_FOOTPATH_MODE_BRIDGE_AND_TUNNEL = 6782,
        STR_SHORTCUT_FOOTPATH_MODE_LAND = 6781,
        STR_SHORTCUT_FOOTPATH_PATH_DROPDOWN = 6783,
        STR_SHORTCUT_FOOTPATH_QUEUE_DROPDOWN = 6784,
        STR_SHORTCUT_FOOTPATH_RAILING_DROPDOWN = 6785,

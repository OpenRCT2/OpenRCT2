...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_TOUCH_HAPTICS = 7061,
        STR_TOUCH_HAPTICS_TIP = 7062,
        STR_TOUCH_GESTURES = 7045,
        STR_TOUCH_GESTURES_TIP = 7046,
        STR_TOUCH_NO_SECONDARY = 7047,
        STR_TOUCH_NO_SECONDARY_TIP = 7048,
        STR_TOUCH_ACTION_BAR = 7055,
        STR_TOUCH_ACTION_BAR_TIP = 7056,
        STR_TOUCH_BAR_CANCEL = 7053,
        STR_TOUCH_BAR_DEMOLISH_TIP = 7063,
        STR_TOUCH_BAR_CANCEL_TIP = 7054,
        STR_TOUCH_BAR_CONFIRM = 7051,
        STR_TOUCH_BAR_CONFIRM_TIP = 7052,
        STR_TOUCH_BAR_ROTATE = 7049,
        STR_TOUCH_BAR_ROTATE_TIP = 7050,
        STR_TOUCH_CENTRE_WINDOWS = 7059,
        STR_TOUCH_CENTRE_WINDOWS_TIP = 7060,
        STR_TOUCH_TAP_TO_PREVIEW = 7057,
        STR_TOUCH_TAP_TO_PREVIEW_TIP = 7058,
        STR_TOUCH_PLACE_ON_RELEASE = 7043,
        STR_TOUCH_PLACE_ON_RELEASE_TIP = 7044,

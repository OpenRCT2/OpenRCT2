...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_TOUCH_HAPTICS = 7045,
        STR_TOUCH_HAPTICS_TIP = 7046,
        STR_TOUCH_ACTION_BAR = 7053,
        STR_TOUCH_BAR_CANCEL = 7051,
        STR_TOUCH_BAR_DEMOLISH_TIP = 7054,
        STR_TOUCH_BAR_CANCEL_TIP = 7052,
        STR_TOUCH_BAR_CONFIRM = 7049,
        STR_TOUCH_BAR_CONFIRM_TIP = 7050,
        STR_TOUCH_BAR_ROTATE = 7047,
        STR_TOUCH_BAR_ROTATE_TIP = 7048,
        STR_TOUCH_CENTRE_WINDOWS = 7043,
        STR_TOUCH_CENTRE_WINDOWS_TIP = 7044,

...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_MAPGEN_RULE_PRESET_LARGE_GRASS_CLUMP_PATCHES = 7069,
        STR_MAPGEN_RULE_PRESET_MEDIUM_DIRT_PATCHES = 7068,
        STR_MAPGEN_RULE_PRESET_MOUNTAIN_PEAKS = 7070,
        STR_MAPGEN_RULE_PRESET_SMALL_ROCK_PATCHES = 7067,

...
static void ShortcutFootpathConstructionModeLand()
{
    if (gLegacyScene == LegacyScene::titleSequence)
        return;
    ...
    if (window != nullptr)
    {
        WindowFootpathKeyboardShortcutConstructionModeLand();
    }
}

static void ShortcutFootpathConstructionModeBridgeOrTunnel()
{
    if (gLegacyScene == LegacyScene::titleSequence)
        return;
    ...
    if (window != nullptr)
    {
        WindowFootpathKeyboardShortcutConstructionModeBridgeOrTunnel();
    }
}

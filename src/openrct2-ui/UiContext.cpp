        ...
        while (SDL_PollEvent(&e))
        {
            switch (e.type)
            {
                ...
                case SDL_MOUSEBUTTONDOWN:
                {
                    ...
                    switch (e.button.button)
                    {
                        case SDL_BUTTON_LEFT:
                            store_mouse_input(MouseState::LeftPress, mousePos);
                        ...
                        case SDL_BUTTON_RIGHT:
                            store_mouse_input(MouseState::RightPress, mousePos);
                ...
                case SDL_MOUSEBUTTONUP:
                {
                    ...
                    {
                        case SDL_BUTTON_LEFT:
                            store_mouse_input(MouseState::LeftRelease, mousePos);
                        ...
                        case SDL_BUTTON_MIDDLE:
                            ...
                            break;
                        case SDL_BUTTON_RIGHT:
                            store_mouse_input(MouseState::RightRelease, mousePos);
                ...
                case SDL_FINGERDOWN:
                {
                    ...
                    {
                        store_mouse_input(MouseState::RightPress, fingerPos);
                        _cursorState.right = CURSOR_PRESSED;
                        _cursorState.old = 2;
                    }
                    else
                    {
                        store_mouse_input(MouseState::LeftPress, fingerPos);
                        _cursorState.left = CURSOR_PRESSED;
                        _cursorState.old = 1;
                    }
                ...
                case SDL_FINGERUP:
                {
                    ...
                    if (_cursorState.touchIsDouble)
                    {
                        store_mouse_input(MouseState::RightRelease, fingerPos);
                        _cursorState.right = CURSOR_RELEASED;
                        _cursorState.old = 4;
                    }
                    else
                    {
                        store_mouse_input(MouseState::LeftRelease, fingerPos);
                        _cursorState.left = CURSOR_RELEASED;
                        _cursorState.old = 3;
                    }
                    _cursorState.touch = true;

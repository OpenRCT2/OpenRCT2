    ...
    rct_drawpixelinfo* dpi, rct_scroll* scroll, int32_t l, int32_t t, int32_t r, int32_t b, int32_t colour)
{
    ...
    // Left button
    {
        ...
        gfx_draw_string(dpi, static_cast<const char*>(BlackLeftArrowString), COLOUR_BLACK, ScreenCoordsXY(l + 1, t));
    }
    ...
    // Right button
    {
        ...
        gfx_draw_string(dpi, static_cast<const char*>(BlackRightArrowString), COLOUR_BLACK, ScreenCoordsXY(r - 6, t));
    }
}
    ...
    rct_drawpixelinfo* dpi, rct_scroll* scroll, int32_t l, int32_t t, int32_t r, int32_t b, int32_t colour)
{
    ...
    gfx_draw_string(dpi, static_cast<const char*>(BlackUpArrowString), COLOUR_BLACK, ScreenCoordsXY(l + 1, t - 1));
...
static void widget_text_box_draw(rct_drawpixelinfo* dpi, rct_window* w, rct_widgetindex widgetIndex)
{
    ...
    if (!active || gTextInput == nullptr)
    {
        if (w->widgets[widgetIndex].text != 0)
        {
            ...
            gfx_draw_string(dpi, wrapped_string, w->colours[1], ScreenCoordsXY(l + 2, t));
        }
        return;
    }

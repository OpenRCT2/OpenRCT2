...
static constexpr WindowThemeDesc WindowThemeDescriptors[] =
{
    ...
    { WindowClass::EditorOwnership,             "WC_EDITOR_OWNERSHIP",               STR_THEMES_WINDOW_EDITOR_OBJECT_SELECTION,        COLOURS_3(opaque(COLOUR_LIGHT_PURPLE),             opaque(COLOUR_GREY),                     opaque(COLOUR_GREY)                                        ) },
};

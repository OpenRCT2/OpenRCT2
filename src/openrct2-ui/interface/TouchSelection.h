...
namespace OpenRCT2::Ui
{
     ...
     * would make a slow second tap silently do nothing, and touch double taps were dropped
     * elsewhere in favour of long press.
     */
    template<typename T>
    ...
    private:
        ...
        {
            if (!Config::Get().interface.touchTapToPreview)
                return false;

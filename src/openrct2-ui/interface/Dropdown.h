...
namespace OpenRCT2::Ui::Windows
{
    ...
    void WindowDropdownShowColour(
        WindowBase* w, Widget* widget, ColourWithFlags dropdownColour, OpenRCT2::Drawing::Colour selectedColour,
        bool alwaysHideSpecialColours = false);

    OpenRCT2::Drawing::Colour ColourDropDownIndexToColour(uint8_t ddidx);

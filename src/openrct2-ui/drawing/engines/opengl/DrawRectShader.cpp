    ...
    , _maxInstancesBufferSize(kInitialInstancesBufferSize)
{
    ...
    glCall(
        glVertexAttribPointer, vVertVec, 2, GL_FLOAT, GL_FALSE, GLsizei(sizeof(VDStruct)),
    ...
    glCall(
        glVertexAttribIPointer, vClip, 4, GL_INT, GLsizei(sizeof(DrawRectCommand)),
        reinterpret_cast<void*>(offsetof(DrawRectCommand, clip)));
    glCall(
        glVertexAttribIPointer, vTexColourAtlas, 1, GL_INT, GLsizei(sizeof(DrawRectCommand)),
        reinterpret_cast<void*>(offsetof(DrawRectCommand, texColourAtlas)));
    glCall(
        glVertexAttribPointer, vTexColourBounds, 4, GL_FLOAT, GL_FALSE, GLsizei(sizeof(DrawRectCommand)),
        reinterpret_cast<void*>(offsetof(DrawRectCommand, texColourBounds)));
    glCall(
        glVertexAttribIPointer, vTexMaskAtlas, 1, GL_INT, GLsizei(sizeof(DrawRectCommand)),
        reinterpret_cast<void*>(offsetof(DrawRectCommand, texMaskAtlas)));
    glCall(
        glVertexAttribPointer, vTexMaskBounds, 4, GL_FLOAT, GL_FALSE, GLsizei(sizeof(DrawRectCommand)),
        reinterpret_cast<void*>(offsetof(DrawRectCommand, texMaskBounds)));
    glCall(
        glVertexAttribIPointer, vPalettes, 3, GL_INT, GLsizei(sizeof(DrawRectCommand)),
        reinterpret_cast<void*>(offsetof(DrawRectCommand, palettes)));
    glCall(
        glVertexAttribIPointer, vFlags, 1, GL_INT, GLsizei(sizeof(DrawRectCommand)),
        reinterpret_cast<void*>(offsetof(DrawRectCommand, flags)));
    glCall(
        glVertexAttribIPointer, vColour, 1, GL_UNSIGNED_INT, GLsizei(sizeof(DrawRectCommand)),
        reinterpret_cast<void*>(offsetof(DrawRectCommand, colour)));
    glCall(
        glVertexAttribIPointer, vBounds, 4, GL_INT, GLsizei(sizeof(DrawRectCommand)),
        reinterpret_cast<void*>(offsetof(DrawRectCommand, bounds)));
    glCall(
        glVertexAttribIPointer, vDepth, 1, GL_INT, GLsizei(sizeof(DrawRectCommand)),
    ...
    glCall(glEnableVertexAttribArray, vTexColourBounds);
    glCall(glEnableVertexAttribArray, vTexMaskAtlas);
    glCall(glEnableVertexAttribArray, vTexMaskBounds);
    ...
    glCall(glVertexAttribDivisor, vTexColourBounds, 1);
    glCall(glVertexAttribDivisor, vTexMaskAtlas, 1);
    glCall(glVertexAttribDivisor, vTexMaskBounds, 1);

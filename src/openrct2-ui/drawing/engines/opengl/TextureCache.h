...
constexpr int32_t TextureCacheMaxAtlasSize = 2048;

// Pixel dimensions of smallest supported slots in texture atlases
// Must be a power of 2!
constexpr int32_t TextureCacheSmallestSlot = 32;
...
public:
    ...
    static int32_t CalculateImageSizeOrder(int32_t actualWidth, int32_t actualHeight)
    {
        ...
        if (actualSize < TextureCacheSmallestSlot)
        {
            actualSize = TextureCacheSmallestSlot;
        }

...
void intro_update()
{
    ...
    case INTRO_STATE_DEVELOPER_SCROLL:
        ...
        if (!_chainLiftFinished && _introStateCounter >= gScreenHeight + 40 - 421)
        {
            ...
            _soundChannel =
                Mixer_Play_Effect(SOUND_TRACK_FRICTION_3, MIXER_LOOP_INFINITE, SDL_MIX_MAXVOLUME, 0.25f, 0.75, true);
        }
...
void intro_draw(rct_drawpixelinfo * dpi)
{
    ...
    case INTRO_STATE_PUBLISHER_SCROLL:
        ...
        gfx_fill_rect(dpi, (screenWidth / 2) - 320 + 50, _introStateCounter + 50, (screenWidth / 2) - 320 + 50 + 540,
